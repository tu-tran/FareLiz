namespace SkyDean.FareLiz.Data.Monitoring
{
    ...
    /// <summary>The monitor state.</summary>
    ...
    {
        /// <summary>The _control factory.</summary>
        ...
        /// <summary>Gets the batch process size.</summary>
        ...
        /// <summary>Gets the pending requests.</summary>
        ...
        /// <summary>Gets the processing requests.</summary>
        ...
        public void Start()
        {
            lock (this._lockObj)
            {
                AppContext.Logger.Debug("Start {0}...", this.GetType());
                ...
                AppContext.Logger.Debug("{0} started", this.GetType());
            }
        }
        ...
        public virtual void Stop()
        {
            lock (this._lockObj)
            {
                AppContext.Logger.Debug("Stopping {0}...", this.GetType());
                ...
                AppContext.Logger.Debug("{0} stopped", this.GetType());
            }
        }
        ...
        private void backgroundWorker_DoWork(object sender, DoWorkEventArgs e)
        {
            ...
            {
                var canProcessCount = this.BatchProcessSize - this._processQueue.Count;
                ...
                if (canProcessCount > 0)
                {
                    ...
                    foreach (var request in itemList)
                    {
                        var args = new FareBrowserRequestArg(request);
        ...
        private void backgroundWorker_RunWorkerCompleted(object sender, RunWorkerCompletedEventArgs e)
        {
            ...
            var noRunningReq = this._pendingQueue.Count == 0 && this._processQueue.Count == 0;
    ...
    public class FareBrowserRequestArg : CancelEventArgs
    {
        ...
        /// <summary>The request initiated date.</summary>
