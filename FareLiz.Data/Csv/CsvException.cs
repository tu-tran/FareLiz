namespace SkyDean.FareLiz.Data.Csv
{
    ...
    public partial class CsvException : Exception
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="CsvException" /> class. Initializes a new instance of the MalformedCsvException class.</summary>
        public CsvException()
            : this(null, null)
        {
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CsvException"/> class. Initializes a new instance of the MalformedCsvException class with
        /// serialized data.
        /// </summary>
        /// <param name="info">
