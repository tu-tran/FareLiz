...
namespace SkyDean.FareLiz.Data.Config
{
    ...
    public class IniConfig
    {
        ...
        public ICollection Sections { get { return m_sections.Values; } }
        ...
        {
            private IniConfig m_pIniConfig;
            private string m_sSection;  //  Name of the section
            private Hashtable m_keys;   //  List of IniKeys in the section
            ...
            public System.Collections.ICollection Keys { get { return m_keys.Values; } }    // Returns and hashtable of keys associated with the section
            public string Name { get { return m_sSection; } } // Returns the section name
            ...
            public bool SetName(string sSection)
            {
                ...
                if (sSection.Length != 0)
                {
                    ...
                    IniSection s = m_pIniConfig.GetSection(sSection);
                    if (s != this && s != null) return false;
                    try
                    {
                        // Remove the current section
                        m_pIniConfig.m_sections.Remove(m_sSection);
                        // Set the new section name to this object
                        m_pIniConfig.m_sections[sSection] = this;
