...
namespace SkyDean.FareLiz.Data.Config
{
    ...
    public class IniConfig
    {
        ...
        {
            IniSection s = this.GetSection(sSection);
            if (s != null)
            {
        ...
        {
            IniSection s = this.AddSection(sSection);
            if (s != null)
            {
        ...
        public class IniSection
        {
            ...
            public bool SetName(string sSection)
            {
                ...
                if (sSection.Length != 0)
                {
                    ...
                    IniSection s = this.m_pIniConfig.GetSection(sSection);
                    if (s != this && s != null)
                    {
                        return false;
                    }
            ...
            public class IniKey
            {
                ...
                public bool SetName(string sKey)
                {
                    ...
                    if (sKey.Length != 0)
                    {
                        IniKey k = this.m_section.GetKey(sKey);
                        if (k != this && k != null)
                        {
                            return false;
                        }
