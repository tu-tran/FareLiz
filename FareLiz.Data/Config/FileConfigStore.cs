namespace SkyDean.FareLiz.Data.Config
{
    ...
    {
        /// <summary>The _plugin resolver.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="FileConfigStore" /> class.</summary>
        protected FileConfigStore()
        {
        }

        /// <summary>Gets the config file.</summary>
        public string ConfigFile { get; private set; }

        /// <summary>Gets or sets the logger.</summary>
        public ILogger Logger { get; set; }

        /// <summary>The load env.</summary>
        /// <returns>The <see cref="MonitorEnvironment" />.</returns>
        ...
        public MonitorEnvironment LoadEnv(string filePath)
        {
            try
            {
                ...
                using (var stream = File.Open(filePath, FileMode.Open, FileAccess.ReadWrite, FileShare.ReadWrite))
                {
                    using (var reader = new BinaryReader(stream))
                    {
                        ...
                        this.Logger.Debug("Loading configuration for {0} {1}...", productName, productVersion);
                ...
                if (configs.Count > 0)
                {
                    ...
                    var backgroundServices = new BackgroundServiceManager(this.Logger);
            ...
            {
                this.Logger.Error("Failed to load environment data: {0}", ex);
            }
