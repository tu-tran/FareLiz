namespace SkyDean.FareLiz.Service.LiveUpdate
{
    ...
    /// <summary>
    /// This class plays the role of a third party application: It will update another application and restart it later on. In order to make use of
    /// this class, create an application that reference to this class
    /// </summary>
    public class LiveUpdateRunner
    {
        /// <summary>The _runner asm name.</summary>
                ...
                callback =>
                    {
                        ...
                        this._logger.Debug("Killing process [{0}]...", this._param.ProcessToEnd);
                ...
                (callback, ex) =>
                    {
                        ...
                        var message = "Update failed! Restoring application backup...";
        ...
        /// <summary>The start post process.</summary>
        ...
        {
            var message = "An error occured: " + ex.Message + Environment.NewLine + ex.StackTrace;
            this._logger.Error(message);
