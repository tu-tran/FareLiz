namespace SkyDean.FareLiz.Service.LiveUpdate
{
    ...
    public class LiveUpdateService : IServiceRunner, IHelperService, IDisposable
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="LiveUpdateService" /> class.</summary>
        ...
        /// <summary>Gets or sets the product logo.</summary>
        public Image ProductLogo { get; set; }

        /// <summary>Gets or sets the parent form.</summary>
        public Form ParentForm { get; set; }

        /// <summary>Gets the version retriever.</summary>
