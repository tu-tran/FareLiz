namespace SkyDean.FareLiz.Service.LiveUpdate
{
    ...
    /// <summary>The update parameter.</summary>
    public class UpdateParameter
    {
        /// <summary>Gets or sets the package location.</summary>
        public string PackageLocation { get; set; }

        /// <summary>Gets or sets the target update path.</summary>
        public string TargetUpdatePath { get; set; }

        /// <summary>Gets or sets the backup path.</summary>
        public string BackupPath { get; set; }

        /// <summary>Gets or sets the process to end.</summary>
        public string ProcessToEnd { get; set; }

        /// <summary>Gets or sets the restart process.</summary>
        public string RestartProcess { get; set; }

        /// <summary>Gets or sets the restart args.</summary>
        public string RestartArgs { get; set; }

        /// <summary>Gets or sets a value indicating whether notify msg.</summary>
        public bool NotifyMsg { get; set; }

        /// <summary>Generate parameter String. Pass this string into the Updater Binary so that it will do the actual update</summary>
