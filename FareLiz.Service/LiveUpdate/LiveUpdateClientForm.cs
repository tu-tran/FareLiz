namespace SkyDean.FareLiz.Service.LiveUpdate
{
    ...
    ///     Workflow: Download package to local folder -> Start updater inside that local folder (Kill process and overwrite
    ///     the file inside the application folder)
    /// </summary>
    public partial class LiveUpdateClientForm : SmartForm
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="LiveUpdateClientForm"/> class.</summary>
        ...
        /// <summary>The live update client form_ shown.</summary>
