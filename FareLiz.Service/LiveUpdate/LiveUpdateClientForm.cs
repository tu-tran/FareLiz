namespace SkyDean.FareLiz.Service.LiveUpdate
{
    ...
    /// <summary>
    /// This class provides GUI for LiveUpdate (used in the main app) The next version content must also contain the Updater Workflow: Download
    /// package to local folder -> Start updater inside that local folder (Kill process and overwrite the file inside the application folder)
    /// </summary>
