namespace SkyDean.FareLiz.Service.Utils
{
    ...
    {
        /// <summary>The m message.</summary>
        private readonly string mMessage;

        /// <summary>
        /// Initializes a new instance of the <see cref="FtpConnectionEventArgs"/> class. Initializes a new instance of the
        /// <see cref="FtpConnectionEventArgs"/>
        /// </summary>
        /// <param name="message">
