namespace SkyDean.FareLiz.Service.TaskScheduler.V1
{
    using System;
	...
	internal struct SystemTime
	{
		...
		{
			dt = dt.ToLocalTime();
			this.Year = Convert.ToUInt16(dt.Year);
			this.Month = Convert.ToUInt16(dt.Month);
			this.DayOfWeek = Convert.ToUInt16(dt.DayOfWeek);
			this.Day = Convert.ToUInt16(dt.Day);
			this.Hour = Convert.ToUInt16(dt.Hour);
			this.Minute = Convert.ToUInt16(dt.Minute);
			this.Second = Convert.ToUInt16(dt.Second);
			this.Milliseconds = Convert.ToUInt16(dt.Millisecond);
		}
