...
namespace SkyDean.FareLiz.Service.TaskScheduler
{
	...
	{
		private ITaskNamedValueCollection v2Coll = null;
		private Dictionary<string, string> unboundDict = null;

		internal NamedValueCollection(ITaskNamedValueCollection iColl) { v2Coll = iColl; }
		...
		/// </summary>
		/// <param name="key">ConfiguredType to get the value for.</param>
		/// <returns>TypeConfiguration for the key, or null if not found.</returns>
