...
namespace SkyDean.FareLiz.Service.TaskScheduler
{
    ...
    public enum TaskTriggerType
    {
        ...
        MonthlyDOW = 5,
        /// <summary>Triggers the task when the computer goes into an idle RequestState.</summary>
        Idle = 6,
        ...
        Logon = 9,
        /// <summary>Triggers the task when a specific user session RequestState changes. Version 1.2 only.</summary>
    ...
    public abstract class Trigger : IDisposable, ICloneable
    {
        ...
        internal ITaskTrigger v1Trigger = null;
        internal TaskTrigger v1TriggerData;
        internal ITrigger v2Trigger = null;
        ...
        {
            ITriggerCollection iTriggers = iTaskDef.Triggers;
    ...
    /// <summary>
    /// Represents a trigger that starts a task when the computer goes into an idle RequestState. For information about idle conditions, see Task Idle Conditions.
    /// </summary>
    ...
    public sealed class MonthlyDOWTrigger : Trigger, ICalendarTrigger, ITriggerDelay, IXmlSerializable
    {
        ...
        public WhichWeek WeeksOfMonth
        {
            get
            {
                if (v2Trigger != null)
                {
                    WhichWeek ww = (WhichWeek)((IMonthlyDOWTrigger)v2Trigger).WeeksOfMonth;
        ...
        public override void CopyProperties(Trigger sourceTrigger)
        {
            ...
            if (sourceTrigger.GetType() == this.GetType())
            {
                ...
                try { this.RunOnLastWeekOfMonth = ((MonthlyDOWTrigger)sourceTrigger).RunOnLastWeekOfMonth; }
                catch { }
                    ...
                    case "Weeks":
                        ...
                        while (reader.MoveToContent() == System.Xml.XmlNodeType.Element)
                        {
                            if (reader.LocalName == "Week")
                            {
                                ...
                                {
                                    switch (Int32.Parse(wk, CultureInfo.InvariantCulture))
                                    {
                                        case 1:
    ...
    public sealed class MonthlyTrigger : Trigger, ICalendarTrigger, ITriggerDelay, IXmlSerializable
    {
        ...
        public override void CopyProperties(Trigger sourceTrigger)
        {
            ...
            if (sourceTrigger.GetType() == this.GetType())
            {
                ...
                try { this.RunOnLastDayOfMonth = ((MonthlyTrigger)sourceTrigger).RunOnLastDayOfMonth; }
                catch { }
            }
        }
                    ...
                    case "DaysOfMonth":
                        ...
                        while (reader.MoveToContent() == System.Xml.XmlNodeType.Element)
                        {
                            if (reader.LocalName == "Day")
                            {
                                ...
                                {
                                    int day = Int32.Parse(sday, CultureInfo.InvariantCulture);
                                    if (day >= 1 && day <= 31)
                                        days.Add(day);
                                }
                            }
    ...
    public sealed class RepetitionPattern : IDisposable, IXmlSerializable
    {
        ...
        private IRepetitionPattern v2Pattern = null;
    ...
    public sealed class SessionStateChangeTrigger : Trigger, ITriggerDelay, ITriggerUserId
    {
        ...
        /// </summary>
        /// <param name="stateChange">The RequestState change.</param>
        ...
        /// <summary>
        /// Gets or sets the user for the Terminal Server session. When a session RequestState change is detected for this user, a task is started.
        /// </summary>
        [DefaultValue((string)null)]
        public string UserId
        {
