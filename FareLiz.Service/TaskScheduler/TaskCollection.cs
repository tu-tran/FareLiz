...
namespace SkyDean.FareLiz.Service.TaskScheduler
{
	...
	public sealed class TaskCollection : IEnumerable<Task>, IDisposable
	{
		...
		private ITaskScheduler v1TS = null;
		private IRegisteredTaskCollection v2Coll = null;
		...
		internal class V1TaskEnumerator : IEnumerator<Task>, IDisposable
		{
			...
			/// </summary>
			public SkyDean.FareLiz.Service.TaskScheduler.Task Current
			{
			...
			public bool MoveNext()
			{
				...
				do
				{
					...
					try
					{
						...
						if (uFetched != 1)
							break;
						using (CoTaskMemString name = new CoTaskMemString(Marshal.ReadIntPtr(names)))
				...
				get
				{
					...
					do
					{
						...
						try
						{
							...
							{
								using (CoTaskMemString name = new CoTaskMemString(Marshal.ReadIntPtr(cName)))
								{
	...
	public sealed class RunningTaskCollection : IEnumerable<RunningTask>, IDisposable
	{
		private TaskService svc;
		private ITaskScheduler v1TS = null;
		private ITaskService v2Svc = null;
		private IRunningTaskCollection v2Coll = null;
		...
		internal class RunningTaskEnumerator : IEnumerator<RunningTask>, IDisposable
		{
			...
			public RunningTask Current
			{
				get
				{
					IRunningTask irt = (IRunningTask)iEnum.Current;
