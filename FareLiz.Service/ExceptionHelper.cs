namespace SkyDean.FareLiz.Service
{
    ...
    /// <summary>The exception helper.</summary>
    public class ExceptionHelper
    {
        /// <summary>The _logger.</summary>
        private readonly ILogger _logger;

        /// <summary>The entry assembly location.</summary>
        ...
        /// <summary>Gets or sets the restart argument.</summary>
        public string RestartArgument { get; set; }

        /// <summary>Gets or sets a value indicating whether auto restart process.</summary>
        public bool AutoRestartProcess { get; set; }

        /// <summary>Gets or sets a value indicating whether silent mode.</summary>
        ...
        private void HandleException(Exception ex)
        {
            ...
            var shouldRestart = this.AutoRestartProcess;
            var shouldExit = true;
        ...
        public string Log(Exception ex)
        {
            ...
            try
            {
                var exHandler = this.GetHandler(ex);
                if (exHandler == null)
                {
            ...
            this._logger.Fatal(procEx.ToString());
