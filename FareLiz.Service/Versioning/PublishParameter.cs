namespace SkyDean.FareLiz.Service.Versioning
{
    ...
    internal class PublishParameter
    {
        ...
        /// <summary>Gets or sets the ftp sub directory.</summary>
        ...
        /// <summary>Gets the product base path.</summary>
        ...
        /// <summary>Gets the x 86 package file.</summary>
        ...
        /// <summary>Gets the x 64 package file.</summary>
        ...
        /// <summary>Gets the x 86 installer file.</summary>
        ...
        /// <summary>Gets the x 64 installer file.</summary>
        ...
        /// <summary>Gets the ftp base path.</summary>
        ...
        /// <summary>Gets the ftp product base path.</summary>
        ...
        /// <summary>Gets the ftp full x 86 package path.</summary>
        ...
        /// <summary>Gets the ftp full x 64 package path.</summary>
        ...
        /// <summary>Gets the ftp full x 86 installer path.</summary>
        ...
        /// <summary>Gets the ftp full x 64 installer path.</summary>
        ...
        /// <summary>Gets the ftp x 86 package relative path.</summary>
        ...
        /// <summary>Gets the ftp x 64 package relative path.</summary>
        ...
        /// <summary>Gets the ftp x 86 installer relative path.</summary>
        ...
        /// <summary>Gets the ftp x 64 installer relative path.</summary>
        ...
        /// <summary>Gets the default installation path.</summary>
        ...
        /// <summary>Gets a value indicating whether has installers.</summary>
        ...
        /// <summary>Gets the ftp server url.</summary>
        ...
        internal static PublishParameter FromCommandLine(string[] parameters)
        {
            ...
            var coreAsmName = Path.GetFileName(typeof(IHelperService).Assembly.Location);
            var newx86CoreLoc = Path.Combine(x86, coreAsmName);
            var x86vi = FileVersionInfo.GetVersionInfo(newx86CoreLoc);
            var newx64CoreLoc = Path.Combine(x64, coreAsmName);
        ...
        /// <summary>The product platform.</summary>
        private enum ProductPlatform
        {
            /// <summary>The x 86.</summary>
            x86, 

            /// <summary>The x 64.</summary>
            x64
        }
