namespace SkyDean.FareLiz.WinForm
{
    ...
    /// <summary>The execution info.</summary>
    [Serializable]
    [DefaultProperty("IsMinimized")]
    public class ExecutionInfo
    {
        /// <summary>The _departure date range.</summary>
        private DateRangeDiff _departureDateRange = new DateRangeDiff(0, 0);

        /// <summary>The _max stay duration.</summary>
        private int _maxStayDuration = 1;

        /// <summary>The _min stay duration.</summary>
        private int _minStayDuration = 1;

        /// <summary>The _price limit.</summary>
        private int _priceLimit = 1;

        /// <summary>The _return date range.</summary>
        private DateRangeDiff _returnDateRange = new DateRangeDiff(0, 0);

        /// <summary>Gets or sets a value indicating whether is minimized.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether auto sync.</summary>
        ...
        /// <summary>Gets or sets the departure date range.</summary>
        ...
        /// <summary>Gets or sets the return date range.</summary>
        ...
        /// <summary>Gets or sets the min stay duration.</summary>
        ...
        /// <summary>Gets or sets the max stay duration.</summary>
