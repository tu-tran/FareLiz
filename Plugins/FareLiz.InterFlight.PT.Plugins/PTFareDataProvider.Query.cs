namespace SkyDean.FareLiz.InterFlight
{
    ...
    /// <summary>The pt fare data provider.</summary>
    public partial class PTFareDataProvider
    {
        ...
        /// <summary>The domain base.</summary>
        ...
        /// <summary>The cookie base.</summary>
        ...
        /// <summary>The result base.</summary>
        ...
        /// <summary>The result referal base.</summary>
        ...
        /// <summary>The _request_.</summary>
        private readonly string _request_;

        /// <summary>The _result_.</summary>
        private readonly string _result_;

        /// <summary>The _result referal_.</summary>
        private readonly string _resultReferal_;

        /// <summary>The _root_.</summary>
        private readonly string _root_;

        /// <summary>Initializes a new instance of the <see cref="PTFareDataProvider" /> class.</summary>
        ...
        {
            var postData = this._generator.GeneratePOSTData(request);
            ...
            {
                var waitUri = response.ResponseUri.ToString();
                response.Close();
