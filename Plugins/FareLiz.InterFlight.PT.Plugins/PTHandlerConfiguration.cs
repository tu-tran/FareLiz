namespace SkyDean.FareLiz.InterFlight
{
    ...
    /// <summary>The pt handler configuration.</summary>
    [Serializable]
    internal class PTHandlerConfiguration : IConfig
    {
        /// <summary>The _max airline count.</summary>
        private int _maxAirlineCount = 15;

        /// <summary>The _max flights per airline.</summary>
        private int _maxFlightsPerAirline = 3;

        /// <summary>The _min price margin.</summary>
        private int _minPriceMargin = 1;

        /// <summary>The _simultaneous requests.</summary>
        private int _simultaneousRequests = 3;

        /// <summary>The _time out in seconds.</summary>
        private int _timeOutInSeconds = 300;

        /// <summary>Gets or sets the simultaneous requests.</summary>
        ...
        /// <summary>Gets or sets the max airline count.</summary>
