namespace SkyDean.FareLiz.InterFlight
{
    ...
    public sealed partial class PTFareDataProvider : IFareDataProvider
    {
        ...
        /// <summary>Gets or sets the currency provider.</summary>
        ...
        /// <summary>Gets the simultaneous requests.</summary>
        ...
        /// <summary>The get parser.</summary>
        /// <returns>The <see cref="PTDataParser" />.</returns>
