namespace SkyDean.FareLiz.InterFlight
{
    ...
    /// <summary>The pt data generator.</summary>
    public class PTDataGenerator
    {
        /// <summary>The f i_ culture.</summary>
        ...
        /// <summary>The use r_ agent.</summary>
        ...
        {
            var retDate = request.IsRoundTrip ? request.ReturnDate : request.DepartureDate.AddDays(7);
            var dataStr = "fly_radio_route_selection=" + (request.IsRoundTrip ? "both" : "oneway") + "&text_fly_from="
                          ...
                          + "&fly_age_select_1=&fly_age_select_2=&fly_age_select_3=&fly_age_select_4=&fly_age_select_5=" + "&from_IATA=" + "&to_IATA="
        ...
        {
            var result = HttpUtility.UrlEncode(postData);
            return result;
        }
    }
}