namespace SkyDean.FareLiz.Core
{
    ...
    /// <summary>
    /// Standard object for managing multiple helper services object
    /// </summary>
    [Serializable]
    public sealed class BackgroundServiceManager : IServiceManager
    {
        /// <summary>
        /// List of stored background services
        /// </summary>
        ...
        /// <summary>
        /// Create a new instance of Background Service Manager with an instance of Logger
        /// </summary>
        ...
        /// </summary>
        /// <param name="type">Target service type</param>
        /// <returns>The helper service of certain class type</returns>
        ...
        /// <summary>
        /// Returns list of all stored helped services in the manager
        /// </summary>
        ...
        /// <summary>
        /// Gets the total number of helper services
        /// </summary>
        public int Count
        {
        ...
        /// </summary>
        /// <param name="service">Target service to be started</param>
        ...
        /// </summary>
        /// <param name="service">Target service to be stopped</param>
