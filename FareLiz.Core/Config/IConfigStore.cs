...
{
    /// <summary>
    /// Interface for storing the configuration objects
    /// </summary>
    public interface IConfigStore
    {
        /// <summary>
        /// Load the working environment based on stored configurations
        /// </summary>
        ...
        /// </summary>
        /// <param name="env">Target working environment</param>
