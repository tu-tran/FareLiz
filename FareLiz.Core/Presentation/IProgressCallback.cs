namespace SkyDean.FareLiz.Core.Presentation
{
    ...
    /// <summary>
    /// This defines an interface which can be implemented by UI elements which indicate the progress of a long operation. (See ProgressDialog for a
    /// typical implementation)
    /// </summary>
    public interface IProgressCallback : INotification, IDisposable
    {
