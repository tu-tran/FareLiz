namespace SkyDean.FareLiz.Core.Utils
{
    ...
    public class StringFormatter
    {
        ...
        {
            var x1 = (this.bf_s0[this.wordByte0(b)] + this.bf_s1[this.wordByte1(b)]) ^ this.bf_s2[this.wordByte2(b)];
            var x2 = x1 + this.bf_s3[this.wordByte3(b)];
            var x3 = x2 ^ this.bf_P[n];
            return x3 ^ a;
        }
        ...
        public byte[] HexToByte(string hex)
        {
            ...
            {
                var a = this.GetHex(hex[i]);
                var b = this.GetHex(hex[i + 1]);
                r[i / 2] = (byte)(a * 16 + b);
            }
