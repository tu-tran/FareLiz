...
namespace SkyDean.FareLiz.Core.Utils.HtmlAgilityPack
{
    ...
    public partial class HtmlNode : IHtmlBaseNode
    {
        ...
        public HtmlNode(HtmlNodeType type, HtmlDocument ownerdocument, int index)
        {
            ...
            if (this._ownerdocument !=null && this._ownerdocument.Openednodes != null)
            {
                if (!this.Closed)
                {
        ...
        public HtmlAttributeCollection ClosingAttributes
        {
            get
            {
                return !this.HasClosingAttributes ? new HtmlAttributeCollection(this) : this._endnode.Attributes;
            }
        }
        ...
        public HtmlNode FirstChild
        {
            get
            {
                return !this.HasChildNodes ? null : this._childnodes[0];
            }
        }
        ...
        public HtmlNode LastChild
        {
            get
            {
                return !this.HasChildNodes ? null : this._childnodes[this._childnodes.Count - 1];
            }
        }
        ...
        public string Name
        {
            get
            {
                ...
                return this._name != null ? this._name.ToLower() : string.Empty;
            }
        ...
        {
            foreach (HtmlNode node in this.DescendantNodes())
            {
                yield return node;
            }
        }
        ...
        public HtmlNode InsertAfter(HtmlNode newChild, HtmlNode refChild)
        {
            ...
            if (this._childnodes != null) this._childnodes.Insert(index + 1, newChild);
        ...
        public HtmlNode InsertBefore(HtmlNode newChild, HtmlNode refChild)
        {
            ...
            if (this._childnodes != null) this._childnodes.Insert(index, newChild);
        ...
        public HtmlNode ReplaceChild(HtmlNode newChild, HtmlNode oldChild)
        {
            ...
            if (this._childnodes != null) this._childnodes.Replace(index, newChild);
        ...
        internal void WriteAttributes(TextWriter outText, bool closing)
        {
            ...
            if (!closing)
            {
                ...
                if (!this._ownerdocument.OptionAddDebuggingAttributes) return;
