...
namespace SkyDean.FareLiz.Core.Utils.HtmlAgilityPack
{
    ...
    public class HtmlNodeNavigator : XPathNavigator
    {
        ...
        private HtmlNodeNavigator(HtmlNodeNavigator nav)
        {
            ...
            this._doc = nav._doc;
            this.CurrentNode = nav._currentnode;
        ...
        public IHtmlBaseNode CurrentNode
        {
            ...
            private set { this._currentnode = value; }
        }
        ...
        public override bool MoveTo(XPathNavigator other)
        {
            ...
            if (nav._doc == this._doc)
            {
                if(nav._attindex>-1)
                {
                    this.CurrentNode = nav._currentnode.Attributes[nav._attindex];
                    this._attindex = 0;
                }
                else
                {
        ...
        public override bool MoveToFirst()
        {
            ...
            this.CurrentNode = this._currentnode.ParentNode.FirstChild;
            this.InternalTrace(">true");
            return true;
        }
        ...
        public override bool MoveToFirstChild()
        {
            ...
            this.CurrentNode = this._currentnode.ChildNodes[0];
            this.InternalTrace(">true");
            return true;
        }
        ...
        public override bool MoveToNext()
        {
            ...
            this.CurrentNode = this._currentnode.NextSibling;
            this.InternalTrace(">true");
            return true;
        }
        ...
        public override bool MoveToParent()
        {
            ...
            this.CurrentNode = this._currentnode.ParentNode;
            this.InternalTrace(">true");
            return true;
        }
        ...
        public override bool MoveToPrevious()
        {
            ...
            this.CurrentNode = this._currentnode.PreviousSibling;
            this.InternalTrace(">true");
            return true;
        }
        ...
        {
            this.CurrentNode = this._doc.DocumentNode;
            this.InternalTrace(null);
        }
        ...
        internal void InternalTrace(object traceValue)
        {
            ...
            HtmlAgilityPack.Trace.WriteLine(string.Format("oid={0},n={1},a={2},v={3},{4}", this.GetHashCode(), nodename, this._attindex, nodevalue, traceValue), "N!" + name);
        }
