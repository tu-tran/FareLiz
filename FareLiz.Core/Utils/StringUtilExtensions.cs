namespace SkyDean.FareLiz.Core.Utils
{
    ...
    public static class StringUtilExtensions
    {
        ...
        /// <summary>
        /// Tests whether specified string can be matched agains provided pattern string. Pattern may contain single- and multiple-replacing wildcard characters.
        /// </summary>
        public static bool IsMatch(this string input, string pattern, char singleWildcard, char multipleWildcard)
        {
            ...
            bool[][] pointTested = new bool[input.Length + 1][];       // Each true value indicates that input position vs. pattern position has been tested
            for (int i = 0; i < pointTested.Length; i++)
