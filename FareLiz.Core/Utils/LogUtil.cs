...
namespace SkyDean.FareLiz.Core.Utils
{
    ...
    using ILogger = SkyDean.FareLiz.Core.ILogger;

    /// <summary>The log utility.</summary>
    public static class LogUtil
    {
        ...
        /// <returns>The <see cref="Core.ILogger" />.</returns>
        ...
        {
            var logFileName = AppUtil.GetLocalDataPath("Logs\\" + AppUtil.EntryModuleName);
            var actualLogFileName = logFileName;
            ...
            var targetFile = actualLogFileName + LOG_EXT;
