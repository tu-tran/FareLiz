    ...
    public class Flight
    {
        ...
        public string TravelDateString
        {
            get
            {
                ...
                var result = StringUtil.GetPeriodString(startTime, endTime);
                return result;
            }
        }
        ...
        public string SummaryString
        {
            get
            {
                var outBound = this.OutboundLeg == null ? null : Environment.NewLine + "Outbound flight: " + this.OutboundLeg.DetailString;
                var inBound = this.InboundLeg == null ? null : Environment.NewLine + "Return flight: " + this.InboundLeg.DetailString;
                var agency = this.TravelAgency == null ? null : Environment.NewLine + "Travel agency: " + this.TravelAgency.Name;
                var result = "Departure: " + this.JourneyData.JourneyInfo.Route.Departure + Environment.NewLine + "Destination: "
        ...
        public bool IsAvailable
        {
            get
            {
                var deptDate = this.OutboundLeg == null ? DateTime.MinValue : this.OutboundLeg.Departure;
        ...
        public bool CanBePurchased
        {
            get
            {
                var result = this.TravelAgency != null && !string.IsNullOrEmpty(this.TravelAgency.Url) && this.IsAvailable;
                return result;
            }
        }
        ...
        {
            var result = string.Equals(this.Operator, otherFLight.Operator, StringComparison.OrdinalIgnoreCase);
