namespace SkyDean.FareLiz.WinForm.Components.Utils
{
    ...
    {
        /// <summary>The cb n_ dropdown.</summary>
        public const int CBN_DROPDOWN = 7;

        /// <summary>The g w_ child.</summary>
        public const int GW_CHILD = 5;

        /// <summary>The g w_ hwndfirst.</summary>
        public const int GW_HWNDFIRST = 0;

        /// <summary>The g w_ hwndlast.</summary>
        public const int GW_HWNDLAST = 1;

        /// <summary>The g w_ hwndnext.</summary>
        public const int GW_HWNDNEXT = 2;

        /// <summary>The g w_ hwndprev.</summary>
        public const int GW_HWNDPREV = 3;

        /// <summary>The g w_ owner.</summary>
        public const int GW_OWNER = 4;

        /// <summary>The gw l_ wndproc.</summary>
        public const int GWL_WNDPROC = -4;

        /// <summary>The h c_ action.</summary>
        public const int HC_ACTION = 0;

        /// <summary>The htbottom.</summary>
        public const int HTBOTTOM = 15;

        /// <summary>The htbottomleft.</summary>
        public const int HTBOTTOMLEFT = 16;

        /// <summary>The htbottomright.</summary>
        public const int HTBOTTOMRIGHT = 17;

        /// <summary>The htleft.</summary>
        public const int HTLEFT = 10;

        /// <summary>The htright.</summary>
        public const int HTRIGHT = 11;

        /// <summary>The httop.</summary>
        public const int HTTOP = 12;

        /// <summary>The httopleft.</summary>
        public const int HTTOPLEFT = 13;

        /// <summary>The httopright.</summary>
        public const int HTTOPRIGHT = 14;

        /// <summary>The httransparent.</summary>
        ...
        /// <summary>The tc m_ hittest.</summary>
        public const int TCM_HITTEST = 0x130D;

        /// <summary>The w h_ callwndproc.</summary>
        public const int WH_CALLWNDPROC = 4;

        /// <summary>The w s_ e x_ noactivate.</summary>
