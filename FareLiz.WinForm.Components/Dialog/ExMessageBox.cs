namespace SkyDean.FareLiz.WinForm.Components.Dialog
{
    ...
    /// <summary>The ex message box.</summary>
    public partial class ExMessageBox : SmartForm
    {
        ...
        /// <summary>The max width ratio.</summary>
        public static double MaxWidthRatio = 0.7;

        /// <summary>The max height ratio.</summary>
        ...
        /// <summary>The _button text.</summary>
        ...
        /// <summary>The _default button.</summary>
        private MessageBoxDefaultButton _defaultButton;

        /// <summary>The _visible buttons count.</summary>
        private int _visibleButtonsCount;

        /// <summary>
        /// Prevents a default instance of the <see cref="ExMessageBox" /> class from being created. Initializes a new instance of the
        /// <see cref="FlexibleMessageBoxForm" /> class.
        /// </summary>
        ...
        /// <summary>
        /// Ensure the given working area factor in the range of  0.2 - 1.0 where: 0.2 means:  Half as large as the working area. 1.0 means:  As large
        /// as the working area.
        /// </summary>
