namespace SkyDean.FareLiz.WinForm.Components.Controls.Custom
{
    ...
    {
        /// <summary>Gets or sets the content font.</summary>
        ...
        protected override Size MeasureContentSize(int maxWidth, int maxHeight)
        {
            ...
            var ver = result.Height > maxHeight;
            var hor = result.Width > maxWidth;

            var scroll = (hor && ver)
                             ? RichTextBoxScrollBars.Both
                             : (hor ? RichTextBoxScrollBars.Horizontal : (ver ? RichTextBoxScrollBars.Vertical : RichTextBoxScrollBars.None));
