namespace SkyDean.FareLiz.WinForm.Components.Controls.Custom
{
    ...
    /// <summary>The tool strip control agent.</summary>
    [ToolStripItemDesignerAvailability(ToolStripItemDesignerAvailability.ToolStrip | ToolStripItemDesignerAvailability.StatusStrip)]
    public class ToolStripControlAgent : ToolStripControlHost
    {
        /// <summary>Initializes a new instance of the <see cref="ToolStripControlAgent" /> class.</summary>
    ...
    public class ToolStripControl<T> : ToolStripControlAgent
        where T : Control
    {
        /// <summary>Initializes a new instance of the <see cref="ToolStripControl{T}" /> class.</summary>
        public ToolStripControl()
            : base(Activator.CreateInstance<T>())
        {
        }

        /// <summary>Gets the control item.</summary>
