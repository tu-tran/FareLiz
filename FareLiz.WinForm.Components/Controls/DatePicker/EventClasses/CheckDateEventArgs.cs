namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker.EventClasses
{
    ...
    /// <summary>Class that holds information for the <see cref="EnhancedDatePicker.ValueChanged" /> event.</summary>
    public class CheckDateEventArgs : EventArgs
    {
        ...
        /// <summary>Gets or sets a value indicating whether the <see cref="Date" /> is valid.</summary>
