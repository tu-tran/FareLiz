namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker.Renderer
{
    ...
    /// <summary>The base renderer class for the <see cref="EnhancedMonthCalendar" /><c>.</c>
    /// <see cref="EnhancedMonthCalendar.Renderer" />.</summary>
    public abstract class MonthCalendarAbstractRenderer
    {
        #region Fields

        /// <summary>The corresponding <see cref="EnhancedMonthCalendar" />.</summary>
        ...
        /// <summary>Gets the associated <see cref="EnhancedMonthCalendar" /> control.</summary>
        ...
        /// </param>
        /// <param name="path">
        /// The <see cref="GraphicsPath"/> to fill.
        /// </param>
        /// <param name="colorStart">
        /// The start color.
        /// </param>
        /// <param name="colorEnd">
        /// The end color if drawing a gradient background.
        /// </param>
        /// <param name="mode">
        /// The <see cref="LinearGradientMode"/> to use.
        /// </param>
        /// <exception cref="ArgumentNullException">
        ...
        public static void FillBackground(Graphics g, GraphicsPath path, Color colorStart, Color colorEnd, LinearGradientMode? mode)
        {
            ...
            if (colorEnd == Color.Empty)
            {
                ...
                {
                    using (var brush = new SolidBrush(colorStart))
                    {
            ...
            else
            {
                ...
                using (var brush = new LinearGradientBrush(rect, colorStart, colorEnd, mode.GetValueOrDefault(LinearGradientMode.Vertical)))
                {
                    g.FillPath(brush, path);
                }
            }
        ...
        /// </param>
        /// <returns>
        /// A <see cref="StringFormat"/> object.
        /// </returns>
        ...
        /// </param>
        /// <param name="bounds">
        /// The <see cref="Rectangle"/> area to draw the background on.
        /// </param>
