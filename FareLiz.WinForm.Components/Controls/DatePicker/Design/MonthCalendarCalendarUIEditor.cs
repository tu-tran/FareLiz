namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker.Design
{
    ...
    /// <summary>
    /// UI editor for the property <see cref="CustomControls.MonthCalendar.CultureCalendar" /> to choose between optional calendars of the culture specified
    /// by <see cref="CustomControls.MonthCalendar.Culture" />.
    /// </summary>
    internal class MonthCalendarCalendarUIEditor : UITypeEditor
    {
        ...
        /// <summary>
        /// Gets the editor style used by the <see cref="UITypeEditor"/><c>.EditValue(<see cref="IServiceProvider"/>, <see cref="Object"/>)</c>
        /// method.
        /// </summary>
        /// <param name="context">
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            if (context != null && context.Instance != null && provider != null)
            {
                ...
                {
                    EnhancedMonthCalendar cal = context.Instance.GetType() == typeof(EnhancedMonthCalendar)
