namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker.Design
{
    ...
    {
        /// <summary>The checklistbox.</summary>
        private readonly FlagCheckedListBox flagEnumCheckBox;

        /// <summary>Initializes a new instance of the <see cref="FlagEnumUIEditor" /> class.</summary>
        ...
        public override object EditValue(ITypeDescriptorContext context, IServiceProvider provider, object value)
        {
            ...
            {
                var editorSvc = (IWindowsFormsEditorService)provider.GetService(typeof(IWindowsFormsEditorService));
