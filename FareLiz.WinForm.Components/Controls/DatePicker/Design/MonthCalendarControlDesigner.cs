namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker.Design
{
    ...
    /// <summary>The <see cref="MonthCalendar" /> designer.</summary>
    internal class MonthCalendarControlDesigner : ControlDesigner
    {
        ...
        /// <summary>Provides the designer action list for the <see cref="CustomControls.MonthCalendar" /> or
        /// <see cref="EnhancedDatePicker" /> controls.</summary>
        internal class MonthCalendarControlDesignerActionList : DesignerActionList
        {
            ...
            /// <summary>Gets or sets a value indicating whether to show the smart tag area while creating.</summary>
            ...
            /// <summary>Returns the collection of <see cref="DesignerActionItem" />.</summary>
                ...
                var actionItems = new DesignerActionItemCollection
                                      {
                                          new DesignerActionMethodItem(
                                              ...
                                              string.Empty, 
                                              "Loads the color table from an XML-file", 
                                              true), 
                                          new DesignerActionMethodItem(
                                              this, 
                                              "SaveColorTable", 
                                              ...
                                              string.Empty, 
                                              "Saves the color table to an XML-file", 
                                              true)
                                      };
            ...
            /// <summary>The file filter.</summary>
            private const string FileFilter = "XML File (*.xml)|*.xml";

            /// <summary>The <see cref="CustomControls.MonthCalendar" /> control.</summary>
            private readonly EnhancedMonthCalendar cal;

            /// <summary>The <see cref="IComponentChangeService" />.</summary>
            private readonly IComponentChangeService iccs;

            /// <summary>The <see cref="DesignerActionUIService" />.</summary>
        ...
        /// <summary>Gets the design time action list collection which is supported by the designer.</summary>
