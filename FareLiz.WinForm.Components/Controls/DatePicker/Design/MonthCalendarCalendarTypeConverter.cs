namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker.Design
{
    ...
    /// <summary>Custom type converter for the <see cref="EnhancedMonthCalendar.CultureCalendar" /> property.</summary>
    internal class MonthCalendarCalendarTypeConverter : TypeConverter
    {
        ...
        /// </param>
        /// <param name="destinationType">
        /// The <see cref="Type"/> to convert the value parameter to.
        /// </param>
        /// <returns>
        ...
        public override object ConvertTo(ITypeDescriptorContext context, CultureInfo culture, object value, Type destinationType)
        {
            if (destinationType == typeof(string) && value != null && value is Calendar)
            {
                ...
                return cal.ToString().Replace("System.Globalization.", string.Empty).Replace("Calendar", string.Empty) + addString;
            }
