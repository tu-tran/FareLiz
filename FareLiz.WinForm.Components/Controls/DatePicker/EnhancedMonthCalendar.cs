namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker
{
    ...
    public sealed partial class EnhancedMonthCalendar : Control
    {
        ...
        {
            get { return this.viewStart; }

            set
            {
                if (value == this.viewStart
                   || value < this._minDate || value > this._maxDate)
                    return;
        ...
        public DateTime ViewEnd
        {
            get
            {
                MonthCalendarDate dt = new MonthCalendarDate(this.cultureCalendar, this.viewStart)
                   .GetEndDateOfWeek(this._formatProvider).FirstOfMonth.AddMonths(this.Months != null ? this.Months.Length - 1 : 1).FirstOfMonth;
        ...
        {
            get { return this.calendarDimensions; }
            set
            {
                ...
                this.scrollChange = Math.Max(0, Math.Min(this.scrollChange, this.calendarDimensions.Width * this.calendarDimensions.Height));   // adjust scroll change
        ...
        {
            get { return this.showWeekHeader; }
            set
            {
        ...
        {
            get { return this.useShortestDayNames; }
            set
            {
        ...
        public List<DateTime> BoldedDates
        {
            ...
            set { this.boldedDates = value ?? new List<DateTime>(); }
        }
        ...
        {
            get { return this._boldDatesCollection; }
        }
        ...
        {
            get { return new SelectionRange(this.selectionStart, this.selectionEnd); }
            set
            {
                if (value == null)
                {
        ...
        {
            get { return this.selectionRanges; }
        }
        ...
        {
            get { return this.maxSelectionCount; }
            set
            {
        ...
        {
            get { return this.daySelectionMode; }
            set
            {
        ...
        {
            get { return this.cultureCalendar; }
            set
            {
                if (value == null)
        ...
        {
            get { return new Size(this._monthWidth, this._monthHeight); }
        }
        ...
        {
            get { return new Size(this._dayWidth, this._dayHeight); }
        }
        ...
        {
            get { return new Size(this.Width, this._footerHeight); }
        }
        ...
        {
            get { return new Size(this._monthWidth, this._headerHeight); }
        }
        ...
        {
            get { return new Size(this._dayWidth * 7, this._dayNameHeight); }
        }
        ...
        {
            get { return new Size(this._weekNumberWidth, this._dayHeight * 7); }
        }
        ...
        {
            get { return this.mouseMoveFlags.LeftArrow ? ButtonState.Pushed : ButtonState.Normal; }
        }
        ...
        {
            get { return this.mouseMoveFlags.RightArrow ? ButtonState.Pushed : ButtonState.Normal; }
        }
        ...
        {
            this.SetStyle(ControlStyles.AllPaintingInWmPaint | ControlStyles.ResizeRedraw | ControlStyles.Selectable
            ...
            this._formatProvider = new MonthCalendarFormatProvider(this.culture, null, this.culture.TextInfo.IsRightToLeft) { EnhancedMonthCalendar = this };
        ...
        private MonthCalendarEraRange GetEraRange(int era)
        {
            ...
            return new MonthCalendarEraRange(this.CultureCalendar.GetEra(DateTime.Today), this.CultureCalendar.MinSupportedDateTime.Date, this.CultureCalendar.MaxSupportedDateTime.Date);
        }
        ...
        private void CalculateSize(bool changeDimension)
        {
            ...
            using (Graphics g = this.CreateGraphics())
            {
                ...
                SizeF monthNameSize = g.MeasureString(
                   this._formatProvider.GetMonthName(date.Year, date.Month),
                   this.headerFont);
                ...
                this.Height = (this._monthHeight * this.calendarDimensions.Height) + (this.showFooter ? this._footerHeight : 0) + this.Padding.Top + this.Padding.Bottom;
        ...
        private void UpdateMonthMenu(int year)
        {
            ...
            foreach (ToolStripMenuItem item in this.monthMenu.Items)
            {
                if (i <= monthsInYear)
                {
                    ...
                    bool isAvailable = (this._monthSelected.Year > this.MinDate.Year || (this._monthSelected.Year == this.MinDate.Year && i >= this.MinDate.Month))
                                     && (this._monthSelected.Year < this.MaxDate.Year || (this._monthSelected.Year == this.MaxDate.Year && i <= this.MaxDate.Month));
