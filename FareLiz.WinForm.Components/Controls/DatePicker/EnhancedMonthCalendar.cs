namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="EnhancedMonthCalendar" /> class.</summary>
        ...
        /// <summary>The _bold dates collection.</summary>
        private readonly BoldedDatesCollection _boldDatesCollection = new BoldedDatesCollection();

        /// <summary>The setredraw.</summary>
        private const int SETREDRAW = 11;

        /// <summary>The extend selection.</summary>
        private bool extendSelection;

        /// <summary>The selection started.</summary>
        private bool selectionStarted;

        /// <summary>The mouse location.</summary>
        private Point mouseLocation = Point.Empty;

        /// <summary>The current move bounds.</summary>
        private Rectangle currentMoveBounds = Rectangle.Empty;

        /// <summary>The _day width.</summary>
        private int _dayWidth;

        /// <summary>The _day height.</summary>
        private int _dayHeight;

        /// <summary>The _day name height.</summary>
        private int _dayNameHeight;

        /// <summary>The _month width.</summary>
        private int _monthWidth;

        /// <summary>The _month height.</summary>
        private int _monthHeight;

        /// <summary>The _week number width.</summary>
        private int _weekNumberWidth;

        /// <summary>The _header height.</summary>
        private int _headerHeight;

        /// <summary>The _footer height.</summary>
        private int _footerHeight;

        /// <summary>The _last visible date.</summary>
        private DateTime _lastVisibleDate;

        /// <summary>The _month selected.</summary>
        private DateTime _monthSelected;

        /// <summary>The _year selected.</summary>
        private DateTime _yearSelected;

        /// <summary>The _footer rect.</summary>
        private Rectangle _footerRect;

        /// <summary>The _left arrow rect.</summary>
        private Rectangle _leftArrowRect;

        /// <summary>The _right arrow rect.</summary>
        private Rectangle _rightArrowRect;

        /// <summary>The _renderer.</summary>
        ...
        /// <summary>The calendar size mode.</summary>
        public enum CalendarSizeMode
        {
            /// <summary>The calendar dimension.</summary>
            CalendarDimension, 

            /// <summary>The calendar size.</summary>
            CalendarSize
        }

        /// <summary>The size mode.</summary>
        ...
        /// <summary>The view start.</summary>
        ...
        /// <summary>The real start.</summary>
        ...
        public DateTime MinDate
        {
            ...
            set
            {
                ...
                this.UpdateMonths();
                var dim1 = Math.Max(1, this.calendarDimensions.Width * this.calendarDimensions.Height);
                var dim2 = this.Months != null ? this.Months.Length : 1;
                if (dim1 != dim2)
                {
        ...
        /// <summary>The calendar dimensions.</summary>
        ...
        /// <summary>The footer font.</summary>
        ...
        /// <summary>The day header font.</summary>
        ...
        /// <summary>The day text align.</summary>
        ...
        public bool RightToLeftLayout
        {
            ...
            set
            {
                ...
                var calDim = this.calendarDimensions;
                this.UpdateMonths();
        ...
        /// <summary>The right to left layout.</summary>
        ...
        /// <summary>The show footer.</summary>
        ...
        /// <summary>The show week header.</summary>
        ...
        /// <summary>The use shortest day names.</summary>
        private bool useShortestDayNames;

        /// <summary>Gets or sets a value indicating whether to use the native digits in
        /// <see cref="NumberFormatInfo.NativeDigits" />
        /// specified by <see cref="EnhancedMonthCalendar.Culture" />s <see cref="CultureInfo.NumberFormat" />
        /// for number display.</summary>
        [DefaultValue(false)]
        [Category("Appearance")]
        ...
        /// <summary>The use native digits.</summary>
        ...
        /// <summary>The bolded dates.</summary>
            ...
            set
            {
                ...
                switch (this.daySelectionMode)
                {
                    ...
                    case MonthCalendarSelectionMode.FullWeek:
                        var dt = new MonthCalendarDate(this.CultureCalendar, value).GetFirstDayInWeek(this._formatProvider);
        ...
        /// <summary>The selection start.</summary>
        ...
        /// <summary>The selection end.</summary>
        ...
        /// <summary>The selection ranges.</summary>
        ...
        /// <summary>The scroll change.</summary>
        ...
        /// <summary>The max selection count.</summary>
        ...
        /// <summary>The day selection mode.</summary>
        ...
        /// <summary>The non work days.</summary>
        ...
        public Calendar CultureCalendar
        {
            ...
            set
            {
                ...
                foreach (var c in this.culture.OptionalCalendars)
                {
                    if (value.GetType() == c.GetType())
                    {
                        if (value.GetType() == typeof(GregorianCalendar))
                        {
                            var g1 = (GregorianCalendar)value;
                            var g2 = (GregorianCalendar)c;
        ...
        /// <summary>The culture calendar.</summary>
        ...
        /// <summary>The _format provider.</summary>
        ...
        /// <summary>The mouse move flags.</summary>
        private readonly MonthCalendarMouseMoveFlags mouseMoveFlags = new MonthCalendarMouseMoveFlags();
        ...
        /// <summary>The current hit type.</summary>
        ...
        /// <summary>The _era ranges.</summary>
        ...
        public MonthCalendarHitTest HitTest(Point location)
        {
            ...
            {
                var hit = month.HitTest(location);
        ...
        internal bool IsSelected(DateTime date)
        {
            ...
            var selected = this.SelectionRange.Contains(date);
        ...
        protected override bool ProcessDialogKey(Keys keyData)
        {
            ...
            var dt = new MonthCalendarDate(this.cultureCalendar, this.selectionStart);
            var retValue = false;
        ...
        private static MonthCalendarEraRange[] GetEraRanges(Calendar cal)
        {
            ...
            var ranges = new List<MonthCalendarEraRange>();
            var date = cal.MinSupportedDateTime.Date;
            var currentEra = -1;
            while (date < cal.MaxSupportedDateTime.Date)
            {
                var era = cal.GetEra(date);
        ...
        {
            foreach (var e in this._eraRanges)
            {
                if (e.Era == era)
                {
                    return e;
        ...
        private void CalculateSize(bool changeDimension)
        {
            ...
            using (var g = this.CreateGraphics())
            {
                ...
                var daySize = g.MeasureString("30", this.Font);
                var weekNumSize = g.MeasureString("59", this.Font);

                var date = new MonthCalendarDate(this.CultureCalendar, this.viewStart);

                var monthNameSize = g.MeasureString(this._formatProvider.GetMonthName(date.Year, date.Month), this.headerFont);
                var yearStringSize = g.MeasureString(this.viewStart.ToString("yyyy"), this.headerFont);
                var footerStringSize = g.MeasureString(this.viewStart.ToShortDateString(), this.footerFont);
                ...
                foreach (var str in DateMethods.GetDayNames(this._formatProvider, this.useShortestDayNames ? 2 : 1))
                {
                    // get the size of the name
                    var dayNameSize = g.MeasureString(str, this.dayHeaderFont);
                ...
                if (changeDimension)
                {
                    ...
                    var calWidthDim = Math.Max(1, this.Width / this._monthWidth);
                    var calHeightDim = Math.Max(1, this.Height / this._monthHeight);
        ...
        private bool SetStartDate(DateTime start)
        {
            ...
            var firstDayOfWeek = this._formatProvider.FirstDayOfWeek;
            var dt = new MonthCalendarDate(this.CultureCalendar, this._maxDate);
            ...
            var length = this.Months != null ? this.Months.Length - 1 : 0;
            ...
            var endDate = dt.AddMonths(length);
            var endDateDay = endDate.AddDays(endDate.DaysInMonth - 1 - (endDate.Day - 1));
        ...
        public void UpdateMonths()
        {
            ...
            var calWidthDim = this.calendarDimensions.Width;
            var calHeightDim = this.calendarDimensions.Height;

            var monthList = new List<MonthCalendarMonth>();
            var dt = new MonthCalendarDate(this.CultureCalendar, this.viewStart);
            ...
            if (this.UseRTL)
            {
                ...
                for (var i = 0; i < calHeightDim; i++)
                {
                    for (var j = calWidthDim - 1; j >= 0; j--)
                    {
        ...
        private void UpdateMonthMenu(int year)
        {
            ...
            var monthsInYear = this.CultureCalendar.GetMonthsInYear(year);
            ...
            foreach (ToolStripMenuItem item in this.monthMenu.Items)
            {
                if (i <= monthsInYear)
                {
                    ...
                    var isAvailable = (this._monthSelected.Year > this.MinDate.Year
                    ...
                    if (isAvailable)
                    {
                        ...
                        var isCurrentMonth = i == now.Month && this._monthSelected.Year == now.Year;
                        var fontStyle = isCurrentMonth ? FontStyle.Bold : FontStyle.Regular;

                        var isSelectedMonth = i == this._monthSelected.Month;
                        if (isSelectedMonth)
                        {
        ...
        private void UpdateYearMenu(int year)
        {
            ...
            var maxYear = this.CultureCalendar.GetYear(this._maxDate);
            var minYear = this.CultureCalendar.GetYear(this._minDate);
            ...
            foreach (ToolStripMenuItem item in this.yearMenu.Items)
            {
                ...
                var isCurrentYear = year == this.CultureCalendar.GetYear(DateTime.Today);
        ...
        {
            var currentMonthYear = new MonthCalendarDate(this.CultureCalendar, (DateTime)this.monthMenu.Tag);

            var monthClicked = (int)((ToolStripMenuItem)sender).Tag;

            if (currentMonthYear.Month != monthClicked)
            {
                var dt = new MonthCalendarDate(this.CultureCalendar, new DateTime(currentMonthYear.Year, monthClicked, 1, this.CultureCalendar));
                var newStartDate = dt.AddMonths(-this.GetIndex(currentMonthYear.Date)).Date;
        ...
        {
            var currentMonthYear = (DateTime)this.yearMenu.Tag;

            var yearClicked = (int)((ToolStripMenuItem)sender).Tag;

            var dt = new MonthCalendarDate(this.CultureCalendar, currentMonthYear);
        ...
        private DateTime GetNewScrollDate(bool up)
        {
            ...
            var monthsToAdd = (this.scrollChange == 0
                                   ? Math.Max((this.calendarDimensions.Width * this.calendarDimensions.Height) - 1, 1)
                                   : this.scrollChange) * (up ? -1 : 1);

            var length = this.Months == null ? Math.Max(1, this.calendarDimensions.Width * this.calendarDimensions.Height) : this.Months.Length;

            var newStartMonthDate = dt.AddMonths(monthsToAdd);
            var lastMonthDate = newStartMonthDate.AddMonths(length - 1);
            var lastMonthEndDate = lastMonthDate.AddDays(lastMonthDate.DaysInMonth - 1 - lastMonthDate.Day);
            ...
            {
                var maxdt = new MonthCalendarDate(this.CultureCalendar, this._maxDate).FirstOfMonth;
        ...
        {
            var state = MonthCalendarHeaderState.Default;
        ...
        private DateTime GetSelectionDate(DateTime baseDate, DateTime newSelectionDate)
        {
            ...
            {
                var days = (baseDate - newSelectionDate).Days;
        ...
        private DateTime GetMinDate(DateTime date)
        {
            ...
            var minEra = this.GetEraRange().MinDate;
            ...
            var mindate = minEra < dt ? dt : minEra;
        ...
        {
            var dt = new DateTime(9998, 12, 31);
            var maxEra = this.GetEraRange().MaxDate;
            var maxdate = maxEra > dt ? dt : maxEra;
        ...
        private void ReAssignSelectionMode()
        {
            ...
            var selMode = this.daySelectionMode;
            this.daySelectionMode = MonthCalendarSelectionMode.Manual;
        ...
        private void SetSelectionRange(MonthCalendarSelectionMode selMode)
        {
            switch (selMode)
            {
                ...
                case MonthCalendarSelectionMode.FullWeek:
                    {
                        var dt = new MonthCalendarDate(this.CultureCalendar, this.selectionStart).GetFirstDayInWeek(this._formatProvider);
                        this.selectionStart = dt.Date;
                ...
                case MonthCalendarSelectionMode.Month:
                    {
                        var dt = new MonthCalendarDate(this.CultureCalendar, this.selectionStart).FirstOfMonth;
                        this.selectionStart = dt.Date;
                        this.selectionEnd = dt.AddMonths(1).AddDays(-1).Date;
