namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker
{
    ...
    public class MonthCalendarMonth
    {
        ...
        internal bool DrawLeftButton
        {
            get
            {
                bool result = (this.Date > this.Calendar.MinDate)
        ...
        internal bool DrawRightButton
        {
            get
            {
                bool result = (this.Date < this.Calendar.MaxDate)
        ...
        public MonthCalendarHitTest HitTest(Point loc)
        {
            ...
            {
                DateTime dt = this.Calendar.CultureCalendar.GetEra(this.Date) != this.Calendar.CultureCalendar.GetEra(this._firstVisibleDate)
