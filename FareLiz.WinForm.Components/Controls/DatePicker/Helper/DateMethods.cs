namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker.Helper
{
    using System;
    ...
    /// <summary>Class for calendar methods.</summary>
    internal static class DateMethods
    {
        ...
        /// </param>
        /// <returns>
        /// The number of days in the month using the specified <see cref="Calendar"/>.
        /// </returns>
        ...
        /// </param>
        /// <param name="date">
        /// The date value to get the week of year for.
        /// </param>
        /// <returns>
        ...
        {
            var ci = info ?? CultureInfo.CurrentUICulture;
            var c = cal ?? ci.Calendar;
        ...
        /// </summary>
        /// <param name="provider">
        /// The <see cref="ICustomFormatProvider"/> to use.
        /// </param>
        /// <returns>
        /// The abbreviated and day names beginning with the first day.
        /// </returns>
        public static string[,] GetDayNames(ICustomFormatProvider provider)
        {
            var abbDayNames = new List<string>(provider.AbbreviatedDayNames);
            var shortestDayNames = new List<string>(provider.ShortestDayNames);
            var dayNames = new List<string>(provider.DayNames);
            var firstDayName = provider.GetAbbreviatedDayName(provider.FirstDayOfWeek);

            var firstNameIndex = abbDayNames.IndexOf(firstDayName);

            var names = new string[3, dayNames.Count];
            var j = 0;

            for (var i = firstNameIndex; i < abbDayNames.Count; i++, j++)
            {
            ...
            for (var i = 0; i < firstNameIndex; i++, j++)
            {
                names[0, j] = dayNames[i];
                names[1, j] = abbDayNames[i];
                names[2, j] = shortestDayNames[i];
        ...
        /// <summary>
        /// Gets the abbreviated or day names, beginning with the first day of the week specified by the
        ...
        public static string[] GetDayNames(ICustomFormatProvider provider, int index)
        {
            ...
            var dayNames = GetDayNames(provider);

            var names = new string[dayNames.GetLength(1)];
        ...
        /// <summary>
        /// Gets from the specified <see cref="CalendarDayOfWeek"/> a generic list with the work days.
        /// </summary>
        /// <param name="nonWorkDays">
        /// The non working days.
        /// </param>
        /// <returns>
        /// A list with the working days.
        /// </returns>
        public static List<DayOfWeek> GetWorkDays(CalendarDayOfWeek nonWorkDays)
        {
            ...
            GetSysDaysOfWeek(nonWorkDays).ForEach(
                day =>
                    {
        ...
        /// <summary>Gets a value indicating whether the current UI culture is a right to left culture.</summary>
        ...
        /// <summary>
        /// Gets a <see cref="string"/> representing the <paramref name="number"/>. If <paramref name="nativeDigits"/>
        /// is not <c>null</c> and valid the numbers in <paramref name="number"/>
        ...
        /// The native digits, can be <c>null</c>.
        /// </param>
        /// <param name="prefixZero">
        /// if set to <c>true</c> prefixes the string with a zero.
        /// </param>
        /// <returns>
        /// A <see cref="string"/> representing the <paramref name="number"/> either in arabic numerals or if specified using the native digits.
        /// </returns>
        ...
        /// <summary>
        /// Gets a string where each number in <paramref name="number"/> is replaced with the native number representation as specified by
        /// <paramref name="nativeDigits"/>.
        /// </summary>
        /// <param name="number">
        /// The number to convert.
        /// </param>
        ...
        /// </param>
        /// <param name="prefixZero">
        /// if set to <c>true</c> and the <paramref name="number"/> is greater 0 and less than 10, prefixes the string with the native
        /// zero.
        /// </param>
        /// <returns>
        /// A <see cref="string"/> representing the <paramref name="number"/> using the native digits specified by
        /// <paramref name="nativeDigits"/>.
        /// </returns>
        ...
        /// <summary>
        /// Gets a generic list of <see cref="DayOfWeek"/> value from the specified <see cref="CalendarDayOfWeek"/>
        /// value.
        /// </summary>
        /// <param name="days">
        /// The <see cref="CalendarDayOfWeek"/> value.
        /// </param>
        /// <returns>
        /// A generic list of type <see cref="DayOfWeek"/>.
        /// </returns>
