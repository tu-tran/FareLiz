namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker.Helper
{
    ...
    internal static class DateMethods
    {
        ...
        /// <summary>
        /// Gets a <see cref="string"/> representing the <paramref name="number"/>. If <paramref name="nativeDigits"/> is not <c>null</c> and valid the
        /// numbers in <paramref name="number"/>
        ...
        /// <summary>
        /// Gets a generic list of <see cref="DayOfWeek"/> value from the specified <see cref="CalendarDayOfWeek"/> value.
        /// </summary>
        /// <param name="days">
