namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker
{
    ...
    public class BoldedDateCategoryCollection : List<BoldedDateCategory>
    {
        ...
        /// The _parent.
        /// </param>
        public BoldedDateCategoryCollection(EnhancedMonthCalendar parent)
        {
            this._parent = parent;
        }
        ...
        public new bool Remove(BoldedDateCategory item)
        {
            if (base.Remove(item))
            {
                this._parent.BoldedDatesCollection.RemoveAll(d => d.Category.Equals(item));
        ...
        {
            this._parent.BoldedDatesCollection.Clear();
            base.Clear();
        }
