namespace SkyDean.FareLiz.WinForm.Components.Controls.DatePicker.Interfaces
{
    using System;
    using System.Globalization;

    /// <summary>Interface to provide culture dependent day and month names.</summary>
    public interface ICustomFormatProvider
    {
        #region Properties

        /// <summary>Gets or sets the used <see cref="DateTimeFormatInfo" /> object.</summary>
        DateTimeFormatInfo DateTimeFormat { get; set; }

        /// <summary>Gets or sets the used <see cref="System.Globalization.Calendar" /> object.</summary>
