...
namespace SkyDean.FareLiz.WinForm.Components.Controls.ComboBox
{
    ...
    public partial class Popup : ToolStripDropDown
    {
        ...
        /// </value>
        /// <remarks>
        ///     To use the fade effect, the FocusOnOpen property also has to be set to <c>true</c>.
        /// </remarks>
        ...
        /// </value>
        /// <remarks>
        ///     If the FocusOnOpen property is set to <c>false</c>, then pop-up cannot use the fade effect.
        /// </remarks>
        ...
        {
            get { return this.resizable && this._resizable; }
        ...
        {
            if (this.acceptAlt && ((keyData & Keys.Alt) == Keys.Alt)) return false;
        ...
        /// </remarks>
        /// <exception cref="T:System.ArgumentNullException">
        ///     <paramref name="control" /> is <code>null</code>.
        /// </exception>
        ...
        ///     <see
        ///         cref="T:System.Windows.Forms.ToolStripDropDown" />
        ...
        ///     <see
        ///         cref="T:System.Windows.Forms.ToolStrip" />
        ...
        protected override void SetVisibleCore(bool visible)
        {
            ...
            if (visible && this.fade && this.focusOnOpen) this.Opacity = 0;
            base.SetVisibleCore(visible);
            if (!visible || !this.fade || !this.focusOnOpen) return;
        ...
        {
            if (m.Msg == (int)W32_WM.WM_NCACTIVATE && m.WParam != IntPtr.Zero && this.childPopup != null &&
                this.childPopup.Visible)
            {
            ...
            else if (m.Msg == (int)W32_WM.WM_GETMINMAXINFO)
            {
        ...
        public void PaintSizeGrip(PaintEventArgs e)
        {
            ...
            if (Application.RenderWithVisualStyles)
            {
                ...
                this.sizeGripRenderer.DrawBackground(e.Graphics,
                                                new Rectangle(clientSize.Width - 0x10, clientSize.Height - 0x10, 0x10,
                                                              0x10));
            }
            else
            {
                ControlPaint.DrawSizeGrip(e.Graphics, this.content.BackColor, clientSize.Width - 0x10,
                                          clientSize.Height - 0x10, 0x10, 0x10);
            }
        }
