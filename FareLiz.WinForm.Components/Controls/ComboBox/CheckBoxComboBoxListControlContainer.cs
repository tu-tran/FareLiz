namespace SkyDean.FareLiz.WinForm.Components.Controls.ComboBox
{
    ...
    /// <summary>
    /// A container control for the ListControl to ensure the ScrollBar on the ListControl does not Paint over the Size grip. Setting the Padding or
    /// Margin on the Popup or host control does not work as I expected.
    /// </summary>
    [ToolboxItem(false)]
    internal class CheckBoxComboBoxListControlContainer : UserControl
    {
        ...
        /// <summary>Initializes a new instance of the <see cref="CheckBoxComboBoxListControlContainer" /> class.</summary>
        ...
        /// <summary>The initialize component.</summary>
