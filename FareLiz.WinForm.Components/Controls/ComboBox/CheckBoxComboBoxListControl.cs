namespace SkyDean.FareLiz.WinForm.Components.Controls.ComboBox
{
    ...
    /// <summary>This ListControl that pops up to the User. It contains the CheckBoxComboBoxItems. The items are docked DockStyle.Top in this control.</summary>
    [ToolboxItem(false)]
    internal class CheckBoxComboBoxListControl : ScrollableControl
    {
        ...
        /// <summary>Simply a reference to the CheckBoxComboBox.</summary>
        private readonly CheckBoxComboBox _CheckBoxComboBox;

        /// <summary>A Typed list of ComboBoxCheckBoxItems.</summary>
        ...
        /// <summary>
        /// Maintains the controls displayed in the list by keeping them in sync with the actual items in the combobox. (e.g. removing and adding as
        /// well as ordering)
        /// </summary>
        public void SynchroniseControlsWithComboBoxItems()
        {
            ...
            for (var Index = this._Items.Count - 1; Index >= 0; Index--)
            {
            ...
            var HasHiddenItem = this._CheckBoxComboBox.DropDownStyle == ComboBoxStyle.DropDownList && this._CheckBoxComboBox.DataSource == null
                                && !this.DesignMode;

            var NewList = new CheckBoxComboBoxItemList(this._CheckBoxComboBox);
            for (var Index0 = 0; Index0 <= this._CheckBoxComboBox.Items.Count - 1; Index0++)
            {
                var Object = this._CheckBoxComboBox.Items[Index0];
                ...
                else
                {
                    var StartIndex = HasHiddenItem
                                         ...
                                         : 0;
                    for (var Index1 = StartIndex; Index1 <= this._Items.Count - 1; Index1++)
                    {
