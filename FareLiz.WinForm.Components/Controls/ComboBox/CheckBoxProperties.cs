namespace SkyDean.FareLiz.WinForm.Components.Controls.ComboBox
{
    ...
    /// <summary>The check box properties.</summary>
    [TypeConverter(typeof(ExpandableObjectConverter))]
    public class CheckBoxProperties
    {
        #region PRIVATE PROPERTIES

        /// <summary>The _ appearance.</summary>
        private Appearance _Appearance = Appearance.Normal;

        /// <summary>The _ auto check.</summary>
        private bool _AutoCheck = true;

        /// <summary>The _ auto ellipsis.</summary>
        private bool _AutoEllipsis;

        /// <summary>The _ auto size.</summary>
        private bool _AutoSize = true;

        /// <summary>The _ check align.</summary>
        private ContentAlignment _CheckAlign = ContentAlignment.MiddleLeft;

        /// <summary>The _ flat appearance border color.</summary>
        private Color _FlatAppearanceBorderColor = Color.Empty;

        /// <summary>The _ flat appearance border size.</summary>
        private int _FlatAppearanceBorderSize = 1;

        /// <summary>The _ flat appearance checked back color.</summary>
        private Color _FlatAppearanceCheckedBackColor = Color.Empty;

        /// <summary>The _ flat appearance mouse down back color.</summary>
        private Color _FlatAppearanceMouseDownBackColor = Color.Empty;

        /// <summary>The _ flat appearance mouse over back color.</summary>
        private Color _FlatAppearanceMouseOverBackColor = Color.Empty;

        /// <summary>The _ flat style.</summary>
        private FlatStyle _FlatStyle = FlatStyle.Standard;

        /// <summary>The _ fore color.</summary>
        private Color _ForeColor = SystemColors.ControlText;

        /// <summary>The _ right to left.</summary>
        private RightToLeft _RightToLeft = RightToLeft.No;

        /// <summary>The _ text align.</summary>
        private ContentAlignment _TextAlign = ContentAlignment.MiddleLeft;

        /// <summary>The _ three state.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether auto check.</summary>
        [DefaultValue(true)]
        ...
        /// <summary>Gets or sets a value indicating whether auto ellipsis.</summary>
        [DefaultValue(false)]
        ...
        /// <summary>Gets or sets the check align.</summary>
        ...
        /// <summary>Gets or sets the flat appearance border color.</summary>
        ...
        /// <summary>Gets or sets the flat appearance border size.</summary>
        [DefaultValue(1)]
        ...
        /// <summary>Gets or sets the flat appearance checked back color.</summary>
        [DefaultValue(typeof(Color), "")]
        ...
        /// <summary>Gets or sets the flat appearance mouse down back color.</summary>
        [DefaultValue(typeof(Color), "")]
        ...
        /// <summary>Gets or sets the flat appearance mouse over back color.</summary>
        [DefaultValue(typeof(Color), "")]
        ...
        /// <summary>Gets or sets a value indicating whether three state.</summary>
        [DefaultValue(false)]
