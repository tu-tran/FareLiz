namespace SkyDean.FareLiz.WinForm.Components.Controls.ComboBox
{
    ...
    /// <summary>The airport combo box.</summary>
    public class AirportComboBox : ComboBox
    {
        /// <summary>The _last selected index.</summary>
        private int _lastSelectedIndex = -1;

        /// <summary>The _last selected item.</summary>
        private object _lastSelectedItem;

        /// <summary>The _suppress selected index change.</summary>
        private bool _suppressSelectedIndexChange;

        /// <summary>The _suppress selected item change.</summary>
        private bool _suppressSelectedItemChange;

        /// <summary>Initializes a new instance of the <see cref="AirportComboBox" /> class.</summary>
        ...
        /// <summary>Gets the default item height.</summary>
        ...
        /// <summary>The measure dimensions.</summary>
        internal void MeasureDimensions()
        {
            var visibleItems = this.MaxDropDownItems > this.Items.Count ? this.Items.Count : this.MaxDropDownItems;
        ...
        private void OnDrawItem(object sender, DrawItemEventArgs e)
        {
            ...
            var isHighlighted = (e.State & DrawItemState.Focus) == DrawItemState.Focus;
