namespace SkyDean.FareLiz.WinForm.Components.Controls.ComboBox
{
    ...
    public class CheckBoxComboBoxItem : CheckBox
    {
        ...
        {
            get { return this._ComboBoxItem; }
            internal set { this._ComboBoxItem = value; }
        }
        ...
        public void AddBindings()
        {
            ...
            this.DataBindings.Add(
                "Text",
                this._ComboBoxItem,
                this._CheckBoxComboBox.DisplayMemberSingleItem
                );
            ...
            if (this._ComboBoxItem is INotifyPropertyChanged)
                ((INotifyPropertyChanged)this._ComboBoxItem).PropertyChanged +=
                    this.CheckBoxComboBoxItem_PropertyChanged;
        }
        ...
        protected override void OnCheckedChanged(EventArgs e)
        {
            ...
            if (this._CheckBoxComboBox.DataSource != null)
            {
                PropertyInfo PI = this.ComboBoxItem.GetType().GetProperty(this._CheckBoxComboBox.ValueMember);
            ...
            if (this._CheckBoxComboBox.DataSource != null)
            {
                string OldDisplayMember = this._CheckBoxComboBox.DisplayMember;
        ...
        private void CheckBoxComboBoxItem_PropertyChanged(object sender, PropertyChangedEventArgs e)
        {
            if (e.PropertyName == this._CheckBoxComboBox.ValueMember)
                this.Checked =
                    (bool)this._ComboBoxItem
                               .GetType()
                               .GetProperty(this._CheckBoxComboBox.ValueMember)
                               .GetValue(this._ComboBoxItem, null);
        }
