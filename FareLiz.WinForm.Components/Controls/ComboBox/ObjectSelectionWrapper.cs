namespace SkyDean.FareLiz.WinForm.Components.Controls.ComboBox
{
    ...
    internal class ObjectSelectionWrapper<T> : INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// An indicator of how many items with the specified status is available for the current filter level. Thaught this would make the app a bit more
        /// user-friendly and help not to miss items in Statusses that are not often used.
        /// </summary>
