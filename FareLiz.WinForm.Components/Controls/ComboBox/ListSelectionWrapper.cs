namespace SkyDean.FareLiz.WinForm.Components.Controls.ComboBox
{
    ...
    internal class ListSelectionWrapper<T> : List<ObjectSelectionWrapper<T>>
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSelectionWrapper{T}"/> class. No property on the object is specified for display purposes,
        /// so simple ToString() operation will be performed. And no Counts will be displayed
        /// </summary>
        /// <param name="source">
        /// The source.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSelectionWrapper{T}"/> class. No property on the object is specified for display purposes,
        /// so simple ToString() operation will be performed.
        /// </summary>
        /// <param name="source">
        /// The source.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ListSelectionWrapper{T}"/> class. A Display "Name" property is specified. ToString() will not
        /// be performed on items. This is specifically useful on DataTable implementations, or where PropertyDescriptors are used to read the values. If a
        /// PropertyDescriptor is not found, a Property will be used.
        /// </summary>
        /// <param name="source">
        /// The source.
        /// </param>
        ...
        /// <summary>
        /// When specified, indicates that ToString() should not be performed on the items. This property will be read instead. This is specifically
        /// useful on DataTable implementations, where PropertyDescriptors are used to read the values.
        /// </summary>
        ...
        */
        ...
        private void Populate()
        {
             ...
             */
            var Enumerator = this._Source.GetEnumerator();
            if (Enumerator != null)
            {
