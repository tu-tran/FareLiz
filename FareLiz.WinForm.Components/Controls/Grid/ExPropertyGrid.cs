namespace SkyDean.FareLiz.WinForm.Components.Controls.Grid
{
    ...
    {
        /// <summary>The doc comment.</summary>
        private readonly Control docComment;

        /// <summary>The doc comment type.</summary>
        private readonly Type docCommentType;

        /// <summary>The lines property.</summary>
        private readonly PropertyInfo linesProperty;

        /// <summary>The property grid view.</summary>
        private readonly Control propertyGridView;

        /// <summary>The description area line count.</summary>
        private int descriptionAreaLineCount = 2;

        /// <summary>The size change is from user.</summary>
        private bool sizeChangeIsFromUser = true;

        /// <summary>Initializes a new instance of the <see cref="ExPropertyGrid" /> class. Initializes a new instance of the CustomPropertyGrid class.</summary>
        public ExPropertyGrid()
        {
            foreach (Control control in this.Controls)
            {
                ...
                if (controlType.Name == "DocComment")
                {
                    ...
                    var userSizedField = this.docCommentType.BaseType.GetField("userSized", BindingFlags.Instance | BindingFlags.NonPublic);
        ...
        public int DescriptionAreaLineCount
        {
            ...
            set
            {
                ...
                try
                {
                    var oldDocCommentHeight = this.docComment.Height;
                    var oldValue = this.DescriptionAreaLineCount;
                    this.linesProperty.SetValue(this.docComment, value, null);
                    var difference = this.docComment.Height - oldDocCommentHeight;
        ...
        public int DescriptionAreaHeight
        {
            ...
            set
            {
                var difference = value - this.docComment.Height;
                if (this.docComment.Top - difference > this.propertyGridView.Top)
                {
        ...
        {
            var handler = this.UserChangedDescriptionAreaSize;
            if (handler != null)
            {
                handler(this, e);
            }
