...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// A class that represents a bordered and/or filled polygon object on the graph.  A list of <see cref="PolyObj" /> objects is maintained by the
    ...
    public class PolyObj : BoxObj, ICloneable, ISerializable
    {
        ...
        /// <summary>
        /// private value that determines if the polygon will be automatically closed. true to close the figure, false to leave it "open."  Use the public
        /// property
        ...
        /// <summary>Gets or sets the <see cref="PointD" /> array that defines the polygon.  This will be in units determined by
        /// <see cref="Location.CoordinateFrame" />.</summary>
        ...
        /// <summary>Gets or sets a value that determines if the polygon will be automatically closed. true to close the figure, false to leave it "open."</summary>
        /// <remarks>
        /// This boolean determines whether or not the CloseFigure() method will be called to fully close the path of the polygon.  This value defaults to true,
        /// and for any closed figure it should fine.  If you want to draw a line that does not close into a shape, then you should set this value to false.  For
        /// a figure that is naturally closed (e.g., the first point of the polygon is the same as the last point), leaving this value set to false may result in
        /// minor pixel artifacts due to rounding.
        /// </remarks>
        ...
        /// A constructor that allows the position, border color, and solid fill color of the <see cref="PolyObj"/> to be pre-specified.
        /// </summary>
        /// <param name="points">
        /// The <see cref="PointD"/> array that defines the polygon.  This will be in units determined by
        /// <see cref="Location.CoordinateFrame"/>.
        /// </param>
        /// <param name="borderColor">
        /// An arbitrary <see cref="System.Drawing.Color"/> specification for the box border
        /// </param>
        /// <param name="fillColor">
        /// An arbitrary <see cref="System.Drawing.Color"/> specification for the box fill (will be a solid color fill)
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PolyObj"/> class. 
        /// A constructor that allows the position of the <see cref="PolyObj"/> to be pre-specified.  Other properties are defaulted.
        /// </summary>
        /// <param name="points">
        /// The <see cref="PointD"/> array that defines the polygon.  This will be in units determined by
        /// <see cref="Location.CoordinateFrame"/>.
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PolyObj"/> class. A default constructor that creates a <see cref="PolyObj"/> from an empty
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PolyObj"/> class. 
        /// A constructor that allows the position, border color, and two-color gradient fill colors of the <see cref="PolyObj"/> to be pre-specified.
        /// </summary>
        /// <param name="points">
        /// The <see cref="PointD"/> array that defines the polygon.  This will be in units determined by
        /// <see cref="Location.CoordinateFrame"/>.
        ...
        /// An arbitrary <see cref="System.Drawing.Color"/> specification for the start of the box gradient fill
        /// </param>
        /// <param name="fillColor2">
        /// An arbitrary <see cref="System.Drawing.Color"/> specification for the end of the box gradient fill
        /// </param>
