...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>Encapsulates an "Error Bar" curve type that displays a vertical or horizontal line with a symbol at each end.</summary>
    /// <remarks>
    /// The <see cref="ErrorBarItem" /> type is intended for displaying confidence intervals, candlesticks, stock High-Low charts, etc.  It is technically
    /// not a bar, since it is drawn as a vertical or horizontal line. The default symbol at each end of the "bar" is <see cref="SymbolType.HDash" />, which
    /// creates an "I-Beam".  For horizontal bars (<see cref="BarBase.Y" /> or
    /// <see cref="BarBase.Y2" />), you will need to change the symbol to
    /// <see cref="SymbolType.VDash" /> to get horizontal "I-Beams". Since the horizontal segments are actually symbols, their widths are controlled by the
    /// symbol size in <see cref="ErrorBar.Symbol" />, specified in points (1/72nd inch).  The position of each "I-Beam" is set according to the
    /// <see cref="PointPair" /> values.  The independent axis is assigned with <see cref="BarSettings.Base" />, and is a
    /// <see cref="BarBase" /> enum type.
    /// </remarks>
    ...
    public class ErrorBarItem : CurveItem, ICloneable, ISerializable
    {
        ...
        /// <summary>
        /// Private field that stores a reference to the <see cref="ErrorBar" />
        /// class defined for this <see cref="ErrorBarItem" />.  Use the public property <see cref="ErrorBar" /> to access this value.
        /// </summary>
        ...
        /// <summary>Gets a reference to the <see cref="ErrorBar" /> class defined for this <see cref="ErrorBarItem" />.</summary>
        public ErrorBar Bar
        {
            get
            {
        ...
        /// </param>
        /// <param name="x">
        /// An array of double precision values that define the X axis values for this curve
        /// </param>
        /// <param name="y">
        /// An array of double precision values that define the Y axis values for this curve
        /// </param>
        /// <param name="lowValue">
        /// An array of double precision values that define the lower dependent values for this curve
        /// </param>
        /// <param name="color">
        ...
        public override void DrawLegendKey(Graphics g, GraphPane pane, RectangleF rect, float scaleFactor)
        {
            ...
            {
                this.Bar.Draw(g, pane, pane._barSettings.Base == BarBase.X, pixBase, pixValue, pixLowValue, scaleFactor, pen, false, null);
            }
        }
