...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// A class that encapsulates Border (frame) properties for an object.  The <see cref="Border" /> class is used in a variety of ZedGraph objects to
    /// handle the drawing of the Border around the object.
    /// </summary>
    ...
    public class Border : LineBase, ISerializable, ICloneable
    {
        ...
        /// <summary>
        /// Private field that stores the amount of inflation to be done on the rectangle before rendering.  This allows the border to be inset or outset
        /// relative to the actual rectangle area.  Use the public property <see cref="InflateFactor" />
        ...
        /// <summary>Gets or sets the amount of inflation to be done on the rectangle before rendering.</summary>
        /// <remarks>This allows the border to be inset or outset relative to the actual rectangle area.</remarks>
		...
		*/
        ...
        {
            /// <summary>The default value for <see cref="Border.InflateFactor" />, in units of points (1/72 inch).</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Border"/> class. The default constructor.  Initialized to default values.
        /// </summary>
        public Border()
        {
