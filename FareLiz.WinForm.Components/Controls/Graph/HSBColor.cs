namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// Hue-Saturation-Brightness Color class to store a color value, and to manage conversions to and from RGB colors in the <see cref="Color" />
    /// struct.
    /// </summary>
    /// <remarks>
    /// This class is based on code from http://www.cs.rit.edu/~ncs/color/ by Eugene Vishnevsky. This struct stores the hue, saturation, brightness, and
    /// alpha values internally as
    /// <see cref="byte" /> values from 0 to 255.  The hue represents a fraction of the 360 degrees of color space available. The saturation is the color
    /// intensity, where 0 represents gray scale and 255 is the most colored.  For the brightness, 0 represents black and 255 represents white.
    /// </remarks>
    [Serializable]
    public struct HSBColor
    {
        /// <summary>The alpha value (opacity), ranging from 0 (transparent) to 255 (opaque).</summary>
        public byte A;

        /// <summary>The brightness value, ranging from 0 (black) to 255 (white).</summary>
        public byte B;

        /// <summary>The color hue value, ranging from 0 to 255.</summary>
        /// <remarks>
        /// This property is actually a rescaling of the 360 degrees on the color wheel to 255 possible values.  Therefore, every 42.5 units is a new sector,
        /// with the following convention:  red=0, yellow=42.5, green=85, cyan=127.5, blue=170, magenta=212.5
        /// </remarks>
        public byte H;

        /// <summary>The color saturation (intensity) value, ranging from 0 (gray scale) to 255 (most colored).</summary>
        public byte S;

        /// <summary>
        /// Initializes a new instance of the <see cref="HSBColor"/> struct. 
        /// Constructor to load an <see cref="HSBColor"/> struct from hue, saturation and brightness values
        /// </summary>
        /// <param name="h">
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HSBColor"/> struct. 
        /// Constructor to load an <see cref="HSBColor"/> struct from hue, saturation, brightness, and alpha values
        /// </summary>
        /// <param name="a">
        ...
        /// </summary>
        /// <param name="color">
        /// An rgb <see cref="Color"/> struct containing the equivalent color you want to generate
        /// </param>
        ...
        /// <summary>Implicit conversion operator to convert directly from an <see cref="HSBColor" /> to a <see cref="Color" /> struct.</summary>
        /// <param name="hsbColor">The <see cref="HSBColor" /> struct to be converted</param>
        /// <returns>An equivalent <see cref="Color" /> struct that can be used in the GDI+ graphics library</returns>
        ...
        /// <summary>Convert this <see cref="HSBColor" /> value to an equivalent <see cref="Color" /> value.</summary>
        /// <remarks>This method is based on code from http://www.cs.rit.edu/~ncs/color/ by Eugene Vishnevsky.</remarks>
        ...
        /// <summary>Convert a <see cref="Color" /> value to an equivalent <see cref="HSBColor" /> value.</summary>
        /// <remarks>This method is based on code from http://www.cs.rit.edu/~ncs/color/ by Eugene Vishnevsky.</remarks>
        ...
        /// </remarks>
        /// <param name="rgbColor">
        /// The <see cref="Color"/> struct to be converted
        /// </param>
        /// <returns>
        /// An equivalent <see cref="HSBColor"/> struct
        /// </returns>
