...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A collection class containing a list of <see cref="CurveItem" /> objects that define the set of curves to be displayed on the graph.</summary>
    ...
    public class CurveList : List<CurveItem>, ICloneable
    {
        ...
        /// <summary>Read only value for the maximum number of points in any of the curves in the list.</summary>
        public int MaxPts
        {
            get
            {
        ...
        /// <summary>
        /// Read only property that returns the number of curves in the list that are of type <see cref="BarItem" />. This does not include
        /// <see cref="HiLowBarItem" /> or
        ...
        /// <summary>
        /// Read only property that returns the number of curves in the list that are potentially "clusterable", which includes <see cref="BarItem" /> and
        ...
        /// </summary>
        /// <remarks>Note that this property is only the number of bars that COULD BE clustered.  The actual cluster settings are not considered.</remarks>
        ...
        /// <summary>Read only property that returns the number of pie slices in the list (class type is
        /// <see cref="PieItem" /> ).</summary>
        public int NumPies
        {
            get
            {
        ...
        /// <summary>Read only property that determines if all items in the <see cref="CurveList" /> are Pies.</summary>
        ...
        /// objects for this graph.  This method does not verify valid data, it only checks to see if <see cref="CurveItem.NPts" /> > 0.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CurveList"/> class. Default constructor for the collection class
        /// </summary>
        public CurveList()
        {
            this.maxPts = 1;
        ...
        // CJBL
        /// <summary>Iterate backwards through the <see cref="CurveList" /> items.</summary>
        ...
        /// <summary>Iterate forward through the <see cref="CurveList" /> items.</summary>
...
*/
        ...
        /// <summary>
        /// Indexer to access the specified <see cref="CurveItem"/> object by its <see cref="CurveItem.Label"/> string.
        /// </summary>
        /// <param name="label">
        /// The string label of the
        /// <see cref="CurveItem"/> object to be accessed.
        /// </param>
        /// <value>
        /// A <see cref="CurveItem"/> object reference.
        /// </value>
        /// <returns>
...
*/
        ...
        /// </param>
        /// <returns>
        /// The zero-based index of the specified <see cref="CurveItem"/>, or -1 if the <see cref="CurveItem"/> is not in the list
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// In order for this method to work, the <see cref="CurveItem.Tag"/>
        ...
        public int IndexOfTag(string tag)
        {
            ...
            foreach (CurveItem p in this)
            {
                if (p.Tag is string && string.Compare((string)p.Tag, tag, true) == 0)
                {
                    return index;
                }
        ...
        /// </summary>
        /// <remarks>
        /// For Graphic type objects, this method controls the Z-Order of the items.  Objects at the beginning of the list appear in front of objects at the end
        /// of the list.
        /// </remarks>
        /// <param name="index">
        ...
        /// The relative number of positions to move the object.  A value of -1 will move the object one position earlier in the list, a value of 1 will move it
        /// one position later.  To move an item to the beginning of the list, use a large negative value (such as -999). To move it to the end of the list, use
        ...
        /// <summary>
        /// Go through each <see cref="CurveItem"/> object in the collection, calling the <see cref="CurveItem.GetRange"/> member to determine the minimum and
        /// maximum values in the
        /// <see cref="CurveItem.Points"/> list of data value pairs.  If the curves include a stack bar, handle within the current GetRange method. In the event
        /// that no data are available, a default range of min=0.0 and max=1.0 are returned. If the Y axis has a valid data range and the Y2 axis not, then the
        /// Y2 range will be a duplicate of the Y range.  Vice-versa for the Y2 axis having valid data when the Y axis does not. If any <see cref="CurveItem"/>
        /// in the list has a missing
        /// <see cref="PointPairList"/>, a new empty one will be generated.
        /// </summary>
        /// <param name="bIgnoreInitial">
        ...
        public void GetRange(bool bIgnoreInitial, bool isBoundedRanges, GraphPane pane)
        {
            ...
            foreach (CurveItem curve in this)
            {
                if (curve.IsVisible)
                {
                    ...
                    {
                        this.GetStackRange(pane, curve, out tXMinVal, out tYMinVal, out tXMaxVal, out tYMaxVal);
                    }
                    else
                    {
                        // Call the GetRange() member function for the current
                        // curve to get the min and max values
                        curve.GetRange(out tXMinVal, out tXMaxVal, out tYMinVal, out tYMaxVal, bIgnoreInitial, true, pane);
                    }
        ...
        /// </summary>
        /// <remarks>
        /// This method is required for the stacked types because (for bars), the negative values are a separate stack than the positive values.  If you just sum
        /// up the bars, you will get the sum of the positive plus negative, which is less than the maximum positive value and greater than the maximum negative
        /// value.
        /// </remarks>
        /// <param name="pane">
        /// A reference to the <see cref="GraphPane"/> object that is the parent or owner of this object.
        /// </param>
        /// <param name="curve">
        /// The <see cref="CurveItem"/> for which to calculate the range
        /// </param>
        /// <param name="tXMinVal">
        ...
        /// <summary>
        /// Render all the <see cref="CurveItem"/> objects in the list to the specified <see cref="Graphics"/>
        /// device by calling the <see cref="CurveItem.Draw"/> member function of each <see cref="CurveItem"/> object.
        /// </summary>
        /// <param name="g">
        ...
        /// <summary>
        /// Find the ordinal position of the specified <see cref="BarItem"/> within the <see cref="CurveList"/>.  This position only counts
        /// <see cef="BarItem"/>
        ...
        /// </param>
        /// <param name="barItem">
        /// The <see cref="BarItem"/> for which to search.
        /// </param>
        /// <returns>
        /// The ordinal position of the specified bar, or -1 if the bar was not found.
        /// </returns>
