...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// A class that represents a graphic arrow or line object on the graph.  A list of ArrowObj objects is maintained by the <see cref="GraphObjList" />
    /// collection class.
    /// </summary>
    ...
    public class ArrowObj : LineObj, ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="ArrowObj" /> class.</summary>
        public new struct Default
        {
            /// <summary>The default size for the <see cref="ArrowObj" /> item arrowhead (<see cref="ArrowObj.Size" /> property).  Units are in points (1/72 inch).</summary>
            public static float Size = 12.0F;

            /// <summary>
            /// The default display mode for the <see cref="ArrowObj" /> item arrowhead (<see cref="ArrowObj.IsArrowHead" /> property).  true to show the arrowhead,
            /// false to hide it.
            /// </summary>
        ...
        /// <summary>Private field that stores the arrowhead size, measured in points. Use the public property <see cref="Size" /> to access this value.</summary>
        private float _size;

        /// <summary>Private boolean field that stores the arrowhead RequestState. Use the public property <see cref="IsArrowHead" /> to access this value.</summary>
        ...
        /// <summary>The size of the arrowhead.</summary>
        /// <remarks>The display of the arrowhead can be enabled or disabled with the <see cref="IsArrowHead" /> property.</remarks>
        ...
        /// <value> true to show the arrowhead, false to show the line segment only</value>
        /// <seealso cref="Default.IsArrowHead" />
        public bool IsArrowHead
        {
            get
            {
                return this._isArrowHead;
            }
        ...
        /// </summary>
        /// <param name="color">
        /// An arbitrary <see cref="System.Drawing.Color"/> specification for the arrow
        /// </param>
        /// <param name="size">
        /// The size of the arrowhead, measured in points.
        /// </param>
        /// <param name="x1">
        /// The x position of the starting point that defines the arrow.  The units of this position are specified by the
        /// <see cref="Location.CoordinateFrame"/> property.
        /// </param>
        /// <param name="y1">
        /// The y position of the starting point that defines the arrow.  The units of this position are specified by the
        /// <see cref="Location.CoordinateFrame"/> property.
        /// </param>
        /// <param name="x2">
        /// The x position of the ending point that defines the arrow.  The units of this position are specified by the
        /// <see cref="Location.CoordinateFrame"/> property.
        /// </param>
        /// <param name="y2">
        /// The y position of the ending point that defines the arrow.  The units of this position are specified by the
        /// <see cref="Location.CoordinateFrame"/> property.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ArrowObj"/> class. Default constructor -- places the <see cref="ArrowObj"/> at location (0,0) to (1,1).  All other values are defaulted.
        /// </summary>
        public ArrowObj()
        ...
        /// </summary>
        /// <param name="rhs">
        /// The <see cref="ArrowObj"/> object from which to copy
        /// </param>
