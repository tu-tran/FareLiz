...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A class representing a pie chart object comprised of one or more
    /// <see cref="PieItem" />s.</summary>
    ...
    public class PieItem : CurveItem, ICloneable, ISerializable
    {
        ...
        /// <summary>Specify the default property values for the <see cref="PieItem" /> class.</summary>
        public struct Default
        {
            /// <summary>Default <see cref="PieItem " /> displacement.</summary>
            public static double Displacement = 0;

            /// <summary>The default pen width	to be used for drawing the	border around	the PieItem (<see cref="LineBase.Width" /> property). Units are points.</summary>
            public static float BorderWidth = 1.0F;

            /// <summary>The default fill mode for this PieItem (<see cref="Fill.Type" /> property).</summary>
            public static FillType FillType = FillType.Brush;

            /// <summary>The default border mode for PieItem (<see cref="LineBase.IsVisible" /> property). true to	display frame around PieItem, false otherwise</summary>
            public static bool IsBorderVisible = true;

            /// <summary>The default color for drawing	frames around	PieItem (<see cref="LineBase.Color" /> property).</summary>
            public static Color BorderColor = Color.Black;

            /// <summary>The default color for filling in	the PieItem (<see cref="Fill.Color" />	property).</summary>
            public static Color FillColor = Color.Red;

            /// <summary>The default custom brush for filling in the PieItem. (<see cref="Fill.Brush" /> property).</summary>
            public static Brush FillBrush = null;

            /// <summary>Default value for controlling <see cref="PieItem" /> display.</summary>
            public static bool isVisible = true;

            /// <summary>Default value for <see cref="PieItem.LabelType" />.</summary>
            public static PieLabelType LabelType = PieLabelType.Name;

            /// <summary>
            /// The default font size for  <see cref="PieItem.LabelDetail" /> entries (<see cref="FontSpec.Size" /> property).  Units are in points (1/72
            /// inch).
            /// </summary>
            public static float FontSize = 10;

            /// <summary>Default value for the number of decimal digits to be displayed when <see cref="LabelType" />  contains a value.</summary>
            public static int ValueDecimalDigits = 0;

            /// <summary>Default value for the number of decimal digits to be displayed where <see cref="LabelType" /> contains a percent.</summary>
...
*/
        ...
        /// <summary>
        /// Percentage (expressed as #.##) of <see cref="PieItem" />	radius  to which this <see cref="PieItem" /> is to be displaced from the center.
        /// Displacement is done outward  along the radius bisecting the chord of this <see cref="PieItem" />.  Maximum allowable value is 0.5.
        /// </summary>
        private double _displacement;

        /// <summary>A <see cref="TextObj" /> which will customize the label display of this
        /// <see cref="PieItem" />
        /// </summary>
        ...
        /// <see cref="PieItem" />.	 Use the public property <see cref="Fill" /> to access this value.
        /// </summary>
        private Fill _fill;

        /// <summary>
        /// Private	field	that stores the	<see cref="Border" /> class that defines	the properties of the	border around	this <see cref="PieItem" />. Use the
        /// public property	<see cref="Border" /> to access this value.
        /// </summary>
        private Border _border;

        /// <summary>
        /// Private field that stores the absolute value of this <see cref="PieItem" /> instance. TypeConfiguration will be set to zero if submitted value is
        /// less than zero.
        /// </summary>
        private double _pieValue;

        /// <summary>
        /// An enum that specifies how each <see cref="CurveItem.Label" /> for this <see cref="PieItem" /> object will be displayed.  Use the public property
        /// <see cref="LabelType" /> to access this data. Use enum <see cref="PieLabelType" />.
        /// </summary>
        private PieLabelType _labelType;

        /// <summary>The point on the arc of this <see cref="PieItem" /> representing the intersection of the arc and the explosion radius.</summary>
        private PointF _intersectionPoint;

        /// <summary>The bounding rectangle for this <see cref="PieItem" />.</summary>
        private RectangleF _boundingRectangle;

        /// <summary>The formatted string for this <see cref="PieItem" />'s label.  Formatting is done based on  the <see cref="PieLabelType" />.</summary>
        private string _labelStr;

        /// <summary>The point at which the line between this <see cref="PieItem" /> and its label bends to the horizontal.</summary>
        private PointF _pivotPoint;

        /// <summary>The point at the end of the line between	this <see cref="PieItem" /> and it's label (i.e. the beginning of the label display)</summary>
        private PointF _endPoint;

        /// <summary>Private field to hold the GraphicsPath of this <see cref="PieItem" /> to be used for 'hit testing'.</summary>
        private GraphicsPath _slicePath;

        /// <summary>Private field which holds the angle (in degrees) at which the display of this <see cref="PieItem" />
        /// object will begin.</summary>
        private float _startAngle;

        /// <summary>Private field which holds the length (in degrees) of the arc representing this <see cref="PieItem" />
        /// object.</summary>
        private float _sweepAngle;

        /// <summary>Private field which represents the angle (in degrees) of the radius along which this <see cref="PieItem" />
        /// object will be displaced, if desired.</summary>
        private float _midAngle;

        /// <summary>Private field which determines the number of decimal digits displayed to in a <see cref="PieItem" /> label containing a value.</summary>
        private int _valueDecimalDigits;

        /// <summary>Private field which determines the number of decimal digits displayed in a <see cref="PieItem" /> label containing a percent.</summary>
        ...
        /// <summary>Gets or sets the a value which determines the amount, if any, of this <see cref="PieItem" />
        ...
        /// <summary>Gets a path representing this <see cref="PieItem" />
        /// </summary>
        ...
        /// <summary>Gets or sets the <see cref="TextObj" /> to be used for displaying this <see cref="PieItem" />'s label.</summary>
        ...
        /// <summary>Gets or sets the <see cref="Border" /> object so as to be able to modify its properties.</summary>
        ...
        /// <summary>Gets or sets the <see cref="Fill" /> object which is used to fill the pie slice with color.</summary>
        public Fill Fill
        {
            get
            {
        ...
        /// <summary>Gets or sets the arc length (in degrees) of this <see cref="PieItem" />.</summary>
        ...
        /// <summary>Gets or sets the starting angle (in degrees) of this <see cref="PieItem" />.</summary>
        ...
        /// <summary>Gets or sets the angle (in degrees) of the radius along which this <see cref="PieItem" /> will be displaced.</summary>
        ...
        /// <summary>Gets or sets the value of this <see cref="PieItem" />. Minimum value is 0.</summary>
        public double Value
        {
            get
            {
        ...
        /// <summary>Gets or sets the <see cref="PieLabelType" /> to be used in displaying
        /// <see cref="PieItem" /> labels.</summary>
        ...
        /// <summary>Gets or sets the number of decimal digits to be displayed in a <see cref="PieItem" />
        /// value label.</summary>
 ...
 */
            ...
            else
            {
                ...
                if (tRect.Width >= 1 && tRect.Height >= 1)
                {
                    ...
                    using (Brush brush = tFill.MakeBrush(this._boundingRectangle))
                    {
                        ...
                        this._slicePath.AddPie(tRect.X, tRect.Y, tRect.Width, tRect.Height, this.StartAngle, this.SweepAngle);

                        if (this.Border.IsVisible)
                        {
                            using (Pen borderPen = tBorder.GetPen(pane, scaleFactor))
                            {
                                g.DrawPie(borderPen, tRect.X, tRect.Y, tRect.Width, tRect.Height, this.StartAngle, this.SweepAngle);
                            }
                        }
        ...
        /// <summary>
        /// Calculate the <see cref="RectangleF"/> that will be used to define the bounding rectangle of the Pie.
        /// </summary>
        /// <remarks>
        /// This rectangle always lies inside of the <see cref="Chart.Rect"/>, and it is normally a square so that the pie itself is not oval-shaped.
        /// </remarks>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        /// </param>
        ...
        /// The <see cref="RectangleF"/> (normally the <see cref="Chart.Rect"/>) that bounds this pie.
        /// </param>
        /// <returns>
            ...
            if (this._midAngle > 45 && this._midAngle <= 135)
            {
                ...
                if (size.Height / 2 > fill)
                {
                    ...
                    if (this._midAngle > 90)
                    {
                        ...
                        this.CalculateLinePoints(rect, this._midAngle + (this._sweepAngle + this._startAngle - this._midAngle) / 3);
                    }
                    else
                    {
                        // move _label counter-clockwise one-third of way to the start of the arc
                        this.CalculateLinePoints(rect, this._midAngle - (this._midAngle - (this._midAngle - this._startAngle) / 3));
                    }
                }
            }
        ...
        private void CalculateLinePoints(RectangleF rect, double midAngle)
        {
            ...
            this._intersectionPoint = new PointF(
        ...
        /// <see cref="PieItem"/>'s in the pie chart.  This method is called after it is found that at least one slice is displaced.
        /// </summary>
        /// <param name="maxDisplacement">
        /// The biggest displacement among the <see cref="PieItem"/>s making up the pie chart.
        /// </param>
        /// <param name="baseRect">
        ...
        public override bool GetCoords(GraphPane pane, int i, out string coords)
        {
            ...
            for (int j = 2; j < count + 2; j++)
            {
                ...
                pts[j] = new PointF(radius * (float)Math.Cos(angle * Math.PI / 180.0), radius * (float)Math.Sin(angle * Math.PI / 180.0));
            }
