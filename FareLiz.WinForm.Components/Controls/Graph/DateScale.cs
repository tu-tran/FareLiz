...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>The DateScale class inherits from the <see cref="Scale" /> class, and implements the features specific to <see cref="AxisType.Date" />.</summary>
    /// <remarks>
    /// DateScale is a cartesian axis with calendar dates or times.  The actual data values should be created with the <see cref="XDate" /> type, which is
    /// directly translatable to a
    ...
    internal class DateScale : Scale, ISerializable
    {
        ...
        /// <see cref="AxisType.Date" />.</summary>
        ...
        /// <summary>Gets or sets the minimum value for this scale.</summary>
        /// <remarks>
        /// The set property is specifically adapted for <see cref="AxisType.Date" /> scales, in that it automatically limits the value to the range of valid
        /// dates for the
        ...
        /// <summary>Gets or sets the maximum value for this scale.</summary>
        /// <remarks>
        /// The set property is specifically adapted for <see cref="AxisType.Date" /> scales, in that it automatically limits the value to the range of valid
        /// dates for the
        /// <see cref="XDate" /> struct.
        ...
        /// appropriate. This method properly accounts for <see cref="Scale.IsLog" />, <see cref="Scale.IsText" />, and other axis format settings.
        /// </remarks>
        ...
        internal override double CalcBaseTic()
        {
            ...
            XDate.XLDateToCalendarDate(this._min, out year, out month, out day, out hour, out minute, out second, out millisecond);
            switch (this._majorUnit)
            {
                case DateUnit.Year:
                default:
        ...
        internal override int CalcNumTics()
        {
            ...
            XDate.XLDateToCalendarDate(this._min, out year1, out month1, out day1, out hour1, out minute1, out second1, out millisecond1);
            XDate.XLDateToCalendarDate(this._max, out year2, out month2, out day2, out hour2, out minute2, out second2, out millisecond2);
        ...
        /// </summary>
        /// <remarks>
        /// This method only applies to <see cref="AxisType.Date"/> type axes, and it is called by the general <see cref="PickScale"/> method.  The scale range
        /// is chosen based on increments of 1, 2, or 5 (because they are even divisors of 10). Note that the <see cref="Scale.MajorStep"/> property setting can
        /// have multiple unit types (<see cref="Scale.MajorUnit"/> and <see cref="Scale.MinorUnit"/>), but the <see cref="Scale.Min"/> and
        /// <see cref="Scale.Max"/> units are always days (<see cref="XDate"/>).  This method honors the <see cref="Scale.MinAuto"/>,
        ...
        /// default for scale selection is defined with
        ...
        /// <see cref="Scale.MajorUnit"/> for a <see cref="AxisType.Date"/> scale. This method is used by <see cref="PickScale"/>.
        /// </summary>
        /// <param name="date">
        /// The date which the calculation should be close to
        /// </param>
        /// <param name="direction">
        /// The desired direction for the date to take. 1 indicates the result date should be greater than the specified date parameter.  -1 indicates the other
        /// direction.
        /// </param>
        /// <returns>
        /// The calculated date
        ...
        protected double CalcEvenStepDate(double date, int direction)
        {
            ...
            XDate.XLDateToCalendarDate(date, out year, out month, out day, out hour, out minute, out second, out millisecond);
        ...
        /// </param>
        /// <param name="dVal">
        /// The numeric value associated with the label.  This value is ignored for log (<see cref="Scale.IsLog"/>) and text (<see cref="Scale.IsText"/>) type
        /// axes.
        /// </param>
        /// <returns>
        ...
        internal override double MajorUnitMultiplier
        {
            get
            {
                return this.GetUnitMultiple(this._majorUnit);
            }
        }
        ...
        internal override double MinorUnitMultiplier
        {
            get
            {
                return this.GetUnitMultiple(this._minorUnit);
            }
        }
        ...
        /// </summary>
        /// <param name="unit">
        /// The unit type for which the multiplier is to be calculated
        /// </param>
        /// <returns>
