...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// <see cref="XAxis" /> inherits from <see cref="Axis" />, and defines the special characteristics of a horizontal axis, specifically located at the
    /// bottom of the <see cref="Chart.Rect" /> of the <see cref="GraphPane" />
    /// object
    /// </summary>
    ...
    public class XAxis : Axis, ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="XAxis" /> class.</summary>
        public new struct Default
        {
            ...
            /// <see cref="XAxis" />, that is, a line that divides the negative values from positive values.
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XAxis"/> class. Default constructor that sets all <see cref="XAxis"/> properties to default values as defined in the <see cref="Default"/> class
        /// </summary>
        public XAxis()
            : this("X Axis")
        {
        ...
        /// Default constructor that sets all <see cref="XAxis"/> properties to default values as defined in the <see cref="Default"/> class, except for the
        /// axis title
        /// </summary>
        /// <param name="title">
