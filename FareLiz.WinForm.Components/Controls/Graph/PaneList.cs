...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A collection class containing a list of <see cref="GraphPane" /> objects.</summary>
    ...
    public class PaneList : List<GraphPane>, ICloneable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaneList"/> class. Default constructor for the collection class.
        /// </summary>
        public PaneList()
        {
        }
...
*/
        ...
        /// <summary>
        /// Indexer to access the specified <see cref="GraphPane"/> object by its <see cref="PaneBase.Title"/> string.
        /// </summary>
        /// <param name="title">
...
*/
        ...
        /// </param>
        /// <returns>
        /// The zero-based index of the specified <see cref="GraphPane"/>, or -1 if the <see cref="PaneBase.Title"/> was not found in the list
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// The zero-based index of the specified <see cref="GraphPane"/>, or -1 if the <see cref="PaneBase.Tag"/> string is not in the list
        /// </returns>
