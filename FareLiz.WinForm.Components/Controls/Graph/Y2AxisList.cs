...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A collection class containing a list of <see cref="YAxis" /> objects.</summary>
    ...
    public class Y2AxisList : List<Y2Axis>, ICloneable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Y2AxisList"/> class. Default constructor for the collection class.
        /// </summary>
        public Y2AxisList()
        {
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Y2AxisList"/> class. 
        /// The Copy Constructor
        /// </summary>
        /// <param name="rhs">
        /// The <see cref="Y2AxisList"/> object from which to copy
        /// </param>
        ...
        /// <summary>
        /// Indexer to access the specified <see cref="Axis"/> object by its ordinal position in the list.
        /// </summary>
        /// <param name="index">
        ...
        /// <summary>
        /// Indexer to access the specified <see cref="Axis"/> object by its <see cref="Axis.Title"/> string.
        /// </summary>
        /// <param name="title">
        ...
        /// </param>
        /// <returns>
        /// The zero-based index of the specified <see cref="Axis"/>, or -1 if the <see cref="Axis.Title"/> was not found in the list
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// The zero-based index of the specified <see cref="Axis"/>, or -1 if the <see cref="Axis.Tag"/> string is not in the list
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// An integer representing the ordinal position of the new <see cref="Y2Axis"/> in this <see cref="Y2AxisList"/>.  This is the value that you would
        /// set the
        /// <see cref="CurveItem.YAxisIndex"/> property of a given <see cref="CurveItem"/> to assign it to this new <see cref="Y2Axis"/>.  Note that, for a
        /// <see cref="Y2Axis"/>, you would also need to set the <see cref="CurveItem.IsY2Axis"/> property to true.
        /// </returns>
