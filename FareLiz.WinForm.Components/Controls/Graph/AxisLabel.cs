...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// Class that handles the data associated with text title and its associated font properties.  Inherits from <see cref="Label" />, and adds
    /// <see cref="IsOmitMag" />
    /// and <see cref="IsTitleAtCross" /> properties, which are specifically associated with the <see cref="Axis" /> <see cref="Axis.Title" />.
    /// </summary>
    ...
    public class AxisLabel : GapLabel, ICloneable, ISerializable
    {
        ...
        /// <summary>Gets or sets the property that controls whether or not the magnitude factor (power of 10) for this scale will be included in the label.</summary>
        /// <remarks>
        /// For large scale values, a "magnitude" value (power of 10) is automatically used for scaling the graph.  This magnitude value is automatically
        /// appended to the end of the Axis <see cref="Axis.Title" /> (e.g., "(10^4)") to indicate that a magnitude is in use.  This property controls whether or
        /// not the magnitude is included in the title.  Note that it only affects the axis title; a magnitude value may still be used even if it is not shown in
        /// the title.
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>This value only applies if <see cref="Axis.CrossAuto" /> is false.</remarks>
        public bool IsTitleAtCross
        {
            get
            {
                return this._isTitleAtCross;
            }
