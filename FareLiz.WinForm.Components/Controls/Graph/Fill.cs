...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// A class that encapsulates color-fill properties for an object.  The <see cref="Fill" /> class is used in <see cref="PaneBase.Rect" />,
    /// <see cref="Chart.Rect" />, <see cref="Legend" />,
    ...
    public class Fill : ISerializable, ICloneable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="Fill" /> class.</summary>
        public struct Default
        {
            // Default Fill properties
            /// <summary>The default scaling mode for <see cref="Brush" /> fills. This is the default value for the <see cref="Fill.IsScaled" /> property.</summary>
            public static bool IsScaled = true;

            /// <summary>The default horizontal alignment for <see cref="Brush" /> fills. This is the default value for the <see cref="Fill.AlignH" /> property.</summary>
            public static AlignH AlignH = AlignH.Center;

            /// <summary>The default vertical alignment for <see cref="Brush" /> fills. This is the default value for the <see cref="Fill.AlignV" /> property.</summary>
        ...
        /// <summary>
        /// Private field that stores the fill color.  Use the public property <see cref="Color" /> to access this value.  This property is only applicable if
        /// the <see cref="Type" /> is not <see cref="FillType.None" />.
        /// </summary>
        private Color _color;

        /// <summary>
        /// Private field that stores the secondary color for gradientByValue fills.  Use the public property <see cref="SecondaryValueGradientColor" /> to
        /// access this value.  This property is only applicable if the <see cref="Type" /> is <see cref="FillType.GradientByX" />,
        /// <see cref="FillType.GradientByY" />, or <see cref="FillType.GradientByZ" />.
        /// </summary>
        private Color _secondaryValueGradientColor;

        /// <summary>
        /// Private field that stores the custom fill brush.  Use the public property <see cref="Brush" /> to access this value.  This property is only
        /// applicable if the
        ...
        /// <summary>
        /// Private field that determines the type of color fill.  Use the public property <see cref="Type" /> to access this value.  The fill color is
        /// determined by the property <see cref="Color" /> or
        /// <see cref="Brush" />.
        /// </summary>
        private FillType _type;

        /// <summary>
        /// Private field that determines if the brush will be scaled to the bounding box of the filled object.  If this value is false, then the brush will only
        /// be aligned with the filled object based on the <see cref="AlignH" /> and <see cref="AlignV" />
        /// properties.
        /// </summary>
        private bool _isScaled;

        /// <summary>
        /// Private field that determines how the brush will be aligned with the filled object in the horizontal direction.  This value is a
        /// <see cref="Graph.AlignH" /> enumeration. This field only applies if <see cref="IsScaled" /> is false. properties.
        /// </summary>
        /// <seealso cref="AlignH" />
        /// <seealso cref="AlignV" />
        ...
        /// <summary>
        /// Private field that determines how the brush will be aligned with the filled object in the vertical direction.  This value is a
        /// <see cref="Graph.AlignV" /> enumeration. This field only applies if <see cref="IsScaled" /> is false. properties.
        /// </summary>
        /// <seealso cref="AlignH" />
        /// <seealso cref="AlignV" />
        ...
        /// <summary>Private field that saves the image passed to the constructor. This is used strictly for serialization.</summary>
        private Image _image;

        /// <summary>Private field that saves the image wrapmode passed to the constructor. This is used strictly for serialization.</summary>
        private WrapMode _wrapMode;

        /// <summary>
        /// Private field that saves the list of colors used to create the
        /// <see cref="LinearGradientBrush" /> in the constructor.  This is used strictly for serialization.
        /// </summary>
        ...
        /// <summary>Private field the saves the angle of the fill.  This is used strictly for serialization.</summary>
        ...
        /// <summary>Generic initializer to default values</summary>
        private void Init()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Fill"/> class. The default constructor.  Initialized to no fill.
        /// </summary>
        public Fill()
        {
            this.Init();
        ...
        /// </param>
        /// <param name="brush">
        /// A custom brush for fills.  Can be a <see cref="SolidBrush"/>,
        /// <see cref="LinearGradientBrush"/>, or <see cref="TextureBrush"/>.
        /// </param>
        /// <param name="type">
        /// The <see cref="FillType"/> for this fill.
        /// </param>
        ...
        /// <see cref="FillType.Solid"/>, and setting <see cref="Color"/> to the specified color value.
        /// </summary>
        /// <param name="color">
        ...
        /// Initializes a new instance of the <see cref="Fill"/> class. 
        /// Constructor that creates a linear gradient color-fill, setting <see cref="Type"/> to
        /// <see cref="FillType.Brush"/> using the specified colors.  This gradient fill consists of three colors.
        /// </summary>
        /// <param name="color1">
        /// The first color for the gradient fill
        /// </param>
        ...
        /// <see cref="FillType.Brush"/> using the specified colors.  This gradient fill consists of many colors based on a <see cref="ColorBlend"/> object.
        /// The gradient angle is defaulted to zero.
        /// </summary>
        /// <param name="blend">
        /// The <see cref="ColorBlend"/> object that defines the colors and positions along the gradient.
        /// </param>
        ...
        /// Constructor that creates a linear gradient multi-color-fill, setting <see cref="Type"/> to
        /// <see cref="FillType.Brush"/> using the specified colors.  This gradient fill consists of many colors based on a <see cref="ColorBlend"/> object,
        /// drawn at the specified angle (degrees).
        /// </summary>
        /// <param name="blend">
        /// The <see cref="ColorBlend"/> object that defines the colors and positions along the gradient.
        /// </param>
        ...
        /// Initializes a new instance of the <see cref="Fill"/> class. 
        /// Constructor that creates a linear gradient multi-color-fill, setting <see cref="Type"/> to
        /// <see cref="FillType.Brush"/> using the specified colors.  This gradient fill consists of many colors based on an array of <see cref="Color"/>
        /// objects, drawn at an angle of zero (degrees).  The <see paramref="colors"/> array is used to create a <see cref="ColorBlend"/> object assuming a
        /// even linear distribution of the colors across the gradient.
        /// </summary>
        /// <param name="colors">
        /// The array of <see cref="Color"/> objects that defines the colors along the gradient.
        /// </param>
        ...
        /// Constructor that creates a linear gradient multi-color-fill, setting <see cref="Type"/> to
        /// <see cref="FillType.Brush"/> using the specified colors.  This gradient fill consists of many colors based on an array of <see cref="Color"/>
        /// objects, drawn at the specified angle (degrees).  The <see paramref="colors"/> array is used to create a <see cref="ColorBlend"/> object assuming a
        /// even linear distribution of the colors across the gradient.
        /// </summary>
        /// <param name="colors">
        /// The array of <see cref="Color"/> objects that defines the colors along the gradient.
        ...
        /// Constructor that creates a linear gradient multi-color-fill, setting <see cref="Type"/> to
        /// <see cref="FillType.Brush"/> using the specified colors.  This gradient fill consists of many colors based on an array of <see cref="Color"/>
        /// objects, drawn at the an angle of zero (degrees).  The <see paramref="colors"/> array is used to create a <see cref="ColorBlend"/> object assuming
        /// a even linear distribution of the colors across the gradient.
        /// </summary>
        /// <param name="colors">
        /// The array of <see cref="Color"/> objects that defines the colors along the gradient.
        /// </param>
        /// <param name="positions">
        /// The array of floating point values that defines the color positions along the gradient.  Values should range from 0 to 1.
        /// </param>
        ...
        /// </summary>
        /// <param name="image">
        /// The <see cref="Image"/> to use for filling
        /// </param>
        /// <param name="wrapMode">
        /// The <see cref="WrapMode"/> class that controls the image wrapping properties
        /// </param>
        ...
        /// <see cref="Brush"/>.  The brush will be scaled to fit the destination screen object unless you manually change <see cref="IsScaled"/> to false;
        /// </summary>
        /// <param name="brush">
        ...
        /// Initializes a new instance of the <see cref="Fill"/> class. 
        /// Constructor that creates a <see cref="Brush"/> fill, using a user-supplied, custom
        /// <see cref="Brush"/>.  This constructor will make the brush unscaled (see <see cref="IsScaled"/>), but it provides <see paramref="alignH"/> and
        /// <see paramref="alignV"/> parameters to control alignment of the brush with respect to the filled object.
        /// </summary>
        /// <param name="brush">
        /// The <see cref="Brush"/> to use for fancy fills.  Typically, this would be a <see cref="LinearGradientBrush"/> or a
        /// <see cref="TextureBrush"/> class
        /// </param>
        /// <param name="alignH">
        /// Controls the horizontal alignment of the brush within the filled object (see <see cref="AlignH"/>
        /// </param>
        /// <param name="alignV">
        /// Controls the vertical alignment of the brush within the filled object (see <see cref="AlignV"/>
        /// </param>
        ...
        private void CreateBrushFromBlend(ColorBlend blend, float angle)
        {
            ...
            this._brush = new LinearGradientBrush(new Rectangle(0, 0, 100, 100), Color.Red, Color.White, angle);
        ...
        /// <summary>
        /// The fill color.  This property is used as a single color to make a solid fill (<see cref="Type" /> is <see cref="FillType.Solid" />), or it can be
        /// used in combination with <see cref="System.Drawing.Color.White" /> to make a
        ...
        /// <summary>Gets or sets the secondary color for gradientByValue fills.</summary>
        /// <remarks>
        /// This property is only applicable if the <see cref="Type" /> is
        /// <see cref="FillType.GradientByX" />,
        /// <see cref="FillType.GradientByY" />, or
        /// <see cref="FillType.GradientByZ" />.  Once the gradient-by-value logic picks a color, a new gradient will be created using the
        /// SecondaryValueGradientColor, the resulting gradient-by-value color, and the angle setting for this
        /// <see cref="Fill" />. Use a value of <see cref="System.Drawing.Color.Empty">Color.Empty</see> to have a solid-color <see cref="Fill" /> resulting from
        /// a gradient-by-value
        /// <see cref="FillType" />.
        /// </remarks>
        public Color SecondaryValueGradientColor
        {
            get
            {
                return this._secondaryValueGradientColor;
            }
        ...
        /// <see cref="LinearGradientBrush" />, or a <see cref="TextureBrush" />.  This property is only applicable if the <see cref="Type" /> property is set to
        ...
        /// <summary>
        /// Determines the type of fill, which can be either solid color (<see cref="FillType.Solid" />) or a custom brush (<see cref="FillType.Brush" />).  See
        /// <see cref="Type" /> for more information.
        /// </summary>
        ...
        /// <summary>
        /// This property determines the type of color fill. Returns true if the <see cref="Type" /> property is either
        /// <see cref="FillType.Solid" /> or
        /// <see cref="FillType.Brush" />.  If set to true, this property will automatically set the <see cref="Type" /> to
        /// <see cref="FillType.Brush" />.  If set to false, this property will automatically set the <see cref="Type" /> to
        /// <see cref="FillType.None" />.  In order to get a regular solid-color fill, you have to manually set <see cref="Type" />
        ...
        public bool IsVisible
        {
            get
            {
                return this._type != FillType.None;
            }
        ...
        /// <summary>
        /// Determines if the brush will be scaled to the bounding box of the filled object.  If this value is false, then the brush will only be aligned with
        /// the filled object based on the <see cref="AlignH" /> and <see cref="AlignV" />
        /// properties.
        /// </summary>
        ...
        /// <summary>
        /// Determines how the brush will be aligned with the filled object in the horizontal direction.  This value is a <see cref="Graph.AlignH" />
        /// enumeration. This field only applies if <see cref="IsScaled" /> is false.
        /// </summary>
        /// <seealso cref="AlignV" />
        ...
        /// <summary>
        /// Determines how the brush will be aligned with the filled object in the vertical direction.  This value is a <see cref="Graph.AlignV" /> enumeration.
        ...
        /// <summary>
        /// Returns a boolean value indicating whether or not this fill is a "Gradient-By-TypeConfiguration" type.  This is true for
        /// <see cref="FillType.GradientByX" />, <see cref="FillType.GradientByY" />, or <see cref="FillType.GradientByZ" />.
        /// </summary>
        /// <remarks>
        /// The gradient by value fill method allows the fill color for each point or bar to be based on a value for that point (either X, Y, or Z in the
        /// <see cref="IPointList" />. For example, assume a <see cref="Fill" /> class is defined with a linear gradient ranging from
        /// <see cref="System.Drawing.Color.Blue" /> to <see cref="System.Drawing.Color.Red" /> and the <see cref="Fill.Type" />
        /// is set to <see cref="FillType.GradientByY" />.  If <see cref="RangeMin" /> is set to 100.0 and <see cref="RangeMax" /> is set to 200.0, then a point
        /// that has a Y value of 100 or less will be colored blue, a point with a Y value of 200 or more will be colored red, and a point between 100 and 200
        /// will have a color based on a linear scale between blue and red.  Note that the fill color is always solid for any given point. You can use the Z
        /// value from <see cref="IPointList" /> along with
        /// <see cref="FillType.GradientByZ" /> to color individual points according to some property that is independent of the X,Y point pair.
        /// </remarks>
        ...
        public bool IsGradientValueType
        {
            get
            {
                return this._type == FillType.GradientByX || this._type == FillType.GradientByY || this._type == FillType.GradientByZ
                       || this._type == FillType.GradientByColorValue;
            }
        }

        /// <summary>The minimum user-scale value for the gradient-by-value determination.  This defines the user-scale value for the start of the gradient.</summary>
        /// <seealso cref="FillType.GradientByX" />
        /// <seealso cref="FillType.GradientByY" />
        /// <seealso cref="FillType.GradientByZ" />
        ...
        /// <summary>The maximum user-scale value for the gradient-by-value determination.  This defines the user-scale value for the end of the gradient.</summary>
        /// <seealso cref="FillType.GradientByX" />
        /// <seealso cref="FillType.GradientByY" />
        /// <seealso cref="FillType.GradientByZ" />
        /// <seealso cref="IsGradientValueType" />
        ...
        /// <summary>
        /// The default user-scale value for the gradient-by-value determination.  This defines the value that will be used when there is no point value
        /// available, or the actual point value is invalid.
        /// </summary>
        /// <remarks>
        /// Note that this value, when defined, will determine the color that is used in the legend. If this value is set to double.MaxValue, then it remains
        /// "undefined."  In this case, the legend symbols will actually be filled with a color gradient representing the range of colors.
        /// </remarks>
        /// <seealso cref="FillType.GradientByX" />
        /// <seealso cref="FillType.GradientByY" />
        /// <seealso cref="FillType.GradientByZ" />
        ...
        private Brush ScaleBrush(RectangleF rect, Brush brush, bool isScaled)
        {
            if (brush != null)
            {
                ...
                if (brush is LinearGradientBrush)
                {
                    ...
                    if (isScaled)
                    {
                        linBrush.ScaleTransform(rect.Width / linBrush.Rectangle.Width, rect.Height / linBrush.Rectangle.Height, MatrixOrder.Append);
                        linBrush.TranslateTransform(rect.Left - linBrush.Rectangle.Left, rect.Top - linBrush.Rectangle.Top, MatrixOrder.Append);
                    }
                    else
                    {
                        float dx = 0, dy = 0;
 ...
 // LinearGradientBrush
                if (brush is TextureBrush)
                {
                    ...
                    if (isScaled)
                    {
                        texBrush.ScaleTransform(rect.Width / texBrush.Image.Width, rect.Height / texBrush.Image.Height, MatrixOrder.Append);
