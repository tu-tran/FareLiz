...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    public class DataSourcePointList : IPointList
    {
        ...
        /// <summary>gets the number of points available in the list</summary>
        public int Count
        {
            get
            {
        ...
        /// <summary>The <see cref="BindingSource" /> object from which to get the bound data</summary>
        /// <remarks>
        ...
        /// <see cref="System.Windows.Forms.BindingSource.DataMember" /> property would be set to the name of the datatable within the
        /// <see cref="System.Windows.Forms.BindingSource.DataSource" />, if applicable.
        /// </remarks>
        ...
        /// <summary>The table or list object from which to extract the data values.</summary>
        /// <remarks>This property is just an alias for
        /// <see cref="System.Windows.Forms.BindingSource.DataSource" />.</remarks>
        ...
        /// <summary>The <see cref="string" /> name of the property or column from which to obtain the X data values for the chart.</summary>
        ...
        /// <summary>The <see cref="string" /> name of the property or column from which to obtain the Y data values for the chart.</summary>
        ...
        /// <summary>The <see cref="string" /> name of the property or column from which to obtain the Z data values for the chart.</summary>
        ...
        /// <summary>The <see cref="string" /> name of the property or column from which to obtain the tag values for the chart.</summary>
        /// <remarks>
        /// Set this to null leave the tag values set to null. If this references string data, then the tags may be used as tooltips using the
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DataSourcePointList"/> class. Default Constructor
        /// </summary>
        ...
        /// Constructor to initialize the DataSourcePointList from an existing <see cref="DataSourcePointList"/>
        /// </summary>
        /// <param name="rhs">
        /// The rhs.
        /// </param>
        ...
        /// <summary>
        /// Extract a double value from the specified table row or data object with the specified column name.
        /// </summary>
        /// <param name="row">
        /// The data object from which to extract the value
        /// </param>
        /// <param name="dataMember">
        /// The property name or column name of the value to be extracted
        /// </param>
        /// <param name="index">
        ...
        /// <summary>
        /// Extract an object from the specified table row or data object with the specified column name.
        /// </summary>
        /// <param name="row">
        /// The data object from which to extract the object
        /// </param>
        /// <param name="dataMember">
        /// The property name or column name of the object to be extracted
        /// </param>
        /// <returns>
        /// The <see cref="object"/>.
        /// </returns>
