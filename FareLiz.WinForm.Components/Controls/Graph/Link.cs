...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A class that maintains hyperlink information for a clickable object on the graph.</summary>
    ...
    public class Link : ISerializable, ICloneable
    {
        ...
        /// <summary>Internal field that stores the title string for this link.</summary>
        internal string _title;

        /// <summary>Internal field that stores the url string for this link</summary>
        internal string _url;

        /// <summary>Internal field that stores the target string for this link</summary>
        internal string _target;

        /// <summary>Internal field that determines if this link is "live".</summary>
        ...
        /// <summary>Gets or sets the title string for this link.</summary>
        /// <remarks>
        /// For web controls, this title will be shown as a tooltip when the mouse hovers over the area of the object that owns this link.  Set the value to
        ...
        /// <summary>Gets or sets the url string for this link.</summary>
        /// <remarks>Set this value to <see cref="String.Empty" /> if you don't want to have a hyperlink associated with the object to which this link belongs.</remarks>
        public string Url
        {
            get
            {
        ...
        /// <summary>Gets or sets the target string for this link.</summary>
        /// <remarks>
        /// This value should be set to a valid target associated with the "Target" property of an html hyperlink.  Typically, this would be "_blank" to open a
        /// new browser window, or "_self" to open in the current browser.
        /// </remarks>
        ...
        /// <summary>
        /// A tag object for use by the user.  This can be used to store additional information associated with the <see cref="Link" />.  ZedGraph does not use
        ...
        /// <summary>Gets or sets a property that determines if this link is active.  True to have a clickable link, false to ignore the link.</summary>
        ...
        /// <summary>
        /// Gets a value that indicates if this <see cref="Link" /> is enabled (see <see cref="IsEnabled" />), and that either the
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Link"/> class. Default constructor.  Set all properties to string.Empty, or null.
        /// </summary>
        public Link()
        {
        ...
        /// <remarks>schema started with 10 for ZedGraph version 5</remarks>
