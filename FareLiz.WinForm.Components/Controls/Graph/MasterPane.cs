...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A collection class containing a list of <see cref="GraphPane" /> objects organized together in some form.</summary>
    ...
    public class MasterPane : PaneBase, ICloneable, ISerializable, IDeserializationCallback
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="MasterPane" /> class.</summary>
        public new struct Default
        {
            /// <summary>The default pane layout for
            ...
            /// <summary>
            /// The default value for the <see cref="Default.InnerPaneGap" /> property. This is the size of the margin between adjacent <see cref="GraphPane" />
            /// objects, in units of points (1/72 inch).
            /// </summary>
            /// <seealso cref="MasterPane.InnerPaneGap" />
            public static float InnerPaneGap = 10;

            /// <summary>The default value for the <see cref="Legend.IsVisible" /> property for the <see cref="MasterPane" /> class.</summary>
            public static bool IsShowLegend = false;

            /// <summary>The default value for the <see cref="IsUniformLegendEntries" /> property.</summary>
            public static bool IsUniformLegendEntries = false;

            /// <summary>The default value for the <see cref="IsCommonScaleFactor" /> property.</summary>
        ...
        /// <summary>
        /// Private field that holds a collection of <see cref="GraphPane" /> objects for inclusion in this <see cref="MasterPane" />.  Use the public property
        /// <see cref="PaneList" />
        /// to access this collection.
        /// </summary>
        internal PaneList _paneList;

        /// <summary>Private field that sets the amount of space between the GraphPanes.  Use the public property
        /// <see cref="InnerPaneGap" /> to access this value;</summary>
        ...
        /// <see cref="Legend" />  If set to true, only one set of entries will be displayed in this <see cref="Legend" /> instance.  If set to false, this
        /// instance will display all entries from all <see cref="GraphPane" />s.
        /// </summary>
        ...
        /// <see cref="DoLayout(Graphics)" />
        /// function will automatically set the <see cref="PaneBase.BaseDimension" /> of each <see cref="GraphPane" /> in the
        ...
        /// <see cref="SetLayout(Graphics,PaneLayout)" /> was called. This value will default to <see cref="MasterPane.Default.PaneLayout" /> if
        /// <see cref="SetLayout(Graphics,PaneLayout)" /> (or an overload) was never called.
        /// </summary>
        internal PaneLayout _paneLayout;

        /// <summary>Private field that stores the boolean value that determines whether
        /// <see cref="_countList" /> is specifying rows or columns.</summary>
        internal bool _isColumnSpecified;

        /// <summary>
        /// private field that stores the row/column item count that was specified to the
        /// <see cref="SetLayout(Graphics,bool,int[],float[])" /> method.  This values will be null if <see cref="SetLayout(Graphics,bool,int[],float[])" /> was
        /// never called.
        /// </summary>
        internal int[] _countList;

        /// <summary>
        /// private field that stores the row/column size proportional values as specified to the <see cref="SetLayout(Graphics,bool,int[],float[])" /> method.
        /// This value will be null if <see cref="SetLayout(Graphics,bool,int[],float[])" />
        /// was never called.
        /// </summary>
...
*/
        ...
        /// <summary>
        /// private field that determines if anti-aliased drawing will be forced on.  Use the public property <see cref="IsAntiAlias" /> to access this
        /// value.
        /// </summary>
...
*/
        ...
        /// </summary>
        /// <remarks>
        /// This property is scaled according to <see cref="PaneBase.CalcScaleFactor" />, based on <see cref="PaneBase.BaseDimension" />.  The default value
        /// comes from
        ...
        /// <summary>Gets or set the value of the	 <see cref="IsUniformLegendEntries" />
        /// </summary>
        public bool IsUniformLegendEntries
        {
            get
            {
                return this._isUniformLegendEntries;
            }
        ...
        /// of each <see cref="GraphPane" /> in the <see cref="PaneList" /> such that the scale factors have the same value.
        /// </summary>
        /// <remarks>
        /// The scale factors, calculated by <see cref="PaneBase.CalcScaleFactor" />, determine scaled font sizes, tic lengths, etc.  This function will insure
        /// that for multiple graphpanes, a certain specified font size will be the same for all the panes.
        /// </remarks>
        /// <seealso cref="SetLayout(Graphics,PaneLayout)" />
        /// <seealso cref="SetLayout(Graphics,int,int)" />
        /// <seealso cref="SetLayout(Graphics,bool,int[])" />
        ...
        public bool IsCommonScaleFactor
        {
            get
            {
                return this._isCommonScaleFactor;
            }
        ...
        /// <see cref="MasterPane" /> will be forced to operate in Anti-alias mode. Note that if this value is set to "true", it overrides the setting for
        /// sub-objects. Otherwise, the sub-object settings (such as <see cref="FontSpec.IsAntiAlias" />) will be honored.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MasterPane"/> class. Default constructor for the class.  Sets the <see cref="PaneBase.Rect"/> to (0, 0, 500, 375).
        /// </summary>
        public MasterPane()
            : this(string.Empty, new RectangleF(0, 0, 500, 375))
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="MasterPane"/> class. 
        /// Default constructor for the class.  Specifies the <see cref="PaneBase.Title"/> of the <see cref="MasterPane"/>, and the size of the
        ...
        /// <summary>
        /// Implement the <see cref="ICloneable" /> interface in a typesafe manner by just calling the typed version of <see cref="Clone" /> to make a deep copy.
        /// </summary>
        ...
        /// </summary>
        /// <param name="pane">
        /// A reference to the <see cref="GraphPane"/> object to be added
        /// </param>
        ...
        /// <summary>
        /// Redo the layout using the current size of the <see cref="PaneBase.Rect"/>, and also handle resizing the contents by calling
        /// <see cref="DoLayout(Graphics)"/>.
        /// </summary>
        /// <remarks>
        /// This method will use the pane layout that was specified by a call to
        /// <see cref="SetLayout(Graphics,PaneLayout)"/>.  If
        /// <see cref="SetLayout(Graphics,PaneLayout)"/> has not previously been called, it will default to <see cref="Default.PaneLayout"/>.
        /// </remarks>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        /// </param>
        ...
        /// <summary>
        /// Change the size of the <see cref="PaneBase.Rect"/>, and also handle resizing the contents by calling <see cref="DoLayout(Graphics)"/>.
        /// </summary>
        /// <remarks>
        /// This method will use the pane layout that was specified by a call to
        /// <see cref="SetLayout(Graphics,PaneLayout)"/>.  If
        ...
        /// <summary>
        /// Method that forces the scale factor calculations (via <see cref="PaneBase.CalcScaleFactor" />), to give a common scale factor for all
        /// <see cref="GraphPane" /> objects in the
        /// <see cref="PaneList" />.
        /// </summary>
        /// <remarks>
        /// This will make it such that a given font size will result in the same output font size for all <see cref="GraphPane" />'s.  Note that this does not
        /// make the scale factor for the <see cref="GraphPane" />'s the same as that of the
        /// <see cref="MasterPane" />.
        /// </remarks>
        ...
        /// <summary>
        /// Render all the <see cref="GraphPane"/> objects in the <see cref="PaneList"/> to the specified graphics device.
        /// </summary>
        /// <remarks>
        /// This method should be part of the Paint() update process.  Calling this routine will redraw all features of all the <see cref="GraphPane"/> items.
        /// No preparation is required other than instantiated <see cref="GraphPane"/> objects that have been added to the list with the
        /// <see cref="Add"/> method.
        /// </remarks>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        ...
        public override void Draw(Graphics g)
        {
            ...
            this.SetAntiAliasMode(g, this._isAntiAlias);
            ...
            RectangleF innerRect = this.CalcClientRect(g, scaleFactor);
        ...
        /// </summary>
        /// <remarks>
        /// This method first finds the <see cref="GraphPane"/> within the list that contains the specified mouse point.  It then calls the
        /// <see cref="GraphPane.FindNearestObject"/>
        /// method to determine which object, if any, was clicked.  With the exception of the
        /// <see paramref="pane"/>, all the parameters in this method are identical to those in the <see cref="GraphPane.FindNearestObject"/> method. If the
        /// mouse point lies within the <see cref="PaneBase.Rect"/> of any
        /// <see cref="GraphPane"/> item, then that pane will be returned (otherwise it will be null).  Further, within the selected pane, if the mouse point is
        /// within the bounding box of any of the items (or in the case of <see cref="ArrowObj"/> and <see cref="CurveItem"/>, within
        /// <see cref="GraphPane.Default.NearestTol"/> pixels), then the object will be returned. You must check the type of the object to determine what object
        /// was selected (for example, "if ( object is Legend ) ...").  The
        ...
        /// </param>
        /// <param name="pane">
        /// A reference to the <see cref="GraphPane"/> object that was clicked.
        /// </param>
        ...
        /// </param>
        /// <returns>
        /// true if a <see cref="GraphPane"/> was found, false otherwise.
        /// </returns>
        ...
        /// </param>
        /// <returns>
        /// A <see cref="GraphPane"/> object that contains the mouse point, or null if no <see cref="GraphPane"/> was found.
        /// </returns>
        ...
        /// <summary>
        /// Automatically set all of the <see cref="GraphPane"/> <see cref="PaneBase.Rect"/>'s in the list to a reasonable configuration.
        /// </summary>
        /// <remarks>
        /// This method explicitly specifies the number of rows and columns to use in the layout, and all <see cref="GraphPane"/> objects will have the same
        /// size. Overloads are available that provide other layout options
        /// </remarks>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally created with a call to the CreateGraphics() method of the Control or
        /// Form.
        /// </param>
        /// <param name="rows">
        /// The number of rows of <see cref="GraphPane"/> objects to include in the layout
        /// </param>
        /// <param name="columns">
        /// The number of columns of <see cref="GraphPane"/> objects to include in the layout
        /// </param>
        /// <seealso cref="SetLayout(Graphics,PaneLayout)"/>
        /// <seealso cref="SetLayout(Graphics,bool,int[])"/>
        /// <seealso cref="SetLayout(Graphics,bool,int[],float[])"/>
        ...
        /// <summary>
        /// Automatically set all of the <see cref="GraphPane"/> <see cref="PaneBase.Rect"/>'s in the list to the specified configuration.
        /// </summary>
        /// <remarks>
        /// This method specifies the number of rows in each column, or the number of columns in each row, allowing for irregular layouts.  Overloads are
        /// available that provide other layout options.
        /// </remarks>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally created with a call to the CreateGraphics() method of the Control or
        /// Form.
        ...
        /// Specifies whether the number of columns in each row, or the number of rows in each column will be specified.  A value of true indicates the number of
        /// columns in each row are specified in <see paramref="countList"/>.
        /// </param>
        ...
        /// <see paramref="isColumnSpecified"/>.
        /// </param>
        /// <seealso cref="SetLayout(Graphics,PaneLayout)"/>
        /// <seealso cref="SetLayout(Graphics,int,int)"/>
        /// <seealso cref="SetLayout(Graphics,bool,int[],float[])"/>
        ...
        /// </remarks>
        /// <remarks>
        /// This method specifies the number of rows in each column, or the number of columns in each row, allowing for irregular layouts.  Additionally, a
        /// <see paramref="proportion"/> parameter is provided that allows varying column or row sizes.  Overloads for SetLayout() are available that provide
        ...
        /// <param name="isColumnSpecified">
        /// Specifies whether the number of columns in each row, or the number of rows in each column will be specified.  A value of true indicates the number of
        /// columns in each row are specified in <see paramref="_countList"/>.
        /// </param>
        /// <param name="countList">
        /// An integer array specifying either the number of columns in each row or the number of rows in each column, depending on the value of
        /// <see paramref="isColumnSpecified"/>.
        ...
        /// An array of float values specifying proportional sizes for each row or column.  Note that these proportions apply to the non-specified dimension --
        /// that is, if <see paramref="isColumnSpecified"/> is true, then these proportions apply to the row heights, and if
        /// <see paramref="isColumnSpecified"/> is false, then these proportions apply to the column widths.  The values in this array are arbitrary floats --
        /// the dimension of any given row or column is that particular proportional value divided by the sum of all the values.  For example, let
        /// <see paramref="isColumnSpecified"/> be true, and
        /// <see paramref="proportion"/> is an array with values of { 1.0, 2.0, 3.0 }.  The sum of those values is 6.0.  Therefore, the first row is 1/6th of
        /// the available height, the second row is 2/6th's of the available height, and the third row is 3/6th's of the available height.
        /// </param>
        /// <seealso cref="SetLayout(Graphics,PaneLayout)"/>
        /// <seealso cref="SetLayout(Graphics,int,int)"/>
        /// <seealso cref="SetLayout(Graphics,bool,int[])"/>
        public void SetLayout(Graphics g, bool isColumnSpecified, int[] countList, float[] proportion)
        {
            ...
            if (countList != null && countList.Length > 0)
            {
                ...
                {
                    this._prop[i] = (proportion == null || proportion.Length <= i || proportion[i] < 1e-10) ? 1.0f : proportion[i];
        ...
        /// </param>
        /// <remarks>
        /// The <see cref="SetLayout(Graphics,PaneLayout)"/> method (and overloads) is used for setting the layout configuration.
        /// </remarks>
        /// <seealso cref="SetLayout(Graphics,PaneLayout)"/>
        /// <seealso cref="SetLayout(Graphics,int,int)"/>
        /// <seealso cref="SetLayout(Graphics,bool,int[])"/>
            ...
            else
            {
                ...
                switch (this._paneLayout)
                {
                    ...
                    case PaneLayout.ExplicitCol12:
                        this.DoLayout(g, true, new[] { 1, 2 }, null);
                        break;
                    case PaneLayout.ExplicitCol21:
                        this.DoLayout(g, true, new[] { 2, 1 }, null);
                        break;
                    case PaneLayout.ExplicitCol23:
                        this.DoLayout(g, true, new[] { 2, 3 }, null);
                        break;
                    case PaneLayout.ExplicitCol32:
                        this.DoLayout(g, true, new[] { 3, 2 }, null);
                        break;
                    case PaneLayout.ExplicitRow12:
                        this.DoLayout(g, false, new[] { 1, 2 }, null);
                        break;
                    case PaneLayout.ExplicitRow21:
                        this.DoLayout(g, false, new[] { 2, 1 }, null);
                        break;
                    case PaneLayout.ExplicitRow23:
                        this.DoLayout(g, false, new[] { 2, 3 }, null);
                        break;
                    case PaneLayout.ExplicitRow32:
                        this.DoLayout(g, false, new[] { 3, 2 }, null);
                        break;
                }
            }
        }
        ...
        internal void DoLayout(Graphics g, bool isColumnSpecified, int[] countList, float[] proportion)
        {
            ...
            float scaledInnerGap = this._innerPaneGap * scaleFactor;
            ...
            if (isColumnSpecified)
            {
                ...
                for (int rowNum = 0; rowNum < rows; rowNum++)
                {
                    ...
                    for (int colNum = 0; colNum < columns; colNum++)
                    {
                        ...
                        this[iPane].Rect = new RectangleF(innerRect.X + colNum * (width + scaledInnerGap), innerRect.Y + y, width, height);
                        iPane++;
                    }
            ...
            else
            {
                ...
                for (int colNum = 0; colNum < columns; colNum++)
                {
                    ...
                    for (int rowNum = 0; rowNum < rows; rowNum++)
                    {
                        ...
                        this[iPane].Rect = new RectangleF(innerRect.X + x, innerRect.Y + rowNum * (height + scaledInnerGap), width, height);
                        iPane++;
                    }
