namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>enumeration used to indicate which type of data will be plotted.</summary>
    public enum SampleType
    {
        /// <summary>Designates the "Time" property will be used</summary>
        Time, 

        /// <summary>Designates the "Position" property will be used</summary>
        Position, 

        /// <summary>Designates the Instantaneous Velocity property will be used</summary>
        VelocityInst, 

        /// <summary>Designates the "Time since start" property will be used</summary>
        TimeDiff, 

        /// <summary>Designates the Average Velocity property will be used</summary>
        VelocityAvg
    };

    /// <summary>A simple storage class to maintain an individual sampling of data</summary>
    public class Sample : object
    {
        ...
        /// <summary>The time of the sample</summary>
        ...
        /// <summary>The position at sample time</summary>
        ...
        /// <summary>The instantaneous velocity at sample time</summary>
    ...
    public class SamplePointList : IPointList
    {
        ...
        /// <summary>Determines what data type gets plotted for the X values</summary>
        public SampleType XType;

        /// <summary>Determines what data type gets plotted for the Y values</summary>
        public SampleType YType;

        /// <summary>
        /// Initializes a new instance of the <see cref="SamplePointList"/> class. default constructor
        /// </summary>
        ...
        /// <summary>Gets the number of samples in the collection</summary>
        public int Count
        {
            get
            {
        ...
        /// <returns>
        /// A new cloned SamplePointList.  This returns a copy of the structure, but it does not duplicate the data (it just keeps a reference to the
        /// original)
        /// </returns>
