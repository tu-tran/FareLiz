...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// The LinearAsOrdinalScale class inherits from the <see cref="Scale" /> class, and implements the features specific to
    /// <see cref="AxisType.LinearAsOrdinal" />.
    /// </summary>
    /// <remarks>
    /// LinearAsOrdinal is an ordinal axis that will have labels formatted with values from the actual data values of the first <see cref="CurveItem" /> in
    ...
    internal class LinearAsOrdinalScale : Scale, ISerializable
    {
        ...
        /// <see cref="AxisType.LinearAsOrdinal" />.</summary>
        public override AxisType Type
        {
            get
            {
                return AxisType.LinearAsOrdinal;
            }
        }
        ...
        /// <summary>
        /// Select a reasonable ordinal axis scale given a range of data values, with the expectation that linear values will be displayed.
        /// </summary>
        /// <remarks>
        /// This method only applies to <see cref="AxisType.DateAsOrdinal"/> type axes, and it is called by the general <see cref="Scale.PickScale"/> method.
        /// For this type, the first curve is the "master", which contains the dates to be applied.
        /// <para>
        /// On Exit:
        /// </para>
        /// <para>
        ...
        public override void PickScale(GraphPane pane, Graphics g, float scaleFactor)
        {
            ...
            {
                if ((this._ownerAxis is Y2Axis && curve.IsY2Axis) || (this._ownerAxis is YAxis && !curve.IsY2Axis)
                    || (this._ownerAxis is X2Axis && curve.IsX2Axis) || (this._ownerAxis is XAxis && !curve.IsX2Axis))
                {
