...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// <see cref="YAxis" /> inherits from <see cref="Axis" />, and defines the special characteristics of a vertical axis, specifically located on the right
    /// side of the <see cref="Chart.Rect" /> of the <see cref="GraphPane" />
    /// object
    /// </summary>
    ...
    public class YAxis : Axis, ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="YAxis" /> class.</summary>
        public new struct Default
        {
            ...
            /// <see cref="YAxis" />, that is, a line that divides the negative values from positive values.
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="YAxis"/> class. Default constructor that sets all <see cref="YAxis"/> properties to default values as defined in the <see cref="Default"/> class
        /// </summary>
        public YAxis()
            : this("Y Axis")
        {
        ...
        /// Default constructor that sets all <see cref="YAxis"/> properties to default values as defined in the <see cref="Default"/> class, except for the
        /// axis title
        /// </summary>
        /// <param name="title">
