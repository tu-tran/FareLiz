   ...
   public class Bar : ICloneable, ISerializable
   {
	...
	#region Defaults
		...
		public struct Default
		{
			...
			/// <summary>
			/// The default fill mode for bars (<see cref="Fill.Type"/> property).
			/// </summary>
			public static FillType FillType = FillType.Brush;
			/// <summary>
			/// The default border mode for bars (<see cref="LineBase.IsVisible"/> property).
