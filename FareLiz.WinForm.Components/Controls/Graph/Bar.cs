...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A class representing all the characteristics of the bar segments that make up a curve on the graph.</summary>
    ...
    public class Bar : ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="Bar" /> class.</summary>
        public struct Default
        {
            // Default Bar properties
            /// <summary>The default pen width to be used for drawing the border around the bars (<see cref="LineBase.Width" /> property).  Units are points.</summary>
            public static float BorderWidth = 1.0F;

            /// <summary>The default fill mode for bars (<see cref="Fill.Type" /> property).</summary>
            public static FillType FillType = FillType.Brush;

            /// <summary>The default border mode for bars (<see cref="LineBase.IsVisible" /> property). true to display frames around bars, false otherwise</summary>
            public static bool IsBorderVisible = true;

            /// <summary>The default color for drawing frames around bars (<see cref="LineBase.Color" /> property).</summary>
            public static Color BorderColor = Color.Black;

            /// <summary>The default color for filling in the bars (<see cref="Fill.Color" /> property).</summary>
            public static Color FillColor = Color.Red;

            /// <summary>The default custom brush for filling in the bars (<see cref="Fill.Brush" /> property).</summary>
        ...
        /// <see cref="Bar" />.  Use the public property <see cref="Fill" /> to access this value.
        /// </summary>
        private Fill _fill;

        /// <summary>
        /// Private field that stores the <see cref="Border" /> class that defines the properties of the border around this <see cref="BarItem" />. Use the
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Bar"/> class. Default constructor that sets all <see cref="Bar"/> properties to default values as defined in the <see cref="Default"/> class.
        /// </summary>
        public Bar()
            : this(Color.Empty)
        {
        ...
        /// <summary>The <see cref="Border" /> object used to draw the border around the <see cref="Bar" />.</summary>
