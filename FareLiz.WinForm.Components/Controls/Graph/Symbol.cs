...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// This class handles the drawing of the curve <see cref="Symbol" /> objects. The symbols are the small shapes that appear over each defined point along
    /// the curve.
    /// </summary>
    ...
    public class Symbol : ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="Symbol" /> class.</summary>
        public struct Default
        {
            // Default Symbol properties
            /// <summary>The default size for curve symbols (<see cref="Symbol.Size" /> property), in units of points.</summary>
            public static float Size = 7;

            /// <summary>The default pen width to be used for drawing curve symbols (<see cref="LineBase.Width" /> property).  Units are points.</summary>
            public static float PenWidth = 1.0F;

            /// <summary>The default color for filling in this <see cref="Symbol" />
            /// (<see cref="Fill.Color" /> property).</summary>
            public static Color FillColor = Color.Red;

            /// <summary>The default custom brush for filling in this <see cref="Symbol" />
            ...
            /// <summary>The default symbol type for curves (<see cref="Symbol.Type" /> property). This is defined as a <see cref="SymbolType" /> enumeration.</summary>
            public static SymbolType Type = SymbolType.Square;

            /// <summary>The default value for the <see cref="Symbol.IsAntiAlias" />
            /// property.</summary>
            public static bool IsAntiAlias = false;

            /// <summary>The default display mode for symbols (<see cref="Symbol.IsVisible" /> property). true to display symbols, false to hide them.</summary>
            public static bool IsVisible = true;

            /// <summary>
            /// The default for drawing frames around symbols (<see cref="LineBase.IsVisible" /> property). true to display symbol frames, false to hide
            /// them.
            /// </summary>
            public static bool IsBorderVisible = true;

            /// <summary>The default color for drawing symbols (<see cref="LineBase.Color" /> property).</summary>
        ...
        /// <see cref="Symbol" /> in points (1/72 inch).  Use the public property <see cref="Size" /> to access this value.
        /// </summary>
        private float _size;

        /// <summary>
        /// Private field that stores the <see cref="SymbolType" /> for this
        /// <see cref="Symbol" />.  Use the public property <see cref="Type" /> to access this value.
        /// </summary>
        private SymbolType _type;

        /// <summary>
        /// private field that determines if the symbols are drawn using Anti-Aliasing capabilities from the <see cref="Graphics" /> class. Use the public
        /// property <see cref="IsAntiAlias" /> to access this value.
        /// </summary>
        private bool _isAntiAlias;

        /// <summary>
        /// Private field that stores the visibility of this
        /// <see cref="Symbol" />.  Use the public property <see cref="IsVisible" /> to access this value.  If this value is false, the symbols will not be shown
        /// (but the <see cref="Line" /> may still be shown).
        /// </summary>
        private bool _isVisible;

        /// <summary>
        /// Private field that stores the <see cref="Graph.Fill" /> data for this
        /// <see cref="Symbol" />.  Use the public property <see cref="Fill" /> to access this value.
        /// </summary>
        private Fill _fill;

        /// <summary>
        /// Private field that stores the <see cref="Graph.Border" /> data for this
        /// <see cref="Symbol" />.  Use the public property <see cref="Border" /> to access this value.
        /// </summary>
        private Border _border;

        /// <summary>
        /// Private field that stores the user defined <see cref="GraphicsPath" /> data for this
        /// <see cref="Symbol" />.  Use the public property <see cref="UserSymbol" /> to access this value.
        /// </summary>
        ...
        /// <summary>Gets or sets the size of the <see cref="Symbol" />
        /// </summary>
        ...
        /// <summary>Gets or sets the type (shape) of the <see cref="Symbol" />
        /// </summary>
        ...
        /// <summary>Gets or sets a value that determines if the symbols are drawn using Anti-Aliasing capabilities from the <see cref="Graphics" /> class.</summary>
        /// <remarks>
        /// If this value is set to true, then the <see cref="Graphics.SmoothingMode" />
        /// property will be set to <see cref="SmoothingMode.HighQuality" /> only while this <see cref="Symbol" /> is drawn.  A value of false will leave the
        /// value of
        ...
        /// <summary>Gets or sets the <see cref="Graph.Border" /> data for this
        /// <see cref="Symbol" />, which controls the border outline of the symbol.</summary>
        ...
        /// <summary>Gets or sets the <see cref="GraphicsPath" /> data for this
        /// <see cref="Symbol" />, describing the user-defined symbol type.</summary>
        /// <remarks>This value only applies if <see cref="Symbol.Type">Symbol.Type</see>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Symbol"/> class. Default constructor that sets all <see cref="Symbol"/> properties to default values as defined in the <see cref="Default"/> class.
        /// </summary>
        public Symbol()
        ...
        /// </param>
        /// <param name="path">
        /// A <see cref="GraphicsPath"/> previously constructed by
        /// <see cref="MakePath"/> for this symbol
        /// </param>
        /// <param name="pen">
        /// A <see cref="Pen"/> class representing the standard pen for this symbol
        /// </param>
        /// <param name="brush">
        /// A <see cref="Brush"/> class representing a default solid brush for this symbol If this symbol uses a <see cref="LinearGradientBrush"/>, it will be
        /// created on the fly for each point, since it has to be scaled to the individual point coordinates.
        /// </param>
        ...
        /// <summary>
        /// Create a <see cref="GraphicsPath"/> struct for the current symbol based on the specified scaleFactor and assuming the symbol will be centered at
        /// position 0,0.
        /// </summary>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        ...
        /// </param>
        /// <returns>
        /// Returns the <see cref="GraphicsPath"/> for the current symbol
        /// </returns>
