...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>This struct encapsulates a date and time value, and handles associated calculations and conversions between various formats.</summary>
    /// <remarks>
    /// This format stored as a double value representing days since a reference date (XL date 0.0 is December 30, 1899 at 00:00 hrs). Negative values are
    /// permissible, and the range of valid dates is from noon on January 1st, 4713 B.C. forward.  Internally, the date calculations are done using
    /// Astronomical Julian Day numbers.  The Astronomical Julian Day number is defined as the number of days since noon on January 1st, 4713 B.C. (also
    /// referred to as 12:00 on January 1, -4712). NOTE: MS Excel actually has an error in the Serial Date calculations because it errantly assumes 1900 is a
    /// leap year.  The XDate calculations do not have this same error.  Therefore, XDate and Excel Date Serial values are 1 day different up until the date
    /// value of 60 (in Excel, this is February 29th, 1900, and in XDate, this is February 28th, 1900).  At a value of 61 (March 1st, 1900) or greater, they
    ...
    public struct XDate : IComparable
    {
        ...
        /// <summary>The actual date value in MS Excel format.  This is the only data field in the <see cref="XDate" /> struct.</summary>
        ...
        /// <summary>The minimum valid Julian Day, which corresponds to January 1st, 4713 B.C.</summary>
        public const double JulDayMin = 0.0;

        /// <summary>The maximum valid Julian Day, which corresponds to December 31st, 9999 A.D.</summary>
        public const double JulDayMax = 5373483.5;

        /// <summary>The minimum valid Excel Day, which corresponds to January 1st, 4713 B.C.</summary>
        public const double XLDayMin = JulDayMin - XLDay1;

        /// <summary>The maximum valid Excel Day, which corresponds to December 31st, 9999 A.D.</summary>
        ...
        /// <summary>The number of milliseconds in a day</summary>
        public const double MillisecondsPerDay = 86400000.0;

        /// <summary>The default format string to be used in <see cref="ToString()" /> when no format is provided</summary>
        ...
        {
            this._xlDate = CalendarDateToXLDate(
                dateTime.Year, 
                dateTime.Month, 
                dateTime.Day, 
                dateTime.Hour, 
        ...
        /// </param>
        /// <param name="month">
        /// An integer value for the month of the year, e.g., 8 for August.  It is permissible to have months outside of the 1-12 range, which will rollover to
        /// the previous or next year.
        /// </param>
        /// <param name="day">
        /// An integer value for the day of the month, e.g., 23. It is permissible to have day numbers outside of the 1-31 range, which will rollover to the
        /// previous or next month and year.
        /// </param>
        ...
        /// </param>
        /// <param name="hour">
        /// An integer value for the hour of the day, e.g. 15. It is permissible to have hour values outside the 0-23 range, which will rollover to the previous
        /// or next day.
        /// </param>
        /// <param name="minute">
        /// An integer value for the minute, e.g. 45. It is permissible to have hour values outside the 0-59 range, which will rollover to the previous or next
        /// hour.
        /// </param>
        /// <param name="second">
        /// An integer value for the second, e.g. 35. It is permissible to have second values outside the 0-59 range, which will rollover to the previous or next
        /// minute.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="XDate"/> struct. 
        /// Construct a date class from a calendar date and time (year, month, day, hour, minute, second), where seconds is a <see cref="System.Double"/> value
        ...
        /// </param>
        /// <param name="second">
        /// A double value for the second, e.g. 35.75. It is permissible to have second values outside the 0-59 range, which will rollover to the previous or
        /// next minute.
        /// </param>
        ...
        /// An integer value for the millisecond, e.g. 632. It is permissible to have millisecond values outside the 0-999 range, which will rollover to the
        /// previous or next second.
        /// </param>
...
*/
        ...
        /// <summary>Gets or sets the date value for this item in MS Excel format.</summary>
        ...
        /// <summary>Returns true if this <see cref="XDate" /> struct is in the valid date range</summary>
        public bool IsValidDate
        {
            get
            {
                return this._xlDate >= XLDayMin && this._xlDate <= XLDayMax;
            }
        }

        /// <summary>Gets or sets the date value for this item in .Net DateTime format.</summary>
        public DateTime DateTime
        {
            get
            {
                return XLDateToDateTime(this._xlDate);
            }
        ...
        /// <summary>
        /// Gets or sets the date value for this item in Julain day format.  This is the Astronomical Julian Day number, so a value of 0.0 corresponds to noon
        /// GMT on January 1st, -4712.  Thus, Julian Day number 2,400,000.0 corresponds to noon GMT on November 16, 1858.
        /// </summary>
        public double JulianDay
        {
            get
            {
                return XLDateToJulianDay(this._xlDate);
            }
        ...
        /// <summary>Gets or sets the decimal year number (i.e., 1997.345) corresponding to this item.</summary>
        public double DecimalYear
        {
            get
            {
                return XLDateToDecimalYear(this._xlDate);
            }
        ...
        /// </param>
        /// <returns>
        /// An XLDate value that lies between the minimum and maximum valid date ranges (see <see cref="XLDayMin"/> and <see cref="XLDayMax"/>)
        /// </returns>
        ...
        /// <summary>Get the day of year value (241.345 means the 241st day of the year) corresponding to this instance.</summary>
        /// <returns>The day of the year in floating point double format.</returns>
        public double GetDayOfYear()
        {
            return XLDateToDayOfYear(this._xlDate);
        }
        ...
        /// </summary>
        /// <remarks>
        /// The Calendar date is always based on the Gregorian Calendar.  Note that the Gregorian calendar is really only valid from October 15, 1582 forward.
        /// The countries that adopted the Gregorian calendar first did so on October 4, 1582, so that the next day was October 15, 1582.  Prior to that time the
        /// Julian Calendar was used.  However, Prior to March 1, 4 AD the treatment of leap years was inconsistent, and prior to 45 BC the Julian Calendar did
        /// not exist.  The <see cref="XDate"/>
        /// struct projects only Gregorian dates backwards and does not deal with Julian calendar dates at all.  The
        /// <see cref="ToString(double,string)"/> method will just append a "(BC)" notation to the end of any dates prior to 1 AD, since the
        /// <see cref="DateTime"/> struct throws an exception when formatting earlier dates.
        /// </remarks>
        /// <param name="year">
        ...
        public static double CalendarDateToXLDate(int year, int month, int day, int hour, int minute, int second, int millisecond)
        {
            ...
            NormalizeCalendarDate(ref year, ref month, ref day, ref hour, ref minute, ref second, ref ms);
        ...
        /// <summary>
        /// Calculate an XL Date from the specified Calendar date (year, month, day, hour, minute, second), first normalizing all input data values.  The seconds
        /// value is a double type, allowing fractional seconds.
        /// </summary>
        /// <remarks>
        /// The Calendar date is always based on the Gregorian Calendar.  Note that the Gregorian calendar is really only valid from October 15, 1582 forward.
        /// The countries that adopted the Gregorian calendar first did so on October 4, 1582, so that the next day was October 15, 1582.  Prior to that time the
        ...
        public static double CalendarDateToXLDate(int year, int month, int day, int hour, int minute, double second)
        {
            ...
            NormalizeCalendarDate(ref year, ref month, ref day, ref hour, ref minute, ref sec, ref ms);

            return _CalendarDateToXLDate(year, month, day, hour, minute, sec, ms);
        }

        /// <summary>
        /// Calculate an Astronomical Julian Day number from the specified Calendar date (year, month, day, hour, minute, second), first normalizing all input
        /// data values
        /// </summary>
        /// <param name="year">
        /// The integer year value (e.g., 1994).
        ...
        /// <summary>
        /// Normalize a set of Calendar date values (year, month, day, hour, minute, second) to make sure that month is between 1 and 12, hour is between 0 and
        /// 23, etc.
        /// </summary>
        /// <param name="year">
        /// The integer year value (e.g., 1994).
        ...
        /// </param>
        private static void NormalizeCalendarDate(
            ref int year, 
            ref int month, 
            ref int day, 
            ref int hour, 
        ...
        /// <summary>
        /// Calculate an XL date from the specified Calendar date (year, month, day, hour, minute, second). This is the internal trusted version, where all
        /// values are assumed to be legitimate ( month is between 1 and 12, minute is between 0 and 59, etc. )
        /// </summary>
        /// <param name="year">
        /// The integer year value (e.g., 1994).
        /// </param>
        ...
        /// <summary>
        /// Calculate an Astronomical Julian Day Number from the specified Calendar date (year, month, day, hour, minute, second). This is the internal trusted
        /// version, where all values are assumed to be legitimate ( month is between 1 and 12, minute is between 0 and 59, etc. )
        /// </summary>
        /// <param name="year">
        /// The integer year value (e.g., 1994).
        /// </param>
        ...
        private static double _CalendarDateToJulianDay(int year, int month, int day, int hour, int minute, int second, double millisecond)
        {
            ...
            return Math.Floor(365.25 * (year + 4716.0)) + Math.Floor(30.6001 * (month + 1)) + day + B - 1524.5 + hour / HoursPerDay
                   + minute / MinutesPerDay + second / SecondsPerDay + millisecond / MillisecondsPerDay;
        }
        ...
        /// </param>
        public static void XLDateToCalendarDate(
            double xlDate, 
            out int year, 
            out int month, 
            out int day, 
            ...
            out int millisecond)
        {
            ...
            double ms;
            JulianDayToCalendarDate(jDay, out year, out month, out day, out hour, out minute, out second, out ms);
            millisecond = (int)ms;
        }
            ...
            out double second)
        {
            ...
            JulianDayToCalendarDate(jDay, out year, out month, out day, out hour, out minute, out sec, out ms);
        ...
        /// </param>
        /// <param name="millisecond">
        /// The <see cref="System.Double"/> millisecond value (e.g., 342.5 for 342.5 milliseconds past the second).
        /// </param>
        public static void JulianDayToCalendarDate(
            double jDay, 
            out int year, 
        ...
        public static DateTime XLDateToDateTime(double xlDate)
        {
            ...
            XLDateToCalendarDate(xlDate, out year, out month, out day, out hour, out minute, out second, out millisecond);
        ...
        {
            this._xlDate += dMilliseconds / MillisecondsPerDay;
        }
        ...
        {
            this._xlDate += dSeconds / SecondsPerDay;
        }
        ...
        {
            this._xlDate += dMinutes / MinutesPerDay;
        }
        ...
        /// <summary>'-' operator overload.  When two XDates are subtracted, the number of days between dates is returned.</summary>
        ...
        /// <summary>'-' operator overload.  When a double value is subtracted from an XDate, the result is a new XDate with the number of days subtracted.</summary>
        /// <param name="lhs">The left-hand-side of the '-' operator (an XDate class)</param>
        ...
        /// <summary>'+' operator overload.  When a double value is added to an XDate, the result is a new XDate with the number of days added.</summary>
        /// <param name="lhs">The left-hand-side of the '-' operator (an XDate class)</param>
        /// <param name="rhs">The right-hand-side of the '+' operator (a double value)</param>
        ...
        /// <summary>Implicit conversion from XDate to double (an XL Date).</summary>
        /// <param name="xDate">The XDate struct on which to operate</param>
        ...
        /// <summary>Implicit conversion from XDate to float (an XL Date).</summary>
        /// <param name="xDate">The XDate struct on which to operate</param>
        /// <returns>A double floating point value representing the XL Date</returns>
        ...
        /// <summary>Implicit conversion from double (an XL Date) to XDate.</summary>
        ...
        /// <summary>Implicit conversion from XDate to <see cref="DateTime" />.</summary>
        /// <param name="xDate">The XDate struct on which to operate</param>
        ...
        /// <summary>Implicit conversion from <see cref="DateTime" /> to <see cref="XDate" />.</summary>
        ...
        /// obj
        /// </param>
        /// is either an <see cref="XDate"/> structure or a double floating point value that is equal to the same date as this <c>XDate</c>
        /// struct instance.
        /// </summary>
        /// <param name="obj">
        ...
        /// obj
        /// </param>
        /// is the same date as this instance; otherwise, <c>false</c>
        /// </returns>
        ...
        /// <summary>
        /// Returns the hash code for this <see cref="XDate" /> structure.  In this case, the hash code is simply the equivalent hash code for the floating point
        /// double date value.
        /// </summary>
        ...
        /// </remarks>
        /// <param name="target">
        /// The second <see cref="XDate"/> object to be compared.
        /// </param>
        /// <returns>
        /// zero if <paramref name="target"/> is equal to the current instance, -1 if <paramref name="target"/> is less than the current instance, and 1 if
        /// <paramref name="target"/> is greater than the current instance.
        /// </returns>
        ...
        /// method in order to provide full localization capability.  The DateTime struct is limited to dates from 1 AD onward.  However, all calendar dates in
        /// <see cref="XDate"/> and <see cref="DateTime"/>
        /// are projected Gregorian calendar dates.  Since the Gregorian calendar was not implemented until October 4, 1582 (or later in some countries),
        /// Gregorian dates prior to that time are really dates that would have been, had the Gregorian calendar existed.  In order to avoid throwing an
        /// exception, for dates prior to 1 AD, the year will be converted to a positive year and the text "(BC)" is appended to the end of the formatted string.
        /// Under this mode, the year sequence is 2BC, 1BC, 1AD, 2AD, etc.  There is no year zero.
        /// </remarks>
        /// <param name="xlDate">
        ...
        /// <summary>Format this XDate value using the default format string (see cref="DefaultFormatStr"/>).</summary>
        /// <remarks>
        ...
        /// <summary>
        /// Format this XL Date value using the specified format string.  The format string is specified according to the <see cref="DateTime"/> class.
        /// </summary>
        /// <remarks>
        /// The formatting is done using the <see cref="DateTime"/>
        /// <see cref="System.DateTime.ToString(String)"/>
        ...
        /// <summary>
        /// Format the specified XL Date value using the specified format string.  The format string is specified according to the <see cref="DateTime"/> class.
        /// </summary>
        /// <remarks>
        /// The formatting is done using the <see cref="DateTime"/>
        /// <see cref="System.DateTime.ToString(String)"/>
