...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A class than contains information about the position of an object on the graph.</summary>
    ...
    public class Location : ICloneable, ISerializable
    {
        ...
        /// <summary>
        /// Private field to store the vertical alignment property for this object.  Use the public property <see cref="Location.AlignV" />
        /// to access this value.  The value of this field is a <see cref="AlignV" /> enum.
        /// </summary>
        private AlignV _alignV;

        /// <summary>
        /// Private field to store the horizontal alignment property for this object.  Use the public property <see cref="Location.AlignH" />
        /// to access this value.  The value of this field is a <see cref="AlignH" /> enum.
        /// </summary>
        private AlignH _alignH;

        /// <summary>
        /// Private fields to store the X and Y coordinate positions for this object.  Use the public properties <see cref="X" /> and
        /// <see cref="Y" /> to access these values.  The coordinate type stored here is dependent upon the setting of <see cref="CoordinateFrame" />.
        /// </summary>
        private double _x;
        ...
        /// <summary>
        /// Private field to store the coordinate system to be used for defining the object position.  Use the public property
        /// <see cref="CoordinateFrame" /> to access this value. The coordinate system is defined with the <see cref="CoordType" /> enum.
        /// </summary>
        ...
        /// <summary>A horizontal alignment parameter for this object specified using the <see cref="AlignH" /> enum type.</summary>
        ...
        /// <summary>A vertical alignment parameter for this object specified using the <see cref="AlignV" /> enum type.</summary>
        ...
        /// <summary>The coordinate system to be used for defining the object position</summary>
        ...
        /// <remarks>
        /// The units of this position are specified by the <see cref="CoordinateFrame" /> property. The object will be aligned to this position based on the
        ...
        /// <summary>The x1 position of the object (an alias for the x position).</summary>
        /// <remarks>
        /// The units of this position are specified by the <see cref="CoordinateFrame" /> property. The object will be aligned to this position based on the
        /// <see cref="AlignH" /> property.
        /// </remarks>
        ...
        /// <summary>The y1 position of the object (an alias for the y position).</summary>
        /// <remarks>
        /// The units of this position are specified by the <see cref="CoordinateFrame" /> property. The object will be aligned to this position based on the
        /// <see cref="AlignV" /> property.
        /// </remarks>
        ...
        /// <remarks>The units of this position are specified by the
        /// <see cref="CoordinateFrame" /> property.</remarks>
        public double Width
        {
            get
            {
        ...
        /// <summary>The x2 position of the object.</summary>
        /// <remarks>
        /// The units of this position are specified by the
        /// <see cref="CoordinateFrame" /> property. The object will be aligned to this position based on the
        /// <see cref="AlignH" /> property.  This position is only used for objects such as <see cref="ArrowObj" />, where it makes sense to have a second
        /// coordinate.  Note that the X2 position is stored internally as a <see cref="Width" /> offset from <see cref="X" />.
        /// </remarks>
        public double X2
        {
            get
        ...
        /// <summary>The y2 position of the object.</summary>
        /// <remarks>
        /// The units of this position are specified by the <see cref="CoordinateFrame" /> property. The object will be aligned to this position based on the
        /// <see cref="AlignV" /> property.  This position is only used for objects such as <see cref="ArrowObj" />, where it makes sense to have a second
        /// coordinate.  Note that the Y2 position is stored internally as a <see cref="Height" /> offset from <see cref="Y" />.
        /// </remarks>
        public double Y2
        {
            get
        ...
        /// </summary>
        /// <remarks>
        /// Note that this method reduces the precision of the location coordinates from double precision to single precision.  In some cases, such as
        /// <see cref="AxisType.Date" />, it may affect the resolution of the point location.
        /// </remarks>
        /// <value>
        /// A <see cref="RectangleF" /> in <see cref="CoordinateFrame" />
        /// units.
        /// </value>
        public RectangleF Rect
        {
            get
            {
                return new RectangleF((float)this._x, (float)this._y, (float)this._width, (float)this._height);
            }
        ...
        /// <summary>The top-left <see cref="PointF" /> for this <see cref="Location" />.</summary>
        /// <remarks>
        /// Note that this method reduces the precision of the location coordinates from double precision to single precision.  In some cases, such as
        /// <see cref="AxisType.Date" />, it may affect the resolution of the point location.
        /// </remarks>
        ...
        /// <summary>The bottom-right <see cref="PointF" /> for this <see cref="Location" />.</summary>
        /// <remarks>
        /// Note that this method reduces the precision of the location coordinates from double precision to single precision.  In some cases, such as
        /// <see cref="AxisType.Date" />, it may affect the resolution of the point location.
        /// </remarks>
        ...
        public PointF BottomRight
        {
            get
            {
                return new PointF((float)this.X2, (float)this.Y2);
            }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Location"/> class. Default constructor for the <see cref="Location"/> class.
        /// </summary>
        public Location()
        ...
        /// Constructor for the <see cref="Location"/> class that specifies the x, y position and the <see cref="CoordType"/>.
        /// </summary>
        /// <remarks>
        /// The (x,y) position corresponds to the top-left corner;
        /// </remarks>
        /// <param name="x">
        /// The x position, specified in units of <see paramref="coordType"/>.
        /// </param>
        /// <param name="y">
        /// The y position, specified in units of <see paramref="coordType"/>.
        /// </param>
        /// <param name="coordType">
        /// The <see cref="CoordType"/> enum that specifies the units for <see paramref="x"/> and <see paramref="y"/>
        /// </param>
        ...
        /// </param>
        /// <param name="alignH">
        /// The <see cref="Graph.AlignH"/> enum that specifies the horizontal alignment of the object with respect to the (x,y) location
        /// </param>
        /// <param name="alignV">
        /// The <see cref="Graph.AlignV"/> enum that specifies the vertical alignment of the object with respect to the (x,y) location
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Location"/> class. 
        /// Constructor for the <see cref="Location"/> class that specifies the (x, y), (width, height), and the <see cref="CoordType"/>.
        /// </summary>
        /// <remarks>
        /// The (x,y) position corresponds to the starting position, the (x2, y2) coorresponds to the ending position (typically used for <see cref="ArrowObj"/>
        /// 's).
        /// </remarks>
        /// <param name="x">
        /// The x position, specified in units of <see paramref="coordType"/>.
        ...
        /// </param>
        /// <param name="width">
        /// The width, specified in units of <see paramref="coordType"/>.
        /// </param>
        /// <param name="height">
        /// The height, specified in units of <see paramref="coordType"/>.
        /// </param>
        /// <param name="coordType">
        /// The <see cref="CoordType"/> enum that specifies the units for <see paramref="x"/> and <see paramref="y"/>
        /// </param>
