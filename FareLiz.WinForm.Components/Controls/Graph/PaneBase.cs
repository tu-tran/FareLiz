...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
	...
	#region Fields
		...
		/// <summary>Private field instance of the <see cref="Graph.Legend"/> class.  Use the
		...
		/// <summary>Private field instance of the <see cref="Graph.GraphObjList"/> class.  Use the
	...
	#region Properties
		...
		/// <summary>
		/// Gets or sets the <see cref="Graph.Border"/> class for drawing the border
		...
		/// <summary>
		/// Gets or sets the <see cref="Graph.Fill"/> data for the
		...
		/// <summary>
		/// Gets or sets the <see cref="Graph.Margin" /> instance that controls the space between
		...
		{
			get { return this._baseDimension; }
			set { this._baseDimension = value; }
		}
		...
		{
			get { return this._titleGap; }
			set { this._titleGap = value; }
		}
		...
		{
			get { return this._isFontsScaled; }
			set { this._isFontsScaled = value; }
		}
		/// <summary>
		...
		{
			get { return this._isPenWidthScaled; }
			set { this._isPenWidthScaled = value; }
		}
	...
	#region Methods
		...
		/// To do so, you must separately call <see cref="Graph.Legend.CalcRect"/>.
		/// </remarks>
		/// <param name="g">
		/// A graphic device object to be drawn into.  This is normally e.Graphics from the
		/// PaintEventArgs argument to the Paint() method.
		...
		{	
			...
			if ( this._title._isVisible )
			{
				...
				// default attributes.
				this._title._fontSpec.Draw( g, this, this._title._text,
