...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// An abstract base class that defines basic functionality for handling a pane.  This class is the parent class for <see cref="MasterPane" /> and
    /// <see cref="GraphPane" />.
    /// </summary>
    ...
    public abstract class PaneBase : ICloneable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="PaneBase" /> class.</summary>
        public struct Default
        {
            // Default GraphPane properties
            /// <summary>
            /// The default display mode for the title at the top of the pane (<see cref="PaneBase.Title" /> <see cref="Label.IsVisible" /> property).  true to
            /// display a title, false otherwise.
            /// </summary>
            public static bool IsShowTitle = true;

            /// <summary>The default font family for the title (<see cref="PaneBase.Title" /> property).</summary>
            public static string FontFamily = SystemFonts.DefaultFont.Name;

            /// <summary>The default font size (points) for the
            /// <see cref="PaneBase.Title" /> (<see cref="FontSpec.Size" /> property).</summary>
            public static float FontSize = 16;

            /// <summary>The default font color for the
            /// <see cref="PaneBase.Title" />
            /// (<see cref="FontSpec.FontColor" /> property).</summary>
            public static Color FontColor = Color.Black;

            /// <summary>The default font bold mode for the
            /// <see cref="PaneBase.Title" />
            /// (<see cref="FontSpec.IsBold" /> property). true for a bold typeface, false otherwise.</summary>
            ...
            /// <summary>
            /// The default border mode for the <see cref="PaneBase" />. (<see cref="PaneBase.Border" /> property). true to draw a border around the
            /// <see cref="PaneBase.Rect" />, false otherwise.
            /// </summary>
            public static bool IsBorderVisible = true;

            /// <summary>The default color for the <see cref="PaneBase" /> border. (<see cref="PaneBase.Border" /> property).</summary>
            public static Color BorderColor = Color.Black;

            /// <summary>The default color for the <see cref="PaneBase.Rect" /> background. (<see cref="PaneBase.Fill" /> property).</summary>
            public static Color FillColor = Color.White;

            /// <summary>The default pen width for the <see cref="PaneBase" /> border. (<see cref="PaneBase.Border" /> property).  Units are in points (1/72 inch).</summary>
            public static float BorderPenWidth = 1;

            /// <summary>
            /// The default dimension of the <see cref="PaneBase.Rect" />, which defines a normal sized plot.  This dimension is used to scale the fonts, symbols,
            /// etc. according to the actual size of the
            ...
            /// <summary>
            /// The default setting for the <see cref="PaneBase.IsPenWidthScaled" /> option. true to have all pen widths scaled according to
            /// <see cref="PaneBase.BaseDimension" />, false otherwise.
            /// </summary>
            /// <seealso cref="PaneBase.CalcScaleFactor" />
            public static bool IsPenWidthScaled = false;

            /// <summary>
            /// The default setting for the <see cref="PaneBase.IsFontsScaled" /> option. true to have all fonts scaled according to
            /// <see cref="PaneBase.BaseDimension" />, false otherwise.
            /// </summary>
            /// <seealso cref="PaneBase.CalcScaleFactor" />
            ...
            /// <summary>
            /// The default value for the <see cref="PaneBase.TitleGap" /> property, expressed as a fraction of the scaled <see cref="Title" /> character
            /// height.
            /// </summary>
        ...
        /// <summary>
        /// The rectangle that defines the full area into which the pane is rendered.  Units are pixels. Use the public property <see cref="Rect" /> to access
        /// this value.
        /// </summary>
        protected RectangleF _rect;

        /// <summary>Private field that holds the main title of the pane.  Use the public property <see cref="Title" /> to access this value.</summary>
        protected GapLabel _title;

        /// <summary>
        /// Private field instance of the <see cref="Graph.Legend" /> class.  Use the public property <see cref="PaneBase.Legend" /> to access this
        /// class.
        /// </summary>
        protected Legend _legend;

        /// <summary>
        /// Private field that stores the user-defined tag for this <see cref="PaneBase" />.  This tag can be any user-defined value.  If it is a
        /// <see cref="String" /> type, it can be used as a parameter to the <see cref="PaneList.IndexOfTag" /> method.  Use the public property
        /// <see cref="Tag" /> to access this value.
        /// </summary>
        protected object _tag;

        /// <summary>
        /// private field to store the margin values for this <see cref="PaneBase" />. Use the public property <see cref="Margin" /> to access this
        /// property.
        /// </summary>
        internal Margin _margin;

        /// <summary>
        /// Private field that determines whether or not the fonts, tics, gaps, etc. will be scaled according to the actual graph size.  true for font and
        /// feature scaling with graph size, false for fixed font sizes (scaleFactor = 1.0 constant). Use the public property <see cref="IsFontsScaled" /> to
        /// access this value.
        /// </summary>
        ...
        /// <summary>
        /// Private field that controls whether or not pen widths are scaled according to the size of the graph.  This value is only applicable if
        /// <see cref="IsFontsScaled" />
        /// is true.  If <see cref="IsFontsScaled" /> is false, then no scaling will be done, regardless of the value of <see cref="IsPenWidthScaled" />.
        /// </summary>
        /// <value>true to scale the pen widths according to the size of the graph, false otherwise.</value>
        /// <seealso cref="IsFontsScaled" />
        /// <seealso cref="CalcScaleFactor" />
        protected bool _isPenWidthScaled;

        /// <summary>
        /// Private field that stores the <see cref="Graph.Fill" /> data for the
        /// <see cref="Rect" /> background.  Use the public property <see cref="Fill" /> to access this value.
        /// </summary>
        protected Fill _fill;

        /// <summary>
        /// Private field that stores the <see cref="Graph.Border" /> data for the
        /// <see cref="Rect" /> border.  Use the public property <see cref="Border" /> to access this value.
        /// </summary>
        protected Border _border;

        /// <summary>
        /// Private field instance of the <see cref="Graph.GraphObjList" /> class.  Use the public property <see cref="GraphObjList" /> to access this
        /// class.
        /// </summary>
        protected GraphObjList _graphObjList;

        /// <summary>
        /// Private field that determines the base size of the pane, in inches. Fonts, tics, gaps, etc. are scaled according to this base size. Use the public
        /// property <see cref="BaseDimension" /> to access this value.
        /// </summary>
        ...
        /// <summary>
        /// private field that stores the gap between the bottom of the pane title and the client area of the pane.  This is expressed as a fraction of the title
        /// character height.
        /// </summary>
        ...
        /// <summary>The rectangle that defines the full area into which all graphics will be rendered.</summary>
        /// <remarks>
        /// Note that this rectangle has x, y, width, and height.  Most of the GDI+ graphic primitive actually draw one pixel beyond those dimensions.  For
        /// example, for a rectangle of ( X=0, Y=0, Width=100, Height=100 ), GDI+ would draw into pixels 0 through 100, which is actually 101 pixels.  For the
        ...
        /// <summary>Accesses the <see cref="Legend" /> for this <see cref="PaneBase" />
        /// </summary>
        ...
        /// <summary>
        /// Gets the <see cref="Label" /> instance that contains the text and attributes of the title. This text can be multiple lines separated by newline
        /// characters ('\n').
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the user-defined tag for this <see cref="PaneBase" />.  This tag can be any user-defined value.  If it is a <see cref="String" /> type,
        /// it can be used as a parameter to the <see cref="PaneList.IndexOfTag" /> method.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>Gets or sets the <see cref="Graph.Border" /> class for drawing the border border around the <see cref="Rect" />
        /// </summary>
        ...
        /// <summary>Gets or sets the <see cref="Graph.Fill" /> data for the filling the background of the <see cref="Rect" />.</summary>
        public Fill Fill
        {
            get
            {
        ...
        /// <summary>Gets or sets the list of <see cref="GraphObj" /> items for this <see cref="GraphPane" />
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="Graph.Margin" /> instance that controls the space between the edge of the <see cref="PaneBase.Rect" /> and the rendered
        ...
        /// <summary>
        /// BaseDimension is a double precision value that sets "normal" pane size on which all the settings are based.  The BaseDimension is in inches.  For
        /// example, if the BaseDimension is 8.0 inches and the
        /// <see cref="Title" /> size is 14 points.  Then the pane title font will be 14 points high when the <see cref="Rect" /> is approximately 8.0 inches
        /// wide.  If the Rect is 4.0 inches wide, the pane title font will be 7 points high.  Most features of the graph are scaled in this manner.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the gap between the bottom of the pane title and the client area of the pane.  This is expressed as a fraction of the scaled
        ...
        /// <summary>
        /// Determines if the font sizes, tic sizes, gap sizes, etc. will be scaled according to the size of the <see cref="Rect" /> and the
        /// <see cref="BaseDimension" />.  If this value is set to false, then the font sizes and tic sizes will always be exactly as specified, without any
        /// scaling.
        /// </summary>
        ...
        /// </summary>
        /// <remarks>
        /// This value is only applicable if <see cref="IsFontsScaled" />
        /// is true.  If <see cref="IsFontsScaled" /> is false, then no scaling will be done, regardless of the value of <see cref="IsPenWidthScaled" />.  Note
        /// that scaling the pen widths can cause "artifacts" to appear at typical screen resolutions.  This occurs because of roundoff differences; in some
        /// cases the pen width may round to 1 pixel wide and in another it may round to 2 pixels wide.  The result is typically undesirable. Therefore, this
        /// option defaults to false.  This option is primarily useful for high resolution output, such as printer output or high resolution bitmaps (from
        /// <see cref="GetImage(int,int,float)" />) where it is desirable to have the pen width be consistent with the screen image.
        /// </remarks>
        /// <value>true to scale the pen widths according to the size of the graph, false otherwise.</value>
        /// <seealso cref="IsFontsScaled" />
        /// <seealso cref="CalcScaleFactor" />
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PaneBase"/> class. Default constructor for the <see cref="PaneBase"/> class.  Leaves the <see cref="Rect"/> empty.
        /// </summary>
        public PaneBase()
        ...
        /// <summary>Create a shallow, memberwise copy of this class.</summary>
        /// <remarks>Note that this method uses MemberWiseClone, which will copy all members (shallow) including those of classes derived from this class.</remarks>
        ...
        /// <see cref="Graphics"/> device.  This abstract method is implemented by the child classes.
        /// </summary>
        /// <param name="g">
        ...
        /// or <see cref="MasterPane"/> items after taking out space for the margins and the title. This method does not take out the area required for the
        /// <see cref="PaneBase.Legend"/>. To do so, you must separately call <see cref="Graph.Legend.CalcRect"/>.
        /// </remarks>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        /// </param>
        /// <param name="scaleFactor">
        /// The scaling factor for the features of the graph based on the <see cref="PaneBase.Default.BaseDimension"/>.  This scaling factor is calculated by
        /// the <see cref="PaneBase.CalcScaleFactor"/> method.  The scale factor represents a linear multiple to be applied to font sizes, symbol sizes, etc.
        /// </param>
        /// <returns>
        ...
        /// </param>
        /// <param name="scaleFactor">
        /// The scaling factor for the features of the graph based on the <see cref="BaseDimension"/>.  This scaling factor is calculated by the
        /// <see cref="CalcScaleFactor"/> method.  The scale factor represents a linear multiple to be applied to font sizes, symbol sizes, etc.
        /// </param>
        ...
        public void DrawTitle(Graphics g, float scaleFactor)
        {
            ...
            if (this._title._isVisible)
            {
                ...
                this._title._fontSpec.Draw(
                    ...
                    this._rect.Top + this._margin.Top * scaleFactor + size.Height / 2.0F, 
                    AlignH.Center, 
                    AlignV.Center, 
                    scaleFactor);
            }
        ...
        /// <summary>
        /// Change the size of the <see cref="Rect"/>.  Override this method to handle resizing the contents as required.
        /// </summary>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        /// </param>
        ...
        /// <summary>Calculate the scaling factor based on the ratio of the current <see cref="Rect" /> dimensions and the <see cref="Default.BaseDimension" />.</summary>
        /// <remarks>
        /// This scaling factor is used to proportionally scale the features of the <see cref="MasterPane" /> so that small graphs don't have huge fonts, and
        /// vice versa. The scale factor represents a linear multiple to be applied to font sizes, symbol sizes, tic sizes, gap sizes, pen widths, etc.  The
        /// units of the scale factor are "World Pixels" per "Standard Point". If any object size, in points, is multiplied by this scale factor, the result is
        /// the size, in pixels, that the object should be drawn using the standard GDI+ drawing instructions.  A "Standard Point" is a dimension based on points
        /// (1/72nd inch) assuming that the <see cref="Rect" /> size matches the <see cref="Default.BaseDimension" />. Note that "World Pixels" will still be
        /// transformed by the GDI+ transform matrices to result in "Output Device Pixels", but "World Pixels" are the reference basis for the drawing commands.
        /// </remarks>
        /// <returns>A <see cref="Single" /> value representing the scaling factor to use for the rendering calculations.</returns>
        ...
        /// <summary>
        /// Calculate the scaled pen width, taking into account the scaleFactor and the setting of the <see cref="IsPenWidthScaled"/> property of the
        /// pane.
        /// </summary>
        /// <param name="penWidth">
        ...
        /// <summary>
        /// Build a <see cref="Bitmap"/> object containing the graphical rendering of all the <see cref="GraphPane"/> objects in this list.
        /// </summary>
        /// <value>
        ...
        /// </summary>
        /// <remarks>
        /// No settings are modified if <paramref name="isAntiAlias"/> is set to false.  This method does not restore original settings, it presumes that the
        /// Graphics instance will be disposed.
        /// </remarks>
        /// <param name="g">
        ...
        private void MakeImage(Graphics g, int width, int height, bool antiAlias)
        {
            ...
            // To restore all the various RequestState variables, you must redraw the graph in it's
