			...
			else
			{
				...
				switch ( this._paneLayout )
				{
					...
					case PaneLayout.ExplicitCol12:
						this.DoLayout( g, master, true, new int[2] { 1, 2 }, null );
						break;
					case PaneLayout.ExplicitCol21:
						this.DoLayout( g, master, true, new int[2] { 2, 1 }, null );
						break;
					case PaneLayout.ExplicitCol23:
						this.DoLayout( g, master, true, new int[2] { 2, 3 }, null );
						break;
					case PaneLayout.ExplicitCol32:
						this.DoLayout( g, master, true, new int[2] { 3, 2 }, null );
						break;
					case PaneLayout.ExplicitRow12:
						this.DoLayout( g, master, false, new int[2] { 1, 2 }, null );
						break;
					case PaneLayout.ExplicitRow21:
						this.DoLayout( g, master, false, new int[2] { 2, 1 }, null );
						break;
					case PaneLayout.ExplicitRow23:
						this.DoLayout( g, master, false, new int[2] { 2, 3 }, null );
						break;
					case PaneLayout.ExplicitRow32:
						this.DoLayout( g, master, false, new int[2] { 3, 2 }, null );
						break;
				}
			}
		}
