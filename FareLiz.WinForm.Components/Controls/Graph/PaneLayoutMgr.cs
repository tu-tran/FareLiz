...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>internal class to store pane layout details for the <see cref="MasterPane" />
    /// </summary>
    ...
    public class PaneLayoutMgr : ICloneable, ISerializable
    {
        ...
        /// <see cref="SetLayout(PaneLayout)" /> was called. This value will default to <see cref="MasterPane.Default.PaneLayout" /> if
        ...
        /// <see cref="SetLayout(bool,int[],float[])" /> method.  This values will be null if <see cref="SetLayout(bool,int[],float[])" /> was never called.
        /// </summary>
        internal int[] _countList;

        /// <summary>
        /// private field that stores the row/column size proportional values as specified to the <see cref="SetLayout(bool,int[],float[])" /> method.  This
        ...
        internal void Init()
        {
            this._paneLayout = MasterPane.Default.PaneLayout;
        ...
        public void SetLayout(int rows, int columns)
        {
            ...
            this.SetLayout(true, countList, null);
        }
        ...
        {
            this.SetLayout(isColumnSpecified, countList, null);
        }
