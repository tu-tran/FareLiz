...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>Class that handles that stores the margin properties for the GraphPane</summary>
    ...
    {
        /// <summary>
        /// Private fields that store the size of the margin around the edge of the pane which will be kept blank.  Use the public properties
        /// <see cref="Margin.Left" />, <see cref="Margin.Right" />,
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="Margin" /> class.</summary>
        public class Default
        {
            /// <summary>
            /// The default value for the <see cref="Margin.Left" /> property, which is the size of the space on the left side of the
            ...
            /// <summary>
            /// The default value for the <see cref="Margin.Right" /> property, which is the size of the space on the right side of the
            /// <see cref="PaneBase.Rect" />.
            /// </summary>
            /// <value>Units are points (1/72 inch)</value>
            ...
            /// <summary>
            /// The default value for the <see cref="Margin.Top" /> property, which is the size of the space on the top side of the
            /// <see cref="PaneBase.Rect" />.
            /// </summary>
            /// <value>Units are points (1/72 inch)</value>
            ...
            /// <summary>
            /// The default value for the <see cref="Margin.Bottom" /> property, which is the size of the space on the bottom side of the
            /// <see cref="PaneBase.Rect" />.
            /// </summary>
            /// <value>Units are points (1/72 inch)</value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Margin"/> class. Constructor to build a <see cref="Margin"/> from the default values.
        /// </summary>
        public Margin()
        {
        ...
        /// </summary>
        /// <value>This value is in units of points (1/72 inch), and is scaled linearly with the graph size.</value>
        ...
        /// <summary>Concurrently sets all outer margin values to a single value.</summary>
        /// <value>This value is in units of points (1/72 inch), and is scaled linearly with the graph size.</value>
        /// <seealso cref="PaneBase.IsFontsScaled" />
        /// <seealso cref="Bottom" />
        /// <seealso cref="Left" />
