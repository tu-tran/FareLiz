...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// <see cref="Y2Axis" /> inherits from <see cref="Axis" />, and defines the special characteristics of a vertical axis, specifically located on the
    /// right side of the <see cref="Chart.Rect" /> of the <see cref="GraphPane" />
    /// object
    /// </summary>
    ...
    public class Y2Axis : Axis, ICloneable, ISerializable
    {
        ...
        /// <summary>A simple subclass of the <see cref="Default" /> class that defines the default property values for the <see cref="Y2Axis" /> class.</summary>
        public new struct Default
        {
            ...
            /// <see cref="Y2Axis" />, that is, a line that divides the negative values from positive values.
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="Y2Axis"/> class. Default constructor that sets all <see cref="Y2Axis"/> properties to default values as defined in the <see cref="Default"/> class
        /// </summary>
        public Y2Axis()
            : this("Y2 Axis")
        {
        ...
        /// Default constructor that sets all <see cref="Y2Axis"/> properties to default values as defined in the <see cref="Default"/> class, except for the
        /// axis title
        /// </summary>
        /// <param name="title">
        ...
        /// </param>
        /// <returns>
        /// true for a primary <see cref="Axis"/>, false otherwise
        /// </returns>
