...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
	...
	{
		/// <summary>
		/// An enumeration that describes whether a given RequestState is the result of a Pan or Zoom
		/// operation.
		/// </summary>
		...
		/// RequestState was saved.
		/// </summary>
		/// <value>A string representation for the RequestState change type; typically
		...
		/// this saved RequestState is from a pan or zoom.</param>
		...
		/// <summary>
		/// Determine if the RequestState contained in this <see cref="ZoomState"/> object is different from
		/// the RequestState of the specified <see cref="GraphPane"/>.
		/// </summary>
