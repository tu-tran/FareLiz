...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>This is a base class that provides base-level functionality for a data point consisting of an (X,Y) pair of double values.</summary>
    /// <remarks>This class is typically a base class for actual <see cref="PointPair" /> type implementations.</remarks>
    ...
    public class PointPairBase : ISerializable
    {
        ...
        /// <summary>
        /// Implicit conversion from PointPair to PointF.  Note that this conversion can result in data loss, since the data are being cast from a type double
        /// (64 bit) to a float (32 bit).
        /// </summary>
        ...
        /// <summary>Missing values are represented internally using <see cref="System.Double.MaxValue" />.</summary>
        public const double Missing = double.MaxValue;

        /// <summary>The default format to be used for displaying point values via the
        /// <see cref="ToString()" /> method.</summary>
        public const string DefaultFormat = "G";

        /// <summary>This PointPair's X coordinate</summary>
        public double X;

        /// <summary>This PointPair's Y coordinate</summary>
        public double Y;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PointPairBase"/> class. Default Constructor
        /// </summary>
        ...
        /// <summary>Readonly value that determines if either the X or the Y coordinate in this PointPair is a missing value.</summary>
        ...
        /// <summary>
        /// Readonly value that determines if either the X or the Y coordinate in this PointPair is an invalid (not plotable) value. It is considered invalid if
        ...
        public bool IsInvalid
        {
            get
            {
                return this.X == Missing || this.Y == Missing || double.IsInfinity(this.X) || double.IsInfinity(this.Y) || double.IsNaN(this.X)
                       || double.IsNaN(this.Y);
            }
        }
        ...
        {
            return value == Missing || double.IsInfinity(value) || double.IsNaN(value);
        }
        ...
        /// <summary>
        /// Compare two <see cref="PointPairBase"/> objects for equality.  To be equal, X and Y must be exactly the same between the two objects.
        /// </summary>
        /// <param name="obj">
        ...
        /// <summary>
        /// Format this PointPair value using different general format strings for the X and Y values. Example:  a format string of "e2" would give "( 1.23e+001,
        /// -1.69e+001 )". The Z value is not displayed (see <see cref="PointPair.ToString( string, string, string )"/>).
        /// </summary>
        /// <param name="formatX">
