...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    public class TextObj : GraphObj, ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="TextObj" /> class.</summary>
        public new struct Default
        {
			...
			*/
            ...
            /// <summary>The default font family for the <see cref="TextObj" /> text (<see cref="FontSpec.Family" /> property).</summary>
            public static string FontFamily = SystemFonts.DefaultFont.Name;

            /// <summary>The default font size for the <see cref="TextObj" /> text (<see cref="FontSpec.Size" /> property).  Units are in points (1/72 inch).</summary>
            public static float FontSize = 12.0F;

            /// <summary>The default font color for the <see cref="TextObj" /> text (<see cref="FontSpec.FontColor" /> property).</summary>
            public static Color FontColor = Color.Black;

            /// <summary>
            /// The default font bold mode for the <see cref="TextObj" /> text (<see cref="FontSpec.IsBold" /> property). true for a bold typeface, false
            /// otherwise.
            /// </summary>
            public static bool FontBold = false;

            /// <summary>
            /// The default font underline mode for the <see cref="TextObj" /> text (<see cref="FontSpec.IsUnderline" /> property). true for an underlined typeface,
            /// false otherwise.
            /// </summary>
            public static bool FontUnderline = false;

            /// <summary>
            /// The default font italic mode for the <see cref="TextObj" /> text (<see cref="FontSpec.IsItalic" /> property). true for an italic typeface, false
            /// otherwise.
            /// </summary>
        ...
        /// <summary>
        /// Private field to store the <see cref="FontSpec" /> class used to render this <see cref="TextObj" />.  Use the public property <see cref="FontSpec" />
		...
		*/
        ...
        /// <summary>The <see cref="TextObj" /> to be displayed.  This text can be multi-line by including newline ('\n') characters between the lines.</summary>
        public string Text
        {
            get
            {
        ...
        /// <summary>Gets a reference to the <see cref="FontSpec" /> class used to render this <see cref="TextObj" />
        /// </summary>
        ...
        /// Constructor that sets all <see cref="TextObj"/> properties to default values as defined in the <see cref="Default"/> class.
        /// </summary>
        /// <param name="text">
        ...
        /// <see cref="Location.CoordinateFrame"/> property.  The text will be aligned to this position based on the <see cref="AlignH"/>
        /// property.
        /// </param>
        /// <param name="y">
        /// The y position of the text.  The units of this position are specified by the
        /// <see cref="Location.CoordinateFrame"/> property.  The text will be aligned to this position based on the
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="TextObj"/> class. Parameterless constructor that initializes a new <see cref="TextObj"/>.
        /// </summary>
        public TextObj()
            : base(0, 0)
        {
