...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// A collection base class containing basic extra functionality to be inherited by <see cref="CurveList" />, <see cref="IPointList" />,
    /// <see cref="GraphObjList" />.
    /// </summary>
    /// <remarks>
    /// The methods in this collection operate on basic
    /// <see cref="object" /> types.  Therefore, in order to make sure that the derived classes remain strongly-typed, there are no Add() or Insert() methods
    /// here, and no methods that return an object. Only Remove(), Move(), IndexOf(), etc. methods are included.
    /// </remarks>
