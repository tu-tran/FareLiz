...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
	...
	/// clustered, depending on the RequestState of <see cref="BarSettings.Type"/>
	/// </remarks>
	...
	#region Properties
		/// <summary>
		/// Gets a reference to the <see cref="Graph.Bar"/> class defined
	...
	#region Constructors
		...
		/// the <see cref="Graph.Bar.Fill"/> and <see cref="Graph.Bar.Border"/> properties.
		/// </param>
	...
	#region Methods
									...
									float scaleFactor  )
		{
			...
			if ( this._isVisible )
				this._bar.DrawBars( g, pane, this, this.BaseAxis( pane ), this.ValueAxis( pane ),
