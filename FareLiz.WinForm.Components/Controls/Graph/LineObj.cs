...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// A class that represents a line segment object on the graph.  A list of GraphObj objects is maintained by the <see cref="GraphObjList" /> collection
    /// class.
    /// </summary>
    /// <remarks>
    /// This should not be confused with the <see cref="LineItem" /> class, which represents a set of points plotted together as a "curve".  The
    /// <see cref="LineObj" /> class is a single line segment, drawn as a "decoration" on the chart.
    /// </remarks>
    ...
    public class LineObj : GraphObj, ICloneable, ISerializable
    {
        ...
        /// <summary>protected field that maintains the attributes of the line using an instance of the <see cref="LineBase" /> class.</summary>
        ...
        /// <summary>A <see cref="LineBase" /> class that contains the attributes for drawing this
        /// <see cref="LineObj" />.</summary>
        ...
        /// </param>
        /// <param name="x1">
        /// The x position of the starting point that defines the line.  The units of this position are specified by the
        /// <see cref="Location.CoordinateFrame"/> property.
        /// </param>
        /// <param name="y1">
        /// The y position of the starting point that defines the line.  The units of this position are specified by the
        /// <see cref="Location.CoordinateFrame"/> property.
        /// </param>
        /// <param name="x2">
        /// The x position of the ending point that defines the line.  The units of this position are specified by the
        /// <see cref="Location.CoordinateFrame"/> property.
        /// </param>
        /// <param name="y2">
        /// The y position of the ending point that defines the line.  The units of this position are specified by the
        /// <see cref="Location.CoordinateFrame"/> property.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LineObj"/> class. Default constructor -- places the <see cref="LineObj"/> at location (0,0) to (1,1).  All other values are defaulted.
        /// </summary>
        public LineObj()
