...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// objects, corresponding to the list of <see cref="Axis" /> objects from <see cref="GraphPane.YAxisList" /> or <see cref="GraphPane.Y2AxisList" />.
    /// </summary>
    public class ScaleStateList : List<ScaleState>, ICloneable
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScaleStateList"/> class. 
        /// Construct a new <see cref="ScaleStateList"/> automatically from an existing <see cref="YAxisList"/>.
        /// </summary>
        /// <param name="list">
        /// The <see cref="YAxisList"/> (a list of Y axes), from which to retrieve the RequestState and create the <see cref="ScaleState"/>
        /// objects.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScaleStateList"/> class. 
        /// Construct a new <see cref="ScaleStateList"/> automatically from an existing <see cref="Y2AxisList"/>.
        /// </summary>
        /// <param name="list">
        /// The <see cref="Y2AxisList"/> (a list of Y axes), from which to retrieve the RequestState and create the <see cref="ScaleState"/>
        /// objects.
        /// </param>
        ...
        /// <summary>
        /// Iterate through the list of <see cref="ScaleState"/> objects, comparing them to the RequestState of the specified <see cref="YAxisList"/>
        /// <see cref="Axis"/>
        /// objects.
        /// </summary>
        /// <param name="list">
        ...
        /// <summary>
        /// Iterate through the list of <see cref="ScaleState"/> objects, comparing them to the RequestState of the specified <see cref="Y2AxisList"/>
        /// <see cref="Axis"/>
        /// objects.
        /// </summary>
        /// <param name="list">
        ...
        /*
				...
				/// </summary>
				/// <param name="RequestState">A reference to the <see cref="ScaleState"/> object to
				/// be added</param>
				/// <seealso cref="IList.Add"/>
				public void Add( ScaleState RequestState )
				{
