...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
	...
	public class ScaleStateList : List<ScaleState>, ICloneable
	{
		...
		/// from which to retrieve the RequestState and create the <see cref="ScaleState" />
		/// objects.</param>
		...
		/// to the RequestState of the specified <see cref="YAxisList" /> <see cref="Axis" />
		/// objects.
		/// </summary>
		...
		/// <summary>
		/// Iterate through the list of <see cref="ScaleState" /> objects, comparing them
		/// to the RequestState of the specified <see cref="Y2AxisList" /> <see cref="Axis" />
		/// objects.
		/// </summary>
