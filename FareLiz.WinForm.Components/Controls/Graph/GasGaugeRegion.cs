...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A class representing a region on the GasGuage chart
    /// <see cref="GasGaugeRegion" />s.</summary>
    ...
    public class GasGaugeRegion : CurveItem, ICloneable, ISerializable
    {
        ...
        /// <summary>Specify the default property values for the <see cref="GasGaugeRegion" /> class.</summary>
        public struct Default
        {
            /// <summary>The default border pen width for the <see cref="GasGaugeRegion" />
            /// </summary>
            public static float BorderWidth = 1.0F;

            /// <summary>The default fill type for the <see cref="GasGaugeRegion" />
            /// </summary>
            public static FillType FillType = FillType.Brush;

            /// <summary>The default value for the visibility of the <see cref="GasGaugeRegion" /> border.</summary>
            public static bool IsBorderVisible = true;

            /// <summary>The default value for the color of the <see cref="GasGaugeRegion" /> border</summary>
            public static Color BorderColor = Color.Gray;

            /// <summary>The default value for the color of the <see cref="GasGaugeRegion" /> fill</summary>
            public static Color FillColor = Color.Empty;

            /// <summary>The default value for the fill brush of the <see cref="GasGaugeRegion" />
            /// </summary>
            public static Brush FillBrush = null;

            /// <summary>The default value for the visibility of the <see cref="GasGaugeRegion" /> fill.</summary>
            public static bool isVisible = true;

            // 			public static PieLabelType LabelType = PieLabelType.Name;

            /// <summary>The default value for the font size of the <see cref="GasGaugeRegion" /> labels.</summary>
        ...
        /// <summary>Defines the minimum value of this <see cref="GasGaugeRegion" />
        /// </summary>
        private double _minValue;

        /// <summary>Defines the maximum value of this <see cref="GasGaugeRegion" />
        /// </summary>
        private double _maxValue;

        /// <summary>Defines the Color of this <see cref="GasGaugeRegion" />
        /// </summary>
        private Color _color;

        /// <summary>Internally calculated; Start angle of this pie that defines this <see cref="GasGaugeRegion" />
        /// </summary>
        private float _startAngle;

        /// <summary>Internally calculated; Sweep angle of this pie that defines this <see cref="GasGaugeRegion" />
        /// </summary>
        private float _sweepAngle;

        /// <summary>
        /// Private	field	that stores the	<see cref="Graph.Fill" /> data for this
        /// <see cref="GasGaugeRegion" />.	 Use the public property <see cref="Fill" /> to access this value.
        /// </summary>
        private Fill _fill;
        ...
        /// <summary>
        /// Private	field	that stores the	<see cref="Border" /> class that defines	the properties of the	border around	this <see cref="GasGaugeRegion" />. Use
        /// the public property	<see cref="Border" /> to access this value.
        /// </summary>
        private Border _border;

        /// <summary>The bounding rectangle for this <see cref="GasGaugeRegion" />.</summary>
        private RectangleF _boundingRectangle;

        /// <summary>Private field to hold the GraphicsPath of this <see cref="GasGaugeRegion" /> to be used for 'hit testing'.</summary>
        ...
        /// <summary>Gets or sets the SlicePath of this <see cref="GasGaugeRegion" />
        /// </summary>
        ...
        /// <summary>Gets or sets the LabelDetail of this <see cref="GasGaugeRegion" />
        /// </summary>
        ...
        /// <summary>Gets or sets the Border of this <see cref="GasGaugeRegion" />
        /// </summary>
        ...
        /// <summary>Gets or sets the RegionColor of this <see cref="GasGaugeRegion" />
        /// </summary>
        ...
        /// <summary>Gets or sets the Fill of this <see cref="GasGaugeRegion" />
        /// </summary>
        public Fill Fill
        {
            get
        ...
        /// <summary>Gets or sets the SweepAngle of this <see cref="GasGaugeRegion" />
        /// </summary>
        ...
        /// <summary>Gets or sets the StartAngle of this <see cref="GasGaugeRegion" />
        /// </summary>
        ...
        /// <summary>Gets or sets the MinValue of this <see cref="GasGaugeRegion" />
        /// </summary>
        ...
        /// <summary>Gets or sets the MaxValue of this <see cref="GasGaugeRegion" />
        /// </summary>
