...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// A class that represents a bordered and/or filled ellipse object on the graph.  A list of EllipseObj objects is maintained by the
    /// <see cref="GraphObjList" /> collection class.  The ellipse is defined as the ellipse that would be contained by the rectangular box as defined by the
    ...
    public class EllipseObj : BoxObj, ICloneable, ISerializable
    {
        ...
        /// A constructor that allows the position and size of the <see cref="EllipseObj"/> to be pre-specified.  Other properties are defaulted.
        /// </summary>
        /// <param name="x">
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EllipseObj"/> class. 
        /// A default constructor that places the <see cref="EllipseObj"/> at location (0,0), with width/height of (1,1).  Other properties are
        /// defaulted.
        /// </summary>
        public EllipseObj()
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EllipseObj"/> class. 
        /// A constructor that allows the position, border color, and solid fill color of the <see cref="EllipseObj"/> to be pre-specified.
        /// </summary>
        /// <param name="x">
        /// The x location for this <see cref="BoxObj"/>.  This will be in units determined by
        /// <see cref="Location.CoordinateFrame"/>.
        ...
        /// An arbitrary <see cref="System.Drawing.Color"/> specification for the ellipse border
        /// </param>
        /// <param name="fillColor">
        /// An arbitrary <see cref="System.Drawing.Color"/> specification for the ellipse fill (will be a solid color fill)
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EllipseObj"/> class. 
        /// A constructor that allows the position, border color, and two-color gradient fill colors of the <see cref="EllipseObj"/> to be
        /// pre-specified.
        /// </summary>
        /// <param name="x">
        /// The x location for this <see cref="BoxObj"/>.  This will be in units determined by
        ...
        /// An arbitrary <see cref="System.Drawing.Color"/> specification for the start of the ellipse gradient fill
        /// </param>
        /// <param name="fillColor2">
        /// An arbitrary <see cref="System.Drawing.Color"/> specification for the end of the ellipse gradient fill
        /// </param>
        ...
        public override void Draw(Graphics g, PaneBase pane, float scaleFactor)
        {
                ...
                && Math.Abs(pixRect.Bottom) < 100000)
            {
                ...
                {
                    using (Brush brush = this._fill.MakeBrush(pixRect)) g.FillEllipse(brush, pixRect);
                }

                if (this._border.IsVisible)
                {
                    using (Pen pen = this._border.GetPen(pane, scaleFactor)) g.DrawEllipse(pen, pixRect);
                }
            }
        }
