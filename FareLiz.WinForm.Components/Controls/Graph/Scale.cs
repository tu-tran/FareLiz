...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>The Scale class is an abstract base class that encompasses the properties and methods associated with a scale of data.</summary>
    /// <remarks>
    ...
    public abstract class Scale : ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="Scale" /> class.</summary>
        public struct Default
        {
            /// <summary>
            /// The default "zero lever" for automatically selecting the axis scale range (see <see cref="PickScale" />). This number is used to determine when an
            /// axis scale range should be extended to include the zero value.  This value is maintained only in the
            /// <see cref="Default" /> class, and cannot be changed after compilation.
            /// </summary>
            public static double ZeroLever = 0.25;

            /// <summary>
            /// The default "grace" value applied to the minimum data range. This value is expressed as a fraction of the total data range.  For example, assume the
            /// data range is from 4.0 to 16.0, leaving a range of 12.0.  If MinGrace is set to 0.1, then 10% of the range, or 1.2 will be subtracted from the
            /// minimum data value. The scale will then be ranged to cover at least 2.8 to 16.0.
            /// </summary>
            /// <seealso cref="MinGrace" />
            public static double MinGrace = 0.1;

            /// <summary>
            /// The default "grace" value applied to the maximum data range. This value is expressed as a fraction of the total data range.  For example, assume the
            /// data range is from 4.0 to 16.0, leaving a range of 12.0.  If MaxGrace is set to 0.1, then 10% of the range, or 1.2 will be added to the maximum data
            /// value. The scale will then be ranged to cover at least 4.0 to 17.2.
            /// </summary>
            /// <seealso cref="MinGrace" />
            ...
            /// <summary>
            /// The maximum number of text labels (major tics) that will be allowed on the plot by the automatic scaling logic.  This value applies only to
            /// <see cref="AxisType.Text" />
            /// axes.  If there are more than MaxTextLabels on the plot, then
            /// <see cref="MajorStep" /> will be increased to reduce the number of labels.  That is, the step size might be increased to 2.0 to show only every other
            /// label.
            /// </summary>
            public static double MaxTextLabels = 12.0;

            /// <summary>
            /// The default target number of steps for automatically selecting the X axis scale step size (see <see cref="PickScale" />). This number is an initial
            /// target value for the number of major steps on an axis.  This value is maintained only in the
            /// <see cref="Default" /> class, and cannot be changed after compilation.
            /// </summary>
            public static double TargetXSteps = 7.0;

            /// <summary>
            /// The default target number of steps for automatically selecting the Y or Y2 axis scale step size (see <see cref="PickScale" />). This number is an
            /// initial target value for the number of major steps on an axis.  This value is maintained only in the
            /// <see cref="Default" /> class, and cannot be changed after compilation.
            /// </summary>
            public static double TargetYSteps = 7.0;

            /// <summary>
            /// The default target number of minor steps for automatically selecting the X axis scale minor step size (see <see cref="PickScale" />). This number is
            /// an initial target value for the number of minor steps on an axis.  This value is maintained only in the
            /// <see cref="Default" /> class, and cannot be changed after compilation.
            /// </summary>
            public static double TargetMinorXSteps = 5.0;

            /// <summary>
            /// The default target number of minor steps for automatically selecting the Y or Y2 axis scale minor step size (see <see cref="PickScale" />). This
            /// number is an initial target value for the number of minor steps on an axis.  This value is maintained only in the
            /// <see cref="Default" /> class, and cannot be changed after compilation.
            /// </summary>
            public static double TargetMinorYSteps = 5.0;

            /// <summary>
            /// The default reverse mode for the <see cref="Axis" /> scale (<see cref="IsReverse" /> property). true for a reversed scale (X decreasing to the left,
            /// Y/Y2 decreasing upwards), false otherwise.
            /// </summary>
            public static bool IsReverse = false;

            /// <summary>
            /// The default setting for the <see cref="Axis" /> scale format string (<see cref="Format" /> property).  For numeric values, this value is setting
            /// according to the <see cref="string.Format(string,object)" /> format strings.  For date type values, this value is set as per the
            /// <see cref="XDate.ToString()" /> function.
            /// </summary>
            // public static string ScaleFormat = "&dd-&mmm-&yy &hh:&nn";
            public static string Format = "g";

            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. If the total span of data
            /// exceeds this number (in days), then the auto-range code will select <see cref="MajorUnit" /> = <see cref="DateUnit.Year" />
            /// and <see cref="MinorUnit" /> = <see cref="DateUnit.Year" />. This value normally defaults to 1825 days (5 years). This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            ...
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. If the total span of data
            /// exceeds this number (in days), then the auto-range code will select <see cref="MajorUnit" /> = <see cref="DateUnit.Year" />
            /// and <see cref="MinorUnit" /> = <see cref="DateUnit.Month" />. This value normally defaults to 730 days (2 years). This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            ...
            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. If the total span of data
            /// exceeds this number (in days), then the auto-range code will select <see cref="MajorUnit" /> = <see cref="DateUnit.Month" />
            /// and <see cref="MinorUnit" /> = <see cref="DateUnit.Month" />. This value normally defaults to 300 days (10 months). This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            ...
            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. If the total span of data
            /// exceeds this number (in days), then the auto-range code will select <see cref="MajorUnit" /> = <see cref="DateUnit.Day" />
            /// and <see cref="MinorUnit" /> = <see cref="DateUnit.Day" />. This value normally defaults to 10 days. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            ...
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. If the total span of data
            /// exceeds this number (in days), then the auto-range code will select <see cref="MajorUnit" /> = <see cref="DateUnit.Day" />
            /// and <see cref="MinorUnit" /> = <see cref="DateUnit.Hour" />. This value normally defaults to 3 days. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            ...
            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. If the total span of data
            /// exceeds this number (in days), then the auto-range code will select <see cref="MajorUnit" /> = <see cref="DateUnit.Hour" />
            /// and <see cref="MinorUnit" /> = <see cref="DateUnit.Hour" />. This value normally defaults to 0.4167 days (10 hours). This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            ...
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. If the total span of data
            /// exceeds this number (in days), then the auto-range code will select <see cref="MajorUnit" /> = <see cref="DateUnit.Hour" />
            /// and <see cref="MinorUnit" /> = <see cref="DateUnit.Minute" />. This value normally defaults to 0.125 days (3 hours). This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            ...
            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. If the total span of data
            /// exceeds this number (in days), then the auto-range code will select <see cref="MajorUnit" /> = <see cref="DateUnit.Minute" />
            /// and <see cref="MinorUnit" /> = <see cref="DateUnit.Minute" />. This value normally defaults to 6.94e-3 days (10 minutes). This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            ...
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. If the total span of data
            /// exceeds this number (in days), then the auto-range code will select <see cref="MajorUnit" /> = <see cref="DateUnit.Minute" />
            /// and <see cref="MinorUnit" /> = <see cref="DateUnit.Second" />. This value normally defaults to 2.083e-3 days (3 minutes). This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            ...
            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. If the total span of data
            /// exceeds this number (in days), then the auto-range code will select <see cref="MajorUnit" /> = <see cref="DateUnit.Second" />
            /// and <see cref="MinorUnit" /> = <see cref="DateUnit.Second" />. This value normally defaults to 3.472e-5 days (3 seconds). This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            public static double RangeSecondSecond = 3.472e-5; // 3 Seconds

            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. This is the format used
            /// for the scale values when auto-ranging code selects a <see cref="Format" /> of <see cref="DateUnit.Year" />
            /// for <see cref="MajorUnit" /> and <see cref="DateUnit.Year" /> for for <see cref="MinorUnit" />. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            ...
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. This is the format used
            /// for the scale values when auto-ranging code selects a <see cref="Format" /> of <see cref="DateUnit.Year" />
            /// for <see cref="MajorUnit" /> and <see cref="DateUnit.Month" /> for for <see cref="MinorUnit" />. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            /// <seealso cref="System.Globalization.DateTimeFormatInfo" />
            ...
            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. This is the format used
            /// for the scale values when auto-ranging code selects a <see cref="Format" /> of <see cref="DateUnit.Month" />
            /// for <see cref="MajorUnit" /> and <see cref="DateUnit.Month" /> for for <see cref="MinorUnit" />. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            /// <seealso cref="System.Globalization.DateTimeFormatInfo" />
            ...
            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. This is the format used
            /// for the scale values when auto-ranging code selects a <see cref="Format" /> of <see cref="DateUnit.Day" />
            /// for <see cref="MajorUnit" /> and <see cref="DateUnit.Day" /> for for <see cref="MinorUnit" />. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            /// <seealso cref="System.Globalization.DateTimeFormatInfo" />
            ...
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. This is the format used
            /// for the scale values when auto-ranging code selects a <see cref="Format" /> of <see cref="DateUnit.Day" />
            /// for <see cref="MajorUnit" /> and <see cref="DateUnit.Hour" /> for for <see cref="MinorUnit" />. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            /// <seealso cref="System.Globalization.DateTimeFormatInfo" />
            ...
            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. This is the format used
            /// for the scale values when auto-ranging code selects a <see cref="Format" /> of <see cref="DateUnit.Hour" />
            /// for <see cref="MajorUnit" /> and <see cref="DateUnit.Hour" /> for for <see cref="MinorUnit" />. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            /// <seealso cref="System.Globalization.DateTimeFormatInfo" />
            ...
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. This is the format used
            /// for the scale values when auto-ranging code selects a <see cref="Format" /> of <see cref="DateUnit.Hour" />
            /// for <see cref="MajorUnit" /> and <see cref="DateUnit.Minute" /> for for <see cref="MinorUnit" />. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            /// <seealso cref="System.Globalization.DateTimeFormatInfo" />
            ...
            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. This is the format used
            /// for the scale values when auto-ranging code selects a <see cref="Format" /> of <see cref="DateUnit.Minute" />
            /// for <see cref="MajorUnit" /> and <see cref="DateUnit.Minute" /> for for <see cref="MinorUnit" />. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            /// <seealso cref="System.Globalization.DateTimeFormatInfo" />
            ...
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. This is the format used
            /// for the scale values when auto-ranging code selects a <see cref="Format" /> of <see cref="DateUnit.Minute" />
            /// for <see cref="MajorUnit" /> and <see cref="DateUnit.Second" /> for for <see cref="MinorUnit" />. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            /// <seealso cref="System.Globalization.DateTimeFormatInfo" />
            ...
            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. This is the format used
            /// for the scale values when auto-ranging code selects a <see cref="Format" /> of <see cref="DateUnit.Second" />
            /// for <see cref="MajorUnit" /> and <see cref="DateUnit.Second" /> for for <see cref="MinorUnit" />. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            /// <seealso cref="System.Globalization.DateTimeFormatInfo" />
            ...
            /// <summary>
            /// A default setting for the <see cref="AxisType.Date" /> auto-ranging code. This values applies only to Date-Time type axes. This is the format used
            /// for the scale values when auto-ranging code selects a <see cref="Format" /> of <see cref="DateUnit.Millisecond" />
            /// for <see cref="MajorUnit" /> and <see cref="DateUnit.Millisecond" /> for for <see cref="MinorUnit" />. This value is used by the
            /// <see cref="DateScale.CalcDateStepSize" /> method.
            /// </summary>
            /// <seealso cref="System.Globalization.DateTimeFormatInfo" />
			...
			*/
            ...
            /// <summary>
            /// The default alignment of the <see cref="Axis" /> tic labels. This value controls whether the inside, center, or outside edges of the text labels are
            /// aligned.
            /// </summary>
            /// <seealso cref="AlignP" />
            ...
            /// <summary>
            /// The default alignment of the <see cref="Axis" /> tic labels. This value controls whether the left, center, or right edges of the text labels are
            /// aligned.
            /// </summary>
            /// <seealso cref="AlignH" />
            public static AlignH AlignH = AlignH.Center;

            /// <summary>The default font family for the <see cref="Axis" /> scale values font specification <see cref="FontSpec" />
            /// (<see cref="FontSpec.Family" /> property).</summary>
            public static string FontFamily = SystemFonts.DefaultFont.Name;

            /// <summary>
            /// The default font size for the <see cref="Axis" /> scale values font specification <see cref="FontSpec" />
            /// (<see cref="FontSpec.Size" /> property).  Units are in points (1/72 inch).
            /// </summary>
            public static float FontSize = 14;

            /// <summary>
            /// The default font color for the <see cref="Axis" /> scale values font specification <see cref="FontSpec" />
            /// (<see cref="FontSpec.FontColor" /> property).
            /// </summary>
            public static Color FontColor = Color.Black;

            /// <summary>
            /// The default font bold mode for the <see cref="Axis" /> scale values font specification <see cref="FontSpec" />
            /// (<see cref="FontSpec.IsBold" /> property). true for a bold typeface, false otherwise.
            /// </summary>
            public static bool FontBold = false;

            /// <summary>
            /// The default font italic mode for the <see cref="Axis" /> scale values font specification <see cref="FontSpec" />
            /// (<see cref="FontSpec.IsItalic" /> property). true for an italic typeface, false otherwise.
            /// </summary>
            public static bool FontItalic = false;

            /// <summary>
            /// The default font underline mode for the <see cref="Axis" /> scale values font specification <see cref="FontSpec" />
            /// (<see cref="FontSpec.IsUnderline" /> property). true for an underlined typeface, false otherwise.
            /// </summary>
            ...
            /// <summary>The default value for <see cref="IsVisible" />, which determines whether or not the scale values are displayed.</summary>
            public static bool IsVisible = true;

            /// <summary>
            /// The default value for <see cref="IsLabelsInside" />, which determines whether or not the scale labels and title for the <see cref="Axis" /> will
            /// appear on the opposite side of the <see cref="Axis" /> that it normally appears.
            /// </summary>
            public static bool IsLabelsInside = false;

            /// <summary>
            /// Determines the size of the band at the beginning and end of the axis that will have labels omitted if the axis is shifted due to a non-default
            /// location using the <see cref="Axis.Cross" />
            /// property.
            /// </summary>
            /// <remarks>
            /// This parameter applies only when <see cref="Axis.CrossAuto" /> is false.  It is scaled according to the size of the graph based on
            /// <see cref="PaneBase.BaseDimension" />.  When a non-default axis location is selected, the first and last labels on that axis will overlap the
            /// opposing axis frame.  This parameter allows those labels to be omitted to avoid the overlap.  Set this parameter to zero to turn off the effect.
            /// </remarks>
            public static float EdgeTolerance = 6;

            /// <summary>
            /// The default setting for the gap between the outside tics (or the axis edge if there are no outside tics) and the scale labels, expressed as a
            /// fraction of the major tic size.
            /// </summary>
        ...
        /// <summary>
        /// Private fields for the <see cref="Axis" /> scale definitions. Use the public properties <see cref="Min" />, <see cref="Max" />,
        ...
        /// <summary>
        /// Private fields for the <see cref="Axis" /> automatic scaling modes. Use the public properties <see cref="MinAuto" />, <see cref="MaxAuto" />,
        ...
        /// <summary>
        /// Private fields for the <see cref="Axis" /> "grace" settings. These values determine how much extra space is left before the first data value and
        /// after the last data value. Use the public properties <see cref="MinGrace" /> and <see cref="MaxGrace" />
        /// for access to these values.
        /// </summary>
        ...
        /// <summary> Private field for the <see cref="Axis" /> scale value display. Use the public property <see cref="Mag" /> for access to this value.</summary>
        internal int _mag;

        /// <summary>
        /// Private fields for the <see cref="Scale" /> attributes. Use the public properties <see cref="Scale.IsReverse" /> and
        /// <see cref="Scale.IsUseTenPower" />
        /// for access to these values.
        /// </summary>
        ...
        /// <summary>
        /// Private <see cref="System.Collections.ArrayList" /> field for the <see cref="Axis" /> array of text labels. This property is only used if
        /// <see cref="Type" /> is set to
        /// <see cref="AxisType.Text" />
        /// </summary>
        internal string[] _textLabels;

        /// <summary> Private field for the format of the <see cref="Axis" /> tic labels. Use the public property <see cref="Format" /> for access to this value. </summary>
        /// <seealso cref="FormatAuto" />
        internal string _format;

        /// <summary>
        /// Private fields for Unit types to be used for the major and minor tics. See <see cref="MajorUnit" /> and <see cref="MinorUnit" /> for the
        /// corresponding public properties. These types only apply for date-time scales (<see cref="IsDate" />).
        /// </summary>
        /// <value>
        /// The value of these types is of enumeration type <see cref="DateUnit" />
        /// </value>
        ...
        /// <summary>
        /// Private field for the alignment of the <see cref="Axis" /> tic labels. This fields controls whether the inside, center, or outside edges of the text
        /// labels are aligned. Use the public property <see cref="Scale.Align" />
        ...
        /// <summary>
        /// Private field for the alignment of the <see cref="Axis" /> tic labels. This fields controls whether the left, center, or right edges of the text
        /// labels are aligned. Use the public property <see cref="Scale.AlignH" />
        /// for access to this value.
        /// </summary>
        /// <seealso cref="FormatAuto" />
        ...
        /// <summary>
        /// Private fields for the <see cref="Axis" /> font specificatios. Use the public properties <see cref="FontSpec" /> and
        /// <see cref="Scale.FontSpec" /> for access to these values.
        /// </summary>
        internal FontSpec _fontSpec;

        /// <summary>
        /// Internal field that stores the amount of space between the scale labels and the major tics.  Use the public property <see cref="LabelGap" /> to
        /// access this value.
        /// </summary>
        internal float _labelGap;

        /// <summary>Data range temporary values, used by GetRange().</summary>
        ...
        /// <summary>Pixel positions at the minimum and maximum value for this scale. These are temporary values used/valid only during the Draw process.</summary>
        internal float _minPix;

        /// <summary>Pixel positions at the minimum and maximum value for this scale. These are temporary values used/valid only during the Draw process.</summary>
        internal float _maxPix;

        /// <summary>Scale values for calculating transforms.  These are temporary values used ONLY during the Draw process.</summary>
        /// <remarks>
        /// These values are just <see cref="Scale.Min" /> and <see cref="Scale.Max" />
        /// for normal linear scales, but for log or exponent scales they will be a linear representation.  For <see cref="LogScale" />, it is the
        /// <see cref="Math.Log(double)" /> of the value, and for <see cref="ExponentScale" />, it is the <see cref="Math.Exp(double)" />
        /// of the value.
        /// </remarks>
        ...
        /// <summary>Gets or sets the linearized version of the <see cref="Min" /> scale range.</summary>
        /// <remarks>This value is valid at any time, whereas <see cref="_minLinTemp" /> is an optimization pre-set that is only valid during draw operations.</remarks>
        ...
        /// <summary>Gets or sets the linearized version of the <see cref="Max" /> scale range.</summary>
        /// <remarks>This value is valid at any time, whereas <see cref="_maxLinTemp" /> is an optimization pre-set that is only valid during draw operations.</remarks>
        ...
        /// <summary>private field that stores the owner Axis that contains this Scale instance.</summary>
...
*/
        ...
        /// <summary>Get an <see cref="AxisType" /> enumeration that indicates the type of this scale.</summary>
        public abstract AxisType Type { get; }

        /// <summary>True if this scale is <see cref="AxisType.Log" />, false otherwise.</summary>
        public bool IsLog
        {
            get
            {
        ...
        /// <summary>True if this scale is <see cref="AxisType.Exponent" />, false otherwise.</summary>
        ...
        /// <summary>True if this scale is <see cref="AxisType.Date" />, false otherwise.</summary>
        public bool IsDate
        {
            get
            {
        ...
        /// <summary>True if this scale is <see cref="AxisType.Text" />, false otherwise.</summary>
        public bool IsText
        {
            get
            {
        ...
        /// <summary>True if this scale is <see cref="AxisType.Ordinal" />, false otherwise.</summary>
        /// <remarks>
        /// Note that this is only true for an actual <see cref="OrdinalScale" /> class. This property will be false for other ordinal types such as
        /// <see cref="AxisType.Text" />, <see cref="AxisType.LinearAsOrdinal" />, or <see cref="AxisType.DateAsOrdinal" />.  Use the <see cref="IsAnyOrdinal" />
        ...
        /// <summary>Gets a value that indicates if this <see cref="Scale" /> is of any of the ordinal types in the <see cref="AxisType" /> enumeration.</summary>
        /// <seealso cref="Type" />
...
*/
        ...
        /// <summary>Gets or sets the minimum scale value for this <see cref="Scale" />.</summary>
        /// <remarks>
        /// This value can be set automatically based on the RequestState of <see cref="MinAuto" />.  If this value is set manually, then <see cref="MinAuto" />
        ...
        /// and <see cref="AxisType.Ordinal" /> axes, this value is an ordinal starting with 1.0.  For <see cref="AxisType.Date" />
        /// axes, this value is in XL Date format (see <see cref="XDate" />, which is the number of days since the reference date of January 1, 1900.
        /// </value>
        /// <seealso cref="Max" />
        ...
        /// <summary>Gets or sets the maximum scale value for this <see cref="Scale" />.</summary>
        /// <remarks>
        /// This value can be set automatically based on the RequestState of <see cref="MaxAuto" />.  If this value is set manually, then <see cref="MaxAuto" />
        /// will also be set to false.
        /// </remarks>
        /// <value>
        /// The value is defined in user scale units for <see cref="AxisType.Log" />
        ...
        /// <summary>Gets or sets the scale step size for this <see cref="Scale" /> (the increment between labeled axis values).</summary>
        /// <remarks>
        /// This value can be set automatically based on the RequestState of <see cref="MajorStepAuto" />.  If this value is set manually, then
        /// <see cref="MajorStepAuto" /> will also be set to false.  This value is ignored for <see cref="AxisType.Log" />
        /// axes.  For <see cref="AxisType.Date" /> axes, this value is defined in units of <see cref="MajorUnit" />.
        /// </remarks>
        ...
        /// <seealso cref="Scale.Default.TargetXSteps" />
        /// <seealso cref="Scale.Default.TargetYSteps" />
        /// <seealso cref="Scale.Default.ZeroLever" />
        /// <seealso cref="Scale.Default.MaxTextLabels" />
        ...
        /// <summary>Gets or sets the scale minor step size for this <see cref="Scale" /> (the spacing between minor tics).</summary>
        /// <remarks>
        /// This value can be set automatically based on the RequestState of <see cref="MinorStepAuto" />.  If this value is set manually, then
        /// <see cref="MinorStepAuto" /> will also be set to false.  This value is ignored for <see cref="AxisType.Log" /> and
        /// <see cref="AxisType.Text" /> axes.  For <see cref="AxisType.Date" /> axes, this value is defined in units of <see cref="MinorUnit" />.
        /// </remarks>
        /// <value> The value is defined in user scale units </value>
        /// <seealso cref="Min" />
        /// <seealso cref="Max" />
        ...
        /// <summary>Gets or sets the scale exponent value.  This only applies to <see cref="AxisType.Exponent" />.</summary>
        /// <seealso cref="Min" />
        /// <seealso cref="Max" />
        /// <seealso cref="MinorStep" />
        /// <seealso cref="MajorStepAuto" />
        ...
        /// <summary>Gets or sets the scale value at which the first major tic label will appear.</summary>
        /// <remarks>
        /// This property allows the scale labels to start at an irregular value. For example, on a scale range with <see cref="Min" /> = 0, <see cref="Max" /> =
        /// 1000, and <see cref="MajorStep" /> = 200, a <see cref="BaseTic" /> value of 50 would cause the scale labels to appear at values 50, 250, 450, 650,
        /// and 850.  Note that the default value for this property is <see cref="PointPairBase.Missing" />, which means the value is not used.  Setting this
        /// property to any value other than
        /// <see cref="PointPairBase.Missing" /> will activate the effect.  The value specified must coincide with the first major tic.  That is, if
        /// <see cref="BaseTic" /> were set to 650 in the example above, then the major tics would only occur at 650 and 850.  This setting may affect the minor
        /// tics, since the minor tics are always referenced to the
        /// <see cref="BaseTic" />.  That is, in the example above, if the <see cref="MinorStep" />
        /// were set to 30 (making it a non-multiple of the major step), then the minor tics would occur at 20, 50 (so it lines up with the BaseTic), 80, 110,
        /// 140, etc.
        /// </remarks>
        /// <value> The value is defined in user scale units </value>
        /// <seealso cref="Min" />
        ...
        /// <summary>Gets or sets the type of units used for the major step size (<see cref="MajorStep" />).</summary>
        /// <remarks>
        /// This unit type only applies to Date-Time axes (<see cref="AxisType.Date" /> = true). The axis is set to date type with the <see cref="Type" />
        /// property. The unit types are defined as <see cref="DateUnit" />.
        /// </remarks>
        ...
        /// <summary>Gets or sets the type of units used for the minor step size (<see cref="MinorStep" />).</summary>
        /// <remarks>
        /// This unit type only applies to Date-Time axes (<see cref="AxisType.Date" /> = true). The axis is set to date type with the <see cref="Type" />
        /// property. The unit types are defined as <see cref="DateUnit" />.
        /// </remarks>
        ...
        /// <summary>Gets the major unit multiplier for this scale type, if any.</summary>
        /// <remarks>
        ...
        /// <summary>Gets or sets a value that determines whether or not the minimum scale value <see cref="Min" />
        /// is set automatically.</summary>
        /// <remarks>This value will be set to false if
        /// <see cref="Min" /> is manually changed.</remarks>
        ...
        /// <summary>Gets or sets a value that determines whether or not the maximum scale value <see cref="Max" />
        /// is set automatically.</summary>
        /// <remarks>This value will be set to false if
        /// <see cref="Max" /> is manually changed.</remarks>
        /// <value>true for automatic mode, false for manual mode</value>
        /// <seealso cref="Max" />
        public bool MaxAuto
        {
        ...
        /// <summary>Gets or sets a value that determines whether or not the scale step size <see cref="MajorStep" />
        /// is set automatically.</summary>
        /// <remarks>This value will be set to false if
        /// <see cref="MajorStep" /> is manually changed.</remarks>
        /// <value>true for automatic mode, false for manual mode</value>
        /// <seealso cref="MajorStep" />
        ...
        /// <summary>Gets or sets a value that determines whether or not the minor scale step size <see cref="MinorStep" />
        /// is set automatically.</summary>
        /// <remarks>This value will be set to false if
        /// <see cref="MinorStep" /> is manually changed.</remarks>
        /// <value>true for automatic mode, false for manual mode</value>
        /// <seealso cref="MinorStep" />
        ...
        /// <summary>Determines whether or not the scale label format <see cref="Format" />
        /// is determined automatically based on the range of data values.</summary>
        /// <remarks>This value will be set to false if
        /// <see cref="Format" /> is manually changed.</remarks>
        /// <value>true if <see cref="Format" /> will be set automatically, false if it is to be set manually by the user</value>
        /// <seealso cref="Mag" />
        /// <seealso cref="Format" />
        ...
        /// <summary>The format of the <see cref="Axis" /> tic labels.</summary>
        /// <remarks>
        /// This property may be a date format or a numeric format, depending on the setting of
        /// <see cref="Type">Scale.Type</see>. This property may be set automatically by ZedGraph, depending on the RequestState of
        /// <see cref="FormatAuto" />.
        /// </remarks>
        /// <value>
        ...
        /// <summary>The magnitude multiplier for scale values.</summary>
        /// <remarks>
        /// This is used to limit the size of the displayed value labels.  For example, if the value is really 2000000, then the graph will display 2000 with a
        /// 10^3 magnitude multiplier.  This value can be determined automatically depending on the RequestState of <see cref="MagAuto" />. If this value is set
        /// manually by the user, then <see cref="MagAuto" /> will also be set to false.
        /// </remarks>
        ...
        /// <summary>Determines whether the <see cref="Mag" /> value will be set automatically based on the data, or manually by the user.</summary>
        /// <remarks>If the user manually sets the <see cref="Mag" /> value, then this flag will be set to false.</remarks>
        /// <value>true to have <see cref="Mag" /> set automatically, false otherwise</value>
        /// <seealso cref="AxisLabel.IsOmitMag" />
        /// <seealso cref="Axis.Title" />
        /// <seealso cref="Mag" />
        public bool MagAuto
        ...
        /// <summary> Gets or sets the "grace" value applied to the minimum data range.</summary>
        /// <remarks>
        /// This value is expressed as a fraction of the total data range.  For example, assume the data range is from 4.0 to 16.0, leaving a range of 12.0.  If
        /// MinGrace is set to 0.1, then 10% of the range, or 1.2 will be subtracted from the minimum data value. The scale will then be ranged to cover at least
        /// 2.8 to 16.0.
        /// </remarks>
        /// <seealso cref="Min" />
        /// <seealso cref="Scale.Default.MinGrace" />
        /// <seealso cref="MaxGrace" />
        ...
        /// <summary> Gets or sets the "grace" value applied to the maximum data range.</summary>
        /// <remarks>
        /// This values determines how much extra space is left after the last data value. This value is expressed as a fraction of the total data range.  For
        /// example, assume the data range is from 4.0 to 16.0, leaving a range of 12.0.  If MaxGrace is set to 0.1, then 10% of the range, or 1.2 will be added
        /// to the maximum data value. The scale will then be ranged to cover at least 4.0 to 17.2.
        /// </remarks>
        /// <seealso cref="Max" />
        /// <seealso cref="Scale.Default.MaxGrace" />
        /// <seealso cref="MinGrace" />
        ...
        /// <summary> Controls the alignment of the <see cref="Axis" /> tic labels.</summary>
        /// <remarks>This property controls whether the inside, center, or outside edges of the text labels are aligned.</remarks>
        public AlignP Align
        {
            get
            {
        ...
        /// <summary> Controls the alignment of the <see cref="Axis" /> tic labels.</summary>
        /// <remarks>This property controls whether the left, center, or right edges of the text labels are aligned.</remarks>
        ...
        /// <summary>Gets a reference to the <see cref="Graph.FontSpec" /> class used to render the scale values</summary>
        ...
        /// <summary>The gap between the scale labels and the tics.</summary>
        ...
        /// <summary>Gets or sets a value that causes the axis scale labels and title to appear on the opposite side of the axis.</summary>
        /// <remarks>
        /// For example, setting this flag to true for the <see cref="YAxis" /> will shift the axis labels and title to the right side of the
        /// <see cref="YAxis" /> instead of the normal left-side location.  Set this property to true for the <see cref="XAxis" />, and set the
        /// <see cref="Axis.Cross" /> property for the <see cref="XAxis" /> to an arbitrarily large value (assuming <see cref="IsReverse" /> is false for the
        /// <see cref="YAxis" />) in order to have the <see cref="XAxis" /> appear at the top of the <see cref="Chart.Rect" />.
        /// </remarks>
        ...
        /// <summary>Gets or sets a value that causes the first scale label for this <see cref="Axis" /> to be hidden.</summary>
        /// <remarks>
        /// Often, for axis that have an active <see cref="Axis.Cross" /> setting (e.g., <see cref="Axis.CrossAuto" />
        /// is false), the first and/or last scale label are overlapped by opposing axes.  Use this property to hide the first scale label to avoid the overlap.
        /// Note that setting this value to true will hide any scale label that appears within <see cref="Scale.Default.EdgeTolerance" /> of the beginning of the
        /// <see cref="Axis" />.
        /// </remarks>
        ...
        /// <summary>Gets or sets a value that causes the last scale label for this <see cref="Axis" /> to be hidden.</summary>
        /// <remarks>
        /// Often, for axis that have an active <see cref="Axis.Cross" /> setting (e.g., <see cref="Axis.CrossAuto" />
        /// is false), the first and/or last scale label are overlapped by opposing axes.  Use this property to hide the last scale label to avoid the overlap.
        /// Note that setting this value to true will hide any scale label that appears within <see cref="Scale.Default.EdgeTolerance" /> of the end of the
        /// <see cref="Axis" />.
        /// </remarks>
        ...
        /// is false), the scale label at the <see cref="Axis.Cross" /> value is overlapped by opposing axes. Use this property to hide the scale label to avoid
        /// the overlap.
        /// </remarks>
        ...
        /// <summary>Determines if the scale values are reversed for this <see cref="Axis" />
        /// </summary>
        /// <value>true for the X values to decrease to the right or the Y values to decrease upwards, false otherwise</value>
        /// <seealso cref="Scale.Default.IsReverse" />
        /// .
        ...
        /// <summary>Determines if powers-of-ten notation will be used for the numeric value labels.</summary>
        /// <remarks>
        /// The powers-of-ten notation is just the text "10" followed by a superscripted value indicating the magnitude.  This mode is only valid for log scales
        /// (see
        /// <see cref="IsLog" /> and <see cref="Type" />).
        /// </remarks>
        /// <value> boolean value; true to show the title as a power of ten, false to show a regular numeric value (e.g., "0.01", "10", "1000")</value>
        ...
        /// <summary>
        /// Gets or sets a <see cref="bool" /> value that determines if ZedGraph will check to see if the <see cref="Axis" /> scale labels are close enough to
        /// overlap.  If so, ZedGraph will adjust the step size to prevent overlap.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>Gets or sets a property that determines whether or not the scale values will be shown.</summary>
        ...
        /// <summary>The text labels for this <see cref="Axis" />.</summary>
        /// <remarks>This property is only applicable if <see cref="Type" /> is set to <see cref="AxisType.Text" />.</remarks>
...
*/
        ...
        /// </summary>
        /// <remarks>
        /// The default behavior is to just return the value unchanged.  However, for <see cref="AxisType.Log"/> and <see cref="AxisType.Exponent"/>, it
        /// returns the log or power equivalent.
        /// </remarks>
        /// <param name="val">
        ...
        /// <remarks>
        /// The default behavior is to just return the value unchanged.  However, for <see cref="AxisType.Log"/> and <see cref="AxisType.Exponent"/>, it
        /// returns the anti-log or inverse-power equivalent.
        /// </remarks>
        /// <param name="val">
        /// The value to be converted
        /// </param>
...
*/
        ...
        /// </summary>
        /// <remarks>
        /// This method properly accounts for <see cref="IsLog"/>, <see cref="IsText"/>, and other axis format settings.
        /// </remarks>
        /// <param name="pane">
        /// A reference to the <see cref="GraphPane"/> object that is the parent or owner of this object.
        /// </param>
        /// <param name="index">
        /// The zero-based, ordinal index of the label to be generated.  For example, a value of 2 would cause the third value label on the axis to be generated.
        /// </param>
        /// <param name="dVal">
        /// The numeric value associated with the label.  This value is ignored for log (<see cref="IsLog"/>) and text (<see cref="IsText"/>
        /// ) type axes.
        /// </param>
        /// <returns>
        ...
        internal virtual string MakeLabel(GraphPane pane, int index, double dVal)
        {
            ...
            // linear or ordinal is the default behavior
            // this method is overridden for other Scale types
            double scaleMult = Math.Pow(10.0, this._mag);
        ...
        /// <see cref="Axis"/>. The results of this method are used to determine how much space is required for the axis labels.
        /// </summary>
        /// <param name="g">
        ...
        /// true to get the bounding box of the text using the <see cref="Graph.FontSpec.Angle"/>, false to just get the bounding box
        /// without rotation
        /// </param>
        /// <returns>
        ...
        internal SizeF GetScaleMaxSpace(Graphics g, GraphPane pane, float scaleFactor, bool applyAngle)
        {
            if (this._isVisible)
            {
                double dVal, scaleMult = Math.Pow(10.0, this._mag);
                int i;
        ...
        internal virtual double CalcMajorTicValue(double baseVal, double tic)
        {
            ...
            return baseVal + this._majorStep * tic;
        }
        ...
        internal virtual double CalcMinorTicValue(double baseVal, int iTic)
        {
            ...
            return baseVal + this._minorStep * iTic;
        }
        ...
        /// </param>
        /// <returns>
        /// The ordinal position of the first minor tic, relative to the first major tic. This value can be negative (e.g., -3 means the first minor tic is 3
        /// minor step increments before the first major tic.
        /// </returns>
        ...
        /// <summary>Determine the value for the first major tic.</summary>
        /// <remarks>
        /// This is done by finding the first possible value that is an integral multiple of the step size, taking into account the date/time units if
        /// appropriate. This method properly accounts for <see cref="IsLog" />, <see cref="IsText" />, and other axis format settings.
        /// </remarks>
        /// <returns>First major tic value (floating point double).</returns>
        internal virtual double CalcBaseTic()
        {
            if (this._baseTic != PointPairBase.Missing)
            {
                return this._baseTic;
            }

            if (this.IsAnyOrdinal)
            {
            ...
            return Math.Ceiling(this._min / this._majorStep - 0.00000001) * this._majorStep;
        }

        /// <summary>
        /// Draw the value labels, tic marks, and grid lines as required for this <see cref="Axis"/>.
        /// </summary>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        /// </param>
            ...
            using (Pen ticPen = tic.GetPen(pane, scaleFactor))
            {
                ...
                for (int i = firstTic; i < nTics + firstTic; i++)
                {
                    ...
                    if (tic._isBetweenLabels && this.IsText)
                    {
                        ...
                        dVal2 = this.CalcMajorTicValue(baseVal, i + 0.5);
                    ...
                    // draw the grid
                    // 					grid.Draw( g, gridPen, pixVal2, topPix );
                    bool isMaxValueAtMaxPix = ((this._ownerAxis is XAxis || this._ownerAxis is Y2Axis) && !this.IsReverse)
                                              || (this._ownerAxis is Y2Axis && this.IsReverse);

                    bool isSkipZone = (((this._isSkipFirstLabel && isMaxValueAtMaxPix) || (this._isSkipLastLabel && !isMaxValueAtMaxPix))
                                       && pixVal < edgeTolerance)
                                      || (((this._isSkipLastLabel && isMaxValueAtMaxPix) || (this._isSkipFirstLabel && !isMaxValueAtMaxPix))
            ...
            float scaleFactor)
        {
            ...
            {
                av = this._alignH == AlignH.Left ? AlignV.Top : (this._alignH == AlignH.Right ? AlignV.Bottom : AlignV.Center);
            }
        ...
        /// </summary>
        /// <remarks>
        /// This method uses the <see cref="BarSettings.ClusterScaleWidth"/> for non-ordinal axes, or a cluster width of 1.0 for ordinal axes.
        /// </remarks>
        /// <param name="pane">
        ...
        public float GetClusterWidth(GraphPane pane)
        {
            ...
            return Math.Abs(this.Transform(basisVal + (this.IsAnyOrdinal ? 1.0 : pane._barSettings._clusterScaleWidth)) - this.Transform(basisVal));
        }
        ...
        #region Scale PickerCalendar Methods

        /// <summary>
        /// Select a reasonable scale given a range of data values.
        /// </summary>
        /// <remarks>
        /// The scale range is chosen based on increments of 1, 2, or 5 (because they are even divisors of 10).  This routine honors the <see cref="MinAuto"/>,
        /// <see cref="MaxAuto"/>, and <see cref="MajorStepAuto"/> autorange settings as well as the <see cref="IsLog"/>
        /// setting.  In the event that any of the autorange settings are false, the corresponding <see cref="Min"/>, <see cref="Max"/>, or
        /// <see cref="MajorStep"/>
        ...
        /// defaults for scale selection are defined using <see cref="Default.ZeroLever"/>,
        ...
        /// </para>
        /// <para>
        /// <see cref="Format"/> is set to the display format for the values (this controls the number of decimal places, whether there are thousands
        ...
        /// </summary>
        /// <remarks>
        /// This method works for both X and Y direction axes, and it works for angled text (assuming that a bounding box is an appropriate measure).
        /// Technically, labels at 45 degree angles could fit better than the return value of this method since the bounding boxes can overlap without the labels
        ...
        /// </summary>
        /// <remarks>
        /// This utility method will try to honor the <see cref="Default.TargetXSteps"/> and
        /// <see cref="Default.TargetYSteps"/> number of steps while using a rational increment (1, 2, or 5 -- which are even divisors of 10).  This method is
        /// used by <see cref="PickScale"/>.
        /// </remarks>
        /// <param name="range">
        /// The range of data in user scale units.  This can be a full range of the data for the major step size, or just the value of the major step size to
        ...
        /// </summary>
        /// <remarks>
        /// This utility method will calculate a step size, of no more than maxSteps, using a rational increment (1, 2, or 5 -- which are even divisors of 10).
        ...
        /// <summary>Internal routine to determine the ordinals of the first and last major axis label.</summary>
        /// <returns>This is the total number of major tics for this axis.</returns>
        ...
        /// </summary>
        /// <remarks>
        /// This method takes into account the scale range (<see cref="Min"/> and <see cref="Max"/>), logarithmic RequestState (<see cref="IsLog"/>), scale
        /// reverse RequestState (<see cref="IsReverse"/>) and axis type (<see cref="XAxis"/>,
        /// <see cref="YAxis"/>, or <see cref="Y2Axis"/>). Note that the <see cref="Chart.Rect"/> must be valid, and
        /// <see cref="SetupScaleData"/> must be called for the current configuration before using this method (this is called everytime the graph is drawn
        /// (i.e., <see cref="GraphPane.Draw"/> is called).
        /// </remarks>
        /// <param name="x">
        /// The coordinate value, in user scale units, to be transformed
        /// </param>
        /// <returns>
        /// the coordinate value transformed to screen coordinates for use in calling the <see cref="Graphics"/> draw routines
        /// </returns>
        public float Transform(double x)
        {
            // Must take into account Logger, and Reverse Axes
        ...
        /// </param>
        /// <param name="i">
        /// The ordinal value of this point, just in case this is an <see cref="AxisType.Ordinal"/> axis
        /// </param>
        /// <param name="x">
        /// The coordinate value, in user scale units, to be transformed
        /// </param>
        ...
        public double ReverseTransform(float pixVal)
        {
            ...
            if (this._isReverse == (this._ownerAxis is XAxis || this._ownerAxis is X2Axis))
            {
                val = (pixVal - this._maxPix) / (double)(this._minPix - this._maxPix) * (this._maxLinTemp - this._minLinTemp) + this._minLinTemp;
            }
            else
            {
                val = (pixVal - this._minPix) / (double)(this._maxPix - this._minPix) * (this._maxLinTemp - this._minLinTemp) + this._minLinTemp;
            }
        ...
        /// </summary>
        /// <remarks>
        /// Assumes that the origin has been set to the "left" of this axis, facing from the label side. Note that the left side corresponds to the scale minimum
        /// for the X and Y2 axes, but it is the scale maximum for the Y axis. This method takes into account the scale range (<see cref="Min"/> and
        /// <see cref="Max"/>), logarithmic RequestState (<see cref="IsLog"/>), scale reverse RequestState (<see cref="IsReverse"/>) and axis type (
        /// <see cref="XAxis"/>,
        /// <see cref="YAxis"/>, or <see cref="Y2Axis"/>).  Note that the <see cref="Chart.Rect"/> must be valid, and
        /// <see cref="SetupScaleData"/> must be called for the current configuration before using this method.
        /// </remarks>
        /// <param name="x">
        /// The coordinate value, in linearized user scale units, to be transformed
        /// </param>
        /// <returns>
        /// the coordinate value transformed to screen coordinates for use in calling the <see cref="Draw"/> method
        /// </returns>
