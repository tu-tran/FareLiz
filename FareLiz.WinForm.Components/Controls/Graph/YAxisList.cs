...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    public class YAxisList : List<YAxis>, ICloneable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="YAxisList"/> class. Default constructor for the collection class.
        /// </summary>
        public YAxisList()
        {
        }
        ...
        /// </param>
        /// <returns>
        /// An integer representing the ordinal position of the new <see cref="YAxis"/> in this <see cref="YAxisList"/>.  This is the value that you would set
        /// the
        /// <see cref="CurveItem.YAxisIndex"/> property of a given <see cref="CurveItem"/> to assign it to this new <see cref="YAxis"/>.
        /// </returns>
