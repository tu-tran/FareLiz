...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>An exception thrown by ZedGraph.  A child class of <see cref="ApplicationException" />.</summary>
    ...
    public class ZedGraphException : ApplicationException
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZedGraphException"/> class. 
        /// Initializes a new instance of the <see cref="Exception"/> class with a specified error message and a reference to the inner exception that is the
        ...
        /// The exception that is the cause of the current exception. If the innerException parameter is not a null reference, the current exception is raised in
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ZedGraphException"/> class. Initializes a new instance of the <see cref="Exception"/> class.
        /// </summary>
