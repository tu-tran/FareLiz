...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A collection class containing a list of <see cref="PointPair" /> objects that define the set of points to be displayed on the curve.</summary>
    /// <seealso cref="BasicArrayPointList" />
    /// <seealso cref="IPointList" />
    /// <author> Jerry Vos based on code by John Champion modified by John Champion</author>
    ...
    public class PointPairList : List<PointPair>, IPointList, IPointListEdit
    {
        ...
        /// <see cref="Sorted" /> to access this value.</summary>
...
*/
        ...
        /// <summary>true if the list is currently sorted.</summary>
        /// <seealso cref="Sort()" />
        public bool Sorted
        {
            get
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PointPairList"/> class. Default constructor for the collection class
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PointPairList"/> class. 
        ...
        /// A reference to the <see cref="PointPairList"/> object to be added
        /// </param>
        ...
        /// <summary>
        /// Add a set of points to the PointPairList from two arrays of type double. If either array is null, then a set of ordinal values is automatically
        /// generated in its place (see <see cref="AxisType.Ordinal"/>. If the arrays are of different size, then the larger array prevails and the smaller
        /// array is padded with <see cref="PointPairBase.Missing"/> values.
        /// </summary>
        /// <param name="x">
        ...
        /// <summary>
        /// Add a set of points to the <see cref="PointPairList"/> from three arrays of type double. If the X or Y array is null, then a set of ordinal values
        /// is automatically generated in its place (see <see cref="AxisType.Ordinal"/>.  If the <see paramref="baseVal"/>
        /// is null, then it is set to zero. If the arrays are of different size, then the larger array prevails and the smaller array is padded with
        /// <see cref="PointPairBase.Missing"/> values.
        /// </summary>
        /// <param name="x">
        /// A double[] array of X values
        /// </param>
        ...
        /// <summary>
        /// Add a <see cref="PointPair"/> object to the collection at the specified, zero-based, index location.
        /// </summary>
        /// <param name="index">
        ...
        /// <summary>
        /// Add a single point (from values of type double ) to the <see cref="PointPairList"/> at the specified, zero-based, index location.
        /// </summary>
        /// <param name="index">
        /// The zero-based ordinal index where the point is to be added in the list.
        /// </param>
		...
		*/
        ...
        /// </param>
        /// <returns>
        /// The zero-based index of the specified <see cref="PointPair"/>, or -1 if the <see cref="PointPair"/> is not in the list
        /// </returns>
        ...
        /// </summary>
        /// <remarks>
        /// Equality is based on equal count of <see cref="PointPair"/> items, and each individual <see cref="PointPair"/> must be equal (as per the
        /// <see cref="PointPair.Equals"/> method.
        /// </remarks>
        /// <param name="obj">
        /// The <see cref="PointPairList"/> to be compared with for equality.
        /// </param>
        /// <returns>
        /// true if the <see cref="PointPairList"/> objects are equal, false otherwise.
        /// </returns>
        ...
        /// <summary>Sorts the list according to the point x values. Will not sort the list if the list is already sorted.</summary>
        ...
        /// <summary>
        /// Set the X values for this <see cref="PointPairList"/> from the specified array of double values.
        /// </summary>
        /// <remarks>
        /// If <see paramref="x"/> has more values than this list, then the extra values will be ignored.  If <see paramref="x"/>
        /// has less values, then the corresponding <see cref="PointPairList"/> values will not be changed.  That is, if the <see cref="PointPairList"/> has 20
        /// values and <see paramref="x"/> has 15 values, then the first 15 values of the
        /// <see cref="PointPairList"/> will be changed, and the last 5 values will not be changed.
        /// </remarks>
        /// <param name="x">
        /// An array of double values that will replace the existing X values in the <see cref="PointPairList"/>.
        /// </param>
        ...
        /// <summary>
        /// Set the Y values for this <see cref="PointPairList"/> from the specified array of double values.
        /// </summary>
        /// <remarks>
        /// If <see paramref="y"/> has more values than this list, then the extra values will be ignored.  If <see paramref="y"/>
        /// has less values, then the corresponding <see cref="PointPairList"/> values will not be changed.  That is, if the <see cref="PointPairList"/> has 20
        /// values and <see paramref="y"/> has 15 values, then the first 15 values of the
        /// <see cref="PointPairList"/> will be changed, and the last 5 values will not be changed.
        /// </remarks>
        /// <param name="y">
        /// An array of double values that will replace the existing Y values in the <see cref="PointPairList"/>.
        /// </param>
        ...
        /// <summary>
        /// Set the Z values for this <see cref="PointPairList"/> from the specified array of double values.
        /// </summary>
        /// <remarks>
        /// If <see paramref="z"/> has more values than this list, then the extra values will be ignored.  If <see paramref="z"/>
        /// has less values, then the corresponding <see cref="PointPairList"/> values will not be changed.  That is, if the <see cref="PointPairList"/> has 20
        /// values and <see paramref="z"/> has 15 values, then the first 15 values of the
        /// <see cref="PointPairList"/> will be changed, and the last 5 values will not be changed.
        /// </remarks>
        /// <param name="z">
        /// An array of double values that will replace the existing Z values in the <see cref="PointPairList"/>.
        /// </param>
        ...
        /// <see cref="PointPairList"/>.  If <see paramref="sumList"/> has more values than this list, then the extra values will be ignored.  If
        /// <see paramref="sumList"/>
        /// has less values, the missing values are assumed to be zero.
        /// </summary>
        /// <param name="sumList">
        /// A reference to the <see cref="PointPairList"/> object to be summed into the this <see cref="PointPairList"/>.
        /// </param>
        ...
        /// </summary>
        /// <remarks>
        /// This method uses linear interpolation with a binary search algorithm.  It therefore requires that the x data be monotonically increasing.  Missing
        /// values are not allowed.  This method will extrapolate outside the range of the PointPairList if necessary.
        /// </remarks>
        /// <param name="xTarget">
        /// The target X value on which to interpolate
        /// </param>
        /// <returns>
        /// The Y value that corresponds to the <see paramref="xTarget"/> value.
        /// </returns>
        public double InterpolateX(double xTarget)
        {
            ...
            return (xTarget - this[lo].X) / (this[hi].X - this[lo].X) * (this[hi].Y - this[lo].Y) + this[lo].Y;
        }
        ...
        /// </summary>
        /// <remarks>
        /// This method uses cardinal spline interpolation with a binary search algorithm.  It therefore requires that the x data be monotonically increasing.
        /// Missing values are not allowed.  This method will not extrapolate outside the range of the PointPairList (it returns
        /// <see cref="PointPairBase.Missing"/> if extrapolation would be required).  WARNING: Cardinal spline interpolation can generate curves with non-unique
        /// X values for higher tension settings.  That is, there may be multiple X values for the same Y value.  This routine follows the path of the spline
        /// curve until it reaches the FIRST OCCURRENCE of the target X value.  It does not check to see if other solutions are possible.
        /// </remarks>
        /// <param name="xTarget">
        /// The target X value on which to interpolate
        /// </param>
        /// <param name="tension">
        /// The tension setting that controls the curvature of the spline fit. Typical values are between 0 and 1, where 0 is a linear fit, and 1 is lots of
        /// "roundness". Values greater than 1 may give odd results.
        /// </param>
        /// <returns>
        /// The Y value that corresponds to the <see paramref="xTarget"/> value.
        /// </returns>
        public double SplineInterpolateX(double xTarget, double tension)
        {
            ...
            double newX, newY, lastX = X1, lastY = Y1;
            ...
            for (double t = 0.01; t <= 1; t += 0.01)
            {
                ...
                newX = X1 * B0 + (X1 + (X2 - X0) * tension) * B1 + (X2 - (X3 - X1) * tension) * B2 + X2 * B3;
                newY = Y1 * B0 + (Y1 + (Y2 - Y0) * tension) * B1 + (Y2 - (Y3 - Y1) * tension) * B2 + Y2 * B3;
                ...
                if (newX >= xTarget)
                {
                    ...
                    // error.
                    return (xTarget - lastX) / (newX - lastX) * (newY - lastY) + lastY;
                }
        ...
        /// </summary>
        /// <remarks>
        /// This method uses linear interpolation with a binary search algorithm.  It therefore requires that the Y data be monotonically increasing.  Missing
        /// values are not allowed.  This method will extrapolate outside the range of the PointPairList if necessary.
        /// </remarks>
        /// <param name="yTarget">
        ...
        /// </param>
        /// <returns>
        /// The X value that corresponds to the <see paramref="yTarget"/> value.
        /// </returns>
        public double InterpolateY(double yTarget)
        {
            ...
            return (yTarget - this[lo].Y) / (this[hi].Y - this[lo].Y) * (this[hi].X - this[lo].X) + this[lo].X;
        }
        ...
        /// </summary>
        /// <remarks>
        /// The output <see cref="PointPairList"/> will cover the same X range of data as the original dataset.
        /// </remarks>
        /// <param name="points">
        /// An <see cref="IPointList"/> instance containing the data to be regressed.
        /// </param>
        /// <param name="pointCount">
        /// The number of desired points to be included in the resultant <see cref="PointPairList"/>.
        /// </param>
        /// <returns>
        /// A new <see cref="PointPairList"/> containing the resultant data fit.
        /// </returns>
        ...
        /// A new <see cref="PointPairList"/> containing the resultant data fit.
        /// </returns>
        /// <author> Brian Chappell - lazarusds modified by John Champion</author>
