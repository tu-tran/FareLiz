...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// The <see cref="FontSpec" /> class is a generic font class that maintains the font family, attributes, colors, border and fill modes, font size, and
    /// angle information. This class can render text with a variety of alignment options using the
    ...
    public class FontSpec : ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="FontSpec" /> class.</summary>
        public struct Default
        {
            /// <summary>The default size fraction of the superscript font, expressed as a fraction of the size of the main font.</summary>
            public static float SuperSize = 0.85F;

            /// <summary>
            /// The default shift fraction of the superscript, expressed as a fraction of the superscripted character height.  This is the height above the main font
            /// (a zero shift means the main font and the superscript font have the tops aligned).
            /// </summary>
            public static float SuperShift = 0.4F;

            /// <summary>The default color for filling in the background of the text block (<see cref="Fill.Color" /> property).</summary>
            public static Color FillColor = Color.White;

            /// <summary>The default custom brush for filling in this <see cref="FontSpec" />
            /// (<see cref="Fill.Brush" /> property).</summary>
            public static Brush FillBrush = null;

            /// <summary>The default fill mode for this <see cref="FontSpec" />
            /// (<see cref="Fill.Type" /> property).</summary>
            public static FillType FillType = FillType.Solid;

            /// <summary>Default value for the alignment with which this
            /// <see cref="FontSpec" /> object is drawn.  This alignment really only affects multi-line strings.</summary>
            /// <value>A <see cref="StringAlignment" /> enumeration.</value>
            public static StringAlignment StringAlignment = StringAlignment.Center;

            /// <summary>Default value for <see cref="FontSpec.IsDropShadow" />, which determines if the drop shadow is displayed for this <see cref="FontSpec" />.</summary>
            public static bool IsDropShadow = false;

            /// <summary>Default value for <see cref="FontSpec.IsAntiAlias" />, which determines if anti-aliasing logic is used for this <see cref="FontSpec" />.</summary>
            public static bool IsAntiAlias = false;

            /// <summary>Default value for <see cref="FontSpec.DropShadowColor" />, which determines the color of the drop shadow for this <see cref="FontSpec" />.</summary>
            public static Color DropShadowColor = Color.Black;

            /// <summary>
            /// Default value for <see cref="FontSpec.DropShadowAngle" />, which determines the offset angle of the drop shadow for this
            /// <see cref="FontSpec" />.
            /// </summary>
            public static float DropShadowAngle = 45f;

            /// <summary>
            /// Default value for <see cref="FontSpec.DropShadowOffset" />, which determines the offset distance of the drop shadow for this
            /// <see cref="FontSpec" />.
            /// </summary>
        ...
        /// <summary>
        /// Private field that stores the font family name for this <see cref="FontSpec" />. Use the public property <see cref="Family" /> to access
        /// this value.
        /// </summary>
        ...
        /// <summary>
        /// Private field that determines whether this <see cref="FontSpec" /> is drawn with bold typeface. Use the public property <see cref="IsBold" /> to
        /// access this value.
        /// </summary>
        ...
        /// <summary>
        /// Private field that determines whether this <see cref="FontSpec" /> is drawn with italic typeface. Use the public property <see cref="IsItalic" /> to
        /// access this value.
        /// </summary>
        ...
        /// <summary>
        /// Private field that determines whether this <see cref="FontSpec" /> is drawn with underlined typeface. Use the public property
        /// <see cref="IsUnderline" /> to access this value.
        /// </summary>
        ...
        /// <see cref="FontSpec" />.  Use the public property <see cref="Fill" /> to access this value.
        /// </summary>
        private Fill _fill;

        /// <summary>
        /// Private field that determines the properties of the border around the text. Use the public property <see cref="Border" /> to access this
        /// value.
        /// </summary>
        ...
        /// </summary>
        /// <value>The angle of the font, measured in anti-clockwise degrees from horizontal.  Negative values are permitted.</value>
        private float _angle;

        /// <summary>
        /// Private field that determines the alignment with which this
        /// <see cref="FontSpec" /> object is drawn.  This alignment really only affects multi-line strings.  Use the public property
        ...
        /// object for this <see cref="FontSpec" />.  This font object will be at the actual drawn size <see cref="_scaledSize" /> according to the current size
        /// of the <see cref="GraphPane" />.  Use the public method
        ...
        /// <summary>
        /// Private field that determines if the <see cref="FontSpec" /> will be displayed using anti-aliasing logic. Use the public property
        /// <see cref="IsAntiAlias" /> to access this value.
        /// </summary>
        private bool _isAntiAlias;

        /// <summary>
        /// Private field that determines if the <see cref="FontSpec" /> will be displayed with a drop shadow. Use the public property
        /// <see cref="IsDropShadow" /> to access this value.
        /// </summary>
        private bool _isDropShadow;

        /// <summary>
        /// Private field that determines the color of the dropshadow for this
        /// <see cref="FontSpec" />. Use the public property <see cref="DropShadowColor" /> to access this value.
        /// </summary>
        private Color _dropShadowColor;

        /// <summary>
        /// Private field that determines the offset angle of the dropshadow for this
        /// <see cref="FontSpec" />. Use the public property <see cref="DropShadowAngle" /> to access this value.
        /// </summary>
        private float _dropShadowAngle;

        /// <summary>
        /// Private field that determines the offset distance of the dropshadow for this
        /// <see cref="FontSpec" />. Use the public property <see cref="DropShadowOffset" /> to access this value.
        /// </summary>
        private float _dropShadowOffset;

        /// <summary>
        /// Private field that stores a reference to the <see cref="Font" />
        /// object that will be used for superscripts.  This font object will be a fraction of the <see cref="FontSpec" /> <see cref="_scaledSize" />, based on
        /// the value of <see cref="Default.SuperSize" />.  This property is internal, and has no public access.
        /// </summary>
        /// <value>A reference to a <see cref="Font" /> object</value>
        ...
        /// <see cref="FontSpec" /> object.  This represents the actual on-screen size, rather than the <see cref="Size" /> that represents the reference size
        /// for a "full-sized" <see cref="GraphPane" />.
        /// </summary>
        /// <value>The size of the font, measured in points (1/72 inch).</value>
        ...
        /// <summary>
        /// The color of the font characters for this <see cref="FontSpec" />. Note that the border and background colors are set using the
        /// <see cref="LineBase.Color" /> and
        /// <see cref="Graph.Fill.Color" /> properties, respectively.
        /// </summary>
        /// <value>A system <see cref="System.Drawing.Color" /> reference.</value>
        ...
        /// <summary>The font family name for this <see cref="FontSpec" />.</summary>
        /// <value>A text string with the font family name, e.g., "Arial"</value>
        ...
        /// <summary>Determines whether this <see cref="FontSpec" /> is drawn with bold typeface.</summary>
        /// <value>A boolean value, true for bold, false for normal</value>
        public bool IsBold
        {
            get
        ...
        /// <summary>Determines whether this <see cref="FontSpec" /> is drawn with italic typeface.</summary>
        /// <value>A boolean value, true for italic, false for normal</value>
        ...
        /// <summary>Determines whether this <see cref="FontSpec" /> is drawn with underlined typeface.</summary>
        /// <value>A boolean value, true for underline, false for normal</value>
        ...
        /// <summary>The angle at which this <see cref="FontSpec" /> object is drawn.</summary>
        /// <value>The angle of the font, measured in anti-clockwise degrees from horizontal.  Negative values are permitted.</value>
        public float Angle
        {
            get
        ...
        /// <summary>Determines the alignment with which this
        /// <see cref="FontSpec" /> object is drawn.  This alignment really only affects multi-line strings.</summary>
        /// <value>A <see cref="StringAlignment" /> enumeration.</value>
        ...
        /// <summary>The size of the font for this <see cref="FontSpec" /> object.</summary>
        /// <value>The size of the font, measured in points (1/72 inch).</value>
        public float Size
        {
            get
        ...
        /// <summary>Gets or sets the <see cref="Border" /> class used to draw the border border around this text.</summary>
        ...
        /// <see cref="FontSpec" />, which controls how the background behind the text is filled.</summary>
        public Fill Fill
        {
            get
            {
        ...
        /// <summary>Gets or sets a value that determines if the <see cref="FontSpec" /> will be drawn using anti-aliasing logic within GDI+.</summary>
        /// <remarks>
        ...
        /// <see cref="SmoothingMode.HighQuality" />.  If this property is set to false, the the current setting of <see cref="Graphics.SmoothingMode" /> will be
        /// left as-is.
        /// </remarks>
        ...
        /// <summary>Gets or sets a value that determines if the <see cref="FontSpec" /> will be displayed with a drop shadow.</summary>
        ...
        /// <summary>Gets or sets the color of the drop shadow for this <see cref="FontSpec" />.</summary>
        /// <remarks>This value only applies if <see cref="IsDropShadow" /> is true.</remarks>
        ...
        /// <summary>Gets or sets the offset angle of the drop shadow for this <see cref="FontSpec" />.</summary>
        /// <remarks>This value only applies if <see cref="IsDropShadow" /> is true.</remarks>
        /// <value>The angle, measured in anti-clockwise degrees from horizontal.  Negative values are permitted.</value>
        /// <seealso cref="IsDropShadow" />
        /// <seealso cref="DropShadowColor" />
        /// <seealso cref="DropShadowOffset" />
        ...
        /// <summary>Gets or sets the offset distance of the drop shadow for this <see cref="FontSpec" />.</summary>
        /// <remarks>This value only applies if <see cref="IsDropShadow" /> is true.</remarks>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="FontSpec"/> class. Construct a <see cref="FontSpec"/> object with default properties.
        /// </summary>
        public FontSpec()
            : this(SystemFonts.DefaultFont.Name, 12, Color.Black, false, false, false)
        {
        }

        /// <summary>
        /// Initializes a new instance of the <see cref="FontSpec"/> class. 
        /// Construct a <see cref="FontSpec"/> object with the given properties.  All other properties are defaulted according to the values specified in the
        /// <see cref="Default"/>
        /// default class.
        /// </summary>
        /// <param name="family">
        /// A text string representing the font family (default is "Arial")
        /// </param>
        /// <param name="size">
        /// A size of the font in points.  This size will be scaled based on the ratio of the <see cref="PaneBase.Rect"/> dimension to the
        ...
        /// </param>
        /// <param name="fillType">
        /// The <see cref="FillType"/> to use for the text background
        /// </param>
        public FontSpec(
            string family, 
            float size, 
        ...
        /// <summary>
        /// Recreate the font based on a new scaled size.  The font will only be recreated if the scaled size has changed by at least 0.1 points.
        /// </summary>
        ...
        private void Remake(float scaleFactor, float size, ref float scaledSize, ref Font font)
        {
            ...
            if (font == null || Math.Abs(newSize - oldSize) > 0.1 || font.Name != this.Family || font.Bold != this._isBold
                || font.Italic != this._isItalic || font.Underline != this._isUnderline)
            {
        ...
        /// </param>
        /// <returns>
        /// Returns a reference to a <see cref="Font"/> object with a size of <see cref="_scaledSize"/>, and font <see cref="Family"/>.
        /// </returns>
        ...
        /// <summary>
        /// Render the specified <paramref name="text"/> to the specifed
        /// <see cref="Graphics"/> device.  The text, border, and fill options will be rendered as required.  This special case method will show the specified
        /// text as a power of 10, using the <see cref="Default.SuperSize"/>
        ...
        public void DrawTenPower(Graphics g, GraphPane pane, string text, float x, float y, AlignH alignH, AlignV alignV, float scaleFactor)
        {
            ...
            SizeF totSize = new SizeF(size10.Width + sizeText.Width, size10.Height + sizeText.Height * Default.SuperShift);
            ...
            using (SolidBrush brush = new SolidBrush(this._fontColor))
            {
                ...
                // is set up such that 0,0 is at the location where the
                // CenterTop of the text needs to be.
                g.DrawString("10", this._font, brush, (-totSize.Width + size10.Width) / 2.0F, sizeText.Height * Default.SuperShift, strFormat);
                g.DrawString(text, this._superScriptFont, brush, (totSize.Width - sizeText.Width - charWidth) / 2.0F, 0.0F, strFormat);
            }
        ...
        /// <summary>
        /// Get a <see cref="SizeF"/> struct representing the width and height of the specified text string, based on the scaled font size
        /// </summary>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        /// </param>
        ...
        /// </param>
        /// <returns>
        /// The scaled text dimensions, in pixels, in the form of a <see cref="SizeF"/> struct
        /// </returns>
        ...
        /// <summary>
        /// Get a <see cref="SizeF"/> struct representing the width and height of the specified text string, based on the scaled font size, and using the
        /// specified <see cref="SizeF"/> as an outer limit.
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Get a <see cref="SizeF"/> struct representing the width and height of the bounding box for the specified text string, based on the scaled
        /// font size.
        /// </summary>
        /// <remarks>
        /// This routine differs from <see cref="MeasureString(Graphics,string,float)"/> in that it takes into account the rotation angle of the font, and gives
        /// the dimensions of the bounding box that encloses the text at the specified angle.
        /// </remarks>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        /// </param>
        ...
        /// </summary>
        /// <remarks>
        /// This special case method will show the specified string as a power of 10, superscripted and downsized according to the
        /// <see cref="Default.SuperSize"/> and <see cref="Default.SuperShift"/>. This routine differs from <see cref="MeasureString(Graphics,string,float)"/>
        /// in that it takes into account the rotation angle of the font, and gives the dimensions of the bounding box that encloses the text at the specified
        /// angle.
        /// </remarks>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        ...
        public SizeF BoundingBoxTenPower(Graphics g, string text, float scaleFactor)
        {
            ...
            if (this._isDropShadow)
            {
                sizeText.Width += (float)(Math.Cos(this._dropShadowAngle) * this._dropShadowOffset * this._superScriptFont.Height);
                sizeText.Height += (float)(Math.Sin(this._dropShadowAngle) * this._dropShadowOffset * this._superScriptFont.Height);
            }
