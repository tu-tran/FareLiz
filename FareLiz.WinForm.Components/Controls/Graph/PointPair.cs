...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A simple point represented by an (X,Y,Z) group of double values.</summary>
    ...
    public class PointPair : PointPairBase, ISerializable, ICloneable
    {
        ...
        /// <summary>
        /// This PointPair's Z coordinate.  Also used for the lower value (dependent axis) for <see cref="HiLowBarItem" /> and <see cref="ErrorBarItem" />
        /// charts.
        /// </summary>
        public double Z;

        /// <summary>
        /// A tag object for use by the user.  This can be used to store additional information associated with the <see cref="PointPair" />.  ZedGraph never
        /// modifies this value, but if it is a <see cref="String" /> type, it may be displayed in a <see cref="System.Windows.Forms.ToolTip" />
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PointPair"/> class. Default Constructor
        /// </summary>
        public PointPair()
            : this(0, 0, 0, null)
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PointPair"/> class. 
        /// Creates a point pair with the specified X, Y, and label (<see cref="Tag"/>).
        /// </summary>
        /// <param name="x">
        /// This pair's x coordinate.
        /// </param>
        ...
        /// </param>
        /// <param name="label">
        /// This pair's string label (<see cref="Tag"/>)
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PointPair"/> class. 
        /// Creates a point pair with the specified X, Y, base value, and string label (<see cref="Tag"/>).
        /// </summary>
        /// <param name="x">
        /// This pair's x coordinate.
        /// </param>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="PointPair"/> class. 
        /// Creates a point pair with the specified X, Y, base value, and (<see cref="Tag"/>).
        /// </summary>
        /// <param name="x">
        /// This pair's x coordinate.
        /// </param>
        ...
        /// </param>
        /// <param name="tag">
        /// This pair's <see cref="Tag"/> property
        /// </param>
        ...
        /// </summary>
        /// <param name="pt">
        /// The <see cref="PointF"/> struct from which to get the new <see cref="PointPair"/> values.
        /// </param>
        ...
        /// <summary>
        /// Readonly value that determines if either the X, Y, or Z coordinate in this PointPair is an invalid (not plotable) value. It is considered invalid if
        /// it is missing (equal to System.Double.Max), Infinity, or NaN.
        /// </summary>
        ...
        public bool IsInvalid3D
        {
            get
            {
                return this.X == Missing || this.Y == Missing || this.Z == Missing || double.IsInfinity(this.X) || double.IsInfinity(this.Y)
                       || double.IsInfinity(this.Z) || double.IsNaN(this.X) || double.IsNaN(this.Y) || double.IsNaN(this.Z);
            }
        }

        /// <summary>The "low" value for this point (lower dependent-axis value). This is really just an alias for <see cref="PointPair.Z" />.</summary>
        ...
        /// <summary>The ColorValue property is just an alias for the <see cref="PointPair.Z" />
        /// property.</summary>
        /// <remarks>
    ...
    /// </summary>
        ...
        /// <summary>Compares points based on their y values.  Is setup to be used in an ascending order sort.
        /// <seealso cref="System.Collections.ArrayList.Sort()" />
        /// </summary>
        ...
        /// <summary>Compares points based on their x values.  Is setup to be used in an ascending order sort.
        /// <seealso cref="System.Collections.ArrayList.Sort()" />
        /// </summary>
        public class PointPairComparer : IComparer<PointPair>
        {
            ...
            /// <summary>
            /// Initializes a new instance of the <see cref="PointPairComparer"/> class. 
            /// Constructor for PointPairComparer.
            /// </summary>
            /// <param name="type">
        ...
        /// <summary>
        /// Compare two <see cref="PointPair"/> objects for equality.  To be equal, X, Y, and Z must be exactly the same between the two objects.
        /// </summary>
        /// <param name="obj">
        /// The <see cref="PointPair"/> object to be compared with.
        /// </param>
        /// <returns>
        /// true if the <see cref="PointPair"/> objects are equal, false otherwise
        /// </returns>
        ...
        {
            return this.ToString(DefaultFormat, isShowZ);
        }

        /// <summary>
        /// Format this PointPair value using a general format string. Example:  a format string of "e2" would give "( 1.23e+001, -1.69e+001 )". If
        /// <see paramref="isShowZ"/>
        /// is true, then the third "Z" coordinate is also shown.
        /// </summary>
        /// <param name="format">
        /// A format string that will be used to format each of the two double type values (see <see cref="System.Double.ToString()"/>).
        /// </param>
        /// <param name="isShowZ">
        /// true to show the third "Z" or low dependent value coordinate
        /// </param>
        ...
        {
            return "( " + this.X.ToString(format) + ", " + this.Y.ToString(format) + (isShowZ ? (", " + this.Z.ToString(format)) : string.Empty) + " )";
        }

        /// <summary>
        /// Format this PointPair value using different general format strings for the X, Y, and Z values. Example:  a format string of "e2" would give "(
        /// 1.23e+001, -1.69e+001 )".
        /// </summary>
        /// <param name="formatX">
        /// A format string that will be used to format the X double type value (see <see cref="System.Double.ToString()"/>).
        /// </param>
        /// <param name="formatY">
        /// A format string that will be used to format the Y double type value (see <see cref="System.Double.ToString()"/>).
        /// </param>
        /// <param name="formatZ">
        /// A format string that will be used to format the Z double type value (see <see cref="System.Double.ToString()"/>).
        /// </param>
        /// <returns>
        /// A string representation of the PointPair
        /// </returns>
