...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// Encapsulates a Japanese CandleStick curve type that displays a vertical (or horizontal) line displaying the range of data values at each sample
    /// point, plus a filled bar signifying the opening and closing value for the sample.
    /// </summary>
    /// <remarks>
    ...
    /// <see cref="StockPt.Low" /> members. For a JapaneseCandleStick chart, the range between opening and closing values is drawn as a filled bar, with the
    /// filled color different (<see cref="JapaneseCandleStick.RisingFill" />) for the case of
    /// <see cref="StockPt.Close" />
    /// higher than <see cref="StockPt.Open" />, and
    /// <see cref="JapaneseCandleStick.FallingFill" />
    /// for the reverse.  The width of the bar is controlled by the <see cref="OHLCBar.Size" /> property, which is specified in points (1/72nd inch), and
    /// scaled according to <see cref="PaneBase.CalcScaleFactor" />. The candlesticks are drawn horizontally or vertically depending on the value of
    /// <see cref="BarSettings.Base" />, which is a
    ...
    public class JapaneseCandleStickItem : CurveItem, ICloneable, ISerializable
    {
        ...
        /// <summary>Gets a reference to the <see cref="JapaneseCandleStick" /> class defined for this <see cref="JapaneseCandleStickItem" />.</summary>
        ...
        /// </summary>
        /// <remarks>
        /// IsZIncluded is true for <see cref="JapaneseCandleStickItem"/> objects, since the Y and Z values are defined as the High and Low values for
        /// the day.
        /// </remarks>
        /// <param name="pane">
        /// The parent <see cref="GraphPane"/> of this <see cref="CurveItem"/>.
