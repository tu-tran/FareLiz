...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    public abstract class GraphObj : ISerializable, ICloneable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="GraphObj" /> class.</summary>
        public struct Default
        {
            // Default text item properties
            /// <summary>
            /// Default value for the vertical <see cref="GraphObj" />
            /// text alignment (<see cref="GraphObj.Location" /> property). This is specified using the <see cref="AlignV" /> enum type.
            /// </summary>
            public static AlignV AlignV = AlignV.Center;

            /// <summary>
            /// Default value for the horizontal <see cref="GraphObj" />
            /// text alignment (<see cref="GraphObj.Location" /> property). This is specified using the <see cref="AlignH" /> enum type.
            /// </summary>
            public static AlignH AlignH = AlignH.Center;

            /// <summary>The default coordinate system to be used for defining the
            /// <see cref="GraphObj" /> location coordinates (<see cref="GraphObj.Location" /> property).</summary>
            ...
            /// <summary>The default value for <see cref="GraphObj.IsClippedToChartRect" />.</summary>
        ...
        /// <summary>
        /// Protected field that stores the location of this <see cref="GraphObj" />. Use the public property <see cref="Location" /> to access this
        /// value.
        /// </summary>
        ...
        /// is visible in the graph.  Use the public property <see cref="IsVisible" /> to access this value.
        /// </summary>
        protected bool _isVisible;

        /// <summary>
        /// Protected field that determines whether or not the rendering of this <see cref="GraphObj" />
        /// will be clipped to the ChartRect.  Use the public property <see cref="IsClippedToChartRect" /> to access this value.
        /// </summary>
        protected bool _isClippedToChartRect;

        /// <summary>
        /// A tag object for use by the user.  This can be used to store additional information associated with the <see cref="GraphObj" />.  ZedGraph does not
        ...
        /// <summary>
        /// Internal field that determines the z-order "depth" of this item relative to other graphic objects.  Use the public property
        /// <see cref="ZOrder" /> to access this value.
        /// </summary>
        internal ZOrder _zOrder;

        /// <summary>Internal field that stores the hyperlink information for this object.</summary>
        internal Link _link;
        ...
        /// <summary>The <see cref="Graph.Location" /> struct that describes the location for this <see cref="GraphObj" />.</summary>
        ...
        /// <summary>Gets or sets a value that determines the z-order "depth" of this item relative to other graphic objects.</summary>
        /// <remarks>
        /// Note that this controls the z-order with respect to other elements such as <see cref="CurveItem" />'s, <see cref="Axis" />
        /// objects, etc.  The order of <see cref="GraphObj" /> objects having the same <see cref="Graph.ZOrder" /> value is controlled by their order in the
        /// <see cref="GraphObjList" />.  The first <see cref="GraphObj" />
        /// in the list is drawn in front of other <see cref="GraphObj" />
        /// objects having the same <see cref="Graph.ZOrder" /> value.
        /// </remarks>
        ...
        /// <summary>Gets or sets a value that determines if this <see cref="GraphObj" /> will be visible in the graph.  true displays the item, false hides it.</summary>
        ...
        /// <summary>Gets or sets a value that determines whether or not the rendering of this <see cref="GraphObj" />
        /// will be clipped to the <see cref="Chart.Rect" />.</summary>
        /// <value>true to clip the <see cref="GraphObj" /> to the <see cref="Chart.Rect" /> bounds, false to leave it unclipped.</value>
        public bool IsClippedToChartRect
        {
            get
            {
                return this._isClippedToChartRect;
            }
        ...
        /// <summary>Gets or sets the hyperlink information for this <see cref="GraphObj" />.</summary>
        ...
        /// <summary>true if the <see cref="ZOrder" /> of this object is set to put it in front of the <see cref="CurveItem" /> data points.</summary>
        public bool IsInFrontOfData
        {
            get
            {
                return this._zOrder == ZOrder.A_InFront || this._zOrder == ZOrder.B_BehindLegend || this._zOrder == ZOrder.C_BehindChartBorder;
            }
        }
        ...
        /// </overloads>
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphObj"/> class. Default constructor that sets all <see cref="GraphObj"/> properties to default values as defined in the <see cref="Default"/> class.
        /// </summary>
        public GraphObj()
        ...
        /// Constructor that sets all <see cref="GraphObj"/> properties to default values as defined in the <see cref="Default"/> class.
        /// </summary>
        /// <param name="x">
        /// The x position of the text.  The units of this position are specified by the
        /// <see cref="Graph.Location.CoordinateFrame"/> property.  The text will be aligned to this position based on the <see cref="AlignH"/>
        /// property.
        /// </param>
        /// <param name="y">
        /// The y position of the text.  The units of this position are specified by the
        /// <see cref="Graph.Location.CoordinateFrame"/> property.  The text will be aligned to this position based on the
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphObj"/> class. 
        /// Constructor that creates a <see cref="GraphObj"/> with the specified coordinates and all other properties to defaults as specified in the
        /// <see cref="Default"/> class..
        /// </summary>
        /// <remarks>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphObj"/> class. 
        /// Constructor that creates a <see cref="GraphObj"/> with the specified position and <see cref="CoordType"/>.  Other properties are set to default
        /// values as defined in the <see cref="Default"/> class.
        /// </summary>
        /// <remarks>
        /// The two coordinates define the location point for the object. The units of the coordinates are specified by the
        /// <see cref="Graph.Location.CoordinateFrame"/> property.
        /// </remarks>
        /// <param name="x">
        /// The x position of the item.  The item will be aligned to this position based on the <see cref="AlignH"/>
        /// property.
        /// </param>
        /// <param name="y">
        /// The y position of the item.  The item will be aligned to this position based on the
        /// <see cref="AlignV"/> property.
        /// </param>
        ...
        /// <remarks>schema changed to 2 when isClippedToChartRect was added.</remarks>
