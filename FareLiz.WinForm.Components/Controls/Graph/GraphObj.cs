...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
	...
	#region Properties
		/// <summary>
		/// The <see cref="Graph.Location"/> struct that describes the location
		...
		/// the same <see cref="Graph.ZOrder"/> value is controlled by their order in
		/// the <see cref="GraphObjList"/>.  The first <see cref="GraphObj"/>
		/// in the list is drawn in front of other <see cref="GraphObj"/>
		/// objects having the same <see cref="Graph.ZOrder"/> value.</remarks>
	...
	#region Constructors
		...
		/// <see cref="Graph.Location.CoordinateFrame"/> property.  The text will be
