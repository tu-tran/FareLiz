...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
	...
	#region Properties
		...
		/// <summary>
		/// Gets or sets the <see cref="Graph.MasterPane"/> property for the control
		/// </summary>
		...
		*/
		...
		/// <summary>
		/// Gets or sets the <see cref="Graph.GraphPane"/> property for the control
		/// </summary>
		/// <remarks>
		...
		/// a given <see cref="CurveItem" /> to drag it to a new location.  The Mouse and ConfiguredType
		...
		/// <b>In most cases, you will probably want to disable
		/// <see cref="Graph.GraphPane.IsBoundedRanges" /> before activating this option.</b>
		/// </remarks>
		...
		/// in the <see cref="Graph.GraphPane.YAxisList" />.  Each ordinal location in
		/// <see cref="YScrollRangeList" /> corresponds to an equivalent ordinal location
		/// in <see cref="Graph.GraphPane.YAxisList" />.
		/// </remarks>
		...
		/// <remarks>
		/// This list maintains the user scale ranges for the scroll bars for each axis
		/// in the <see cref="Graph.GraphPane.Y2AxisList" />.  Each ordinal location in
		/// <see cref="Y2ScrollRangeList" /> corresponds to an equivalent ordinal location
		/// in <see cref="Graph.GraphPane.Y2AxisList" />.
		/// </remarks>
		/// <seealso cref="ScrollMinY2" />
		/// <seealso cref="ScrollMaxY2" />
		[Bindable( true ), Category( "Display" ), NotifyParentProperty( true )]
