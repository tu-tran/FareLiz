...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>The Axis class is an abstract base class that encompasses all properties and methods required to define a graph Axis.</summary>
    /// <remarks>
    /// This class is inherited by the
    /// <see cref="XAxis" />, <see cref="YAxis" />, and <see cref="Y2Axis" /> classes to define specific characteristics for those types.
    /// </remarks>
    ...
    public abstract class Axis : ISerializable, ICloneable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="Axis" /> class.</summary>
        public struct Default
        {
            /// <summary>The default size for the gap between multiple axes (<see cref="Axis.AxisGap" /> property). Units are in points (1/72 inch).</summary>
            public static float AxisGap = 5;

            /// <summary>The default setting for the gap between the scale labels and the axis title.</summary>
            public static float TitleGap = 0.0f;

            /// <summary>
            /// The default font family for the <see cref="Axis" /> <see cref="Title" /> text font specification <see cref="FontSpec" />
            /// (<see cref="FontSpec.Family" /> property).
            /// </summary>
            public static string TitleFontFamily = SystemFonts.CaptionFont.Name;

            /// <summary>
            /// The default font size for the <see cref="Axis" /> <see cref="Title" /> text font specification <see cref="FontSpec" />
            /// (<see cref="FontSpec.Size" /> property).  Units are in points (1/72 inch).
            /// </summary>
            public static float TitleFontSize = 14;

            /// <summary>
            /// The default font color for the <see cref="Axis" /> <see cref="Title" /> text font specification <see cref="FontSpec" />
            /// (<see cref="FontSpec.FontColor" /> property).
            /// </summary>
            public static Color TitleFontColor = Color.Black;

            /// <summary>
            /// The default font bold mode for the <see cref="Axis" /> <see cref="Title" /> text font specification <see cref="FontSpec" />
            /// (<see cref="FontSpec.IsBold" /> property). true for a bold typeface, false otherwise.
            /// </summary>
            public static bool TitleFontBold = true;

            /// <summary>
            /// The default font italic mode for the <see cref="Axis" /> <see cref="Title" /> text font specification <see cref="FontSpec" />
            /// (<see cref="FontSpec.IsItalic" /> property). true for an italic typeface, false otherwise.
            /// </summary>
            public static bool TitleFontItalic = false;

            /// <summary>
            /// The default font underline mode for the <see cref="Axis" /> <see cref="Title" /> text font specification <see cref="FontSpec" />
            ...
            /// <summary>The default color for filling in the <see cref="Title" /> text background (see <see cref="Fill.Color" /> property).</summary>
            public static Color TitleFillColor = Color.White;

            /// <summary>The default custom brush for filling in the <see cref="Title" /> text background (see <see cref="Fill.Brush" /> property).</summary>
            public static Brush TitleFillBrush = null;

            /// <summary>The default fill mode for filling in the <see cref="Title" /> text background (see <see cref="Fill.Type" /> property).</summary>
            public static FillType TitleFillType = FillType.None;

            /// <summary>The default color for the <see cref="Axis" /> itself (<see cref="Axis.Color" /> property).  This color only affects the the axis border.</summary>
            public static Color BorderColor = Color.Black;

            /// <summary>The default value for <see cref="Axis.IsAxisSegmentVisible" />, which determines whether or not the scale segment itself is visible</summary>
            public static bool IsAxisSegmentVisible = true;

            /// <summary>
            /// The default setting for the <see cref="Axis" /> scale axis type (<see cref="Axis.Type" /> property).  This value is set as per the
            /// <see cref="AxisType" /> enumeration
            /// </summary>
            public static AxisType Type = AxisType.Linear;

            /// <summary>The default color for the axis segment.</summary>
            public static Color Color = Color.Black;

            /// <summary>
            /// The default setting for the axis space allocation.  This term, expressed in points (1/72 inch) and scaled according to
            /// <see cref="PaneBase.CalcScaleFactor" /> for the
            /// <see cref="GraphPane" />, determines the minimum amount of space an axis must have between the <see cref="Chart.Rect" /> and the
            /// <see cref="PaneBase.Rect" />.  This minimum space applies whether <see cref="Axis.IsVisible" /> is true or false.
            /// </summary>
        ...
        /// <summary>
        /// private field that stores the <see cref="Graph.Scale" /> class, which implements all the calculations and methods associated with the numeric scale
        /// for this
        ...
        /// <summary>
        /// Private field that stores the <see cref="Graph.MinorTic" /> class, which handles all the minor tic information.  See the public property
        /// <see cref="MinorTic" /> to access this class.
        /// </summary>
        internal MinorTic _minorTic;

        /// <summary>
        /// Private field that stores the <see cref="Graph.MajorTic" /> class, which handles all the major tic information.  See the public property
        /// <see cref="MajorTic" /> to access this class.
        /// </summary>
        internal MajorTic _majorTic;

        /// <summary>
        /// Private field that stores the <see cref="Graph.MajorGrid" /> class, which handles all the major grid information.  See the public property
        /// <see cref="MajorGrid" /> to access this class.
        /// </summary>
        internal MajorGrid _majorGrid;

        /// <summary>
        /// Private field that stores the <see cref="Graph.MinorGrid" /> class, which handles all the minor grid information.  See the public property
        /// <see cref="MinorGrid" /> to access this class.
        /// </summary>
        internal MinorGrid _minorGrid;

        /// <summary>
        /// Private fields for the <see cref="Axis" /> scale rendering properties. Use the public properties <see cref="Cross" /> and
        /// <see cref="Graph.Scale.BaseTic" />
        /// for access to these values.
        /// </summary>
        internal double _cross;

        /// <summary>
        /// Private field for the <see cref="Axis" /> automatic cross position mode. Use the public property <see cref="CrossAuto" /> for access to
        /// this value.
        /// </summary>
        internal bool _crossAuto;

        /// <summary>
        /// Private fields for the <see cref="Axis" /> attributes. Use the public properties <see cref="IsVisible" />, <see cref="IsAxisSegmentVisible" />
        /// for access to these values.
        /// </summary>
        ...
        /// <summary> Private field for the <see cref="Axis" /> title string. Use the public property <see cref="Title" /> for access to this value.</summary>
        protected AxisLabel _title;

        /// <summary>
        /// A tag object for use by the user.  This can be used to store additional information associated with the <see cref="Axis" />.  ZedGraph does not use
        /// this value for any purpose.
        /// </summary>
        /// <remarks>
        ...
        /// <summary> Private field for the <see cref="Axis" /> drawing dimensions. Use the public property <see cref="AxisGap" />
        /// for access to these values. </summary>
        private float _axisGap;

        /// <summary>
        /// Private field for the <see cref="Axis" /> minimum allowable space allocation. Use the public property <see cref="MinSpace" /> to access this
        /// value.
        /// </summary>
        /// <seealso cref="Default.MinSpace" />
        private float _minSpace;

        /// <summary> Private fields for the <see cref="Axis" /> colors. Use the public property <see cref="Color" /> for access to this values.</summary>
        private Color _color;

        /// <summary>Temporary values for axis space calculations (see <see cref="CalcSpace" />).</summary>
        ...
        /// <summary>A delegate that allows full custom formatting of the Axis labels</summary>
        /// <param name="pane">The <see cref="GraphPane" /> for which the label is to be formatted</param>
        ...
        /// <returns>A string value representing the label, or null if the ZedGraph should go ahead and generate the label according to the current settings</returns>
        /// <seealso cref="ScaleFormatEvent" />
        public delegate string ScaleFormatHandler(GraphPane pane, Axis axis, double val, int index);

        /// <summary>Subscribe to this event to handle custom formatting of the scale labels.</summary>
        public event ScaleFormatHandler ScaleFormatEvent;

        // Revision: JCarpenter 10/06
        /// <summary>Allow customization of title based on user preferences.</summary>
        /// <param name="axis">The <see cref="Axis" /> of interest.</param>
        /// <returns>
        /// A string value representing the label, or null if the ZedGraph should go ahead and generate the label according to the current settings.  To make the
        /// title blank, return "".
        /// </returns>
        /// <seealso cref="ScaleFormatEvent" />
        ...
        // Revision: JCarpenter 10/06
        /// <summary>Allow customization of the title when the scale is very large Subscribe to this event to handle custom formatting of the scale axis label.</summary>
        ...
        /// Constructor for <see cref="Axis"/> that sets all axis properties to default values as defined in the <see cref="Default"/> class, except for the
        /// <see cref="Title"/>.
        /// </summary>
        /// <param name="title">
        ...
        /// <summary>Gets the <see cref="Scale" /> instance associated with this <see cref="Axis" />.</summary>
        public Scale Scale
        {
            get
            {
        ...
        /// <summary>Gets or sets the scale value at which this axis should cross the "other" axis.</summary>
        /// <remarks>
        /// This property allows the axis to be shifted away from its default location. For example, for a graph with an X range from -100 to +100, the Y Axis
        /// can be located at the X=0 value rather than the left edge of the ChartRect.  This value can be set automatically based on the RequestState of
        /// <see cref="CrossAuto" />.  If this value is set manually, then <see cref="CrossAuto" /> will also be set to false.  The "other" axis is the axis the
        /// handles the second dimension for the graph.  For the XAxis, the "other" axis is the YAxis.  For the YAxis or Y2Axis, the "other" axis is the XAxis.
        /// </remarks>
        /// <value> The value is defined in user scale units </value>
        /// <seealso cref="Graph.Scale.Min" />
        /// <seealso cref="Graph.Scale.Max" />
        /// <seealso cref="Graph.Scale.MajorStep" />
        ...
        /// <summary>Gets or sets a value that determines whether or not the <see cref="Cross" /> value is set automatically.</summary>
        /// <value>
        /// Set to true to have ZedGraph put the axis in the default location, or false to specify the axis location manually with a <see cref="Cross" />
        /// value.
        /// </value>
        /// <seealso cref="Graph.Scale.Min" />
        /// <seealso cref="Graph.Scale.Max" />
        ...
        /// <summary>Gets or sets the minimum axis space allocation.</summary>
        /// <remarks>
        /// This term, expressed in points (1/72 inch) and scaled according to <see cref="PaneBase.CalcScaleFactor" />
        /// for the <see cref="GraphPane" />, determines the minimum amount of space an axis must have between the <see cref="Chart.Rect">Chart.Rect</see> and
        /// the
        /// <see cref="PaneBase.Rect">GraphPane.Rect</see>.  This minimum space applies whether <see cref="IsVisible" /> is true or false.
        /// </remarks>
        ...
        /// <summary>The color to use for drawing this <see cref="Axis" />.</summary>
        /// <remarks>
        /// This affects only the axis segment (see <see cref="IsAxisSegmentVisible" />), since the <see cref="Title" />,
        ...
        /// <summary>
        /// Gets a reference to the <see cref="Graph.MajorTic" /> class instance for this <see cref="Axis" />.  This class stores all the major tic
        /// settings.
        /// </summary>
        ...
        /// <summary>
        /// Gets a reference to the <see cref="Graph.MinorTic" /> class instance for this <see cref="Axis" />.  This class stores all the minor tic
        /// settings.
        /// </summary>
        ...
        /// <summary>Gets a reference to the <see cref="MajorGrid" /> class that contains the properties of the major grid.</summary>
        ...
        /// <summary>Gets a reference to the <see cref="MinorGrid" /> class that contains the properties of the minor grid.</summary>
        ...
        /// <summary>This property determines whether or not the <see cref="Axis" /> is shown.</summary>
        /// <remarks>Note that even if the axis is not visible, it can still be actively used to draw curves on a graph, it will just be invisible to the user</remarks>
        ...
        /// <summary>Gets or sets a property that determines whether or not the axis segment (the line that represents the axis itself) is drawn.</summary>
        /// <remarks>
        /// Under normal circumstances, this value won't affect the appearance of the display because the Axis segment is overlain by the Axis border (see
        /// <see cref="Chart.Border" />). However, when the border is not visible, or when <see cref="Axis.CrossAuto" /> is set to false, this value will make a
        /// difference.
        /// </remarks>
        public bool IsAxisSegmentVisible
        {
            get
            {
                return this._isAxisSegmentVisible;
            }
        ...
        /// <summary>Gets or sets the <see cref="AxisType" /> for this <see cref="Axis" />.</summary>
        /// <remarks>The type can be either <see cref="AxisType.Linear" />,
        /// <see cref="AxisType.Log" />, <see cref="AxisType.Date" />, or <see cref="AxisType.Text" />.</remarks>
        /// <seealso cref="Graph.Scale.IsLog" />
        /// <seealso cref="Graph.Scale.IsText" />
        /// <seealso cref="Graph.Scale.IsOrdinal" />
        /// <seealso cref="Graph.Scale.IsDate" />
        /// <seealso cref="Graph.Scale.IsReverse" />
        ...
        /// </summary>
        /// <remarks>
        /// The title normally shows the basis and dimensions of the scale range, such as "Time (Years)".  The title is only shown if the
        /// <see cref="Label.IsVisible" /> property is set to true.  If the Title text is empty, then no title is shown, and no space is "reserved" for the title
        /// on the graph.
        /// </remarks>
        ...
        /// <summary>The size of the gap between multiple axes (see <see cref="GraphPane.YAxisList" /> and
        /// <see cref="GraphPane.Y2AxisList" />).</summary>
        /// <remarks>This size will be scaled according to the <see cref="PaneBase.CalcScaleFactor" /> for the
        /// <see cref="GraphPane" />
        /// </remarks>
        ...
        /// </summary>
        /// <remarks>
        /// The currently required space is calculated using <see cref="CalcSpace"/>, and is based on current data ranges, font sizes, etc.  The "space" is
        /// actually the amount of space required to fit the tic marks, scale labels, and axis title.
        /// </remarks>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        /// </param>
        ...
        /// <summary>
        /// Calculate the "shift" size, in pixels, in order to shift the axis from its default location to the value specified by <see cref="Cross"/>.
        /// </summary>
        /// <param name="pane">
        /// A reference to the <see cref="GraphPane"/> object that is the parent or owner of this object.
        /// </param>
        ...
        /// <see cref="Cross"/>, <see cref="CrossAuto"/>, and <see cref="Graph.Scale.IsReverse"/>.
        /// </summary>
        /// <param name="pane">
        /// The pane.
        /// </param>
        /// <remarks>
        /// If the value of <see cref="Cross"/> lies outside the axis range, it is limited to the axis range.
        /// </remarks>
        /// <returns>
        /// The <see cref="double"/>.
        /// </returns>
        ...
        /// <summary>
        /// Calculates the proportional fraction of the total cross axis width at which this axis is located.
        /// </summary>
        /// <param name="pane">
        /// </param>
        /// <returns>
        ...
        /// </summary>
        /// <remarks>
        /// This is the total space (vertical space for the X axis, horizontal space for the Y axes) required to contain the axis.  If <see cref="Cross"/> is
        /// zero, then this space will be the space required between the <see cref="Chart.Rect"/> and the <see cref="PaneBase.Rect"/>.  This method sets the
        /// internal values of
        ...
        /// The amount of space (pixels) at the edge of the ChartRect that is always required for this axis, even if the axis is shifted by the
        ...
        public float CalcSpace(Graphics g, GraphPane pane, float scaleFactor, out float fixedSpace)
        {
            ...
            if (this._isVisible)
            {
                bool hasTic = this.MajorTic.IsOutside || this.MajorTic._isCrossOutside || this.MinorTic.IsOutside || this.MinorTic._isCrossOutside;
                ...
                this._tmpSpace += this._scale.GetScaleMaxSpace(g, pane, scaleFactor, true).Height + scaledLabelGap;
                ...
                if (!string.IsNullOrEmpty(str) && this._title._isVisible)
                {
                    ...
                    fixedSpace = this.Title.FontSpec.BoundingBox(g, str, scaleFactor).Height + scaledTitleGap;
            ...
            if (this.IsPrimary(pane)
                && (((this is YAxis
                     ...
                     || (this is Y2Axis
                         && ((!pane.XAxis._scale._isSkipFirstLabel && pane.XAxis._scale._isReverse)
                             || (!pane.XAxis._scale._isSkipLastLabel && !pane.XAxis._scale._isReverse)))) && pane.XAxis.IsVisible
                    && pane.XAxis._scale._isVisible))
            {
        ...
        /// </summary>
        /// <remarks>
        /// On entry, it is assumed that the graphics transform has been configured so that the origin is at the left side of this axis, and the axis is aligned
        ...
        public void DrawTitle(Graphics g, GraphPane pane, float shiftPos, float scaleFactor)
        {
            ...
            if (this._isVisible && this._title._isVisible && !string.IsNullOrEmpty(str))
            {
                bool hasTic = this._scale._isLabelsInside
                                   ? (this.MajorTic.IsInside || this.MajorTic._isCrossInside || this.MinorTic.IsInside || this.MinorTic._isCrossInside)
                ...
                // rely on ChartRect).
                float gap = scaledTic * (hasTic ? 1.0f : 0.0f) + this.Title.FontSpec.BoundingBox(g, str, scaleFactor).Height / 2.0F;
                float y = this._scale._isVisible ? this._scale.GetScaleMaxSpace(g, pane, scaleFactor, true).Height + scaledLabelGap : 0;
                ...
                // Draw the title
                this.Title.FontSpec.Draw(g, pane, str, x, y, AlignH.Center, alignV, scaleFactor);
            }
        }
        ...
        private string MakeTitle()
        {
            ...
            {
                this._title._text = string.Empty;
            }
        ...
        /// </summary>
        /// <remarks>
        /// This method properly accounts for <see cref="Graph.Scale.IsLog"/>,
        /// <see cref="Graph.Scale.IsText"/>, and other axis format settings.  It also implements the ScaleFormatEvent such that custom labels can be created.
        /// </remarks>
        /// <param name="pane">
        /// A reference to the <see cref="GraphPane"/> object that is the parent or owner of this object.
        /// </param>
        ...
        /// </param>
        /// <param name="dVal">
        /// The numeric value associated with the label.  This value is ignored for log (<see cref="Graph.Scale.IsLog"/>) and text (
        /// <see cref="Graph.Scale.IsText"/>) type axes.
        /// </param>
        /// <returns>
