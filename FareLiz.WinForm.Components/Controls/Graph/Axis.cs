...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
	...
	#region Class Fields
		...
		/// <summary>
		/// private field that stores the <see cref="Graph.Scale" /> class, which implements all the
		...
		/// Use the public properties <see cref="Cross"/> and <see cref="Graph.Scale.BaseTic"/>
	...
	#region Defaults
		...
		public struct Default
		{
			...
			/// </summary>
            public static string TitleFontFamily = System.Drawing.SystemFonts.CaptionFont.Name;
			/// <summary>
	...
	#region Scale Properties
		...
		/// automatically based on the RequestState of <see cref="CrossAuto"/>.  If
	...
	#region Tic Properties
		...
		/// <summary>
		/// Gets a reference to the <see cref="Graph.MajorTic" /> class instance
		...
		/// <summary>
		/// Gets a reference to the <see cref="Graph.MinorTic" /> class instance
...
//		abstract internal float GetMinPix( GraphPane pane );
		...
		/// (<see cref="Graph.Scale.IsLog"/>)
		/// and text (<see cref="Graph.Scale.IsText"/>) type axes.
		/// </param>
