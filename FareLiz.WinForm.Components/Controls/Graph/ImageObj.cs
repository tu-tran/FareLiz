...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    public class ImageObj : GraphObj, ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="ImageObj" /> class.</summary>
        public new struct Default
        {
            // Default text item properties
            /// <summary>Default value for the <see cref="ImageObj" />
            /// <see cref="ImageObj.IsScaled" /> property.</summary>
        ...
        /// <summary>Private field that stores the image.  Use the public property <see cref="Image" />
        /// to access this value.</summary>
        private Image _image;

        /// <summary>Private field that determines if the image will be scaled to the output rectangle.</summary>
        /// <value>true to scale the image, false to draw the image unscaled, but clipped to the destination rectangle</value>
        ...
        /// <summary>The <see cref="System.Drawing.Image" /> object.</summary>
        ...
        /// <summary>Gets or sets a property that determines if the image will be scaled to the output rectangle (see <see cref="Location" />).</summary>
        /// <value>true to scale the image, false to draw the image unscaled, but clipped to the destination rectangle</value>
        ...
        /// </overloads>
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageObj"/> class. A default constructor that places a null <see cref="System.Drawing.Image"/> at a default <see cref="RectangleF"/> of (0,0,1,1)
        /// </summary>
        public ImageObj()
            : this(null, 0, 0, 1, 1)
        {
        ...
        /// </summary>
        /// <param name="image">
        /// A <see cref="System.Drawing.Image"/> class that defines the image
        /// </param>
        /// <param name="rect">
        /// A <see cref="RectangleF"/> struct that defines the image location, specifed in units based on the
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ImageObj"/> class. 
        /// A constructor that allows the <see cref="System.Drawing.Image"/> and individual <see cref="System.Single"/> coordinate locations for the
        /// <see cref="ImageObj"/> to be pre-specified.
        /// </summary>
        /// <param name="image">
        /// A <see cref="System.Drawing.Image"/> class that defines the image
        ...
        /// <see cref="ArrowObj"/>.  The bounding box is calculated assuming a distance of <see cref="GraphPane.Default.NearestTol"/> pixels around the arrow
        /// segment.
        /// </summary>
        /// <param name="pt">
