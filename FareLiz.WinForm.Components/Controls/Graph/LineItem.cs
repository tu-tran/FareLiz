...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>Encapsulates a curve type that is displayed as a line and/or a set of symbols at each point.</summary>
    ...
    public class LineItem : CurveItem, ICloneable, ISerializable
    {
        ...
        /// <summary>
        /// Private field that stores a reference to the <see cref="Graph.Symbol" />
        /// class defined for this <see cref="LineItem" />.  Use the public property <see cref="Symbol" /> to access this value.
        /// </summary>
        protected Symbol _symbol;

        /// <summary>
        /// Private field that stores a reference to the <see cref="Graph.Line" />
        /// class defined for this <see cref="LineItem" />.  Use the public property <see cref="Line" /> to access this value.
        /// </summary>
        ...
        /// <summary>Gets or sets the <see cref="Graph.Symbol" /> class instance defined for this <see cref="LineItem" />.</summary>
        ...
        /// <summary>Gets or sets the <see cref="Graph.Line" /> class instance defined for this <see cref="LineItem" />.</summary>
        public Line Line
        {
            get
            {
