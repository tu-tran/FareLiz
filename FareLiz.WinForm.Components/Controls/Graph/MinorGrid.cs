...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>Class that holds the specific properties for the minor grid.</summary>
    ...
    public class MinorGrid : ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="MinorGrid" /> class.</summary>
        public struct Default
        {
            /// <summary>
            /// The default "dash on" size for drawing the <see cref="Axis" /> minor grid (<see cref="MinorGrid.DashOn" /> property). Units are in points
            /// (1/72 inch).
            /// </summary>
            public static float DashOn = 1.0F;

            /// <summary>
            /// The default "dash off" size for drawing the <see cref="Axis" /> minor grid (<see cref="MinorGrid.DashOff" /> property). Units are in points (1/72
            /// inch).
            /// </summary>
            public static float DashOff = 10.0F;

            /// <summary>
            /// The default pen width for drawing the <see cref="Axis" /> minor grid (<see cref="MinorGrid.PenWidth" /> property). Units are in points (1/72
            /// inch).
            /// </summary>
            public static float PenWidth = 1.0F;

            /// <summary>
            /// The default color for the <see cref="Axis" /> minor grid lines (<see cref="MinorGrid.Color" /> property).  This color only affects the minor grid
            /// lines.
            /// </summary>
            public static Color Color = Color.Gray;

            /// <summary>
            /// The default display mode for the <see cref="Axis" /> minor grid lines (<see cref="MinorGrid.IsVisible" /> property). true to show the minor grid
            /// lines, false to hide them.
            /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MinorGrid"/> class. Default constructor
        /// </summary>
        public MinorGrid()
        {
        ...
        /// <summary>Gets or sets a value that determines if the major <see cref="Axis" /> gridlines (at each labeled value) will be visible</summary>
        ...
        /// <summary>The "Dash On" mode for drawing the grid.</summary>
        /// <remarks>This is the distance, in points (1/72 inch), of the dash segments that make up the dashed grid lines.</remarks>
        ...
        /// <summary>The "Dash Off" mode for drawing the grid.</summary>
        /// <remarks>This is the distance, in points (1/72 inch), of the spaces between the dash segments that make up the dashed grid lines.</remarks>
        ...
        /// <summary>The pen width used for drawing the grid lines.</summary>
        ...
        /// <summary>The color to use for drawing this <see cref="Axis" /> grid.</summary>
