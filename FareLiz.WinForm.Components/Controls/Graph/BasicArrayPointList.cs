...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A data collection class for ZedGraph, provided as an alternative to <see cref="PointPairList" />.</summary>
    /// <remarks>
    ...
    public class BasicArrayPointList : IPointList
    {
        ...
        /// <summary>Returns the number of points available in the arrays.  Count will be the greater of the lengths of the X and Y arrays.</summary>
        public int Count
        {
            get
            {
