...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>Class <see cref="GraphPane" /> encapsulates the graph pane, which is all display elements associated with an individual graph.</summary>
    /// <remarks>
    /// This class is the outside "wrapper" for the ZedGraph classes, and provides the interface to access the attributes of the graph.  You can have
    /// multiple graphs in the same document or form, just instantiate multiple GraphPane's.
    /// </remarks>
    ...
    public class GraphPane : PaneBase, ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="GraphPane" /> class.</summary>
        public new struct Default
        {
            /// <summary>
            /// The default settings for the <see cref="Axis" /> scale ignore initial zero values option (<see cref="GraphPane.IsIgnoreInitial" /> property). true to
            /// have the auto-scale-range code ignore the initial data points until the first non-zero Y value, false otherwise.
            /// </summary>
            public static bool IsIgnoreInitial = false;

            /// <summary>
            /// The default settings for the <see cref="Axis" /> scale bounded ranges option (<see cref="GraphPane.IsBoundedRanges" /> property). true to have the
            /// auto-scale-range code subset the data according to any manually set scale values, false otherwise.
            /// </summary>
            public static bool IsBoundedRanges = false;

            /// <summary>
            /// The default value for the <see cref="GraphPane.LineType" /> property, which determines if the lines are drawn in normal or "stacked" mode.  See the
            /// <see cref="Graph.LineType" /> for more information.
            /// </summary>
            /// <seealso cref="GraphPane.LineType" />
            public static LineType LineType = LineType.Normal;

            /// <summary>
            /// The default width of a bar cluster on a <see cref="Bar" /> graph.  This value only applies to
            /// <see cref="Bar" /> graphs, and only when the
            /// <see cref="Axis.Type" /> is <see cref="AxisType.Linear" />,
            /// <see cref="AxisType.Log" /> or <see cref="AxisType.Date" />. This dimension is expressed in terms of X scale user units.
            /// </summary>
            /// <seealso cref="BarSettings.Default.MinClusterGap" />
            /// <seealso cref="BarSettings.MinBarGap" />
            public static double ClusterScaleWidth = 1.0;

            /// <summary>
            /// The tolerance that is applied to the
            /// <see cref="GraphPane.FindNearestPoint(PointF,out CurveItem,out int)" /> routine. If a given curve point is within this many pixels of the mousePt,
            /// the curve point is considered to be close enough for selection as a nearest point candidate.
            /// </summary>
        ...
        /// <summary>A delegate to provide notification through the <see cref="AxisChangeEvent" />
        /// when <see cref="AxisChange()" /> is called.</summary>
        /// <param name="pane">The <see cref="GraphPane" /> for which AxisChange() has been called.</param>
        /// <seealso cref="AxisChangeEvent" />
        public delegate void AxisChangeEventHandler(GraphPane pane);

        /// <summary>Subscribe to this event to be notified when <see cref="AxisChange()" /> is called.</summary>
        ...
        /// <summary>
        /// Private field instance of the <see cref="Graph.XAxis" /> class.  Use the public property <see cref="GraphPane.XAxis" /> to access this
        /// class.
        /// </summary>
        private XAxis _xAxis;

        /// <summary>
        /// Private field instance of the <see cref="Graph.XAxis" /> class.  Use the public property <see cref="GraphPane.X2Axis" /> to access this
        /// class.
        /// </summary>
        private X2Axis _x2Axis;

        /// <summary>
        /// Private field instance of the <see cref="Graph.YAxisList" /> class.  Use the public property <see cref="GraphPane.YAxisList" /> to access
        /// this class.
        /// </summary>
        private YAxisList _yAxisList;

        /// <summary>
        /// Private field instance of the <see cref="Graph.Y2AxisList" /> class.  Use the public property <see cref="GraphPane.Y2AxisList" /> to access
        /// this class.
        /// </summary>
        private Y2AxisList _y2AxisList;

        /// <summary>
        /// Private field instance of the <see cref="Graph.CurveList" /> class.  Use the public property <see cref="GraphPane.CurveList" /> to access
        /// this class.
        /// </summary>
        ...
        /// <see cref="ZoomState" /> objects containing scale range information.  This enables zooming and panning functionality for the
        ...
        /// <summary>
        /// Private field that determines whether or not initial zero values will be included or excluded when determining the Y or Y2 axis scale range. Use the
        /// public property <see cref="IsIgnoreInitial" /> to access this value.
        /// </summary>
        private bool _isIgnoreInitial;

        /// <summary>
        /// Private field that determines whether or not initial
        /// <see cref="PointPairBase.Missing" /> values will cause the line segments of a curve to be discontinuous.  If this field is true, then the curves will
        /// be plotted as continuous lines as if the Missing values did not exist. Use the public property <see cref="IsIgnoreMissing" /> to access this value.
        /// </summary>
        private bool _isIgnoreMissing;

        /// <summary>
        /// private field that determines if the auto-scaled axis ranges will subset the data points based on any manually set scale range values.  Use the
        /// public property
        /// <see cref="IsBoundedRanges" /> to access this value.
        /// </summary>
        /// <remarks>
        /// The bounds provide a means to subset the data.  For example, if all the axes are set to autoscale, then the full range of data are used.  But, if the
        /// XAxis.Min and XAxis.Max values are manually set, then the Y data range will reflect the Y values within the bounds of XAxis.Min and XAxis.Max.
        /// </remarks>
        private bool _isBoundedRanges;

        /// <summary>
        /// private field that determines if ZedGraph should modify the scale ranges for the Y and Y2 axes such that the number of steps, and therefore the grid
        /// lines, line up.  Use the public property <see cref="IsAlignGrids" /> to acccess this value.
        /// </summary>
        private bool _isAlignGrids;

        /// <summary>
        /// Private field that determines how the <see cref="LineItem" />
        /// graphs will be displayed. See the <see cref="Graph.LineType" /> enum for the individual types available. To access this value, use the public
        /// property <see cref="LineType" />.
        /// </summary>
        ...
        /// <summary>Gets or sets the list of <see cref="CurveItem" /> items for this <see cref="GraphPane" />
        /// </summary>
        ...
        /// <summary>Accesses the <see cref="XAxis" /> for this graph</summary>
        ...
        /// <summary>Accesses the <see cref="X2Axis" /> for this graph</summary>
        ...
        /// <summary>Accesses the primary <see cref="YAxis" /> for this graph</summary>
        ...
        public YAxis YAxis
        {
            get
            {
                return this._yAxisList[0];
            }
        }

        /// <summary>Accesses the primary <see cref="Y2Axis" /> for this graph</summary>
        ...
        public Y2Axis Y2Axis
        {
            get
            {
                return this._y2AxisList[0];
            }
        }

        /// <summary>Gets the collection of Y axes that belong to this <see cref="GraphPane" />.</summary>
        public YAxisList YAxisList
        {
            get
            {
                return this._yAxisList;
            }
        }

        /// <summary>Gets the collection of Y2 axes that belong to this <see cref="GraphPane" />.</summary>
        public Y2AxisList Y2AxisList
        {
            get
            {
                return this._y2AxisList;
            }
        }

        /// <summary>Gets the <see cref="Chart" /> instance for this <see cref="GraphPane" />.</summary>
        public Chart Chart
        {
            get
            {
        ...
        /// <summary>Gets the <see cref="BarSettings" /> instance for this <see cref="GraphPane" />, which stores the global properties for bar type charts.</summary>
        public BarSettings BarSettings
        {
            get
            {
                return this._barSettings;
            }
        }
        ...
        /// <summary>Gets or sets a boolean value that affects the data range that is considered for the automatic scale ranging.</summary>
        /// <remarks>
        /// If true, then initial data points where the Y value is zero are not included when automatically determining the scale <see cref="Scale.Min" />,
        ...
        /// <summary>
        /// Gets or sets a boolean value that determines if the auto-scaled axis ranges will subset the data points based on any manually set scale
        /// range values.
        /// </summary>
        /// <remarks>
        /// The bounds provide a means to subset the data.  For example, if all the axes are set to autoscale, then the full range of data are used.  But, if the
        /// XAxis.Min and XAxis.Max values are manually set, then the Y data range will reflect the Y values within the bounds of XAxis.Min and XAxis.Max.  Set
        /// to true to subset the data, or false to always include all data points when calculating scale ranges.
        /// </remarks>
        public bool IsBoundedRanges
        {
            get
            {
                return this._isBoundedRanges;
            }
        ...
        /// <see cref="PointPairBase.Missing" /> values will cause the line segments of a curve to be discontinuous.
        /// </summary>
        /// <remarks>
        /// If this field is true, then the curves will be plotted as continuous lines as if the Missing values did not exist. Use the public property
        /// <see cref="IsIgnoreMissing" /> to access this value.
        /// </remarks>
        public bool IsIgnoreMissing
        {
            get
            {
                return this._isIgnoreMissing;
            }
        ...
        /// <summary>
        /// Gets or sets a value that determines if ZedGraph should modify the scale ranges for the Y and Y2 axes such that the number of major steps, and
        /// therefore the major grid lines, line up.
        /// </summary>
        /// <remarks>
        /// This property affects the way that <see cref="AxisChange()" /> selects the scale ranges for the Y and Y2 axes.  It applies to the scale ranges of all
        /// Y and Y2 axes, but only if the <see cref="Scale.MaxAuto" /> is set to true.<br />
        /// </remarks>
        public bool IsAlignGrids
        {
            get
            {
                return this._isAlignGrids;
            }
        ...
        /// graphs will be displayed. See the <see cref="Graph.LineType" /> enum for the individual types available.</summary>
        /// <seealso cref="Default.LineType" />
        ...
        /// <summary>
        /// Gets a value that indicates whether or not the <see cref="ZoomStateStack" /> for this <see cref="GraphPane" /> is empty.  Note that this value is
        /// only used for the <see cref="ZedGraphControl" />.
        /// </summary>
        public bool IsZoomed
        {
            get
            {
                return !this._zoomStack.IsEmpty;
            }
        }

        /// <summary>Gets a reference to the <see cref="ZoomStateStack" /> for this <see cref="GraphPane" />.</summary>
        ...
        /// Default Constructor.  Sets the <see cref="PaneBase.Rect"/> to (0, 0, 500, 375), and sets the <see cref="PaneBase.Title"/> and
        /// <see cref="Axis.Title"/> values to empty strings.
        /// </summary>
        public GraphPane()
        ...
        /// <summary>AxisChange causes the axes scale ranges to be recalculated based on the current data range.</summary>
        /// <remarks>
        /// There is no obligation to call AxisChange() for manually scaled axes.  AxisChange() is only intended to handle auto scaling operations.  Call this
        /// function anytime you change, add, or remove curve data to insure that the scale range of the axes are appropriate for the data range. This method
        /// calculates a scale minimum, maximum, and step size for each axis based on the current curve data. Only the axis attributes (min, max, step) that are
        /// set to auto-range (<see cref="Scale.MinAuto" />, <see cref="Scale.MaxAuto" />, <see cref="Scale.MajorStepAuto" />) will be modified.  You must call
        /// <see cref="Control.Invalidate()" /> after calling AxisChange to make sure the display gets updated.<br />
        /// This overload of AxisChange just uses the default Graphics instance for the screen. If you have a Graphics instance available from your Windows Form,
        /// you should use the <see cref="AxisChange(Graphics)" /> overload instead.
        /// </remarks>
        public void AxisChange()
        {
            using (Graphics g = Graphics.FromHwnd(IntPtr.Zero)) this.AxisChange(g);
        }
        ...
        public void AxisChange(Graphics g)
        {
            ...
            this._curveList.GetRange(
                /* out xMin, out xMax, out yMin,
        ...
        /// </summary>
        /// <remarks>
        /// This method should be part of the Paint() update process.  Calling this routine will redraw all features of the graph.  No preparation is required
        /// other than an instantiated
        ...
        {
            bool showGraf = this._xAxis._scale._min < this._xAxis._scale._max && this._x2Axis._scale._min < this._x2Axis._scale._max;
            foreach (Axis axis in this._yAxisList)
            {
        ...
        /// <summary>
        /// Calculate the <see cref="Graph.Chart.Rect"/> based on the <see cref="PaneBase.Rect"/>.
        /// </summary>
        /// <remarks>
        ...
        /// is calculated using the currently required space multiplied by a fraction (<paramref>bufferFraction</paramref>). The currently required space is
        /// calculated using <see cref="Axis.CalcSpace"/>, and is based on current data ranges, font sizes, etc.  The "space" is actually the amount of space
        /// required to fit the tic marks, scale labels, and axis title. The calculation is done by calling the <see cref="Axis.SetMinSpaceBuffer"/> method for
        /// each <see cref="Axis"/>.
        /// </remarks>
        /// <param name="g">
        /// A graphic device object to be drawn into.  This is normally e.Graphics from the PaintEventArgs argument to the Paint() method.
        ...
        /// The amount of space to allocate for the axis, expressed as a fraction of the currently required space.  For example, a value of 1.2 would allow for
        /// 20% extra above the currently required space.
        /// </param>
        ...
        /// <summary>
        /// Add a curve (<see cref="CurveItem"/> object) to the plot with the given data points (double arrays) and properties. This is simplified way to add
        /// curves without knowledge of the
        ...
        /// <summary>
        /// Add a curve (<see cref="CurveItem"/> object) to the plot with the given data points (<see cref="IPointList"/>) and properties. This is simplified
        /// way to add curves without knowledge of the
        /// <see cref="CurveList"/> class.  An alternative is to use the <see cref="Graph.CurveList"/> Add() method.
        /// </summary>
        /// <param name="label">
        /// The text label (string) for the curve that will be used as a <see cref="Legend"/> entry.
        ...
        /// A symbol type (<see cref="SymbolType"/>) that will be used for this curve.
        /// </param>
        /// <returns>
        /// A <see cref="CurveItem"/> class for the newly created curve. This can then be used to access all of the curve properties that are not defined as
        /// arguments to the
        ...
        /// <summary>
        /// Add a stick graph (<see cref="StickItem"/> object) to the plot with the given data points (double arrays) and properties. This is simplified way to
        /// add curves without knowledge of the
        /// <see cref="CurveList"/> class.  An alternative is to use the <see cref="Graph.CurveList"/> Add() method.
        /// </summary>
        /// <param name="label">
        /// The text label (string) for the curve that will be used as a <see cref="Legend"/> entry.
        ...
        /// </param>
        /// <returns>
        /// A <see cref="StickItem"/> class for the newly created curve. This can then be used to access all of the curve properties that are not defined as
        /// arguments to the
        ...
        /// <summary>
        /// Add a stick graph (<see cref="StickItem"/> object) to the plot with the given data points (<see cref="IPointList"/>) and properties. This is
        ...
        /// <summary>
        /// Add a candlestick graph (<see cref="OHLCBarItem"/> object) to the plot with the given data points (<see cref="IPointList"/>) and
        /// properties.
        /// </summary>
        /// <remarks>
        ...
        /// </summary>
        /// <param name="value">
        /// The value associated with this <see cref="PieItem"/>item.
        /// </param>
        /// <param name="color">
        /// The display color for this <see cref="PieItem"/>item.
        /// </param>
        /// <param name="displacement">
        /// The amount this <see cref="PieItem"/>item will be displaced from the center of the <see cref="PieItem"/>.
        /// </param>
        /// <param name="label">
        /// Text label for this <see cref="PieItem"/>
        /// </param>
        /// <returns>
        /// a reference to the <see cref="PieItem"/> constructed
        /// </returns>
        ...
        /// This method implicitly assumes that <see cref="Graph.Chart.Rect"/>
        /// has already been calculated via <see cref="AxisChange()"/> or
        /// <see cref="Draw"/> methods, or the <see cref="Graph.Chart.Rect"/> is set manually (see <see cref="Graph.Chart.IsRectAuto"/>). Note that this
        /// method is more accurate than the <see cref="GeneralTransform(PointF,CoordType)"/>
        ...
        /// <summary>
        /// Return the user scale values that correspond to the specified screen coordinate position (pixels).  This overload assumes the default
        ...
        /// </param>
        /// <param name="y">
        /// The resultant value in user coordinates from the primary <see cref="YAxis"/>
        /// </param>
        ...
        /// </param>
        /// <param name="y2">
        /// The resultant value in user coordinates from the primary <see cref="Y2Axis"/>
        /// </param>
        ...
        /// The ordinal index of the Y or Y2 axis from which to return data (see 
        /// <seealso cref="YAxisList"/>
        /// ,
        /// <seealso cref="Y2AxisList"/>
        /// )
        ...
        /// </param>
        /// <param name="y">
        /// An array of resultant values in user coordinates from the list of <see cref="YAxis"/> instances.  This method allocates the array for you, according
        /// to the number of <see cref="YAxis"/> objects in the list.
        /// </param>
        /// <param name="y2">
        /// An array of resultant values in user coordinates from the list of <see cref="Y2Axis"/> instances.  This method allocates the array for you,
        /// according to the number of <see cref="Y2Axis"/> objects in the list.
        /// </param>
        public void ReverseTransform(PointF ptF, out double x, out double x2, out double[] y, out double[] y2)
        {
            // Setup the scaling data based on the chart rect
        ...
        /// <see cref="GraphObj"/>, and <see cref="CurveItem"/>. If the mouse point is within the bounding box of the items (or in the case of
        /// <see cref="ArrowObj"/> and <see cref="CurveItem"/>, within
        /// <see cref="Default.NearestTol"/> pixels), then the object will be returned. You must check the type of the object to determine what object was
        /// selected (for example, "if ( object is Legend ) ...").  The
        /// <see paramref="index"/> parameter returns the index number of the item within the selected object (such as the point number within a
        ...
        /// A reference to the nearest object to the specified screen point.  This can be any of <see cref="Axis"/>,
        /// <see cref="Legend"/>, <see cref="PaneBase.Title"/>,
        /// <see cref="TextObj"/>, <see cref="ArrowObj"/>, or <see cref="CurveItem"/>. Note: If the pane title is selected, then the <see cref="GraphPane"/>
        /// object will be returned.
        /// </param>
        /// <param name="index">
        /// The index number of the item within the selected object (where applicable).  For example, for a <see cref="CurveItem"/> object,
        /// <see paramref="index"/> will be the index number of the nearest data point, accessible via
        /// <see cref="CurveItem.Points">CurveItem.Points[index]</see>. index will be -1 if no data points are available.
        /// </param>
        /// <returns>
        ...
        public bool FindNearestObject(PointF mousePt, Graphics g, out object nearestObj, out int index)
        {
            ...
            if (this.AxisRangesValid())
            {
                ...
                if (saveZOrder <= ZOrder.B_BehindLegend && this.Legend.FindPoint(mousePt, this, scaleFactor, out index))
                {
                ...
                if (saveZOrder <= ZOrder.H_BehindAll && this._title._isVisible)
                {
                    tmpRect = new RectangleF(
                        (this._rect.Left + this._rect.Right - paneTitleBox.Width) / 2, 
                ...
                for (int yIndex = 0; yIndex < this._yAxisList.Count; yIndex++)
                {
                    ...
                    if (width > 0)
                    {
                        tmpRect = new RectangleF(left - width, tmpChartRect.Top, width, tmpChartRect.Height);
                ...
                for (int yIndex = 0; yIndex < this._y2AxisList.Count; yIndex++)
                {
                    ...
                    if (width > 0)
                    {
                        tmpRect = new RectangleF(left, tmpChartRect.Top, width, tmpChartRect.Height);
                        if (saveZOrder <= ZOrder.D_BehindAxis && tmpRect.Contains(mousePt))
                        {
                            nearestObj = y2Axis;
                            index = yIndex;
                ...
                tmpRect = new RectangleF(tmpChartRect.Left, tmpChartRect.Bottom, tmpChartRect.Width, height); // _rect.Bottom - tmpChartRect.Bottom );
                ...
                tmpRect = new RectangleF(tmpChartRect.Left, tmpChartRect.Top - height, tmpChartRect.Width, height);
                if (saveZOrder <= ZOrder.D_BehindAxis && tmpRect.Contains(mousePt))
                {
