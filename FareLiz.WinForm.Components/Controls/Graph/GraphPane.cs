...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
	...
	#region Private Fields
		...
		/// <summary>Private field instance of the <see cref="Graph.XAxis"/> class.  Use the
		...
		/// <summary>Private field instance of the <see cref="Graph.YAxisList"/> class.  Use the
		/// public property <see cref="GraphPane.YAxisList"/> to access this class.</summary>
		private YAxisList _yAxisList;
		/// <summary>Private field instance of the <see cref="Graph.Y2AxisList"/> class.  Use the
		/// public property <see cref="GraphPane.Y2AxisList"/> to access this class.</summary>
		private Y2AxisList _y2AxisList;
		/// <summary>Private field instance of the <see cref="Graph.CurveList"/> class.  Use the
		...
		/// graphs will be displayed. See the <see cref="Graph.LineType"/> enum
...
//			minSpaceT = Math.Max( minSpaceT, spaceT );
	...
	#region AddCurve Methods
		...
		/// the <see cref="Graph.CurveList" /> Add() method.
		/// </summary>
	...
	#region General Utility Methods
		...
		/// </summary>
		/// <remarks>This method implicitly assumes that <see cref="Graph.Chart.Rect"/>
		/// has already been calculated via <see cref="AxisChange()"/> or
		/// <see cref="Draw"/> methods, or the <see cref="Graph.Chart.Rect"/> is
		/// set manually (see <see cref="Graph.Chart.IsRectAuto"/>).</remarks>
		...
		/// has already been calculated via <see cref="AxisChange()"/> or
		/// <see cref="Draw"/> methods, or the <see cref="Graph.Chart.Rect"/> is
		/// set manually (see <see cref="Graph.Chart.IsRectAuto"/>).
