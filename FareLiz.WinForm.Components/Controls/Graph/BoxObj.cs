...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// A class that represents a bordered and/or filled box (rectangle) object on the graph.  A list of BoxObj objects is maintained by the
    ...
    public class BoxObj : GraphObj, ICloneable, ISerializable
    {
        ...
        {
            /// <summary>The default pen width used for the <see cref="BoxObj" /> border (<see cref="LineBase.Width" /> property).  Units are points (1/72 inch).</summary>
            public static float PenWidth = 1.0F;

            /// <summary>The default color used for the <see cref="BoxObj" /> border (<see cref="LineBase.Color" /> property).</summary>
            public static Color BorderColor = Color.Black;

            /// <summary>The default color used for the <see cref="BoxObj" /> fill (<see cref="Fill.Color" /> property).</summary>
        ...
        /// <see cref="BoxObj" />.  Use the public property <see cref="Fill" /> to access this value.
        /// </summary>
        ...
        /// <summary>Gets or sets the <see cref="Graph.Border" /> object, which determines the properties of the border around this
        /// <see cref="BoxObj" />
        /// </summary>
        ...
        /// A constructor that allows the position, border color, and solid fill color of the <see cref="BoxObj"/> to be pre-specified.
        /// </summary>
        /// <param name="x">
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BoxObj"/> class. 
        /// A constructor that allows the position of the <see cref="BoxObj"/> to be pre-specified.  Other properties are defaulted.
        /// </summary>
        /// <param name="x">
        /// The x location for this <see cref="BoxObj"/>.  This will be in units determined by
        /// <see cref="Location.CoordinateFrame"/>.
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BoxObj"/> class. 
        /// A default constructor that creates a <see cref="BoxObj"/> using a location of (0,0), and a width,height of (1,1).  Other properties are
        /// defaulted.
        /// </summary>
        public BoxObj()
            : this(0, 0, 1, 1)
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="BoxObj"/> class. 
        /// A constructor that allows the position, border color, and two-color gradient fill colors of the <see cref="BoxObj"/> to be pre-specified.
        /// </summary>
        /// <param name="x">
        /// The x location for this <see cref="BoxObj"/>.  This will be in units determined by
        /// <see cref="Location.CoordinateFrame"/>.
