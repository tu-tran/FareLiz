...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// Class that handles the data associated with a text title and its associated font properties.  Inherits from <see cref="Label" />, and adds the
    /// <see cref="Gap" />
    ...
    public class GapLabel : Label, ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="GapLabel" /> class.</summary>
        public struct Default
        {
            /// <summary>The default <see cref="GapLabel.Gap" /> setting.</summary>
        ...
        /// Constructor to build a <see cref="GapLabel"/> from the text and the associated font properties.
        /// </summary>
        /// <param name="text">
        ...
        /// <summary>Gets or sets the gap factor between this label and the opposing <see cref="Axis" />
        /// or <see cref="Chart" />.</summary>
        /// <remarks>This value is expressed as a fraction of the character height for the <see cref="GapLabel" />.</remarks>
        public float Gap
        {
            get
            {
