...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A collection class containing a list of <see cref="ScrollRange" /> objects.</summary>
    ...
    public class ScrollRangeList : List<ScrollRange>, ICloneable
    {
        ...
        /// <summary>
        /// Indexer to access the specified <see cref="ScrollRange"/> object by its ordinal position in the list.
        /// </summary>
        /// <param name="index">
		...
		*/
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ScrollRangeList"/> class. Default constructor for the collection class.
        /// </summary>
