...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A collection class containing a list of <see cref="StockPt" /> objects that define the set of points to be displayed on the curve.</summary>
    ...
    public class StockPointList : List<StockPt>, IPointList, IPointListEdit
    {
        ...
        /// <summary>
        /// Indexer to access the specified <see cref="StockPt"/> object by its ordinal position in the list.
        /// </summary>
        /// <param name="index">
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StockPointList"/> class. Default constructor for the collection class
        /// </summary>
        ...
        /// </summary>
        /// <param name="point">
        /// The <see cref="StockPt"/> object to be added
        /// </param>
        ...
        /// <summary>
        /// Add a <see cref="StockPt"/> object to the collection at the end of the list using the specified values.  The unspecified values (low, open, close)
        /// are all set to
        ...
        {
            this.Add(new StockPt(date, high, PointPairBase.Missing, PointPairBase.Missing, PointPairBase.Missing, PointPairBase.Missing));
        }
        ...
        /// <see cref="PointPair"/> rather than a <see cref="StockPt"/>.  This method will return the actual <see cref="StockPt"/> at the specified position.
        /// </remarks>
        /// <param name="index">
