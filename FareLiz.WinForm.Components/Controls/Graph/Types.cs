...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
	...
	public enum SymbolType 
	{
		...
		Circle,
		/// <summary> "X" shaped <see cref="Symbol"/>.  This symbol cannot
		/// be filled since it has no outline. </summary>
		XCross,
		/// <summary> "+" shaped <see cref="Symbol"/>.  This symbol cannot
		/// be filled since it has no outline. </summary>
		Plus,
		/// <summary> Asterisk-shaped <see cref="Symbol"/>.  This symbol
		/// cannot be filled since it has no outline. </summary>
		Star,
		/// <summary> Unilateral triangle <see cref="Symbol"/>, pointing
		/// down. </summary>
		TriangleDown,
		/// <summary>
		/// Horizontal dash <see cref="Symbol"/>.  This symbol cannot be
		/// filled since it has no outline.
		/// </summary>
		HDash,
		/// <summary>
		/// Vertical dash <see cref="Symbol"/>.  This symbol cannot be
		/// filled since it has no outline.
		/// </summary>
		VDash,
