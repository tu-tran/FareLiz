...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// A class containing a set of data values to be plotted as a RadarPlot. This class will effectively convert the data into <see cref="PointPair" />
    /// objects by converting the polar coordinates to rectangular coordinates
    /// </summary>
...
*/
        ...
        /// </param>
        /// <param name="z">
        /// The 'Z' coordinate value, which is not normally used for plotting, but can be used for <see cref="FillType.GradientByZ"/> type fills
        /// </param>
        public void Add(double r, double z)
        {
            this.Add(new PointPair(PointPairBase.Missing, r, z));
        }
        ...
        /// <summary>Default to clockwise rotation as this is the standard for radar charts</summary>
        private bool _clockwise = true;

        /// <summary>Default to 90 degree rotation so main axis is in the 12 o'clock position, which is the standard for radar charts.</summary>
        ...
        /// <summary>
        /// Indexer to access the specified <see cref="PointPair"/> object by its ordinal position in the list.  This method does the calculations to convert
        /// the data from polar to rectangular coordinates.
        /// </summary>
        /// <param name="index">
        ...
        public new PointPair this[int index]
        {
            get
            {
                ...
                double theta = rotationRadians + (this._clockwise ? -1.0d : 1.0d) * (index / (double)(count - 1) * 2.0 * Math.PI);
        ...
        /// <summary>Indicates if points should be added in clockwise or counter-clockwise order</summary>
        ...
        /// <summary>Sets the angular rotation (starting angle) for the initial axis</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="RadarPointList"/> class. Default Constructor
        /// </summary>
