...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A class representing a needle on the GasGuage chart
    /// <see cref="GasGaugeNeedle" />s.</summary>
    ...
    public class GasGaugeNeedle : CurveItem, ICloneable, ISerializable
    {
        ...
        /// <summary>Specify the default property values for the <see cref="GasGaugeNeedle" /> class.</summary>
        public struct Default
        {
            /// <summary>The default width of the gas gauge needle.  Units are points, scaled according to <see cref="PaneBase.CalcScaleFactor" />
            /// </summary>
            public static float NeedleWidth = 10.0F;

            /// <summary>
            /// The default pen width to be used for drawing the border around the GasGaugeNeedle (<see cref="LineBase.Width" /> property). Units are
            /// points.
            /// </summary>
            public static float BorderWidth = 1.0F;

            /// <summary>The default border mode for GasGaugeNeedle (<see cref="LineBase.IsVisible" />
            /// property). true to display frame around GasGaugeNeedle, false otherwise</summary>
            public static bool IsBorderVisible = true;

            /// <summary>The default color for drawing frames around GasGaugeNeedle (<see cref="LineBase.Color" /> property).</summary>
            public static Color BorderColor = Color.Gray;

            /// <summary>The default fill type for filling the GasGaugeNeedle.</summary>
            public static FillType FillType = FillType.Brush;

            /// <summary>The default color for filling in the GasGaugeNeedle (<see cref="Fill.Color" /> property).</summary>
            public static Color FillColor = Color.Empty;

            /// <summary>The default custom brush for filling in the GasGaugeNeedle. (<see cref="Fill.Brush" /> property).</summary>
            public static Brush FillBrush = null;

            /// <summary>Default value for controlling <see cref="GasGaugeNeedle" /> display.</summary>
            ...
            /// <summary>
            /// The default font size for <see cref="GasGaugeNeedle.LabelDetail" /> entries (<see cref="FontSpec.Size" /> property). Units are in points
            /// (1/72 inch).
            /// </summary>
        ...
        /// <summary>TypeConfiguration of this needle</summary>
        private double _needleValue;

        /// <summary>Width of the line being drawn</summary>
        private float _needleWidth;

        /// <summary>Color of the needle line</summary>
        private Color _color;

        /// <summary>Internally calculated angle that places this needle relative to the MinValue and MaxValue of 180 degree GasGuage</summary>
        private float _sweepAngle;

        /// <summary>
        /// Private field that stores the <see cref="Graph.Fill" /> data for this
        /// <see cref="GasGaugeNeedle" />. Use the public property <see cref="Fill" /> to access this value.
        /// </summary>
        private Fill _fill;
        ...
        /// <summary>
        /// Private field that stores the <see cref="Border" /> class that defines the properties of the border around this <see cref="GasGaugeNeedle" />. Use
        /// the public property <see cref="Border" /> to access this value.
        /// </summary>
        private Border _border;

        /// <summary>The bounding rectangle for this <see cref="GasGaugeNeedle" />.</summary>
        private RectangleF _boundingRectangle;

        /// <summary>Private field to hold the GraphicsPath of this <see cref="GasGaugeNeedle" /> to be used for 'hit testing'.</summary>
        ...
        /// <summary>Gets or Sets the NeedleWidth of this <see cref="GasGaugeNeedle" />
        /// </summary>
        ...
        /// <summary>Gets or Sets the Border of this <see cref="GasGaugeNeedle" />
        /// </summary>
        ...
        /// <summary>Gets or Sets the SlicePath of this <see cref="GasGaugeNeedle" />
        /// </summary>
        ...
        /// <summary>Gets or Sets the LableDetail of this <see cref="GasGaugeNeedle" />
        /// </summary>
        ...
        /// <summary>Gets or Sets the NeedelColor of this <see cref="GasGaugeNeedle" />
        /// </summary>
        ...
        /// <summary>Gets or Sets the Fill of this <see cref="GasGaugeNeedle" />
        /// </summary>
        public Fill Fill
        {
            get
        ...
        /// <summary>Private property that Gets or Sets the SweepAngle of this <see cref="GasGaugeNeedle" />
        /// </summary>
        ...
        /// <summary>Gets or Sets the NeedleValue of this <see cref="GasGaugeNeedle" />
        /// </summary>
        ...
        /// <summary>
        /// Calculate the <see cref="RectangleF"/> that will be used to define the bounding rectangle of the GasGaugeNeedle.
        /// </summary>
        /// <remarks>
