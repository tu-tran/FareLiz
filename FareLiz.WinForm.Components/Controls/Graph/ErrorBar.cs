...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// This class handles the drawing of the curve <see cref="ErrorBar" /> objects. The Error Bars are the vertical lines with a symbol at each
    /// end.
    /// </summary>
    /// <remarks>
    /// To draw "I-Beam" bars, the symbol type defaults to
    /// <see cref="SymbolType.HDash" />, which is just a horizontal line. If <see cref="BarBase" /> is Y-oriented, then the symbol type should be set to
    /// <see cref="SymbolType.VDash" /> to get the same effect.
    /// </remarks>
    ...
    public class ErrorBar : ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="ErrorBar" /> class.</summary>
        public struct Default
        {
            ...
            /// <summary>The default pen width to be used for drawing error bars (<see cref="ErrorBar.PenWidth" /> property).  Units are points.</summary>
            public static float PenWidth = 1.0F;

            /// <summary>The default display mode for symbols (<see cref="ErrorBar.IsVisible" /> property). true to display symbols, false to hide them.</summary>
            public static bool IsVisible = true;

            /// <summary>The default color for drawing error bars (<see cref="ErrorBar.Color" /> property).</summary>
            public static Color Color = Color.Red;

            /// <summary>The default symbol for drawing at the top and bottom of the error bar (see <see cref="ErrorBar.Symbol" />).</summary>
        ...
        /// <see cref="ErrorBar" />.  Use the public property <see cref="IsVisible" /> to access this value.  If this value is false, the symbols will not be
        /// shown.
        /// </summary>
        private bool _isVisible;

        /// <summary>Private field that stores the error bar color.  Use the public property <see cref="Color" /> to access this value.</summary>
        private Color _color;

        /// <summary>Private field that stores the pen width for this error bar.  Use the public property <see cref="PenWidth" /> to access this value.</summary>
        private float _penWidth;

        /// <summary>
        /// private field that contains the symbol element that will be drawn at the top and bottom of the error bar.  Use the public property
        ...
        /// <summary>Gets or sets a property that shows or hides the <see cref="ErrorBar" />.</summary>
        ...
        /// </summary>
        /// <remarks>
        /// This property only controls the color of the vertical line.  The symbol color is controlled separately in the <see cref="Symbol" />
        /// property.
        /// </remarks>
        public Color Color
        {
        ...
        /// <summary>The pen width to be used for drawing error bars Units are points.</summary>
        /// <remarks>
        /// This property only controls the pen width for the vertical line.  The pen width for the symbol outline is controlled separately by the
        /// <see cref="Symbol" /> property.
        /// </remarks>
        ...
        /// <summary>Contains the symbol element that will be drawn at the top and bottom of the error bar.</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ErrorBar"/> class. Default constructor that sets all <see cref="ErrorBar"/> properties to default values as defined in the <see cref="Default"/> class.
        /// </summary>
        public ErrorBar()
            : this(Default.Color)
        {
