...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A collection class containing a list of <see cref="TextObj" /> objects to be displayed on the graph.</summary>
    ...
    public class GraphObjList : List<GraphObj>, ICloneable
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphObjList"/> class. Default constructor for the <see cref="GraphObjList"/> collection class
        /// </summary>
        public GraphObjList()
        {
        }
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="GraphObjList"/> class. 
        /// The Copy Constructor
        /// </summary>
        /// <param name="rhs">
        /// The <see cref="GraphObjList"/> object from which to copy
        /// </param>
...
*/
        ...
        /// <summary>
        /// Indexer to access the specified <see cref="GraphObj"/> object by its <see cref="GraphObj.Tag"/>. Note that the <see cref="GraphObj.Tag"/> must be
        /// a <see cref="String"/> type for this method to work.
        /// </summary>
        /// <param name="tag">
        /// The <see cref="String"/> type tag to search for.
        /// </param>
        /// <value>
        /// A <see cref="GraphObj"/> object reference.
        /// </value>
        /// <seealso cref="IndexOfTag"/>
        /// <returns>
        /// The <see cref="GraphObj"/>.
        /// </returns>
...
*/
        ...
        /// </summary>
        /// <remarks>
        /// In order for this method to work, the <see cref="GraphObj.Tag"/>
        ...
        /// </param>
        /// <returns>
        /// The zero-based index of the specified <see cref="GraphObj"/>, or -1 if the <see cref="GraphObj"/> is not in the list
        /// </returns>
        ...
        /// <summary>
        /// Render text to the specified <see cref="Graphics"/> device by calling the Draw method of each <see cref="GraphObj"/> object in the
        /// collection.
        /// </summary>
        /// <remarks>
        ...
        /// </param>
        /// <param name="zOrder">
        /// A <see cref="ZOrder"/> enumeration that controls the placement of this <see cref="GraphObj"/> relative to other graphic objects.  The order of
        /// <see cref="GraphObj"/>'s with the same <see cref="ZOrder"/> value is control by their order in this <see cref="GraphObjList"/>.
        /// </param>
        ...
        /// <summary>
        /// Determine if a mouse point is within any <see cref="GraphObj"/>, and if so, return the index number of the the <see cref="GraphObj"/>.
        /// </summary>
        /// <param name="mousePt">
        ...
        /// </param>
        /// <param name="index">
        /// The index number of the <see cref="TextObj"/>
        /// that is under the mouse point.  The <see cref="TextObj"/> object is accessible via the <see cref="GraphObjList"/> indexer property.
        /// </param>
        /// <returns>
        /// true if the mouse point is within a <see cref="GraphObj"/> bounding box, false otherwise.
        /// </returns>
