...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>A class that handles the basic attributes of a line segment.</summary>
    /// <remarks>This is the base class for <see cref="Line" /> and <see cref="Border" /> classes.</remarks>
    ...
    public class LineBase : ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="LineBase" /> class.</summary>
        public struct Default
        {
            /// <summary>The default mode for displaying line segments (<see cref="LineBase.IsVisible" />
            /// property).  True to show the line segments, false to hide them.</summary>
            public static bool IsVisible = true;

            /// <summary>The default width for line segments (<see cref="LineBase.Width" /> property). Units are points (1/72 inch).</summary>
            public static float Width = 1;

            /// <summary>The default value for the <see cref="LineBase.IsAntiAlias" />
            /// property.</summary>
            public static bool IsAntiAlias = false;

            /// <summary>
            /// The default drawing style for line segments (<see cref="LineBase.Style" /> property). This is defined with the <see cref="DashStyle" />
            /// enumeration.
            /// </summary>
            public static DashStyle Style = DashStyle.Solid;

            /// <summary>The default "dash on" size for drawing the line (<see cref="LineBase.DashOn" /> property). Units are in points (1/72 inch).</summary>
            public static float DashOn = 1.0F;

            /// <summary>The default "dash off" size for drawing the the line (<see cref="LineBase.DashOff" /> property). Units are in points (1/72 inch).</summary>
            public static float DashOff = 1.0F;

            /// <summary>The default color for the line. This is the default value for the <see cref="LineBase.Color" /> property.</summary>
        ...
        /// <summary>Private field that stores the pen width for this line. Use the public property <see cref="Width" /> to access this value.</summary>
        internal float _width;

        /// <summary>Private field that stores the <see cref="DashStyle" /> for this line.  Use the public property <see cref="Style" /> to access this value.</summary>
        internal DashStyle _style;

        /// <summary>private field that stores the "Dash On" length for drawing the line.  Use the public property <see cref="DashOn" /> to access this value.</summary>
        internal float _dashOn;

        /// <summary>private field that stores the "Dash Off" length for drawing the line.  Use the public property <see cref="DashOff" /> to access this value.</summary>
        internal float _dashOff;

        /// <summary>Private field that stores the visibility of this line.  Use the public property <see cref="IsVisible" /> to access this value.</summary>
        internal bool _isVisible;

        /// <summary>
        /// private field that determines if the line is drawn using Anti-Aliasing capabilities from the <see cref="Graphics" /> class. Use the public property
        /// <see cref="IsAntiAlias" /> to access this value.
        /// </summary>
        internal bool _isAntiAlias;

        /// <summary>
        /// Private field that stores the color of this line.  Use the public property <see cref="Color" /> to access this value.  If this value is false, the
        /// line will not be shown (but the <see cref="Symbol" /> may still be shown).
        /// </summary>
        internal Color _color;

        /// <summary>
        /// Internal field that stores a custom <see cref="Fill" /> class.  This fill is used strictly for <see cref="FillType.GradientByX" />,
        /// <see cref="FillType.GradientByY" />, <see cref="FillType.GradientByZ" />, and <see cref="FillType.GradientByColorValue" /> calculations to determine
        ...
        /// <summary>
        /// The color of the <see cref="Line" />.  Note that this color value can be overridden if the <see cref="Fill.Type">GradientFill.Type</see> is one of
        /// the
        /// <see cref="FillType.GradientByX" />,
        /// <see cref="FillType.GradientByY" />, <see cref="FillType.GradientByZ" />, and <see cref="FillType.GradientByColorValue" /> types.
        /// </summary>
        ...
        /// <summary>The style of the <see cref="Line" />, defined as a <see cref="DashStyle" /> enum. This allows the line to be solid, dashed, or dotted.</summary>
        ...
        /// <summary>The "Dash On" mode for drawing the line.</summary>
        /// <remarks>
        /// This is the distance, in points (1/72 inch), of the dash segments that make up the dashed grid lines.  This setting is only valid if
        ...
        /// <summary>The "Dash Off" mode for drawing the line.</summary>
        /// <remarks>
        /// This is the distance, in points (1/72 inch), of the spaces between the dash segments that make up the dashed grid lines.  This setting is only valid
        /// if
        /// <see cref="Style" /> is set to <see cref="DashStyle.Custom" />.
        /// </remarks>
        ...
        /// <summary>The pen width used to draw the <see cref="Line" />, in points (1/72 inch)</summary>
        ...
        /// <summary>Gets or sets a property that shows or hides the <see cref="Line" />.</summary>
        ...
        /// <summary>Gets or sets a value that determines if the lines are drawn using Anti-Aliasing capabilities from the <see cref="Graphics" /> class.</summary>
        /// <remarks>
        /// If this value is set to true, then the <see cref="Graphics.SmoothingMode" />
        /// property will be set to <see cref="SmoothingMode.HighQuality" /> only while this <see cref="Line" /> is drawn.  A value of false will leave the value
        /// of
        ...
        /// <summary>Gets or sets a custom <see cref="Fill" /> class.</summary>
        /// <remarks>
        /// This fill is used strictly for <see cref="FillType.GradientByX" />,
        /// <see cref="FillType.GradientByY" />, <see cref="FillType.GradientByZ" />, and <see cref="FillType.GradientByColorValue" /> calculations to determine
        /// the color of the line.  It overrides the <see cref="Color" /> property if one of the above <see cref="FillType" /> values are selected.
        /// </remarks>
        /// <seealso cref="Color" />
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="LineBase"/> class. Default constructor that sets all <see cref="LineBase"/> properties to default values as defined in the <see cref="Default"/> class.
        /// </summary>
        public LineBase()
            : this(Color.Empty)
        {
        ...
        /// Constructor that sets the color property to the specified value, and sets the remaining <see cref="LineBase"/> properties to default values as
        /// defined in the <see cref="Default"/> class.
        /// </summary>
        /// <param name="color">
