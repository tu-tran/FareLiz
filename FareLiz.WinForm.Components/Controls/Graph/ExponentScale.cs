...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// The ExponentScale class inherits from the <see cref="Scale" /> class, and implements the features specific to
    /// <see cref="AxisType.Exponent" />.
    /// </summary>
    /// <remarks>
    /// ExponentScale is a non-linear axis in which the values are scaled using an exponential function with the <see cref="Scale.Exponent" />
    /// property.
    /// </remarks>
    ...
    internal class ExponentScale : Scale, ISerializable
    {
        ...
        {
            return baseVal + Math.Pow(this._majorStep * iTic, this._exponent);
        }
        ...
        /// </param>
        /// <remarks>
        /// This method only applies to <see cref="AxisType.Exponent"/> type axes, and it is called by the general <see cref="Scale.PickScale"/> method.  The
        /// exponential scale relies on the <see cref="Scale.Exponent"/> property to set the scaling exponent.  This method honors the
        /// <see cref="Scale.MinAuto"/>, <see cref="Scale.MaxAuto"/>, and <see cref="Scale.MajorStepAuto"/> autorange settings. In the event that any of the
        /// autorange settings are false, the corresponding <see cref="Scale.Min"/>, <see cref="Scale.Max"/>, or <see cref="Scale.MajorStep"/>
