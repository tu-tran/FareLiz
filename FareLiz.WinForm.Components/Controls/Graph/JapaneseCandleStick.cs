...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>This class handles the drawing of the curve <see cref="JapaneseCandleStick" /> objects.</summary>
    ...
    public class JapaneseCandleStick : OHLCBar, ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="JapaneseCandleStick" /> class.</summary>
        public new struct Default
        {
            /// <summary>The default fillcolor for drawing the rising case CandleSticks (<see cref="JapaneseCandleStick.RisingFill" /> property).</summary>
            public static Color RisingColor = Color.White;

            /// <summary>The default fillcolor for drawing the falling case CandleSticks (<see cref="JapaneseCandleStick.FallingFill" /> property).</summary>
            public static Color FallingColor = Color.Black;

            /// <summary>The default color for the border of the rising CandleSticks (<see cref="JapaneseCandleStick.RisingBorder" /> property).</summary>
            public static Color RisingBorder = Color.Black;

            /// <summary>The default color for the border of the falling CandleSticks (<see cref="JapaneseCandleStick.FallingBorder" /> property).</summary>
        ...
        /// <summary>
        /// Private field to store the <see cref="Fill" /> class to be used for filling the candlestick "bars" when the <see cref="StockPt.Close" /> value is
        /// greater than the <see cref="StockPt.Open" /> value.  See the public property
        ...
        /// <summary>
        /// Private field to store the <see cref="Fill" /> class to be used for filling the candlestick "bars" when the <see cref="StockPt.Close" /> value is
        /// less than the <see cref="StockPt.Open" /> value.  See the public property
        /// <see cref="FallingFill" /> to access this value.
        /// </summary>
        private Fill _fallingFill;

        /// <summary>
        /// Private field to store the <see cref="Border" /> class to be used for drawing the candlestick "bars" when the <see cref="StockPt.Close" /> value is
        /// greater than the <see cref="StockPt.Open" /> value.  See the public property
        ...
        /// value is less than the <see cref="StockPt.Open" /> value.  Use the public property <see cref="FallingColor" /> to access this value.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the <see cref="Fill" /> class that is used to fill the candlestick "bars" when the <see cref="StockPt.Close" /> value is greater than
        /// the
        ...
        /// <summary>
        /// Gets or sets the <see cref="Fill" /> class that is used to fill the candlestick "bars" when the <see cref="StockPt.Close" /> value is less than the
        /// <see cref="StockPt.Open" /> value.
        /// </summary>
        ...
        /// <summary>
        /// The <see cref="Border" /> instance to be used for drawing the border frame of the candlestick "bars" when the <see cref="StockPt.Close" /> value is
        /// greater than the
        /// <see cref="StockPt.Open" /> value.
        /// </summary>
        ...
        /// <see cref="JapaneseCandleStick" /> when the value of the candlestick is falling.
        /// </summary>
        /// <remarks>
        /// This property only controls the color of the vertical line when the value is falling.  The rising color is controlled by the
