...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// <see cref="X2Axis" /> inherits from <see cref="Axis" />, and defines the special characteristics of a horizontal axis, specifically located at the
    /// top of the <see cref="Chart.Rect" /> of the <see cref="GraphPane" />
    /// object
    /// </summary>
    ...
    public class X2Axis : Axis, ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="X2Axis" /> class.</summary>
        public new struct Default
        {
            // Default X2 Axis properties
            /// <summary>
            /// The default display mode for the <see cref="X2Axis" />
            /// (<see cref="Axis.IsVisible" /> property). true to display the scale values, title, tic marks, false to hide the axis entirely.
            /// </summary>
            public static bool IsVisible = false;

            /// <summary>
            /// Determines if a line will be drawn at the zero value for the
            /// <see cref="X2Axis" />, that is, a line that divides the negative values from positive values.
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="X2Axis"/> class. Default constructor that sets all <see cref="X2Axis"/> properties to default values as defined in the <see cref="Default"/> class
        /// </summary>
        public X2Axis()
            : this("X2 Axis")
        {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="X2Axis"/> class. 
        /// Default constructor that sets all <see cref="X2Axis"/> properties to default values as defined in the <see cref="Default"/> class, except for the
        /// axis title
        /// </summary>
        /// <param name="title">
            ...
            : base(title)
        {
            ...
            this._scale._fontSpec.Angle = 180F;
        ...
        /// </summary>
        /// <remarks>
        /// The primary axes are the <see cref="XAxis"/> (always), the <see cref="X2Axis"/> (always), the first
        ...
        /// </param>
        /// <returns>
        /// true for a primary <see cref="Axis"/> (for the <see cref="X2Axis"/>, this is always true), false otherwise
        /// </returns>
