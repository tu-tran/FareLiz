...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// Encapsulates a CandleStick curve type that displays a vertical (or horizontal) line displaying the range of data values at each sample point, plus an
    /// starting mark and an ending mark signifying the opening and closing value for the sample.
    /// </summary>
    /// <remarks>
    /// For this type to work properly, your <see cref="IPointList" /> must contain
    /// <see cref="StockPt" /> objects, rather than ordinary <see cref="PointPair" /> types. This is because the <see cref="OHLCBarItem" /> type actually
    /// displays 5 data values but the <see cref="PointPair" /> only stores 3 data values.  The <see cref="StockPt" />
    /// stores <see cref="StockPt.Date" />, <see cref="StockPt.Close" />,
    /// <see cref="StockPt.Open" />, <see cref="StockPt.High" />, and
    /// <see cref="StockPt.Low" /> members. For a vertical CandleStick chart, the opening value is drawn as a horizontal line segment to the left of the
    /// vertical range bar, and the closing value is a horizontal line segment to the right.  The total length of these two line segments is controlled by
    /// the <see cref="OHLCBar.Size" /> property, which is specified in points (1/72nd inch), and scaled according to <see cref="PaneBase.CalcScaleFactor" />
    /// . The candlesticks are drawn horizontally or vertically depending on the value of <see cref="BarSettings.Base" />, which is a
    ...
    public class OHLCBarItem : CurveItem, ICloneable, ISerializable
    {
        ...
        /// class defined for this <see cref="OHLCBarItem" />.  Use the public property <see cref="OHLCBar" /> to access this value.
        /// </summary>
        ...
        /// <summary>Gets a reference to the <see cref="OHLCBar" /> class defined for this <see cref="OHLCBarItem" />.</summary>
        public OHLCBar Bar
        {
            get
            {
        ...
        /// </summary>
        /// <remarks>
        /// IsZIncluded is true for <see cref="OHLCBarItem"/> objects, since the Y and Z values are defined as the High and Low values for the day.
        /// </remarks>
        /// <param name="pane">
        /// The parent <see cref="GraphPane"/> of this <see cref="CurveItem"/>.
        /// </param>
        ...
        public override void DrawLegendKey(Graphics g, GraphPane pane, RectangleF rect, float scaleFactor)
        {
            ...
            {
                this._bar.Draw(g, pane, pane._barSettings.Base == BarBase.X, pixBase, pixHigh, pixLow, pixOpen, pixClose, halfSize, pen);
            }
        }
