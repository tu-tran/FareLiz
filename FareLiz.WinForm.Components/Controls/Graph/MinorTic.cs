...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>Class that holds the specific properties for the minor tics.</summary>
    ...
    public class MinorTic : ICloneable, ISerializable
    {
        ...
        /// <summary>
        /// The _is cross outside.
        /// </summary>
        internal bool _isCrossOutside;

        /// <summary>
        /// The _is cross inside.
        /// </summary>
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="MinorTic" /> class.</summary>
        public struct Default
        {
            /// <summary>The default size for the <see cref="Axis" /> minor tic marks. (<see cref="MinorTic.Size" /> property). Units are in points (1/72 inch).</summary>
            public static float Size = 2.5F;

            /// <summary>
            /// The default pen width for drawing the <see cref="Axis" /> tic marks. (<see cref="MinorTic.PenWidth" /> property). Units are in points (1/72
            /// inch).
            /// </summary>
            public static float PenWidth = 1.0F;

            /// <summary>
            /// The display mode for the <see cref="Axis" /> minor outside tic marks (<see cref="MinorTic.IsOutside" /> property). The minor tic spacing is
            /// controlled by <see cref="Scale.MinorStep" />.
            /// </summary>
            /// <value>true to show the minor tic marks (outside the axis), false otherwise</value>
            public static bool IsOutside = true;

            /// <summary>
            /// The display mode for the <see cref="Axis" /> minor inside tic marks (<see cref="MinorTic.IsInside" /> property). The minor tic spacing is controlled
            /// by <see cref="Scale.MinorStep" />.
            /// </summary>
            /// <value>true to show the minor tic marks (inside the axis), false otherwise</value>
            public static bool IsInside = true;

            /// <summary>
            /// The display mode for the <see cref="Axis" /> minor opposite tic marks (<see cref="MinorTic.IsOpposite" /> property). The minor tic spacing is
            /// controlled by <see cref="Scale.MinorStep" />.
            /// </summary>
            /// <value>true to show the minor tic marks (inside the axis on the opposite side), false otherwise</value>
            public static bool IsOpposite = true;

            /// <summary>The default display mode for the <see cref="Axis" /> minor outside "cross" tic marks (<see cref="MinorTic.IsCrossOutside" /> property).</summary>
            /// <remarks>
            /// The "cross" tics are a special, additional set of tic marks that always appear on the actual axis, even if it has been shifted due to the
            /// <see cref="Axis.Cross" /> setting.  The other tic marks are always fixed to the edges of the <see cref="Chart.Rect" />.  The cross tics are normally
            /// not displayed, since, if <see cref="Axis.CrossAuto" /> is true, they will exactly overlay the "normal" and "inside" tics.  If
            /// <see cref="Axis.CrossAuto" /> is false, then you will most likely want to enable the cross tics. The minor tic spacing is controlled by
            ...
            /// <summary>The default display mode for the <see cref="Axis" /> minor inside "cross" tic marks (<see cref="MinorTic.IsCrossInside" /> property).</summary>
            /// <remarks>
            /// The "cross" tics are a special, additional set of tic marks that always appear on the actual axis, even if it has been shifted due to the
            /// <see cref="Axis.Cross" /> setting.  The other tic marks are always fixed to the edges of the <see cref="Chart.Rect" />.  The cross tics are normally
            /// not displayed, since, if <see cref="Axis.CrossAuto" /> is true, they will exactly overlay the "normal" and "inside" tics.  If
            /// <see cref="Axis.CrossAuto" /> is false, then you will most likely want to enable the cross tics. The major tic spacing is controlled by
            /// <see cref="Scale.MinorStep" />.
            /// </remarks>
            /// <value>true to show the major cross tic marks, false otherwise</value>
            public static bool IsCrossInside = false;

            /// <summary>The default color for minor tics (<see cref="MinorTic.Color" /> property).</summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MinorTic"/> class. Default Constructor
        /// </summary>
        public MinorTic()
        {
        ...
        /// </summary>
        /// <param name="rhs">
        /// The <see cref="MinorTic"/> that is to be copied.
        /// </param>
        ...
        /// <summary>The color to use for drawing the tics of this class instance</summary>
        ...
        /// <summary>The length of the major tic marks.</summary>
        /// <remarks>This length will be scaled according to the <see cref="PaneBase.CalcScaleFactor" /> for the
        /// <see cref="GraphPane" />
        /// </remarks>
        ...
        {
            return this._size * scaleFactor;
        }

        /// <summary>
        /// This is convenience property sets the status of all the different tic properties in this instance to the same value.  true to activate all tics,
        ...
        /// <summary>Gets or sets a property that determines whether or not the minor outside tic marks are shown.</summary>
        /// <remarks>
        /// These are the tic marks on the outside of the <see cref="Axis" /> border. The minor tic spacing is controlled by
        /// <see cref="Scale.MinorStep" />.
        /// </remarks>
        ...
        /// <summary>Gets or sets a property that determines whether or not the major inside tic marks are shown.</summary>
        /// <remarks>
        /// These are the tic marks on the inside of the <see cref="Axis" /> border. The major tic spacing is controlled by
        /// <see cref="Scale.MajorStep" />.
        /// </remarks>
        ...
        /// <summary>Gets or sets a property that determines whether or not the major opposite tic marks are shown.</summary>
        /// <remarks>
        /// These are the tic marks on the inside of the <see cref="Axis" /> border on the opposite side from the axis. The major tic spacing is controlled by
        /// <see cref="Scale.MajorStep" />.
        /// </remarks>
        ...
        /// <summary>Gets or sets the display mode for the <see cref="Axis" /> major outside "cross" tic marks.</summary>
        /// <remarks>
        /// The "cross" tics are a special, additional set of tic marks that always appear on the actual axis, even if it has been shifted due to the
        /// <see cref="Axis.Cross" /> setting.  The other tic marks are always fixed to the edges of the <see cref="Chart.Rect" />.  The cross tics are normally
        /// not displayed, since, if <see cref="Axis.CrossAuto" /> is true, they will exactly overlay the "normal" and "inside" tics.  If
        ...
        /// <summary>Gets or sets the display mode for the <see cref="Axis" /> major inside "cross" tic marks.</summary>
        /// <remarks>
        /// The "cross" tics are a special, additional set of tic marks that always appear on the actual axis, even if it has been shifted due to the
        /// <see cref="Axis.Cross" /> setting.  The other tic marks are always fixed to the edges of the <see cref="Chart.Rect" />.  The cross tics are normally
        /// not displayed, since, if <see cref="Axis.CrossAuto" /> is true, they will exactly overlay the "normal" and "inside" tics.  If
        ...
        /// <summary>Gets or sets the pen width to be used when drawing the tic marks for this <see cref="Axis" />
        /// </summary>
