...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>
    /// The basic <see cref="PointPair" /> class holds three data values (X, Y, Z).  This class extends the basic PointPair to contain five data values (X,
    /// Y, Z, Open, Close).
    /// </summary>
    /// <remarks>
    ...
    public class StockPt : PointPair, ISerializable
    {
        ...
        /// <summary>This opening value</summary>
        public double Open;

        /// <summary>This closing value</summary>
        public double Close;

        /// <summary>This daily trading volume</summary>
        public double Vol;
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="StockPt"/> class. Default Constructor
        /// </summary>
        public StockPt()
        ...
        /// <summary>Map the Date property to the X value</summary>
        public double Date
        {
            get
            {
        ...
        /// <summary>Map the high property to the Y value</summary>
        public double High
        {
            get
            {
        ...
        /// <summary>Map the low property to the Z value</summary>
        public double Low
        {
            get
            {
        ...
        /// <summary>
        /// Readonly value that determines if either the Date, Close, Open, High, or Low coordinate in this StockPt is an invalid (not plotable) value. It is
        /// considered invalid if it is missing (equal to System.Double.Max), Infinity, or NaN.
        /// </summary>
        ...
        public bool IsInvalid5D
        {
            get
            {
                return this.Date == Missing || this.Close == Missing || this.Open == Missing || this.High == Missing || this.Low == Missing
                       || double.IsInfinity(this.Date) || double.IsInfinity(this.Close) || double.IsInfinity(this.Open)
                       || double.IsInfinity(this.High) || double.IsInfinity(this.Low) || double.IsNaN(this.Date) || double.IsNaN(this.Close)
                       || double.IsNaN(this.Open) || double.IsNaN(this.High) || double.IsNaN(this.Low);
            }
        }
        ...
        /// <summary>
        /// Format this StockPt value using the default format.  Example:  "( 12.345, -16.876 )". The two double values are formatted with the "g"
        /// format type.
        /// </summary>
        ...
        {
            return this.ToString(DefaultFormat, isShowAll);
        }
        ...
        public override string ToString(string format, bool isShowAll)
        {
            return "( " + XDate.ToString(this.Date, "g") + ", " + this.Close.ToString(format)
                   + (isShowAll ? (", " + this.Low.ToString(format) + ", " + this.Open.ToString(format) + ", " + this.Close.ToString(format)) : string.Empty)
                   + " )";
        }
