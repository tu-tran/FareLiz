...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>Class that handles the global settings for bar charts</summary>
    ...
    public class BarSettings : ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="BarSettings" /> class.</summary>
        public struct Default
        {
            /// <summary>The default dimension gap between clusters of bars on a
            /// <see cref="Bar" /> graph. This dimension is expressed in terms of the normal bar width.</summary>
            /// <seealso cref="Default.MinBarGap" />
            /// <seealso cref="BarSettings.MinClusterGap" />
            public static float MinClusterGap = 1.0F;

            /// <summary>
            /// The default dimension gap between each individual bar within a bar cluster on a <see cref="Bar" /> graph. This dimension is expressed in terms of the
            /// normal bar width.
            /// </summary>
            ...
            /// <summary>
            /// The default value for the <see cref="BarSettings.Type" /> property, which determines if the bars are drawn overlapping eachother in a "stacked"
            /// format, or side-by-side in a "cluster" format.  See the <see cref="BarType" />
            ...
            /// <summary>The default value for <see cref="BarSettings.ClusterScaleWidthAuto" />.</summary>
        ...
        /// <summary>
        /// Private field that determines the size of the gap between bar clusters for bar charts.  This gap is expressed as a fraction of the bar size (1.0
        /// means leave a 1-barwidth gap between clusters). Use the public property <see cref="MinClusterGap" /> to access this value.
        /// </summary>
        private float _minClusterGap;

        /// <summary>
        /// Private field that determines the size of the gap between individual bars within a bar cluster for bar charts.  This gap is expressed as a fraction
        /// of the bar size (1.0 means leave a 1-barwidth gap between each bar). Use the public property <see cref="MinBarGap" /> to access this value.
        /// </summary>
        private float _minBarGap;

        /// <summary>
        /// Private field that determines the base axis from which <see cref="Bar" />
        /// graphs will be displayed.  The base axis is the axis from which the bars grow with increasing value. The value is of the enumeration type
        /// <see cref="BarBase" />. To access this value, use the public property <see cref="Base" />.
        /// </summary>
        /// <seealso cref="Default.Base" />
        private BarBase _base;

        /// <summary>
        /// Private field that determines how the <see cref="BarItem" />
        /// graphs will be displayed. See the <see cref="BarType" /> enum for the individual types available. To access this value, use the public property
        /// <see cref="Type" />.
        /// </summary>
        ...
        /// <summary>
        /// Private field that determines the width of a bar cluster (for bar charts) in user scale units.  Normally, this value is 1.0 because bar charts are
        /// typically
        /// <see cref="AxisType.Ordinal" /> or <see cref="AxisType.Text" />, and the bars are defined at ordinal values (1.0 scale units apart).  For
        /// <see cref="AxisType.Linear" />
        /// or other scale types, you can use this value to scale the bars to an arbitrary user scale. Use the public property <see cref="ClusterScaleWidth" />
        /// to access this value.
        /// </summary>
        internal double _clusterScaleWidth;

        /// <summary>
        /// Private field that determines if the <see cref="ClusterScaleWidth" /> will be calculated automatically.  Use the public property
        /// <see cref="ClusterScaleWidthAuto" />
        /// to access this value.
        /// </summary>
        internal bool _clusterScaleWidthAuto;

        /// <summary>private field that stores the owner GraphPane that contains this BarSettings instance.</summary>
        ...
        /// </param>
        /// <param name="parentPane">
        /// The <see cref="GraphPane"/> that will be the parent of this new BarSettings object.
        /// </param>
        ...
        /// <summary>The minimum space between <see cref="Bar" /> clusters, expressed as a fraction of the bar size.</summary>
        /// <seealso cref="Default.MinClusterGap" />
        ...
        /// <summary>The minimum space between individual <see cref="Bar">Bars</see>
        /// within a cluster, expressed as a fraction of the bar size.</summary>
        /// <seealso cref="Default.MinBarGap" />
        ...
        /// graphs will be displayed.</summary>
        /// <remarks>The base axis is the axis from which the bars grow with increasing value. The value is of the enumeration type <see cref="BarBase" />.</remarks>
        /// <seealso cref="Default.Base" />
        public BarBase Base
        {
            get
        ...
        /// graphs will be displayed. See the <see cref="BarType" /> enum for the individual types available.</summary>
        /// <seealso cref="Default.Type" />
        public BarType Type
        {
            get
        ...
        /// <summary>
        /// The width of an individual bar cluster on a <see cref="Bar" /> graph. This value only applies to bar graphs plotted on non-ordinal X axis types (
        /// <see cref="AxisType.Linear" />, <see cref="AxisType.Log" />, and
        ...
        /// <see cref="Base" /> refers to an <see cref="Axis" /> of a non-ordinal type (<see cref="Scale.IsAnyOrdinal" /> is false).  The ClusterScaleWidth is
        /// calculated from the minimum difference found between any two points on the <see cref="Base" />
        /// <see cref="Axis" /> for any <see cref="BarItem" /> in the
        /// <see cref="GraphPane.CurveList" />.  The ClusterScaleWidth is set automatically each time <see cref="GraphPane.AxisChange()" /> is called.
        /// Calculations are done by the <see cref="BarSettings.CalcClusterScaleWidth" /> method.
        /// </remarks>
        ...
        /// <summary>Gets or sets a property that determines if the <see cref="ClusterScaleWidth" /> will be calculated automatically.</summary>
        /// <remarks>
        /// true for the <see cref="ClusterScaleWidth" /> to be calculated automatically based on the available data, false otherwise.  This value will be set to
        /// false automatically if the <see cref="ClusterScaleWidth" /> value is changed by the user.
        /// </remarks>
        ...
        /// <summary>
        /// Calculate the width of an individual bar cluster on a <see cref="BarItem" /> graph. This value only applies to bar graphs plotted on non-ordinal X
        /// axis types (<see cref="Scale.IsAnyOrdinal" /> is false).
        /// </summary>
        /// <remarks>
        /// This value can be calculated automatically if <see cref="ClusterScaleWidthAuto" />
        /// is set to true.  In this case, ClusterScaleWidth will be calculated if
        ...
        /// </summary>
        /// <param name="list">
        /// The <see cref="IPointList"/> list of points for the bar of interest
        /// </param>
        /// <param name="baseAxis">
        ...
        /// <summary>Determine the width, in screen pixel units, of each bar cluster including the cluster gaps and bar gaps.</summary>
        /// <remarks>
        /// This method calls the <see cref="Scale.GetClusterWidth(GraphPane)" />
        /// method for the base <see cref="Axis" /> for <see cref="Bar" /> graphs (the base <see cref="Axis" /> is assigned by the
        /// <see cref="BarSettings.Base" />
        /// property).
        /// </remarks>
        ...
        /// <summary>Determine the <see cref="Axis" /> from which the <see cref="Bar" /> charts are based.</summary>
        /// <seealso cref="BarBase" />
        /// <seealso cref="BarSettings" />
        /// <seealso cref="BarSettings.Base" />
        /// <seealso cref="Scale.GetClusterWidth(GraphPane)" />
