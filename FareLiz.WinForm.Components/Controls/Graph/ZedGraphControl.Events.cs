...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    partial class ZedGraphControl
    {
        ...
        /// <summary>A delegate that allows subscribing methods to append or modify the context menu.</summary>
        /// <param name="sender">The source <see cref="ZedGraphControl" /> object</param>
        /// <param name="menuStrip">A reference to the <see cref="ContextMenuStrip" /> object that contains the context menu.</param>
        /// <param name="mousePt">The point at which the mouse was clicked</param>
        /// <param name="objState">The current context menu RequestState</param>
        ...
        /// <summary>Subscribe to this event to be able to modify the ZedGraph context menu.</summary>
        /// <remarks>
        /// The context menu is built on the fly after a right mouse click.  You can add menu items to this menu by simply modifying the <see paramref="menu" />
        /// parameter.
        /// </remarks>
        [Bindable(true)]
        [Category("Events")]
        ...
        /// <summary>A delegate that allows notification of zoom and pan events.</summary>
        /// <param name="sender">The source <see cref="ZedGraphControl" /> object</param>
        /// <param name="oldState">A <see cref="ZoomState" /> object that corresponds to the RequestState of the
        /// <see cref="GraphPane" /> before the zoom or pan event.</param>
        /// <param name="newState">A <see cref="ZoomState" /> object that corresponds to the RequestState of the
        ...
        /// <summary>
        /// Subscribe to this event to be notified when the <see cref="GraphPane" /> is zoomed or panned by the user, either via a mouse drag operation or by the
        ...
        /// <summary>A delegate that allows notification of scroll events.</summary>
        /// <param name="sender">The source <see cref="ZedGraphControl" /> object</param>
        ...
        /// <summary>Subscribe to this event to be notified when the <see cref="GraphPane" /> is scrolled by the user using the scrollbars.</summary>
        [Bindable(true)]
        [Category("Events")]
        ...
        /// <summary>A delegate that receives notification after a point-edit operation is completed.</summary>
        /// <param name="sender">The source <see cref="ZedGraphControl" /> object</param>
        /// <param name="pane">The <see cref="GraphPane" /> object that contains the point that has been edited</param>
        /// <param name="curve">The <see cref="CurveItem" /> object that contains the point that has been edited</param>
        ...
        /// <summary>
        /// Subscribe to this event to receive notifcation and/or respond after a data point has been edited via <see cref="IsEnableHEdit" /> and
        /// <see cref="IsEnableVEdit" />.
        /// </summary>
        /// <example>
        ...
        /// <summary>A delegate that allows custom formatting of the point value tooltips</summary>
        /// <param name="sender">The source <see cref="ZedGraphControl" /> object</param>
        ...
        /// <summary>Subscribe to this event to provide custom formatting for the tooltips</summary>
        /// <example>
        ...
        /// <summary>A delegate that allows custom formatting of the cursor value tooltips</summary>
        /// <param name="sender">The source <see cref="ZedGraphControl" /> object</param>
        ...
        /// <summary>Subscribe to this event to provide custom formatting for the cursor value tooltips</summary>
        /// <example>
        /// <para>To subscribe to this event, use the following in your FormLoad method:</para>
        ...
        /// <summary>A delegate that allows notification of mouse events on Graph objects.</summary>
        /// <param name="sender">The source <see cref="ZedGraphControl" /> object</param>
        /// <param name="e">A <see cref="MouseEventArgs" /> corresponding to this event</param>
        /// <seealso cref="MouseDownEvent" />
        /// <returns>
        /// Return true if you have handled the mouse event entirely, and you do not want the <see cref="ZedGraphControl" /> to do any further action (e.g.,
        /// starting a zoom operation).  Return false if ZedGraph should go ahead and process the mouse event.
        /// </returns>
        public delegate bool ZedMouseEventHandler(ZedGraphControl sender, MouseEventArgs e);

        /// <summary>Subscribe to this event to provide notification of MouseDown clicks on graph objects</summary>
        /// <remarks>
        /// This event provides for a notification when the mouse is clicked on an object within any <see cref="GraphPane" /> of the <see cref="MasterPane" />
        /// associated with this <see cref="ZedGraphControl" />.  This event will use the
        /// <see cref="Graph.MasterPane.FindNearestPaneObject" /> method to determine which object was clicked.  The boolean value that you return from this
        /// handler determines whether or not the <see cref="ZedGraphControl" /> will do any further handling of the MouseDown event (see
        /// <see cref="ZedMouseEventHandler" />).  Return true if you have handled the MouseDown event entirely, and you do not want the
        /// <see cref="ZedGraphControl" /> to do any further action (e.g., starting a zoom operation).  Return false if ZedGraph should go ahead and process the
        /// MouseDown event.
        /// </remarks>
        [Bindable(true)]
        [Category("Events")]
        ...
        /// <summary>
        /// Hide the standard control MouseDown event so that the ZedGraphControl.MouseDownEvent can be used.  This is so that the user must return true/false in
        /// order to indicate whether or not we should respond to the event.
        /// </summary>
        [Bindable(false)]
        [Browsable(false)]
        ...
        /// <summary>
        /// Hide the standard control MouseUp event so that the ZedGraphControl.MouseUpEvent can be used.  This is so that the user must return true/false in
        /// order to indicate whether or not we should respond to the event.
        /// </summary>
        [Bindable(false)]
        [Browsable(false)]
        ...
        /// <summary>
        /// Hide the standard control MouseMove event so that the ZedGraphControl.MouseMoveEvent can be used.  This is so that the user must return true/false in
        /// order to indicate whether or not we should respond to the event.
        /// </summary>
        [Bindable(false)]
        [Browsable(false)]
        ...
        /// <summary>Subscribe to this event to provide notification of MouseUp clicks on graph objects</summary>
        /// <remarks>
        /// This event provides for a notification when the mouse is clicked on an object within any <see cref="GraphPane" /> of the <see cref="MasterPane" />
        /// associated with this <see cref="ZedGraphControl" />.  This event will use the
        /// <see cref="Graph.MasterPane.FindNearestPaneObject" /> method to determine which object was clicked.  The boolean value that you return from this
        /// handler determines whether or not the <see cref="ZedGraphControl" /> will do any further handling of the MouseUp event (see
        /// <see cref="ZedMouseEventHandler" />).  Return true if you have handled the MouseUp event entirely, and you do not want the
        /// <see cref="ZedGraphControl" /> to do any further action (e.g., starting a zoom operation).  Return false if ZedGraph should go ahead and process the
        /// MouseUp event.
        /// </remarks>
        [Bindable(true)]
        ...
        /// <summary>Subscribe to this event to provide notification of MouseMove events over graph objects</summary>
        /// <remarks>
        /// This event provides for a notification when the mouse is moving over on the control. The boolean value that you return from this handler determines
        /// whether or not the <see cref="ZedGraphControl" /> will do any further handling of the MouseMove event (see <see cref="ZedMouseEventHandler" />).
        /// Return true if you have handled the MouseMove event entirely, and you do not want the <see cref="ZedGraphControl" /> to do any further action. Return
        /// false if ZedGraph should go ahead and process the MouseMove event.
        /// </remarks>
        [Bindable(true)]
        [Category("Events")]
        ...
        /// <summary>Subscribe to this event to provide notification of Double Clicks on graph objects</summary>
        /// <remarks>
        /// This event provides for a notification when the mouse is double-clicked on an object within any <see cref="GraphPane" /> of the
        /// <see cref="MasterPane" /> associated with this <see cref="ZedGraphControl" />.  This event will use the
        /// <see cref="Graph.MasterPane.FindNearestPaneObject" /> method to determine which object was clicked.  The boolean value that you return from this
        /// handler determines whether or not the <see cref="ZedGraphControl" /> will do any further handling of the DoubleClick event (see
        /// <see cref="ZedMouseEventHandler" />).  Return true if you have handled the DoubleClick event entirely, and you do not want the
        /// <see cref="ZedGraphControl" /> to do any further action. Return false if ZedGraph should go ahead and process the DoubleClick event.
        /// </remarks>
        [Bindable(true)]
        [Category("Events")]
        ...
        /// <summary>A delegate that allows notification of clicks on ZedGraph objects that have active links enabled</summary>
        /// <param name="sender">The source <see cref="ZedGraphControl" /> object</param>
        /// <param name="pane">The source <see cref="GraphPane" /> in which the click occurred.</param>
        /// <param name="source">
        /// The source object which was clicked.  This is typically a type of <see cref="CurveItem" /> if a curve point was clicked, or a type of
        /// <see cref="GraphObj" /> if a graph object was clicked.
        /// </param>
        /// <param name="link">
        /// The <see cref="Link" /> object, belonging to
        /// <paramref name="source" />, that contains the link information
        /// </param>
        /// <param name="index">
        /// An index value, typically used if a <see cref="CurveItem" />
        /// was clicked, indicating the ordinal value of the actual point that was clicked.
        /// </param>
        /// <returns>
        /// Return true if you have handled the LinkEvent entirely, and you do not want the <see cref="ZedGraphControl" /> to do any further action. Return false
        /// if ZedGraph should go ahead and process the LinkEvent.
        /// </returns>
        public delegate bool LinkEventHandler(ZedGraphControl sender, GraphPane pane, object source, Link link, int index);

        /// <summary>Subscribe to this event to be able to respond to mouse clicks within linked objects.</summary>
        /// <remarks>
        /// Linked objects are typically either <see cref="GraphObj" /> type objects or
        /// <see cref="CurveItem" /> type objects.  These object types can include hyperlink information allowing for "drill-down" type operation.
        /// </remarks>
        ...
        protected void ZedGraphControl_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            if (pane != null && e.Button == this._linkButtons && ModifierKeys == this._linkModifierKeys)
            {
                object source;
                Link link;
                int index;
            ...
            if (pane != null && (this._isEnableHPan || this._isEnableVPan)
                && ((e.Button == this._panButtons && ModifierKeys == this._panModifierKeys)
                    || (e.Button == this._panButtons2 && ModifierKeys == this._panModifierKeys2)))
            {
                ...
                this.ZoomStateSave(this._dragPane, ZoomState.StateType.Pan);
                     ...
                     && ((e.Button == this._zoomButtons && ModifierKeys == this._zoomModifierKeys)
                         || (e.Button == this._zoomButtons2 && ModifierKeys == this._zoomModifierKeys2)))
            {
            ...
            // Revision: JCarpenter 10/06
                     ...
                     && (ModifierKeys == this._selectModifierKeys || ModifierKeys == this._selectAppendModifierKeys))
            {
                ...
                this._dragPane = pane;
                     ...
                     && (e.Button == this.EditButtons && ModifierKeys == this.EditModifierKeys))
            {
                ...
                if (pane.FindNearestPoint(mousePt, out this._dragCurve, out this._dragIndex) && this._dragCurve.Points is IPointListEdit)
                {
        ...
        /// <summary>Set the cursor according to the current mouse location.</summary>
        protected void SetCursor()
        {
            this.SetCursor(this.PointToClient(MousePosition));
        }
        ...
        protected void SetCursor(Point mousePt)
        {
            if (this._masterPane != null)
            {
                ...
                if ((this._isEnableHPan || this._isEnableVPan) && (ModifierKeys == Keys.Shift || this._isPanning) && (pane != null || this._isPanning))
                {
        ...
        /// <summary>
        /// Handle the ConfiguredType Events so ZedGraph can Escape out of a panning or zooming operation.
        /// </summary>
        /// <param name="sender">
        /// </param>
        /// <param name="e">
        ...
        private void HandleSelectionFinish(object sender, MouseEventArgs e)
        {
            ...
            if ((Math.Abs(mousePtF.X - this._dragStartPt.X) > 4) && (Math.Abs(mousePtF.Y - this._dragStartPt.Y) > 4))
            {
                ...
                if (ModifierKeys == this._selectAppendModifierKeys)
                {
