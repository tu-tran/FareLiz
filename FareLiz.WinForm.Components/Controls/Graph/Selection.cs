...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    public class Selection : CurveList
    {
        ...
        /// <summary>Subscribe to this event to receive notice that the list of selected CurveItems has changed</summary>
        ...
        /// <see cref="PieItem" />, <see cref="BarItem" />, <see cref="HiLowBarItem" />, and <see cref="JapaneseCandleStickItem" /> item types.
        /// </summary>
        public static Fill Fill = new Fill(Color.Gray);

        /// <summary>The <see cref="Line" /> type to be used for drawing "selected"
        /// <see cref="LineItem" /> and <see cref="StickItem" /> types</summary>
        public static Line Line = new Line(Color.Gray);

        // 			public static ErrorBar ErrorBar = new ErrorBar( Color.Gray );
        /// <summary>The <see cref="Symbol" /> type to be used for drawing "selected"
        /// <see cref="LineItem" /> and <see cref="ErrorBarItem" /> types.</summary>
