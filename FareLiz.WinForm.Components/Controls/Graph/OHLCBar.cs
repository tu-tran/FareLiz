...
namespace SkyDean.FareLiz.WinForm.Components.Controls.Graph
{
    ...
    /// <summary>This class handles the drawing of the curve <see cref="OHLCBar" /> objects.</summary>
    ...
    public class OHLCBar : LineBase, ICloneable, ISerializable
    {
        ...
        /// <summary>A simple struct that defines the default property values for the <see cref="OHLCBar" /> class.</summary>
        public new struct Default
        {
            // Default Symbol properties
            /// <summary>The default width for the candlesticks (see <see cref="OHLCBar.Size" />), in units of points.</summary>
            public static float Size = 12;

            /// <summary>The default display mode for symbols (<see cref="OHLCBar.IsOpenCloseVisible" /> property). true to display symbols, false to hide them.</summary>
            public static bool IsOpenCloseVisible = true;

            /// <summary>The default value for the <see cref="OHLCBar.IsAutoSize" /> property.</summary>
        ...
        /// <summary>
        /// Private field that stores the visibility of the <see cref="OHLCBar" /> open and close line segments ("wings").  Use the public property
        /// <see cref="IsOpenCloseVisible" /> to access this value.  If this value is false, the wings will not be shown.
        /// </summary>
        protected bool _isOpenCloseVisible;

        /// <summary>
        /// Private field that stores the total width for the Opening/Closing line segments.  Use the public property <see cref="Size" /> to access this
        /// value.
        /// </summary>
        protected float _size;

        /// <summary>
        /// Private field that determines if the <see cref="Size" /> property will be calculated automatically based on the minimum axis scale step size between
        ...
        /// <summary>Gets or sets a property that shows or hides the <see cref="OHLCBar" /> open/close "wings".</summary>
        ...
        public bool IsOpenCloseVisible
        {
            get
            {
                return this._isOpenCloseVisible;
            }
        ...
        /// <summary>
        /// Gets or sets the total width to be used for drawing the opening/closing line segments ("wings") of the <see cref="OHLCBar" /> items. Units are
        /// points.
        /// </summary>
        /// <remarks>
        /// The size of the candlesticks can be set by this value, which is then scaled according to the scaleFactor (see
        ...
        /// <summary>
        /// Gets or sets a value that determines if the <see cref="Size" /> property will be calculated automatically based on the minimum axis scale step size
        /// between bars.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OHLCBar"/> class. Default constructor that sets all <see cref="OHLCBar"/> properties to default values as defined in the <see cref="Default"/> class.
        /// </summary>
        public OHLCBar()
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OHLCBar"/> class. 
        /// Default constructor that sets the
        /// <see cref="Color"/> as specified, and the remaining
        /// <see cref="OHLCBar"/> properties to default values as defined in the <see cref="Default"/> class.
        /// </summary>
        /// <param name="color">
        ...
        /// </summary>
        /// <param name="rhs">
        /// The <see cref="OHLCBar"/> object from which to copy
        /// </param>
        ...
        /// <see cref="OHLCBar"/> is the X axis.  True for an <see cref="XAxis"/> base, false for a <see cref="YAxis"/> or <see cref="Y2Axis"/> base.
        /// </param>
        /// <param name="pixBase">
        ...
        /// <see cref="LineBase.Width"/> for this <see cref="OHLCBar"/>
        /// </param>
        public void Draw(
            Graphics g, 
            GraphPane pane, 
        ...
        /// </param>
        /// <param name="curve">
        /// A <see cref="OHLCBarItem"/> object representing the
        /// <see cref="OHLCBar"/>'s to be drawn.
        /// </param>
        /// <param name="baseAxis">
        /// The <see cref="Axis"/> class instance that defines the base (independent) axis for the <see cref="OHLCBar"/>
        /// </param>
        /// <param name="valueAxis">
        /// The <see cref="Axis"/> class instance that defines the value (dependent) axis for the <see cref="OHLCBar"/>
        /// </param>
        ...
        public void Draw(Graphics g, GraphPane pane, OHLCBarItem curve, Axis baseAxis, Axis valueAxis, float scaleFactor)
        {
            ...
            if (curve.Points != null)
            {
                ...
                using (Pen pen = !curve.IsSelected ? new Pen(this._color, this._width) : new Pen(Selection.Border.Color, Selection.Border.Width))
                {
        ...
        public float GetBarWidth(GraphPane pane, Axis baseAxis, float scaleFactor)
        {
            ...
            if (this._isAutoSize)
            {
                width = baseAxis._scale.GetClusterWidth(this._userScaleSize) / (1.0F + pane._barSettings.MinClusterGap) / 2.0f;
            }
            else
            {
                width = this._size * scaleFactor / 2.0f;
            }
