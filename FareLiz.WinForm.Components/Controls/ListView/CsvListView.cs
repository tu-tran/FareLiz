namespace SkyDean.FareLiz.WinForm.Components.Controls.ListView
{
    ...
    /// <summary>The csv data type.</summary>
    public enum CsvDataType
    {
        /// <summary>The csv file.</summary>
        CsvFile, 

        /// <summary>The csv string.</summary>
        CsvString
    }

    /// <summary>The csv list view.</summary>
    public class CsvListView : EnhancedListView
    {
        /// <summary>The _data lines.</summary>
        private readonly List<string[]> _dataLines = new List<string[]>();

        /// <summary>The _filtered lines.</summary>
        ...
        /// <summary>Initializes a new instance of the <see cref="CsvListView" /> class.</summary>
        public CsvListView()
        {
        ...
        /// <summary>The csv list view column sorter.</summary>
        private class CsvListViewColumnSorter : ListViewTextColumnSorter, IComparer<string[]>
        {
            ...
            public int Compare(string[] x, string[] y)
            {
                ...
                var result = StringLogicalComparer.Compare(xText, yText);
