namespace SkyDean.FareLiz.WinForm.Components.Controls.ListView
{
    ...
    /// <summary>The list view column header.</summary>
    public class ListViewColumnHeader : NativeWindow
    {
        /// <summary>The _sort info.</summary>
        ...
        /// <summary>The _owner list view.</summary>
        private EnhancedListView _ownerListView; // owning listview control        

        /// <summary>The hdr_filter.</summary>
        private bool hdr_filter; // show filterbar in header

        /// <summary>The hdr_hditem.</summary>
        private HDITEM hdr_hditem; // instance container

        /// <summary>
        /// Initializes a new instance of the <see cref="ListViewColumnHeader"/> class. Class constructor.  Initializes various elements
        /// </summary>
        /// <param name="filtered">
        /// The filtered.
        /// </param>
        ...
        /// <summary>Gets the sort info.</summary>
        ...
        public void Attach(EnhancedListView listView)
        {
            ...
            if ((int)headerHandle != 0)
            {
                ...
                // set the handle to this control.  the first dialog item for a listview is this header control...
            }
        }

        /// <summary>The clear all filters.</summary>
        ...
        private void ChangeFiltered()
        {
            ...
            var style = NativeMethods.GetWindowLong(this.Handle, W32_GWL.GWL_STYLE);
        ...
        /// <summary>The on handle change.</summary>
