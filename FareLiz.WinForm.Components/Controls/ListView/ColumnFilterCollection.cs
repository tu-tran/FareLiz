namespace SkyDean.FareLiz.WinForm.Components.Controls.ListView
{
    ...
    /// <summary>
    /// This is an indexer to the filter values for each column.  This is the most complex access to the HDITEM data since the filter data must be
    /// get/set via the HDTEXTFILTER structure referenced in the HDITEM structure.  It is simple to Marshall this, but figuring that out in the first place
    /// took alot of effort.
    /// </summary>
    public class ColumnFilterCollection
    {
        ...
        /// <summary>The _hditem.</summary>
        private HDITEM _hditem; // HDITEM instance

        /// <summary>The _hd text filter.</summary>
        private HDTEXTFILTER _hdTextFilter; // HDTEXTFILTER instance

        /// <summary>
        /// Initializes a new instance of the <see cref="ColumnFilterCollection"/> class. Constructor this must be given the header instance for access
