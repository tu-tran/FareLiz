namespace SkyDean.FareLiz.WinForm.Components.Controls.ListView
{
    ...
    public class MenuBuilderEventArgs : CancelEventArgs
    {
        ...
        /// <summary>Gets the new items.</summary>
