namespace SkyDean.FareLiz.WinForm.Components.Controls.ListView
{
    ...
    /// <summary>
    /// This is an indexer to the READONLY Size values for a column. NOTE: The Size really contains the Width and Left position, the Left is sorted in the
    /// Height property of the Size class We do this because a Rectangle is not really necessary.
    /// </summary>
