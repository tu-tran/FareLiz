    ...
    public class ColumnSizeInfoCollection
    {
        ...
        public Size this[int index]
        {
            get
            {
                ...
                if (index < this.Count)
                {
                    NativeMethods.SendMessage(this._header.Handle, W32_HDM.HDM_GETITEMRECT,
                                index, ref this._colRectangle);
                    return new Size((this._colRectangle.right - this._colRectangle.left),
                                    this._colRectangle.left);
                }
