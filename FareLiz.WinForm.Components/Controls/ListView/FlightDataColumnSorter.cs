        ...
        private int Compare(string textX, string textY)
        {
            ...
            switch (this.SortInfo.SortColumn)
            {
                ...
                case 7: // Duration
                    ...
                    break;
                case 8: // Data Date
                    DateTime xD = DateTime.ParseExact(textX, "ddd, MMM dd, yyyy h:mm:ss tt", CultureInfo.InvariantCulture);
                    DateTime yD = DateTime.ParseExact(textY, "ddd, MMM dd, yyyy h:mm:ss tt", CultureInfo.InvariantCulture);
