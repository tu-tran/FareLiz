namespace SkyDean.FareLiz.WinForm.Components.Controls.ListView
{
    ...
    public struct LVGROUP
    {
        ...
        /// </summary>
        [Description("Mask used with LVM_GETGROUPINFO (Microsoft Windows XP and Windows Vista) and LVM_SETGROUPINFO (Windows Vista only) to specify which flags in the RequestState value are being retrieved or set.")]
