namespace SkyDean.FareLiz.WinForm.Components.Controls.Button
{
    ...
    {
        /// <summary>The _auto switch state on click.</summary>
        private bool _autoSwitchStateOnClick = true;

        /// <summary>The _first state image.</summary>
        private Image _firstStateImage;

        /// <summary>The _first state text.</summary>
        private string _firstStateText;

        /// <summary>The _is second state.</summary>
        private bool _isSecondState;

        /// <summary>The _second state image.</summary>
        private Image _secondStateImage;

        /// <summary>The _second state text.</summary>
        private string _secondStateText;

        /// <summary>Gets or sets a value indicating whether auto switch state on click.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether is second state.</summary>
        ...
        /// <summary>Gets or sets the first state image.</summary>
        [Localizable(true)]
        ...
        /// <summary>Gets or sets the second state image.</summary>
        [Localizable(true)]
        ...
        /// <summary>Gets or sets the first state text.</summary>
        [Localizable(true)]
        ...
        /// <summary>Gets or sets the second state text.</summary>
        [Localizable(true)]
        ...
        /// <summary>The state changing.</summary>
