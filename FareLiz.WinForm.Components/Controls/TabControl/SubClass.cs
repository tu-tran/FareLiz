namespace SkyDean.FareLiz.WinForm.Components.Controls.TabControl
{
    ...
    /// <summary>The sub class.</summary>
    internal class SubClass : NativeWindow
    {
        /// <summary>The sub class wnd proc event handler.</summary>
        /// <param name="m">The m.</param>
        public delegate int SubClassWndProcEventHandler(ref Message m);

        /// <summary>The is sub classed.</summary>
        ...
        /// <summary>Gets or sets a value indicating whether sub classed.</summary>
        ...
        /// <summary>The sub classed wnd proc.</summary>
