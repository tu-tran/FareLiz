    ...
    partial class FlatTabControl
    {
        ...
        protected override void WndProc(ref Message m)
        {
            ...
            if (m.Msg == (int)W32_WM.WM_HSCROLL)
            {
                ...
                this.OnHScroll(new ScrollEventArgs(((ScrollEventType)NativeMethods.LoWord(m.WParam)), this._oldScrollValue, NativeMethods.HiWord(m.WParam), ScrollOrientation.HorizontalScroll));
            }
        }
