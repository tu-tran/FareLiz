namespace SkyDean.FareLiz.WinForm.Components.Controls.TabControl
{
    ...
    {
        /// <summary>The _margin.</summary>
        private const int _margin = 5;

        /// <summary>The _overlap.</summary>
        private const int _overlap = 16;

        /// <summary>The _radius.</summary>
        private const int _radius = 16;

        /// <summary>The _b up down.</summary>
        private bool _bUpDown; // true when the button UpDown is required        

        /// <summary>Initializes a new instance of the <see cref="FlatTabControl" /> class.</summary>
        ...
        {
            var hitTestInfo = new TCHITTESTINFO(isRelativeToScreen ? this.PointToClient(position) : position);
        ...
        private void DrawControl(Graphics g)
        {
            ...
            var rSaved = g.Clip;
            var nWidth = tabArea.Width + _margin;
            if (this._bUpDown)
            {
                ...
                if (NativeMethods.IsWindowVisible(this.scUpDown.Handle))
                {
                    ...
                    var rupdown2 = this.RectangleToClient(rupdown);
                    nWidth = rupdown2.X;
                }
            }
            ...
            // draw tabs
            for (var i = this.TabCount - 1; i >= 0; i--)
            {
        ...
        /// <summary>The tabpage ex collection editor.</summary>
        internal class TabpageExCollectionEditor : CollectionEditor
        {
            ...
            /// <summary>The create collection item type.</summary>
        ...
        /// <summary>Gets or sets the indicator width.</summary>
        [Category("Appearance")]
        ...
        /// <summary>The _indicator width.</summary>
        ...
        /// <summary>The _show tab borders.</summary>
        private bool _showTabBorders = true;

        /// <summary>Gets or sets a value indicating whether show tab borders.</summary>
        [Category("Appearance")]
        [DefaultValue(true)]
        ...
        /// <summary>The _use tab closer.</summary>
        private bool _useTabCloser = true;

        /// <summary>Gets or sets a value indicating whether use tab closer.</summary>
        [Category("Appearance")]
        [DefaultValue(true)]
        ...
        /// <summary>The _use tab refresher.</summary>
        private bool _useTabRefresher = true;

        /// <summary>Gets or sets a value indicating whether use tab reloader.</summary>
        [Category("Appearance")]
        [DefaultValue(true)]
    ...
    /// <summary>The tab page event handler.</summary>
